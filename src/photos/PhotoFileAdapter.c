...
#line 25 "/shotwell/src/photos/PhotoFileAdapter.vala"
	g_return_val_if_fail (filepath != NULL, NULL);
#line 25 "/shotwell/src/photos/PhotoFileAdapter.vala"
	self = (PhotoFileAdapter*) g_type_create_instance (object_type);
#line 26 "/shotwell/src/photos/PhotoFileAdapter.vala"
	_tmp0_ = filepath;
#line 26 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
#line 27 "/shotwell/src/photos/PhotoFileAdapter.vala"
	_tmp2_ = file_format;
#line 27 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
gboolean photo_file_adapter_file_exists (PhotoFileAdapter* self) {
	...
	const gchar* _tmp0_;
	gboolean _tmp1_;
#line 30 "/shotwell/src/photos/PhotoFileAdapter.vala"
	g_return_val_if_fail (IS_PHOTO_FILE_ADAPTER (self), FALSE);
#line 31 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
gchar* photo_file_adapter_get_filepath (PhotoFileAdapter* self) {
	...
	const gchar* _tmp0_;
	gchar* _tmp1_;
#line 34 "/shotwell/src/photos/PhotoFileAdapter.vala"
	g_return_val_if_fail (IS_PHOTO_FILE_ADAPTER (self), NULL);
#line 35 "/shotwell/src/photos/PhotoFileAdapter.vala"
	_tmp0_ = self->priv->filepath;
#line 35 "/shotwell/src/photos/PhotoFileAdapter.vala"
	_tmp1_ = g_strdup (_tmp0_);
#line 35 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
#line 44 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
#line 38 "/shotwell/src/photos/PhotoFileAdapter.vala"
	g_return_val_if_fail (IS_PHOTO_FILE_ADAPTER (self), NULL);
#line 351 "PhotoFileAdapter.c"
	{
		GFile* _tmp0_;
#line 40 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
#line 358 "PhotoFileAdapter.c"
		{
			...
			GFile* _tmp4_;
			GFile* _tmp5_;
#line 41 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
#line 367 "PhotoFileAdapter.c"
				const gchar* _tmp2_;
				GFile* _tmp3_;
#line 42 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
#line 47 "/shotwell/src/photos/PhotoFileAdapter.vala"
	result = _result_;
#line 47 "/shotwell/src/photos/PhotoFileAdapter.vala"
	return result;
...
#line 50 "/shotwell/src/photos/PhotoFileAdapter.vala"
	g_return_val_if_fail (IS_PHOTO_FILE_ADAPTER (self), 0);
#line 51 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
#line 20 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
#line 23 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
#line 21 "/shotwell/src/photos/PhotoFileAdapter.vala"
	_g_free0 (self->priv->filepath);
#line 23 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
#line 67 "/shotwell/src/photos/PhotoFileAdapter.vala"
	g_return_val_if_fail (filepath != NULL, NULL);
#line 68 "/shotwell/src/photos/PhotoFileAdapter.vala"
	_tmp0_ = filepath;
#line 68 "/shotwell/src/photos/PhotoFileAdapter.vala"
	_tmp1_ = file_format;
#line 68 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
PhotoFileWriter* photo_file_reader_create_writer (PhotoFileReader* self, GError** error) {
	...
	GError * _inner_error_ = NULL;
#line 71 "/shotwell/src/photos/PhotoFileAdapter.vala"
	g_return_val_if_fail (IS_PHOTO_FILE_READER (self), NULL);
#line 72 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
PhotoFileMetadataWriter* photo_file_reader_create_metadata_writer (PhotoFileReader* self, GError** error) {
	...
	GError * _inner_error_ = NULL;
#line 75 "/shotwell/src/photos/PhotoFileAdapter.vala"
	g_return_val_if_fail (IS_PHOTO_FILE_READER (self), NULL);
#line 76 "/shotwell/src/photos/PhotoFileAdapter.vala"
	_tmp1_ = photo_file_adapter_get_file_format (G_TYPE_CHECK_INSTANCE_CAST (self, TYPE_PHOTO_FILE_ADAPTER, PhotoFileAdapter));
#line 76 "/shotwell/src/photos/PhotoFileAdapter.vala"
	_tmp2_ = photo_file_adapter_get_filepath (G_TYPE_CHECK_INSTANCE_CAST (self, TYPE_PHOTO_FILE_ADAPTER, PhotoFileAdapter));
#line 76 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
static PhotoMetadata* photo_file_reader_real_read_metadata (PhotoFileReader* self, GError** error) {
#line 79 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
static GdkPixbuf* photo_file_reader_real_unscaled_read (PhotoFileReader* self, GError** error) {
#line 81 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
static GdkPixbuf* photo_file_reader_real_scaled_read (PhotoFileReader* self, Dimensions* full, Dimensions* scaled, GError** error) {
	...
	GdkPixbuf* _tmp3_;
	GError * _inner_error_ = NULL;
#line 83 "/shotwell/src/photos/PhotoFileAdapter.vala"
	g_return_val_if_fail (full != NULL, NULL);
#line 83 "/shotwell/src/photos/PhotoFileAdapter.vala"
	g_return_val_if_fail (scaled != NULL, NULL);
#line 84 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
#line 87 "/shotwell/src/photos/PhotoFileAdapter.vala"
	g_return_if_fail (IS_PHOTO_FILE_READER (self));
#line 88 "/shotwell/src/photos/PhotoFileAdapter.vala"
	_tmp0_ = role;
#line 88 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
PhotoFileReaderRole photo_file_reader_get_role (PhotoFileReader* self) {
	...
	PhotoFileReaderRole _tmp0_;
#line 91 "/shotwell/src/photos/PhotoFileAdapter.vala"
	g_return_val_if_fail (IS_PHOTO_FILE_READER (self), 0);
#line 92 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
#line 59 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
#line 65 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
PhotoFileWriter* photo_file_writer_construct (GType object_type, const gchar* filepath, PhotoFileFormat file_format) {
	...
	const gchar* _tmp0_;
	PhotoFileFormat _tmp1_;
#line 101 "/shotwell/src/photos/PhotoFileAdapter.vala"
	g_return_val_if_fail (filepath != NULL, NULL);
#line 102 "/shotwell/src/photos/PhotoFileAdapter.vala"
	_tmp0_ = filepath;
#line 102 "/shotwell/src/photos/PhotoFileAdapter.vala"
	_tmp1_ = file_format;
#line 102 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
#line 105 "/shotwell/src/photos/PhotoFileAdapter.vala"
	g_return_val_if_fail (IS_PHOTO_FILE_WRITER (self), NULL);
#line 106 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
static void photo_file_writer_real_write (PhotoFileWriter* self, GdkPixbuf* pixbuf, JpegQuality quality, GError** error) {
#line 109 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
#line 100 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
PhotoFileMetadataWriter* photo_file_metadata_writer_construct (GType object_type, const gchar* filepath, PhotoFileFormat file_format) {
	...
	const gchar* _tmp0_;
	PhotoFileFormat _tmp1_;
#line 117 "/shotwell/src/photos/PhotoFileAdapter.vala"
	g_return_val_if_fail (filepath != NULL, NULL);
#line 118 "/shotwell/src/photos/PhotoFileAdapter.vala"
	_tmp0_ = filepath;
#line 118 "/shotwell/src/photos/PhotoFileAdapter.vala"
	_tmp1_ = file_format;
#line 118 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
PhotoFileReader* photo_file_metadata_writer_create_reader (PhotoFileMetadataWriter* self) {
	...
	PhotoFileReader* _tmp3_;
	PhotoFileReader* _tmp4_;
#line 121 "/shotwell/src/photos/PhotoFileAdapter.vala"
	g_return_val_if_fail (IS_PHOTO_FILE_METADATA_WRITER (self), NULL);
#line 122 "/shotwell/src/photos/PhotoFileAdapter.vala"
	_tmp0_ = photo_file_adapter_get_file_format (G_TYPE_CHECK_INSTANCE_CAST (self, TYPE_PHOTO_FILE_ADAPTER, PhotoFileAdapter));
#line 122 "/shotwell/src/photos/PhotoFileAdapter.vala"
	_tmp1_ = photo_file_adapter_get_filepath (G_TYPE_CHECK_INSTANCE_CAST (self, TYPE_PHOTO_FILE_ADAPTER, PhotoFileAdapter));
#line 122 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
static void photo_file_metadata_writer_real_write_metadata (PhotoFileMetadataWriter* self, PhotoMetadata* metadata, GError** error) {
#line 125 "/shotwell/src/photos/PhotoFileAdapter.vala"
...
#line 116 "/shotwell/src/photos/PhotoFileAdapter.vala"
