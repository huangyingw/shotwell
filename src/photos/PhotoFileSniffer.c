...
#line 7 "/shotwell/src/photos/PhotoFileSniffer.vala"
...
#line 8 "/shotwell/src/photos/PhotoFileSniffer.vala"
	self->file_format = PHOTO_FILE_FORMAT_UNKNOWN;
#line 9 "/shotwell/src/photos/PhotoFileSniffer.vala"
	self->metadata = NULL;
#line 10 "/shotwell/src/photos/PhotoFileSniffer.vala"
	self->md5 = NULL;
#line 11 "/shotwell/src/photos/PhotoFileSniffer.vala"
	self->exif_md5 = NULL;
#line 12 "/shotwell/src/photos/PhotoFileSniffer.vala"
	self->thumbnail_md5 = NULL;
#line 13 "/shotwell/src/photos/PhotoFileSniffer.vala"
	self->format_name = NULL;
#line 14 "/shotwell/src/photos/PhotoFileSniffer.vala"
	dimensions_init (&self->image_dim, 0, 0);
#line 15 "/shotwell/src/photos/PhotoFileSniffer.vala"
	self->colorspace = GDK_COLORSPACE_RGB;
#line 16 "/shotwell/src/photos/PhotoFileSniffer.vala"
	self->channels = 0;
#line 17 "/shotwell/src/photos/PhotoFileSniffer.vala"
...
#line 43 "/shotwell/src/photos/PhotoFileSniffer.vala"
...
#line 42 "/shotwell/src/photos/PhotoFileSniffer.vala"
...
#line 43 "/shotwell/src/photos/PhotoFileSniffer.vala"
	self->file = _tmp1_;
#line 44 "/shotwell/src/photos/PhotoFileSniffer.vala"
	_tmp2_ = options;
#line 44 "/shotwell/src/photos/PhotoFileSniffer.vala"
	self->options = _tmp2_;
#line 46 "/shotwell/src/photos/PhotoFileSniffer.vala"
	_tmp3_ = options;
#line 46 "/shotwell/src/photos/PhotoFileSniffer.vala"
...
static DetectedPhotoInformation* photo_file_sniffer_real_sniff (PhotoFileSniffer* self, gboolean* is_corrupted, GError** error) {
#line 49 "/shotwell/src/photos/PhotoFileSniffer.vala"
...
#line 32 "/shotwell/src/photos/PhotoFileSniffer.vala"
	value->data[0].v_pointer = NULL;
...
#line 32 "/shotwell/src/photos/PhotoFileSniffer.vala"
	g_signal_handlers_destroy (self);
#line 38 "/shotwell/src/photos/PhotoFileSniffer.vala"
	_g_object_unref0 (self->file);
...
PhotoFileInterrogator* photo_file_interrogator_construct (GType object_type, GFile* file, PhotoFileSnifferOptions options) {
	...
	GFile* _tmp1_;
	PhotoFileSnifferOptions _tmp2_;
#line 67 "/shotwell/src/photos/PhotoFileSniffer.vala"
	g_return_val_if_fail (G_IS_FILE (file), NULL);
#line 67 "/shotwell/src/photos/PhotoFileSniffer.vala"
	self = (PhotoFileInterrogator*) g_type_create_instance (object_type);
#line 69 "/shotwell/src/photos/PhotoFileSniffer.vala"
	_tmp0_ = file;
#line 69 "/shotwell/src/photos/PhotoFileSniffer.vala"
	_tmp1_ = _g_object_ref0 (_tmp0_);
#line 69 "/shotwell/src/photos/PhotoFileSniffer.vala"
...
#line 70 "/shotwell/src/photos/PhotoFileSniffer.vala"
	_tmp2_ = options;
#line 70 "/shotwell/src/photos/PhotoFileSniffer.vala"
...
#line 76 "/shotwell/src/photos/PhotoFileSniffer.vala"
...
#line 75 "/shotwell/src/photos/PhotoFileSniffer.vala"
...
gboolean photo_file_interrogator_get_is_photo_corrupted (PhotoFileInterrogator* self) {
	...
	gboolean _tmp0_;
#line 80 "/shotwell/src/photos/PhotoFileSniffer.vala"
	g_return_val_if_fail (IS_PHOTO_FILE_INTERROGATOR (self), FALSE);
#line 81 "/shotwell/src/photos/PhotoFileSniffer.vala"
...
#line 84 "/shotwell/src/photos/PhotoFileSniffer.vala"
	g_return_if_fail (IS_PHOTO_FILE_INTERROGATOR (self));
#line 85 "/shotwell/src/photos/PhotoFileSniffer.vala"
...
#line 86 "/shotwell/src/photos/PhotoFileSniffer.vala"
				_tmp2_ = file_format;
#line 86 "/shotwell/src/photos/PhotoFileSniffer.vala"
...
#line 86 "/shotwell/src/photos/PhotoFileSniffer.vala"
				sniffer = _tmp5_;
#line 89 "/shotwell/src/photos/PhotoFileSniffer.vala"
				_tmp7_ = sniffer;
#line 89 "/shotwell/src/photos/PhotoFileSniffer.vala"
...
#line 90 "/shotwell/src/photos/PhotoFileSniffer.vala"
...
#line 91 "/shotwell/src/photos/PhotoFileSniffer.vala"
...
#line 93 "/shotwell/src/photos/PhotoFileSniffer.vala"
...
#line 1041 "PhotoFileSniffer.c"
					...
					gboolean _tmp17_;
#line 94 "/shotwell/src/photos/PhotoFileSniffer.vala"
...
#line 1048 "PhotoFileSniffer.c"
						...
						gchar* _tmp19_;
						gchar* _tmp20_;
#line 95 "/shotwell/src/photos/PhotoFileSniffer.vala"
...
#line 95 "/shotwell/src/photos/PhotoFileSniffer.vala"
						_g_free0 (_tmp20_);
#line 96 "/shotwell/src/photos/PhotoFileSniffer.vala"
						self->priv->is_photo_corrupted = TRUE;
#line 97 "/shotwell/src/photos/PhotoFileSniffer.vala"
						_detected_photo_information_unref0 (self->priv->detected);
#line 97 "/shotwell/src/photos/PhotoFileSniffer.vala"
						self->priv->detected = NULL;
#line 99 "/shotwell/src/photos/PhotoFileSniffer.vala"
						_detected_photo_information_unref0 (_tmp6_);
#line 99 "/shotwell/src/photos/PhotoFileSniffer.vala"
						_photo_file_sniffer_unref0 (sniffer);
#line 99 "/shotwell/src/photos/PhotoFileSniffer.vala"
...
#line 61 "/shotwell/src/photos/PhotoFileSniffer.vala"
	value->data[0].v_pointer = NULL;
...
#line 64 "/shotwell/src/photos/PhotoFileSniffer.vala"
	self->priv->detected = NULL;
#line 65 "/shotwell/src/photos/PhotoFileSniffer.vala"
...
#line 61 "/shotwell/src/photos/PhotoFileSniffer.vala"
	g_signal_handlers_destroy (self);
#line 62 "/shotwell/src/photos/PhotoFileSniffer.vala"
	_g_object_unref0 (self->priv->file);
#line 64 "/shotwell/src/photos/PhotoFileSniffer.vala"
	_detected_photo_information_unref0 (self->priv->detected);
