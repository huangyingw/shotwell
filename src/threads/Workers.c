...
#line 10 "/shotwell/src/threads/Workers.vala"
	return result;
#line 204 "Workers.c"
}
...
#line 9 "/shotwell/src/threads/Workers.vala"
	return self;
#line 214 "Workers.c"
}
...
#line 8 "/shotwell/src/threads/Workers.vala"
...
static void _background_job_unref0_ (gpointer var) {
#line 19 "/shotwell/src/threads/Workers.vala"
...
static void _workers_thread_start_gfunc (gpointer data, gpointer self) {
#line 31 "/shotwell/src/threads/Workers.vala"
...
#line 23 "/shotwell/src/threads/Workers.vala"
	self = (Workers*) g_type_create_instance (object_type);
#line 24 "/shotwell/src/threads/Workers.vala"
	_tmp1_ = max_threads;
#line 24 "/shotwell/src/threads/Workers.vala"
	if (_tmp1_ <= ((guint) 0)) {
#line 274 "Workers.c"
...
#line 24 "/shotwell/src/threads/Workers.vala"
	if (_tmp0_) {
#line 25 "/shotwell/src/threads/Workers.vala"
		max_threads = (guint) 1;
#line 290 "Workers.c"
	}
#line 28 "/shotwell/src/threads/Workers.vala"
...
#line 30 "/shotwell/src/threads/Workers.vala"
...
#line 30 "/shotwell/src/threads/Workers.vala"
		_inner_error_ = NULL;
#line 33 "/shotwell/src/threads/Workers.vala"
		_tmp9_ = err->message;
#line 33 "/shotwell/src/threads/Workers.vala"
...
guint workers_threads_per_cpu (gint per, gint max) {
	...
	guint _tmp9_;
	guint _tmp10_;
#line 37 "/shotwell/src/threads/Workers.vala"
	_tmp0_ = per;
#line 37 "/shotwell/src/threads/Workers.vala"
	_vala_return_val_if_fail (_tmp0_ > 0, "per > 0", 0U);
#line 38 "/shotwell/src/threads/Workers.vala"
	_tmp1_ = g_get_num_processors ();
#line 38 "/shotwell/src/threads/Workers.vala"
	_tmp2_ = per;
#line 38 "/shotwell/src/threads/Workers.vala"
	count = _tmp1_ * _tmp2_;
#line 40 "/shotwell/src/threads/Workers.vala"
	_tmp4_ = max;
#line 40 "/shotwell/src/threads/Workers.vala"
	if (_tmp4_ < 0) {
#line 403 "Workers.c"
...
guint workers_thread_per_cpu_minus_one (void) {
	...
	guint _tmp2_;
	guint _tmp3_;
#line 46 "/shotwell/src/threads/Workers.vala"
...
#line 55 "/shotwell/src/threads/Workers.vala"
...
void workers_enqueue (Workers* self, BackgroundJob* job) {
	...
	GError * _inner_error_ = NULL;
#line 51 "/shotwell/src/threads/Workers.vala"
	g_return_if_fail (IS_WORKERS (self));
#line 51 "/shotwell/src/threads/Workers.vala"
	g_return_if_fail (IS_BACKGROUND_JOB (job));
#line 52 "/shotwell/src/threads/Workers.vala"
...
#line 485 "Workers.c"
	{
		GAsyncQueue* _tmp1_;
#line 54 "/shotwell/src/threads/Workers.vala"
...
#line 56 "/shotwell/src/threads/Workers.vala"
...
#line 60 "/shotwell/src/threads/Workers.vala"
...
#line 554 "Workers.c"
	...
	__catch10_g_thread_error:
	{
		...
		GError* _tmp9_;
		const gchar* _tmp10_;
#line 59 "/shotwell/src/threads/Workers.vala"
		err = _inner_error_;
#line 59 "/shotwell/src/threads/Workers.vala"
		_inner_error_ = NULL;
#line 64 "/shotwell/src/threads/Workers.vala"
		_tmp9_ = err;
#line 64 "/shotwell/src/threads/Workers.vala"
...
void workers_enqueue_many (Workers* self, BackgroundJobBatch* batch) {
#line 68 "/shotwell/src/threads/Workers.vala"
	g_return_if_fail (IS_WORKERS (self));
#line 68 "/shotwell/src/threads/Workers.vala"
...
#line 596 "Workers.c"
	{
		...
		GeeIterator* _tmp1_;
#line 69 "/shotwell/src/threads/Workers.vala"
		_tmp0_ = batch;
#line 69 "/shotwell/src/threads/Workers.vala"
...
#line 70 "/shotwell/src/threads/Workers.vala"
			_tmp6_ = job;
#line 70 "/shotwell/src/threads/Workers.vala"
...
void workers_wait_for_empty_queue (Workers* self) {
	EventSemaphore* _tmp0_;
#line 73 "/shotwell/src/threads/Workers.vala"
	g_return_if_fail (IS_WORKERS (self));
#line 74 "/shotwell/src/threads/Workers.vala"
	_tmp0_ = self->priv->empty_event;
#line 74 "/shotwell/src/threads/Workers.vala"
...
gint workers_get_pending_job_count (Workers* self) {
	gint result = 0;
	GError * _inner_error_ = NULL;
#line 78 "/shotwell/src/threads/Workers.vala"
	g_return_val_if_fail (IS_WORKERS (self), 0);
#line 664 "Workers.c"
	{
		GAsyncQueue* _tmp0_;
		gint _tmp4_ = 0;
#line 79 "/shotwell/src/threads/Workers.vala"
...
#line 672 "Workers.c"
		{
			gint _tmp1_;
#line 80 "/shotwell/src/threads/Workers.vala"
...
static void workers_thread_start (Workers* self, void* ignored) {
	...
	gboolean _tmp7_;
	GError * _inner_error_ = NULL;
#line 84 "/shotwell/src/threads/Workers.vala"
	g_return_if_fail (IS_WORKERS (self));
#line 719 "Workers.c"
	{
		GAsyncQueue* _tmp0_;
#line 87 "/shotwell/src/threads/Workers.vala"
		_tmp0_ = self->priv->queue;
#line 87 "/shotwell/src/threads/Workers.vala"
		g_rec_mutex_lock (&self->priv->__lock_queue);
#line 726 "Workers.c"
		{
			...
			gint _tmp4_;
			gint _tmp5_;
#line 88 "/shotwell/src/threads/Workers.vala"
			_tmp1_ = self->priv->queue;
#line 88 "/shotwell/src/threads/Workers.vala"
...
#line 89 "/shotwell/src/threads/Workers.vala"
			_vala_assert (job != NULL, "job != null");
#line 91 "/shotwell/src/threads/Workers.vala"
			_tmp3_ = self->priv->enqueued;
#line 91 "/shotwell/src/threads/Workers.vala"
			_vala_assert (_tmp3_ > 0, "enqueued > 0");
#line 92 "/shotwell/src/threads/Workers.vala"
...
#line 95 "/shotwell/src/threads/Workers.vala"
	_tmp7_ = background_job_is_cancelled (job);
#line 95 "/shotwell/src/threads/Workers.vala"
	if (!_tmp7_) {
#line 96 "/shotwell/src/threads/Workers.vala"
		background_job_execute (job);
#line 785 "Workers.c"
	}
#line 98 "/shotwell/src/threads/Workers.vala"
	background_job_internal_notify_completion (job);
#line 100 "/shotwell/src/threads/Workers.vala"
	if (empty) {
#line 791 "Workers.c"
		EventSemaphore* _tmp8_;
#line 101 "/shotwell/src/threads/Workers.vala"
...
#line 15 "/shotwell/src/threads/Workers.vala"
...
#line 20 "/shotwell/src/threads/Workers.vala"
	_tmp1_ = event_semaphore_new ();
#line 20 "/shotwell/src/threads/Workers.vala"
	self->priv->empty_event = _tmp1_;
#line 21 "/shotwell/src/threads/Workers.vala"
...
#line 18 "/shotwell/src/threads/Workers.vala"
	_g_thread_pool_free0 (self->priv->thread_pool);
#line 19 "/shotwell/src/threads/Workers.vala"
