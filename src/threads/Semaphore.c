...
#line 30 "/shotwell/src/threads/Semaphore.vala"
	self = (AbstractSemaphore*) g_type_create_instance (object_type);
#line 31 "/shotwell/src/threads/Semaphore.vala"
	_tmp1_ = type;
#line 31 "/shotwell/src/threads/Semaphore.vala"
...
#line 33 "/shotwell/src/threads/Semaphore.vala"
	_tmp3_ = type;
#line 33 "/shotwell/src/threads/Semaphore.vala"
...
#line 36 "/shotwell/src/threads/Semaphore.vala"
	g_return_if_fail (IS_ABSTRACT_SEMAPHORE (self));
#line 37 "/shotwell/src/threads/Semaphore.vala"
	_tmp0_ = self->priv->type;
#line 37 "/shotwell/src/threads/Semaphore.vala"
	if (_tmp0_ == ABSTRACT_SEMAPHORE_TYPE_SERIAL) {
#line 38 "/shotwell/src/threads/Semaphore.vala"
		g_cond_signal (&self->priv->monitor);
#line 305 "Semaphore.c"
	} else {
#line 40 "/shotwell/src/threads/Semaphore.vala"
...
#line 43 "/shotwell/src/threads/Semaphore.vala"
	g_return_if_fail (IS_ABSTRACT_SEMAPHORE (self));
#line 44 "/shotwell/src/threads/Semaphore.vala"
	g_mutex_lock (&self->priv->mutex);
#line 46 "/shotwell/src/threads/Semaphore.vala"
	_tmp0_ = abstract_semaphore_do_notify (self);
#line 46 "/shotwell/src/threads/Semaphore.vala"
	action = _tmp0_;
#line 47 "/shotwell/src/threads/Semaphore.vala"
	_tmp1_ = action;
#line 47 "/shotwell/src/threads/Semaphore.vala"
	switch (_tmp1_) {
#line 47 "/shotwell/src/threads/Semaphore.vala"
...
#line 332 "Semaphore.c"
		{
#line 50 "/shotwell/src/threads/Semaphore.vala"
			break;
...
#line 340 "Semaphore.c"
		{
#line 53 "/shotwell/src/threads/Semaphore.vala"
			abstract_semaphore_trigger (self);
#line 54 "/shotwell/src/threads/Semaphore.vala"
			break;
#line 346 "Semaphore.c"
		...
		default:
		{
			...
			GEnumValue* _tmp3_;
#line 57 "/shotwell/src/threads/Semaphore.vala"
			_tmp2_ = action;
#line 57 "/shotwell/src/threads/Semaphore.vala"
...
#line 60 "/shotwell/src/threads/Semaphore.vala"
...
static AbstractSemaphoreNotifyAction abstract_semaphore_real_do_notify (AbstractSemaphore* self) {
#line 64 "/shotwell/src/threads/Semaphore.vala"
...
void abstract_semaphore_wait (AbstractSemaphore* self) {
#line 66 "/shotwell/src/threads/Semaphore.vala"
	g_return_if_fail (IS_ABSTRACT_SEMAPHORE (self));
#line 67 "/shotwell/src/threads/Semaphore.vala"
	g_mutex_lock (&self->priv->mutex);
#line 69 "/shotwell/src/threads/Semaphore.vala"
	while (TRUE) {
...
#line 70 "/shotwell/src/threads/Semaphore.vala"
		g_cond_wait (&self->priv->monitor, &self->priv->mutex);
#line 404 "Semaphore.c"
	}
#line 72 "/shotwell/src/threads/Semaphore.vala"
	g_mutex_unlock (&self->priv->mutex);
...
static AbstractSemaphoreWaitAction abstract_semaphore_real_do_wait (AbstractSemaphore* self) {
#line 76 "/shotwell/src/threads/Semaphore.vala"
...
gboolean abstract_semaphore_reset (AbstractSemaphore* self) {
	...
	gboolean _tmp0_;
#line 79 "/shotwell/src/threads/Semaphore.vala"
	g_return_val_if_fail (IS_ABSTRACT_SEMAPHORE (self), FALSE);
#line 80 "/shotwell/src/threads/Semaphore.vala"
	g_mutex_lock (&self->priv->mutex);
#line 81 "/shotwell/src/threads/Semaphore.vala"
	_tmp0_ = abstract_semaphore_do_reset (self);
#line 81 "/shotwell/src/threads/Semaphore.vala"
	is_reset = _tmp0_;
#line 82 "/shotwell/src/threads/Semaphore.vala"
	g_mutex_unlock (&self->priv->mutex);
#line 84 "/shotwell/src/threads/Semaphore.vala"
	result = is_reset;
#line 84 "/shotwell/src/threads/Semaphore.vala"
	return result;
...
static gboolean abstract_semaphore_real_do_reset (AbstractSemaphore* self) {
	gboolean result = FALSE;
#line 90 "/shotwell/src/threads/Semaphore.vala"
	result = FALSE;
#line 90 "/shotwell/src/threads/Semaphore.vala"
	return result;
...
gboolean abstract_semaphore_do_reset (AbstractSemaphore* self) {
#line 89 "/shotwell/src/threads/Semaphore.vala"
	g_return_val_if_fail (IS_ABSTRACT_SEMAPHORE (self), FALSE);
#line 89 "/shotwell/src/threads/Semaphore.vala"
...
#line 10 "/shotwell/src/threads/Semaphore.vala"
...
#line 27 "/shotwell/src/threads/Semaphore.vala"
	g_mutex_init (&self->priv->mutex);
#line 28 "/shotwell/src/threads/Semaphore.vala"
...
static AbstractSemaphoreNotifyAction semaphore_real_do_notify (AbstractSemaphore* base) {
	...
	gboolean _tmp0_;
#line 101 "/shotwell/src/threads/Semaphore.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_SEMAPHORE, Semaphore);
#line 102 "/shotwell/src/threads/Semaphore.vala"
	_tmp0_ = self->priv->passed;
#line 102 "/shotwell/src/threads/Semaphore.vala"
	if (_tmp0_) {
#line 103 "/shotwell/src/threads/Semaphore.vala"
		result = ABSTRACT_SEMAPHORE_NOTIFY_ACTION_NONE;
#line 103 "/shotwell/src/threads/Semaphore.vala"
		return result;
#line 765 "Semaphore.c"
	}
#line 105 "/shotwell/src/threads/Semaphore.vala"
	self->priv->passed = TRUE;
#line 107 "/shotwell/src/threads/Semaphore.vala"
...
static AbstractSemaphoreWaitAction semaphore_real_do_wait (AbstractSemaphore* base) {
	...
	gboolean _tmp1_;
#line 110 "/shotwell/src/threads/Semaphore.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_SEMAPHORE, Semaphore);
#line 111 "/shotwell/src/threads/Semaphore.vala"
...
#line 94 "/shotwell/src/threads/Semaphore.vala"
...
#line 95 "/shotwell/src/threads/Semaphore.vala"
...
CountdownSemaphore* countdown_semaphore_construct (GType object_type, gint total) {
	...
	gint _tmp0_;
#line 120 "/shotwell/src/threads/Semaphore.vala"
	self = (CountdownSemaphore*) abstract_semaphore_construct (object_type, ABSTRACT_SEMAPHORE_TYPE_BROADCAST);
#line 122 "/shotwell/src/threads/Semaphore.vala"
	_tmp0_ = total;
#line 122 "/shotwell/src/threads/Semaphore.vala"
	self->priv->total = _tmp0_;
#line 119 "/shotwell/src/threads/Semaphore.vala"
	return self;
...
static AbstractSemaphoreNotifyAction countdown_semaphore_real_do_notify (AbstractSemaphore* base) {
	...
	gint _tmp6_;
	gint _tmp7_;
#line 125 "/shotwell/src/threads/Semaphore.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_COUNTDOWN_SEMAPHORE, CountdownSemaphore);
#line 126 "/shotwell/src/threads/Semaphore.vala"
	_tmp0_ = self->priv->passed;
#line 126 "/shotwell/src/threads/Semaphore.vala"
...
#line 889 "Semaphore.c"
		gint _tmp2_;
		gint _tmp3_;
#line 127 "/shotwell/src/threads/Semaphore.vala"
...
#line 129 "/shotwell/src/threads/Semaphore.vala"
...
static AbstractSemaphoreWaitAction countdown_semaphore_real_do_wait (AbstractSemaphore* base) {
	...
	gint _tmp1_;
	gint _tmp2_;
#line 132 "/shotwell/src/threads/Semaphore.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_COUNTDOWN_SEMAPHORE, CountdownSemaphore);
#line 133 "/shotwell/src/threads/Semaphore.vala"
	_tmp1_ = self->priv->passed;
#line 133 "/shotwell/src/threads/Semaphore.vala"
...
#line 115 "/shotwell/src/threads/Semaphore.vala"
...
#line 117 "/shotwell/src/threads/Semaphore.vala"
	self->priv->passed = 0;
...
static AbstractSemaphoreNotifyAction event_semaphore_real_do_notify (AbstractSemaphore* base) {
	EventSemaphore * self;
	AbstractSemaphoreNotifyAction result = 0;
#line 144 "/shotwell/src/threads/Semaphore.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_EVENT_SEMAPHORE, EventSemaphore);
#line 145 "/shotwell/src/threads/Semaphore.vala"
	self->priv->fired = TRUE;
#line 147 "/shotwell/src/threads/Semaphore.vala"
	result = ABSTRACT_SEMAPHORE_NOTIFY_ACTION_SIGNAL;
#line 147 "/shotwell/src/threads/Semaphore.vala"
	return result;
...
static AbstractSemaphoreWaitAction event_semaphore_real_do_wait (AbstractSemaphore* base) {
	...
	AbstractSemaphoreWaitAction _tmp0_ = 0;
	gboolean _tmp1_;
#line 150 "/shotwell/src/threads/Semaphore.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_EVENT_SEMAPHORE, EventSemaphore);
#line 151 "/shotwell/src/threads/Semaphore.vala"
...
static gboolean event_semaphore_real_do_reset (AbstractSemaphore* base) {
	EventSemaphore * self;
	gboolean result = FALSE;
#line 154 "/shotwell/src/threads/Semaphore.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_EVENT_SEMAPHORE, EventSemaphore);
#line 155 "/shotwell/src/threads/Semaphore.vala"
	self->priv->fired = FALSE;
#line 157 "/shotwell/src/threads/Semaphore.vala"
	result = TRUE;
#line 157 "/shotwell/src/threads/Semaphore.vala"
	return result;
...
#line 137 "/shotwell/src/threads/Semaphore.vala"
...
#line 138 "/shotwell/src/threads/Semaphore.vala"
	self->priv->fired = FALSE;
