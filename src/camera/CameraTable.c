...
#line 14 "/shotwell/src/camera/CameraTable.vala"
...
DiscoveredCamera* discovered_camera_construct (GType object_type, Camera* gcamera, const gchar* uri, const gchar* display_name, const gchar* icon) {
	...
	const gchar* _tmp6_;
	gchar* _tmp7_;
#line 13 "/shotwell/src/camera/CameraTable.vala"
...
#line 14 "/shotwell/src/camera/CameraTable.vala"
	self->gcamera = _tmp1_;
#line 15 "/shotwell/src/camera/CameraTable.vala"
	_tmp2_ = uri;
#line 15 "/shotwell/src/camera/CameraTable.vala"
...
#line 15 "/shotwell/src/camera/CameraTable.vala"
	self->uri = _tmp3_;
#line 16 "/shotwell/src/camera/CameraTable.vala"
	_tmp4_ = display_name;
#line 16 "/shotwell/src/camera/CameraTable.vala"
...
#line 17 "/shotwell/src/camera/CameraTable.vala"
	_tmp6_ = icon;
#line 17 "/shotwell/src/camera/CameraTable.vala"
...
#line 7 "/shotwell/src/camera/CameraTable.vala"
...
#line 8 "/shotwell/src/camera/CameraTable.vala"
	_gp_camera_unref0 (self->gcamera);
#line 9 "/shotwell/src/camera/CameraTable.vala"
	_g_free0 (self->uri);
#line 10 "/shotwell/src/camera/CameraTable.vala"
	_g_free0 (self->display_name);
#line 11 "/shotwell/src/camera/CameraTable.vala"
	_g_free0 (self->icon);
...
static void _camera_table_on_update_cameras_one_shot_callback (gpointer self) {
#line 42 "/shotwell/src/camera/CameraTable.vala"
...
static void _camera_table_on_udev_event_g_udev_client_uevent (GUdevClient* _sender, const gchar* action, GUdevDevice* device, gpointer self) {
#line 46 "/shotwell/src/camera/CameraTable.vala"
...
static void _camera_table_on_volume_changed_g_volume_monitor_volume_changed (GVolumeMonitor* _sender, GVolume* volume, gpointer self) {
#line 48 "/shotwell/src/camera/CameraTable.vala"
...
static void _camera_table_on_volume_changed_g_volume_monitor_volume_added (GVolumeMonitor* _sender, GVolume* volume, gpointer self) {
#line 49 "/shotwell/src/camera/CameraTable.vala"
	camera_table_on_volume_changed ((CameraTable*) self, volume);
...
#line 54 "/shotwell/src/camera/CameraTable.vala"
	return result;
...
#line 41 "/shotwell/src/camera/CameraTable.vala"
...
#line 47 "/shotwell/src/camera/CameraTable.vala"
...
#line 57 "/shotwell/src/camera/CameraTable.vala"
	g_return_val_if_fail (IS_CAMERA_TABLE (self), FALSE);
#line 60 "/shotwell/src/camera/CameraTable.vala"
...
#line 673 "CameraTable.c"
	{
#line 63 "/shotwell/src/camera/CameraTable.vala"
...
#line 692 "CameraTable.c"
	...
	__catch57_gphoto_error:
	{
		...
		GError* _tmp3_;
		const gchar* _tmp4_;
#line 62 "/shotwell/src/camera/CameraTable.vala"
		err = _inner_error_;
#line 62 "/shotwell/src/camera/CameraTable.vala"
		_inner_error_ = NULL;
#line 65 "/shotwell/src/camera/CameraTable.vala"
		_tmp3_ = err;
#line 65 "/shotwell/src/camera/CameraTable.vala"
		_tmp4_ = _tmp3_->message;
#line 65 "/shotwell/src/camera/CameraTable.vala"
		g_warning ("CameraTable.vala:65: Unable to initialize camera table: %s", _tmp4_);
#line 67 "/shotwell/src/camera/CameraTable.vala"
		result = FALSE;
#line 67 "/shotwell/src/camera/CameraTable.vala"
		_g_error_free0 (err);
#line 67 "/shotwell/src/camera/CameraTable.vala"
...
#line 730 "CameraTable.c"
	...
	{
#line 71 "/shotwell/src/camera/CameraTable.vala"
...
#line 750 "CameraTable.c"
	...
	__catch58_gphoto_error:
	{
		...
		GError* _tmp7_;
		const gchar* _tmp8_;
#line 70 "/shotwell/src/camera/CameraTable.vala"
		err = _inner_error_;
#line 70 "/shotwell/src/camera/CameraTable.vala"
		_inner_error_ = NULL;
#line 73 "/shotwell/src/camera/CameraTable.vala"
		_tmp7_ = err;
#line 73 "/shotwell/src/camera/CameraTable.vala"
...
#line 78 "/shotwell/src/camera/CameraTable.vala"
...
#line 79 "/shotwell/src/camera/CameraTable.vala"
	result = FALSE;
#line 79 "/shotwell/src/camera/CameraTable.vala"
	return result;
...
#line 86 "/shotwell/src/camera/CameraTable.vala"
...
CameraTable* camera_table_get_instance (void) {
	...
	CameraTable* _tmp2_;
	CameraTable* _tmp3_;
#line 83 "/shotwell/src/camera/CameraTable.vala"
	_tmp0_ = camera_table_instance;
#line 83 "/shotwell/src/camera/CameraTable.vala"
	if (_tmp0_ == NULL) {
#line 818 "CameraTable.c"
		CameraTable* _tmp1_;
#line 84 "/shotwell/src/camera/CameraTable.vala"
...
#line 89 "/shotwell/src/camera/CameraTable.vala"
	g_return_val_if_fail (IS_CAMERA_TABLE (self), NULL);
#line 90 "/shotwell/src/camera/CameraTable.vala"
...
gint camera_table_get_count (CameraTable* self) {
	...
	gint _tmp1_;
	gint _tmp2_;
#line 93 "/shotwell/src/camera/CameraTable.vala"
	g_return_val_if_fail (IS_CAMERA_TABLE (self), 0);
#line 94 "/shotwell/src/camera/CameraTable.vala"
	_tmp0_ = self->priv->camera_map;
#line 94 "/shotwell/src/camera/CameraTable.vala"
...
DiscoveredCamera* camera_table_get_for_uri (CameraTable* self, const gchar* uri) {
	...
	const gchar* _tmp1_;
	gpointer _tmp2_;
#line 97 "/shotwell/src/camera/CameraTable.vala"
	g_return_val_if_fail (IS_CAMERA_TABLE (self), NULL);
#line 97 "/shotwell/src/camera/CameraTable.vala"
	g_return_val_if_fail (uri != NULL, NULL);
#line 98 "/shotwell/src/camera/CameraTable.vala"
	_tmp0_ = self->priv->camera_map;
#line 98 "/shotwell/src/camera/CameraTable.vala"
	_tmp1_ = uri;
#line 98 "/shotwell/src/camera/CameraTable.vala"
...
static void camera_table_do_op (CameraTable* self, int res, const gchar* op, GError** error) {
	int _tmp0_;
	GError * _inner_error_ = NULL;
#line 101 "/shotwell/src/camera/CameraTable.vala"
	g_return_if_fail (IS_CAMERA_TABLE (self));
#line 101 "/shotwell/src/camera/CameraTable.vala"
	g_return_if_fail (op != NULL);
#line 102 "/shotwell/src/camera/CameraTable.vala"
	_tmp0_ = res;
#line 102 "/shotwell/src/camera/CameraTable.vala"
	if (_tmp0_ != GP_OK) {
#line 916 "CameraTable.c"
		...
		const gchar* _tmp4_;
		GError* _tmp5_;
#line 103 "/shotwell/src/camera/CameraTable.vala"
		_tmp1_ = res;
#line 103 "/shotwell/src/camera/CameraTable.vala"
		_tmp2_ = op;
#line 103 "/shotwell/src/camera/CameraTable.vala"
...
static void camera_table_init_camera_table (CameraTable* self, GError** error) {
	...
	int _tmp4_;
	GError * _inner_error_ = NULL;
#line 106 "/shotwell/src/camera/CameraTable.vala"
	g_return_if_fail (IS_CAMERA_TABLE (self));
#line 107 "/shotwell/src/camera/CameraTable.vala"
...
#line 108 "/shotwell/src/camera/CameraTable.vala"
...
#line 115 "/shotwell/src/camera/CameraTable.vala"
...
static void _vala_array_add66 (gchar** * array, int* length, int* size, gchar* value) {
#line 135 "/shotwell/src/camera/CameraTable.vala"
	if ((*length) == (*size)) {
#line 135 "/shotwell/src/camera/CameraTable.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 135 "/shotwell/src/camera/CameraTable.vala"
...
static void _g_object_unref0_ (gpointer var) {
#line 139 "/shotwell/src/camera/CameraTable.vala"
...
#line 111 "/shotwell/src/camera/CameraTable.vala"
	g_return_val_if_fail (IS_CAMERA_TABLE (self), NULL);
#line 112 "/shotwell/src/camera/CameraTable.vala"
...
#line 114 "/shotwell/src/camera/CameraTable.vala"
	_tmp1_ = self->priv->client;
#line 114 "/shotwell/src/camera/CameraTable.vala"
...
#line 1105 "CameraTable.c"
			{
				...
				gboolean _tmp9_ = FALSE;
				const gchar* _tmp10_;
#line 116 "/shotwell/src/camera/CameraTable.vala"
				_tmp5_ = device;
#line 116 "/shotwell/src/camera/CameraTable.vala"
...
#line 116 "/shotwell/src/camera/CameraTable.vala"
				device_file = _tmp7_;
#line 120 "/shotwell/src/camera/CameraTable.vala"
				_tmp10_ = device_file;
#line 120 "/shotwell/src/camera/CameraTable.vala"
				if (_tmp10_ != NULL) {
#line 1126 "CameraTable.c"
					GUdevDevice* _tmp11_;
					gboolean _tmp12_;
#line 121 "/shotwell/src/camera/CameraTable.vala"
					_tmp11_ = device;
#line 121 "/shotwell/src/camera/CameraTable.vala"
...
#line 1143 "CameraTable.c"
					GUdevDevice* _tmp13_;
					gboolean _tmp14_;
#line 122 "/shotwell/src/camera/CameraTable.vala"
					_tmp13_ = device;
#line 122 "/shotwell/src/camera/CameraTable.vala"
...
#line 117 "/shotwell/src/camera/CameraTable.vala"
				if (_tmp8_) {
#line 1160 "CameraTable.c"
					...
					const gchar* _tmp23_;
					gchar* _tmp24_;
#line 128 "/shotwell/src/camera/CameraTable.vala"
					_tmp15_ = device_file;
#line 128 "/shotwell/src/camera/CameraTable.vala"
...
#line 1180 "CameraTable.c"
						const gchar* _tmp17_;
#line 129 "/shotwell/src/camera/CameraTable.vala"
						_tmp17_ = device_file;
#line 129 "/shotwell/src/camera/CameraTable.vala"
						g_critical ("CameraTable.vala:129: get_all_usb_cameras: Failed to scanf device file" \
" %s", _tmp17_);
#line 131 "/shotwell/src/camera/CameraTable.vala"
...
#line 133 "/shotwell/src/camera/CameraTable.vala"
					_tmp18_ = camera_bus;
#line 133 "/shotwell/src/camera/CameraTable.vala"
...
#line 133 "/shotwell/src/camera/CameraTable.vala"
					camera = _tmp20_;
#line 134 "/shotwell/src/camera/CameraTable.vala"
					_tmp21_ = camera;
#line 134 "/shotwell/src/camera/CameraTable.vala"
...
#line 1303 "CameraTable.c"
		...
		const gchar* _tmp9_;
		const gchar* _tmp10_;
#line 161 "/shotwell/src/camera/CameraTable.vala"
		_tmp6_ = usb_cameras;
#line 161 "/shotwell/src/camera/CameraTable.vala"
...
#line 169 "/shotwell/src/camera/CameraTable.vala"
	_tmp11_ = port;
#line 169 "/shotwell/src/camera/CameraTable.vala"
	if (g_strcmp0 (_tmp11_, "usb:") == 0) {
#line 1348 "CameraTable.c"
		const gchar* _tmp12_;
#line 170 "/shotwell/src/camera/CameraTable.vala"
		_tmp12_ = port;
#line 170 "/shotwell/src/camera/CameraTable.vala"
		g_debug ("CameraTable.vala:170: USB ESP: Skipping %s", _tmp12_);
#line 172 "/shotwell/src/camera/CameraTable.vala"
		result = FALSE;
#line 172 "/shotwell/src/camera/CameraTable.vala"
		if (full_port) {
#line 172 "/shotwell/src/camera/CameraTable.vala"
...
#line 177 "/shotwell/src/camera/CameraTable.vala"
	_tmp13_ = port;
#line 177 "/shotwell/src/camera/CameraTable.vala"
...
#line 1376 "CameraTable.c"
		const gchar* _tmp15_;
#line 178 "/shotwell/src/camera/CameraTable.vala"
		_tmp15_ = port;
#line 178 "/shotwell/src/camera/CameraTable.vala"
		g_critical ("CameraTable.vala:178: USB ESP: Failed to scanf %s", _tmp15_);
#line 180 "/shotwell/src/camera/CameraTable.vala"
		result = FALSE;
#line 180 "/shotwell/src/camera/CameraTable.vala"
		if (full_port) {
#line 180 "/shotwell/src/camera/CameraTable.vala"
...
#line 183 "/shotwell/src/camera/CameraTable.vala"
	_tmp16_ = usb_cameras;
#line 183 "/shotwell/src/camera/CameraTable.vala"
...
#line 1421 "CameraTable.c"
			{
				...
				gint _tmp22_;
				gint _tmp23_;
#line 185 "/shotwell/src/camera/CameraTable.vala"
				_tmp18_ = usb_camera;
#line 185 "/shotwell/src/camera/CameraTable.vala"
...
#line 1436 "CameraTable.c"
					const gchar* _tmp20_;
#line 186 "/shotwell/src/camera/CameraTable.vala"
					_tmp20_ = usb_camera;
#line 186 "/shotwell/src/camera/CameraTable.vala"
					g_critical ("CameraTable.vala:186: USB ESP: Failed to scanf %s", _tmp20_);
#line 188 "/shotwell/src/camera/CameraTable.vala"
					_g_free0 (usb_camera);
#line 188 "/shotwell/src/camera/CameraTable.vala"
					continue;
#line 1446 "CameraTable.c"
				}
#line 191 "/shotwell/src/camera/CameraTable.vala"
				_tmp22_ = bus;
#line 191 "/shotwell/src/camera/CameraTable.vala"
				_tmp23_ = camera_bus;
#line 191 "/shotwell/src/camera/CameraTable.vala"
...
#line 1471 "CameraTable.c"
					...
					const gchar* _tmp28_;
					const gchar* _tmp29_;
#line 192 "/shotwell/src/camera/CameraTable.vala"
					_tmp26_ = port;
#line 192 "/shotwell/src/camera/CameraTable.vala"
...
#line 200 "/shotwell/src/camera/CameraTable.vala"
	_tmp30_ = port;
#line 200 "/shotwell/src/camera/CameraTable.vala"
	g_debug ("CameraTable.vala:200: USB ESP: No matching bus/device found for port=%" \
"s", _tmp30_);
#line 202 "/shotwell/src/camera/CameraTable.vala"
	result = FALSE;
#line 202 "/shotwell/src/camera/CameraTable.vala"
	if (full_port) {
#line 202 "/shotwell/src/camera/CameraTable.vala"
...
gchar* camera_table_get_port_uri (const gchar* port) {
	...
	const gchar* _tmp0_;
	gchar* _tmp1_;
#line 205 "/shotwell/src/camera/CameraTable.vala"
	g_return_val_if_fail (port != NULL, NULL);
#line 206 "/shotwell/src/camera/CameraTable.vala"
	_tmp0_ = port;
#line 206 "/shotwell/src/camera/CameraTable.vala"
...
gchar* camera_table_get_port_path (const gchar* port) {
	...
	const gchar* _tmp1_;
	gboolean _tmp2_;
#line 209 "/shotwell/src/camera/CameraTable.vala"
	g_return_val_if_fail (port != NULL, NULL);
#line 211 "/shotwell/src/camera/CameraTable.vala"
	_tmp1_ = port;
#line 211 "/shotwell/src/camera/CameraTable.vala"
...
#line 1897 "CameraTable.c"
		...
		gchar* _tmp7_;
		gchar* _tmp8_;
#line 212 "/shotwell/src/camera/CameraTable.vala"
		_tmp3_ = port;
#line 212 "/shotwell/src/camera/CameraTable.vala"
...
static gchar* camera_table_get_name_for_uuid (CameraTable* self, const gchar* uuid) {
	...
	GList* _tmp1_;
#line 215 "/shotwell/src/camera/CameraTable.vala"
	g_return_val_if_fail (IS_CAMERA_TABLE (self), NULL);
#line 215 "/shotwell/src/camera/CameraTable.vala"
	g_return_val_if_fail (uuid != NULL, NULL);
#line 216 "/shotwell/src/camera/CameraTable.vala"
...
#line 1967 "CameraTable.c"
			{
				...
				const gchar* _tmp6_;
				gboolean _tmp7_;
#line 217 "/shotwell/src/camera/CameraTable.vala"
				_tmp3_ = volume;
#line 217 "/shotwell/src/camera/CameraTable.vala"
...
#line 1988 "CameraTable.c"
					GVolume* _tmp8_;
					gchar* _tmp9_;
#line 218 "/shotwell/src/camera/CameraTable.vala"
					_tmp8_ = volume;
#line 218 "/shotwell/src/camera/CameraTable.vala"
...
#line 221 "/shotwell/src/camera/CameraTable.vala"
	result = NULL;
#line 221 "/shotwell/src/camera/CameraTable.vala"
	return result;
...
static gchar* camera_table_get_icon_for_uuid (CameraTable* self, const gchar* uuid) {
	...
	GVolumeMonitor* _tmp0_;
	GList* _tmp1_;
#line 224 "/shotwell/src/camera/CameraTable.vala"
	g_return_val_if_fail (IS_CAMERA_TABLE (self), NULL);
#line 224 "/shotwell/src/camera/CameraTable.vala"
	g_return_val_if_fail (uuid != NULL, NULL);
#line 225 "/shotwell/src/camera/CameraTable.vala"
	_tmp0_ = self->priv->volume_monitor;
#line 225 "/shotwell/src/camera/CameraTable.vala"
	_tmp1_ = g_volume_monitor_get_volumes (_tmp0_);
...
#line 2049 "CameraTable.c"
			{
				...
				const gchar* _tmp6_;
				gboolean _tmp7_;
#line 226 "/shotwell/src/camera/CameraTable.vala"
				_tmp3_ = volume;
#line 226 "/shotwell/src/camera/CameraTable.vala"
				_tmp4_ = g_volume_get_identifier (_tmp3_, G_VOLUME_IDENTIFIER_KIND_UUID);
#line 226 "/shotwell/src/camera/CameraTable.vala"
...
#line 2070 "CameraTable.c"
					...
					gchar* _tmp11_;
					gchar* _tmp12_;
#line 227 "/shotwell/src/camera/CameraTable.vala"
					_tmp8_ = volume;
#line 227 "/shotwell/src/camera/CameraTable.vala"
...
#line 230 "/shotwell/src/camera/CameraTable.vala"
	result = NULL;
#line 230 "/shotwell/src/camera/CameraTable.vala"
	return result;
...
#line 292 "/shotwell/src/camera/CameraTable.vala"
...
static void camera_table_update_camera_table (CameraTable* self, GError** error) {
	...
	GError * _inner_error_ = NULL;
#line 233 "/shotwell/src/camera/CameraTable.vala"
	g_return_if_fail (IS_CAMERA_TABLE (self));
#line 236 "/shotwell/src/camera/CameraTable.vala"
...
#line 237 "/shotwell/src/camera/CameraTable.vala"
...
#line 240 "/shotwell/src/camera/CameraTable.vala"
...
#line 241 "/shotwell/src/camera/CameraTable.vala"
...
#line 243 "/shotwell/src/camera/CameraTable.vala"
...
#line 246 "/shotwell/src/camera/CameraTable.vala"
...
#line 2315 "CameraTable.c"
	{
		gint ctr = 0;
#line 249 "/shotwell/src/camera/CameraTable.vala"
		ctr = 0;
...
#line 251 "/shotwell/src/camera/CameraTable.vala"
				_tmp19_ = camera_list;
#line 251 "/shotwell/src/camera/CameraTable.vala"
				_tmp20_ = ctr;
#line 251 "/shotwell/src/camera/CameraTable.vala"
...
#line 254 "/shotwell/src/camera/CameraTable.vala"
				_tmp24_ = camera_list;
#line 254 "/shotwell/src/camera/CameraTable.vala"
				_tmp25_ = ctr;
#line 254 "/shotwell/src/camera/CameraTable.vala"
...
#line 256 "/shotwell/src/camera/CameraTable.vala"
				_tmp29_ = ctr;
#line 256 "/shotwell/src/camera/CameraTable.vala"
				_tmp30_ = camera_list;
#line 256 "/shotwell/src/camera/CameraTable.vala"
...
#line 259 "/shotwell/src/camera/CameraTable.vala"
				_tmp34_ = port;
#line 259 "/shotwell/src/camera/CameraTable.vala"
...
#line 2505 "CameraTable.c"
					...
					const gchar* _tmp42_;
					gchar* _tmp43_;
#line 261 "/shotwell/src/camera/CameraTable.vala"
					_tmp36_ = camera_list;
#line 261 "/shotwell/src/camera/CameraTable.vala"
...
#line 261 "/shotwell/src/camera/CameraTable.vala"
					if (!_tmp41_) {
#line 262 "/shotwell/src/camera/CameraTable.vala"
						_g_free0 (full_port);
#line 262 "/shotwell/src/camera/CameraTable.vala"
						_g_free0 (port);
#line 262 "/shotwell/src/camera/CameraTable.vala"
...
#line 264 "/shotwell/src/camera/CameraTable.vala"
					_tmp42_ = full_port;
#line 264 "/shotwell/src/camera/CameraTable.vala"
...
#line 267 "/shotwell/src/camera/CameraTable.vala"
...
#line 271 "/shotwell/src/camera/CameraTable.vala"
...
#line 2580 "CameraTable.c"
	{
		...
		GeeIterator* _tmp52_;
		GeeIterator* _tmp53_;
#line 272 "/shotwell/src/camera/CameraTable.vala"
...
#line 276 "/shotwell/src/camera/CameraTable.vala"
			_tmp58_ = camera;
#line 276 "/shotwell/src/camera/CameraTable.vala"
...
#line 279 "/shotwell/src/camera/CameraTable.vala"
...
#line 279 "/shotwell/src/camera/CameraTable.vala"
			tmp_path = _tmp63_;
#line 282 "/shotwell/src/camera/CameraTable.vala"
			_tmp64_ = camera;
#line 282 "/shotwell/src/camera/CameraTable.vala"
...
#line 284 "/shotwell/src/camera/CameraTable.vala"
...
#line 2806 "CameraTable.c"
				...
				const gchar* _tmp72_;
				const gchar* _tmp73_;
#line 285 "/shotwell/src/camera/CameraTable.vala"
				_tmp71_ = abilities;
#line 285 "/shotwell/src/camera/CameraTable.vala"
...
#line 287 "/shotwell/src/camera/CameraTable.vala"
				 (abilities);
#line 287 "/shotwell/src/camera/CameraTable.vala"
				_g_free0 (tmp_path);
#line 287 "/shotwell/src/camera/CameraTable.vala"
...
#line 290 "/shotwell/src/camera/CameraTable.vala"
			_tmp74_ = abilities;
#line 290 "/shotwell/src/camera/CameraTable.vala"
...
#line 296 "/shotwell/src/camera/CameraTable.vala"
	_tmp80_ = missing;
#line 296 "/shotwell/src/camera/CameraTable.vala"
...
#line 300 "/shotwell/src/camera/CameraTable.vala"
				_tmp82_ = camera;
#line 300 "/shotwell/src/camera/CameraTable.vala"
...
#line 302 "/shotwell/src/camera/CameraTable.vala"
...
#line 302 "/shotwell/src/camera/CameraTable.vala"
				tmp_path = _tmp87_;
#line 305 "/shotwell/src/camera/CameraTable.vala"
				_tmp88_ = camera;
#line 305 "/shotwell/src/camera/CameraTable.vala"
...
#line 307 "/shotwell/src/camera/CameraTable.vala"
				_tmp92_ = abilities;
#line 307 "/shotwell/src/camera/CameraTable.vala"
...
#line 309 "/shotwell/src/camera/CameraTable.vala"
...
#line 309 "/shotwell/src/camera/CameraTable.vala"
				_g_free0 (_tmp98_);
#line 311 "/shotwell/src/camera/CameraTable.vala"
				_tmp99_ = camera;
#line 311 "/shotwell/src/camera/CameraTable.vala"
...
#line 315 "/shotwell/src/camera/CameraTable.vala"
...
#line 315 "/shotwell/src/camera/CameraTable.vala"
			port = (gchar*) _tmp109_;
#line 316 "/shotwell/src/camera/CameraTable.vala"
...
#line 316 "/shotwell/src/camera/CameraTable.vala"
			name = (gchar*) _tmp112_;
#line 317 "/shotwell/src/camera/CameraTable.vala"
			display_name = NULL;
#line 318 "/shotwell/src/camera/CameraTable.vala"
			icon = NULL;
#line 319 "/shotwell/src/camera/CameraTable.vala"
			_tmp113_ = port;
#line 319 "/shotwell/src/camera/CameraTable.vala"
			_tmp114_ = camera_table_get_port_uri (_tmp113_);
#line 319 "/shotwell/src/camera/CameraTable.vala"
			uri = _tmp114_;
#line 321 "/shotwell/src/camera/CameraTable.vala"
...
#line 323 "/shotwell/src/camera/CameraTable.vala"
				_tmp118_ = name;
#line 323 "/shotwell/src/camera/CameraTable.vala"
				_tmp119_ = port;
#line 323 "/shotwell/src/camera/CameraTable.vala"
				g_debug ("CameraTable.vala:323: %s @ %s already registered, skipping", _tmp118_, _tmp119_);
#line 325 "/shotwell/src/camera/CameraTable.vala"
				_g_free0 (uri);
#line 325 "/shotwell/src/camera/CameraTable.vala"
				_g_free0 (icon);
#line 325 "/shotwell/src/camera/CameraTable.vala"
...
#line 329 "/shotwell/src/camera/CameraTable.vala"
			_tmp120_ = port;
#line 329 "/shotwell/src/camera/CameraTable.vala"
			_tmp121_ = camera_table_get_port_path (_tmp120_);
#line 329 "/shotwell/src/camera/CameraTable.vala"
			path = _tmp121_;
#line 330 "/shotwell/src/camera/CameraTable.vala"
			_tmp122_ = path;
#line 330 "/shotwell/src/camera/CameraTable.vala"
			if (NULL != _tmp122_) {
...
#line 331 "/shotwell/src/camera/CameraTable.vala"
...
#line 331 "/shotwell/src/camera/CameraTable.vala"
				device = _tmp125_;
#line 332 "/shotwell/src/camera/CameraTable.vala"
				_tmp126_ = device;
#line 332 "/shotwell/src/camera/CameraTable.vala"
...
#line 332 "/shotwell/src/camera/CameraTable.vala"
				serial = _tmp128_;
#line 333 "/shotwell/src/camera/CameraTable.vala"
				_tmp129_ = serial;
#line 333 "/shotwell/src/camera/CameraTable.vala"
				if (NULL != _tmp129_) {
#line 3299 "CameraTable.c"
					...
					gchar* _tmp133_;
#line 335 "/shotwell/src/camera/CameraTable.vala"
					_tmp130_ = serial;
#line 335 "/shotwell/src/camera/CameraTable.vala"
...
#line 336 "/shotwell/src/camera/CameraTable.vala"
					_tmp132_ = serial;
#line 336 "/shotwell/src/camera/CameraTable.vala"
...
#line 338 "/shotwell/src/camera/CameraTable.vala"
...
#line 3326 "CameraTable.c"
					...
					gchar* _tmp137_;
#line 339 "/shotwell/src/camera/CameraTable.vala"
					_tmp135_ = device;
#line 339 "/shotwell/src/camera/CameraTable.vala"
...
#line 341 "/shotwell/src/camera/CameraTable.vala"
...
#line 3346 "CameraTable.c"
					...
					gchar* _tmp141_;
#line 342 "/shotwell/src/camera/CameraTable.vala"
					_tmp139_ = device;
#line 342 "/shotwell/src/camera/CameraTable.vala"
...
#line 345 "/shotwell/src/camera/CameraTable.vala"
...
#line 3372 "CameraTable.c"
				...
				gchar* _tmp144_;
#line 347 "/shotwell/src/camera/CameraTable.vala"
				_tmp143_ = name;
#line 347 "/shotwell/src/camera/CameraTable.vala"
...
#line 350 "/shotwell/src/camera/CameraTable.vala"
...
#line 350 "/shotwell/src/camera/CameraTable.vala"
			index = _tmp147_;
#line 351 "/shotwell/src/camera/CameraTable.vala"
			_tmp148_ = index;
#line 351 "/shotwell/src/camera/CameraTable.vala"
			if (_tmp148_ < 0) {
#line 3397 "CameraTable.c"
				...
				gchar* _tmp151_;
				gchar* _tmp152_;
#line 352 "/shotwell/src/camera/CameraTable.vala"
				_tmp149_ = index;
#line 352 "/shotwell/src/camera/CameraTable.vala"
				_tmp150_ = port;
#line 352 "/shotwell/src/camera/CameraTable.vala"
...
#line 357 "/shotwell/src/camera/CameraTable.vala"
...
#line 358 "/shotwell/src/camera/CameraTable.vala"
...
#line 358 "/shotwell/src/camera/CameraTable.vala"
			tmp_path = _tmp161_;
#line 361 "/shotwell/src/camera/CameraTable.vala"
			_tmp162_ = port;
#line 361 "/shotwell/src/camera/CameraTable.vala"
			_tmp163_ = tmp_path;
#line 361 "/shotwell/src/camera/CameraTable.vala"
			_vala_assert (g_strcmp0 (_tmp162_, _tmp163_) == 0, "port == tmp_path");
#line 363 "/shotwell/src/camera/CameraTable.vala"
...
#line 363 "/shotwell/src/camera/CameraTable.vala"
			index = _tmp166_;
#line 364 "/shotwell/src/camera/CameraTable.vala"
			_tmp167_ = index;
#line 364 "/shotwell/src/camera/CameraTable.vala"
			if (_tmp167_ < 0) {
#line 3603 "CameraTable.c"
				...
				gchar* _tmp170_;
				gchar* _tmp171_;
#line 365 "/shotwell/src/camera/CameraTable.vala"
				_tmp168_ = index;
#line 365 "/shotwell/src/camera/CameraTable.vala"
				_tmp169_ = name;
#line 365 "/shotwell/src/camera/CameraTable.vala"
...
#line 368 "/shotwell/src/camera/CameraTable.vala"
...
#line 372 "/shotwell/src/camera/CameraTable.vala"
...
#line 373 "/shotwell/src/camera/CameraTable.vala"
			_tmp184_ = gcamera;
#line 373 "/shotwell/src/camera/CameraTable.vala"
...
#line 374 "/shotwell/src/camera/CameraTable.vala"
			_tmp190_ = gcamera;
#line 374 "/shotwell/src/camera/CameraTable.vala"
			_tmp191_ = port_info;
#line 374 "/shotwell/src/camera/CameraTable.vala"
...
#line 376 "/shotwell/src/camera/CameraTable.vala"
			_tmp197_ = name;
#line 376 "/shotwell/src/camera/CameraTable.vala"
			_tmp198_ = port;
#line 376 "/shotwell/src/camera/CameraTable.vala"
			g_debug ("CameraTable.vala:376: Adding to camera table: %s @ %s", _tmp197_, _tmp198_);
#line 378 "/shotwell/src/camera/CameraTable.vala"
			_tmp199_ = gcamera;
#line 378 "/shotwell/src/camera/CameraTable.vala"
			_tmp200_ = uri;
#line 378 "/shotwell/src/camera/CameraTable.vala"
...
#line 378 "/shotwell/src/camera/CameraTable.vala"
			camera = _tmp203_;
#line 379 "/shotwell/src/camera/CameraTable.vala"
...
#line 381 "/shotwell/src/camera/CameraTable.vala"
			_tmp207_ = camera;
#line 381 "/shotwell/src/camera/CameraTable.vala"
...
#line 385 "/shotwell/src/camera/CameraTable.vala"
	g_return_if_fail (IS_CAMERA_TABLE (self));
#line 385 "/shotwell/src/camera/CameraTable.vala"
	g_return_if_fail (action != NULL);
#line 385 "/shotwell/src/camera/CameraTable.vala"
	g_return_if_fail (G_UDEV_IS_DEVICE (device));
#line 386 "/shotwell/src/camera/CameraTable.vala"
	_tmp0_ = action;
#line 386 "/shotwell/src/camera/CameraTable.vala"
	_tmp1_ = device;
#line 386 "/shotwell/src/camera/CameraTable.vala"
...
#line 390 "/shotwell/src/camera/CameraTable.vala"
...
void camera_table_on_volume_changed (CameraTable* self, GVolume* volume) {
	OneShotScheduler* _tmp0_;
#line 393 "/shotwell/src/camera/CameraTable.vala"
	g_return_if_fail (IS_CAMERA_TABLE (self));
#line 393 "/shotwell/src/camera/CameraTable.vala"
	g_return_if_fail (G_IS_VOLUME (volume));
#line 394 "/shotwell/src/camera/CameraTable.vala"
...
static void camera_table_on_update_cameras (CameraTable* self) {
	GError * _inner_error_ = NULL;
#line 397 "/shotwell/src/camera/CameraTable.vala"
	g_return_if_fail (IS_CAMERA_TABLE (self));
#line 4211 "CameraTable.c"
	{
		CameraTable* _tmp0_;
		CameraTable* _tmp1_;
#line 399 "/shotwell/src/camera/CameraTable.vala"
...
#line 4236 "CameraTable.c"
	...
	__catch60_gphoto_error:
	{
		...
		GError* _tmp2_;
		const gchar* _tmp3_;
#line 398 "/shotwell/src/camera/CameraTable.vala"
		err = _inner_error_;
#line 398 "/shotwell/src/camera/CameraTable.vala"
		_inner_error_ = NULL;
#line 401 "/shotwell/src/camera/CameraTable.vala"
		_tmp2_ = err;
#line 401 "/shotwell/src/camera/CameraTable.vala"
...
#line 21 "/shotwell/src/camera/CameraTable.vala"
...
#line 29 "/shotwell/src/camera/CameraTable.vala"
	_tmp0_ = g_udev_client_new (CAMERA_TABLE_SUBSYSTEMS);
#line 29 "/shotwell/src/camera/CameraTable.vala"
	self->priv->client = _tmp0_;
#line 30 "/shotwell/src/camera/CameraTable.vala"
	self->priv->camera_update_scheduler = NULL;
#line 31 "/shotwell/src/camera/CameraTable.vala"
	_tmp1_ = gp_context_new ();
#line 31 "/shotwell/src/camera/CameraTable.vala"
	self->priv->null_context = _tmp1_;
#line 35 "/shotwell/src/camera/CameraTable.vala"
...
#line 32 "/shotwell/src/camera/CameraTable.vala"
	_gp_abilities_list_free0 (self->priv->abilities_list);
#line 33 "/shotwell/src/camera/CameraTable.vala"
	_g_object_unref0 (self->priv->volume_monitor);
#line 35 "/shotwell/src/camera/CameraTable.vala"
