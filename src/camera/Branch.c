...
#line 14 "/shotwell/src/camera/Branch.vala"
	return result;
#line 465 "Branch.c"
}
...
static void _camera_branch_on_camera_added_camera_table_camera_added (CameraTable* _sender, DiscoveredCamera* camera, gpointer self) {
#line 21 "/shotwell/src/camera/Branch.vala"
...
static void _camera_branch_on_camera_removed_camera_table_camera_removed (CameraTable* _sender, DiscoveredCamera* camera, gpointer self) {
#line 22 "/shotwell/src/camera/Branch.vala"
...
#line 499 "Branch.c"
	{
		...
		GeeIterator* _tmp6_;
		GeeIterator* _tmp7_;
#line 18 "/shotwell/src/camera/Branch.vala"
...
#line 19 "/shotwell/src/camera/Branch.vala"
			_tmp12_ = camera;
#line 19 "/shotwell/src/camera/Branch.vala"
...
#line 13 "/shotwell/src/camera/Branch.vala"
	return self;
#line 581 "Branch.c"
}
...
#line 39 "/shotwell/src/camera/Branch.vala"
...
static gint camera_branch_camera_comparator (SidebarEntry* a, SidebarEntry* b) {
	...
	gint _tmp9_;
	gint _tmp10_;
#line 31 "/shotwell/src/camera/Branch.vala"
	g_return_val_if_fail (SIDEBAR_IS_ENTRY (a), 0);
#line 31 "/shotwell/src/camera/Branch.vala"
	g_return_val_if_fail (SIDEBAR_IS_ENTRY (b), 0);
#line 32 "/shotwell/src/camera/Branch.vala"
	_tmp0_ = a;
#line 32 "/shotwell/src/camera/Branch.vala"
	_tmp1_ = b;
#line 32 "/shotwell/src/camera/Branch.vala"
	if (_tmp0_ == _tmp1_) {
#line 33 "/shotwell/src/camera/Branch.vala"
		result = 0;
#line 33 "/shotwell/src/camera/Branch.vala"
		return result;
#line 635 "Branch.c"
	}
#line 36 "/shotwell/src/camera/Branch.vala"
	_tmp2_ = a;
#line 36 "/shotwell/src/camera/Branch.vala"
...
#line 36 "/shotwell/src/camera/Branch.vala"
	ret = _tmp9_;
#line 37 "/shotwell/src/camera/Branch.vala"
	_tmp10_ = ret;
#line 37 "/shotwell/src/camera/Branch.vala"
	if (_tmp10_ == 0) {
#line 663 "Branch.c"
...
#line 42 "/shotwell/src/camera/Branch.vala"
		_tmp18_ = cam_a;
#line 42 "/shotwell/src/camera/Branch.vala"
...
#line 45 "/shotwell/src/camera/Branch.vala"
	result = ret;
#line 45 "/shotwell/src/camera/Branch.vala"
	return result;
#line 739 "Branch.c"
...
static void camera_branch_on_camera_removed (CameraBranch* self, DiscoveredCamera* camera) {
	DiscoveredCamera* _tmp0_;
#line 56 "/shotwell/src/camera/Branch.vala"
	g_return_if_fail (CAMERA_IS_BRANCH (self));
#line 56 "/shotwell/src/camera/Branch.vala"
	g_return_if_fail (IS_DISCOVERED_CAMERA (camera));
#line 57 "/shotwell/src/camera/Branch.vala"
	_tmp0_ = camera;
#line 57 "/shotwell/src/camera/Branch.vala"
...
static void camera_branch_add_camera (CameraBranch* self, DiscoveredCamera* camera) {
	...
	SidebarEntry* _tmp7_;
	SidebarEntry* _tmp8_;
#line 60 "/shotwell/src/camera/Branch.vala"
	g_return_if_fail (CAMERA_IS_BRANCH (self));
#line 60 "/shotwell/src/camera/Branch.vala"
	g_return_if_fail (IS_DISCOVERED_CAMERA (camera));
#line 61 "/shotwell/src/camera/Branch.vala"
	_tmp0_ = self->priv->camera_map;
#line 61 "/shotwell/src/camera/Branch.vala"
	_tmp1_ = camera;
#line 61 "/shotwell/src/camera/Branch.vala"
...
#line 63 "/shotwell/src/camera/Branch.vala"
	_tmp3_ = camera;
#line 63 "/shotwell/src/camera/Branch.vala"
	_tmp4_ = camera_sidebar_entry_new (_tmp3_);
#line 63 "/shotwell/src/camera/Branch.vala"
	entry = _tmp4_;
#line 64 "/shotwell/src/camera/Branch.vala"
...
#line 67 "/shotwell/src/camera/Branch.vala"
...
static void camera_branch_remove_camera (CameraBranch* self, DiscoveredCamera* camera) {
	...
	gboolean _tmp8_;
#line 70 "/shotwell/src/camera/Branch.vala"
	g_return_if_fail (CAMERA_IS_BRANCH (self));
#line 70 "/shotwell/src/camera/Branch.vala"
	g_return_if_fail (IS_DISCOVERED_CAMERA (camera));
#line 71 "/shotwell/src/camera/Branch.vala"
	_tmp0_ = self->priv->camera_map;
#line 71 "/shotwell/src/camera/Branch.vala"
	_tmp1_ = camera;
#line 71 "/shotwell/src/camera/Branch.vala"
...
#line 71 "/shotwell/src/camera/Branch.vala"
	_vala_assert (_tmp2_, "camera_map.has_key(camera)");
#line 73 "/shotwell/src/camera/Branch.vala"
...
#line 74 "/shotwell/src/camera/Branch.vala"
	_vala_assert (entry != NULL, "entry != null");
#line 76 "/shotwell/src/camera/Branch.vala"
...
#line 76 "/shotwell/src/camera/Branch.vala"
	removed = _tmp8_;
#line 77 "/shotwell/src/camera/Branch.vala"
	_vala_assert (removed, "removed");
#line 79 "/shotwell/src/camera/Branch.vala"
...
static void camera_branch_class_init (CameraBranchClass * klass) {
	gchar* _tmp0_;
#line 7 "/shotwell/src/camera/Branch.vala"
...
#line 8 "/shotwell/src/camera/Branch.vala"
...
#line 10 "/shotwell/src/camera/Branch.vala"
...
#line 85 "/shotwell/src/camera/Branch.vala"
	self = (CameraHeader*) sidebar_header_construct (object_type, _ ("Cameras"), TRUE);
#line 84 "/shotwell/src/camera/Branch.vala"
	return self;
#line 953 "Branch.c"
}
...
#line 83 "/shotwell/src/camera/Branch.vala"
...
#line 94 "/shotwell/src/camera/Branch.vala"
...
CameraSidebarEntry* camera_sidebar_entry_construct (GType object_type, DiscoveredCamera* camera) {
	...
	const gchar* _tmp3_;
	gchar* _tmp4_;
#line 93 "/shotwell/src/camera/Branch.vala"
	g_return_val_if_fail (IS_DISCOVERED_CAMERA (camera), NULL);
#line 93 "/shotwell/src/camera/Branch.vala"
...
#line 95 "/shotwell/src/camera/Branch.vala"
	_tmp2_ = camera;
#line 95 "/shotwell/src/camera/Branch.vala"
	_tmp3_ = _tmp2_->uri;
#line 95 "/shotwell/src/camera/Branch.vala"
...
static gchar* camera_sidebar_entry_real_get_sidebar_icon (SidebarSimplePageEntry* base) {
	...
	const gchar* _tmp2_;
	gchar* _tmp4_;
#line 102 "/shotwell/src/camera/Branch.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, CAMERA_TYPE_SIDEBAR_ENTRY, CameraSidebarEntry);
#line 103 "/shotwell/src/camera/Branch.vala"
	_tmp1_ = self->priv->camera;
#line 103 "/shotwell/src/camera/Branch.vala"
	_tmp2_ = _tmp1_->icon;
#line 103 "/shotwell/src/camera/Branch.vala"
...
static Page* camera_sidebar_entry_real_create_page (SidebarSimplePageEntry* base) {
	...
	ImportPage* _tmp7_;
	Page* _tmp8_;
#line 106 "/shotwell/src/camera/Branch.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, CAMERA_TYPE_SIDEBAR_ENTRY, CameraSidebarEntry);
#line 107 "/shotwell/src/camera/Branch.vala"
...
gchar* camera_sidebar_entry_get_uri (CameraSidebarEntry* self) {
	...
	const gchar* _tmp0_;
	gchar* _tmp1_;
#line 110 "/shotwell/src/camera/Branch.vala"
	g_return_val_if_fail (CAMERA_IS_SIDEBAR_ENTRY (self), NULL);
#line 111 "/shotwell/src/camera/Branch.vala"
...
#line 89 "/shotwell/src/camera/Branch.vala"
...
#line 90 "/shotwell/src/camera/Branch.vala"
	_discovered_camera_unref0 (self->priv->camera);
#line 91 "/shotwell/src/camera/Branch.vala"
	_g_free0 (self->priv->uri);
#line 89 "/shotwell/src/camera/Branch.vala"
