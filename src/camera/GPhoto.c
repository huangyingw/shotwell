...
static void _gp_context_wrapper_on_idle_gp_context_idle_func (GPContext* context, gpointer self) {
#line 18 "/shotwell/src/camera/GPhoto.vala"
...
static void _gp_context_wrapper_on_error_gp_context_error_func (GPContext* context, const gchar* text, gpointer self) {
#line 19 "/shotwell/src/camera/GPhoto.vala"
...
static void _gp_context_wrapper_on_status_gp_context_status_func (GPContext* context, const gchar* text, gpointer self) {
#line 20 "/shotwell/src/camera/GPhoto.vala"
...
static void _gp_context_wrapper_on_message_gp_context_message_func (GPContext* context, const gchar* text, gpointer self) {
#line 21 "/shotwell/src/camera/GPhoto.vala"
...
#line 22 "/shotwell/src/camera/GPhoto.vala"
	return result;
#line 273 "GPhoto.c"
}
...
GPContextWrapper* gp_context_wrapper_construct (GType object_type) {
	...
	GPContext* _tmp3_;
	GPContext* _tmp4_;
#line 17 "/shotwell/src/camera/GPhoto.vala"
...
void gp_context_wrapper_idle (GPContextWrapper* self) {
#line 25 "/shotwell/src/camera/GPhoto.vala"
...
static void gp_context_wrapper_real_error (GPContextWrapper* self, const gchar* text, void* data) {
#line 28 "/shotwell/src/camera/GPhoto.vala"
...
static void gp_context_wrapper_real_status (GPContextWrapper* self, const gchar* text, void* data) {
#line 31 "/shotwell/src/camera/GPhoto.vala"
	g_return_if_fail (text != NULL);
#line 365 "GPhoto.c"
}
...
static void gp_context_wrapper_real_message (GPContextWrapper* self, const gchar* text, void* data) {
#line 34 "/shotwell/src/camera/GPhoto.vala"
	g_return_if_fail (text != NULL);
#line 381 "GPhoto.c"
}
...
static void gp_context_wrapper_real_progress_start (GPContextWrapper* self, gfloat current, const gchar* text, void* data) {
#line 37 "/shotwell/src/camera/GPhoto.vala"
	g_return_if_fail (text != NULL);
#line 397 "GPhoto.c"
}
...
void gp_context_wrapper_progress_update (GPContextWrapper* self, gfloat current, void* data) {
#line 40 "/shotwell/src/camera/GPhoto.vala"
	g_return_if_fail (GP_IS_CONTEXT_WRAPPER (self));
#line 40 "/shotwell/src/camera/GPhoto.vala"
...
void gp_context_wrapper_progress_stop (GPContextWrapper* self) {
#line 43 "/shotwell/src/camera/GPhoto.vala"
	g_return_if_fail (GP_IS_CONTEXT_WRAPPER (self));
#line 43 "/shotwell/src/camera/GPhoto.vala"
...
static void gp_context_wrapper_on_idle (GPContextWrapper* self, GPContext* context) {
#line 46 "/shotwell/src/camera/GPhoto.vala"
	g_return_if_fail (GP_IS_CONTEXT_WRAPPER (self));
#line 46 "/shotwell/src/camera/GPhoto.vala"
	g_return_if_fail (context != NULL);
#line 47 "/shotwell/src/camera/GPhoto.vala"
...
static void gp_context_wrapper_on_error (GPContextWrapper* self, GPContext* context, const gchar* text) {
	const gchar* _tmp0_;
#line 50 "/shotwell/src/camera/GPhoto.vala"
	g_return_if_fail (GP_IS_CONTEXT_WRAPPER (self));
#line 50 "/shotwell/src/camera/GPhoto.vala"
	g_return_if_fail (context != NULL);
#line 50 "/shotwell/src/camera/GPhoto.vala"
	g_return_if_fail (text != NULL);
#line 51 "/shotwell/src/camera/GPhoto.vala"
	_tmp0_ = text;
#line 51 "/shotwell/src/camera/GPhoto.vala"
...
static void gp_context_wrapper_on_status (GPContextWrapper* self, GPContext* context, const gchar* text) {
	const gchar* _tmp0_;
#line 54 "/shotwell/src/camera/GPhoto.vala"
	g_return_if_fail (GP_IS_CONTEXT_WRAPPER (self));
#line 54 "/shotwell/src/camera/GPhoto.vala"
	g_return_if_fail (context != NULL);
#line 54 "/shotwell/src/camera/GPhoto.vala"
	g_return_if_fail (text != NULL);
#line 55 "/shotwell/src/camera/GPhoto.vala"
	_tmp0_ = text;
#line 55 "/shotwell/src/camera/GPhoto.vala"
...
static void gp_context_wrapper_on_message (GPContextWrapper* self, GPContext* context, const gchar* text) {
	const gchar* _tmp0_;
#line 58 "/shotwell/src/camera/GPhoto.vala"
	g_return_if_fail (GP_IS_CONTEXT_WRAPPER (self));
#line 58 "/shotwell/src/camera/GPhoto.vala"
	g_return_if_fail (context != NULL);
#line 58 "/shotwell/src/camera/GPhoto.vala"
	g_return_if_fail (text != NULL);
#line 59 "/shotwell/src/camera/GPhoto.vala"
	_tmp0_ = text;
#line 59 "/shotwell/src/camera/GPhoto.vala"
...
static void gp_context_wrapper_on_progress_update (GPContextWrapper* self, GPContext* context, guint id, gfloat current) {
	gfloat _tmp0_;
#line 68 "/shotwell/src/camera/GPhoto.vala"
	g_return_if_fail (GP_IS_CONTEXT_WRAPPER (self));
#line 68 "/shotwell/src/camera/GPhoto.vala"
	g_return_if_fail (context != NULL);
#line 69 "/shotwell/src/camera/GPhoto.vala"
	_tmp0_ = current;
#line 69 "/shotwell/src/camera/GPhoto.vala"
...
static void gp_context_wrapper_on_progress_stop (GPContextWrapper* self, GPContext* context, guint id) {
#line 72 "/shotwell/src/camera/GPhoto.vala"
	g_return_if_fail (GP_IS_CONTEXT_WRAPPER (self));
#line 72 "/shotwell/src/camera/GPhoto.vala"
	g_return_if_fail (context != NULL);
#line 73 "/shotwell/src/camera/GPhoto.vala"
...
#line 14 "/shotwell/src/camera/GPhoto.vala"
...
static void gp_context_wrapper_instance_init (GPContextWrapper * self) {
	GPContext* _tmp0_;
#line 15 "/shotwell/src/camera/GPhoto.vala"
...
#line 79 "/shotwell/src/camera/GPhoto.vala"
...
#line 85 "/shotwell/src/camera/GPhoto.vala"
	spin_event_loop ();
#line 835 "GPhoto.c"
}
...
static void gp_spin_idle_wrapper_real_progress_update (GPContextWrapper* base, gfloat current, void* data) {
	...
	gfloat _tmp0_;
	void* _tmp1_;
#line 88 "/shotwell/src/camera/GPhoto.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, GP_TYPE_SPIN_IDLE_WRAPPER, GPSpinIdleWrapper);
#line 89 "/shotwell/src/camera/GPhoto.vala"
	_tmp0_ = current;
#line 89 "/shotwell/src/camera/GPhoto.vala"
	_tmp1_ = data;
#line 89 "/shotwell/src/camera/GPhoto.vala"
...
#line 91 "/shotwell/src/camera/GPhoto.vala"
	spin_event_loop ();
#line 853 "GPhoto.c"
}
...
#line 78 "/shotwell/src/camera/GPhoto.vala"
...
#line 102 "/shotwell/src/camera/GPhoto.vala"
...
#line 104 "/shotwell/src/camera/GPhoto.vala"
	_tmp1_ = folder;
#line 104 "/shotwell/src/camera/GPhoto.vala"
...
#line 105 "/shotwell/src/camera/GPhoto.vala"
		 (_vala_info);
#line 105 "/shotwell/src/camera/GPhoto.vala"
		_vala_info = _tmp7_;
#line 107 "/shotwell/src/camera/GPhoto.vala"
		result = FALSE;
#line 107 "/shotwell/src/camera/GPhoto.vala"
		if (info) {
#line 107 "/shotwell/src/camera/GPhoto.vala"
...
#line 110 "/shotwell/src/camera/GPhoto.vala"
	_tmp8_ = camera;
#line 110 "/shotwell/src/camera/GPhoto.vala"
	_tmp9_ = folder;
#line 110 "/shotwell/src/camera/GPhoto.vala"
...
#line 110 "/shotwell/src/camera/GPhoto.vala"
	res = _tmp13_;
#line 111 "/shotwell/src/camera/GPhoto.vala"
	_tmp14_ = res;
#line 111 "/shotwell/src/camera/GPhoto.vala"
	if (_tmp14_ != GP_OK) {
#line 977 "GPhoto.c"
...
#line 112 "/shotwell/src/camera/GPhoto.vala"
		_tmp15_ = res;
#line 112 "/shotwell/src/camera/GPhoto.vala"
		_tmp16_ = folder;
#line 112 "/shotwell/src/camera/GPhoto.vala"
...
#line 115 "/shotwell/src/camera/GPhoto.vala"
	result = TRUE;
#line 115 "/shotwell/src/camera/GPhoto.vala"
	if (info) {
#line 115 "/shotwell/src/camera/GPhoto.vala"
...
PhotoMetadata* gp_get_fallback_metadata (Camera* camera, GPContext* context, const gchar* folder, const gchar* filename) {
	...
	GError * _inner_error_ = NULL;
#line 121 "/shotwell/src/camera/GPhoto.vala"
...
#line 122 "/shotwell/src/camera/GPhoto.vala"
	sifs = NULL;
#line 123 "/shotwell/src/camera/GPhoto.vala"
	count = 0;
#line 124 "/shotwell/src/camera/GPhoto.vala"
	_tmp0_ = camera;
#line 124 "/shotwell/src/camera/GPhoto.vala"
	_tmp1_ = context;
#line 124 "/shotwell/src/camera/GPhoto.vala"
...
#line 124 "/shotwell/src/camera/GPhoto.vala"
	count = _tmp2_;
#line 127 "/shotwell/src/camera/GPhoto.vala"
	_tmp3_ = camera;
#line 127 "/shotwell/src/camera/GPhoto.vala"
...
#line 127 "/shotwell/src/camera/GPhoto.vala"
	port_info = _tmp4_;
#line 130 "/shotwell/src/camera/GPhoto.vala"
...
#line 130 "/shotwell/src/camera/GPhoto.vala"
	path = _tmp6_;
#line 132 "/shotwell/src/camera/GPhoto.vala"
	_tmp7_ = g_strdup ("disk:");
#line 132 "/shotwell/src/camera/GPhoto.vala"
	prefix = _tmp7_;
#line 133 "/shotwell/src/camera/GPhoto.vala"
	_tmp8_ = path;
#line 133 "/shotwell/src/camera/GPhoto.vala"
...
#line 1208 "GPhoto.c"
		...
		gint _tmp15_;
		gchar* _tmp16_;
#line 134 "/shotwell/src/camera/GPhoto.vala"
		_tmp10_ = path;
#line 134 "/shotwell/src/camera/GPhoto.vala"
...
#line 136 "/shotwell/src/camera/GPhoto.vala"
		result = NULL;
#line 136 "/shotwell/src/camera/GPhoto.vala"
		_g_free0 (prefix);
#line 136 "/shotwell/src/camera/GPhoto.vala"
...
#line 138 "/shotwell/src/camera/GPhoto.vala"
...
#line 1252 "GPhoto.c"
	{
		...
		GFile* _tmp28_;
		GFile* _tmp29_;
#line 140 "/shotwell/src/camera/GPhoto.vala"
		_tmp18_ = metadata;
#line 140 "/shotwell/src/camera/GPhoto.vala"
		_tmp19_ = path;
#line 140 "/shotwell/src/camera/GPhoto.vala"
...
#line 1302 "GPhoto.c"
	...
	__catch61_g_error:
	{
#line 139 "/shotwell/src/camera/GPhoto.vala"
		g_clear_error (&_inner_error_);
#line 139 "/shotwell/src/camera/GPhoto.vala"
		_inner_error_ = NULL;
#line 142 "/shotwell/src/camera/GPhoto.vala"
...
#line 145 "/shotwell/src/camera/GPhoto.vala"
	result = metadata;
#line 145 "/shotwell/src/camera/GPhoto.vala"
	_g_free0 (prefix);
#line 145 "/shotwell/src/camera/GPhoto.vala"
...
static guint8* _vala_array_dup23 (guint8* self, int length) {
#line 186 "/shotwell/src/camera/GPhoto.vala"
...
GdkPixbuf* gp_load_preview (GPContext* context, Camera* camera, const gchar* folder, const gchar* filename, guint8** raw, int* raw_length1, gsize* raw_length, GError** error) {
	...
	GMemoryInputStream* _tmp44_;
	GdkPixbuf* _tmp45_ = NULL;
	GMemoryInputStream* _tmp46_;
	GdkPixbuf* _tmp47_;
	GdkPixbuf* _tmp48_;
	GError * _inner_error_ = NULL;
#line 148 "/shotwell/src/camera/GPhoto.vala"
	g_return_val_if_fail (context != NULL, NULL);
#line 148 "/shotwell/src/camera/GPhoto.vala"
	g_return_val_if_fail (camera != NULL, NULL);
#line 148 "/shotwell/src/camera/GPhoto.vala"
...
#line 148 "/shotwell/src/camera/GPhoto.vala"
	g_return_val_if_fail (filename != NULL, NULL);
#line 150 "/shotwell/src/camera/GPhoto.vala"
	_vala_raw = (g_free (_vala_raw), NULL);
#line 150 "/shotwell/src/camera/GPhoto.vala"
	_vala_raw = NULL;
#line 150 "/shotwell/src/camera/GPhoto.vala"
	_vala_raw_length1 = 0;
#line 151 "/shotwell/src/camera/GPhoto.vala"
...
#line 1396 "GPhoto.c"
	{
		...
		guint8* _tmp7_;
		gint _tmp7__length1;
#line 154 "/shotwell/src/camera/GPhoto.vala"
		_tmp1_ = context;
#line 154 "/shotwell/src/camera/GPhoto.vala"
		_tmp2_ = camera;
#line 154 "/shotwell/src/camera/GPhoto.vala"
...
#line 153 "/shotwell/src/camera/GPhoto.vala"
...
#line 153 "/shotwell/src/camera/GPhoto.vala"
		_inner_error_ = NULL;
#line 156 "/shotwell/src/camera/GPhoto.vala"
		_tmp8_ = camera;
#line 156 "/shotwell/src/camera/GPhoto.vala"
		_tmp9_ = context;
#line 156 "/shotwell/src/camera/GPhoto.vala"
...
#line 156 "/shotwell/src/camera/GPhoto.vala"
		metadata = _tmp12_;
#line 157 "/shotwell/src/camera/GPhoto.vala"
		_tmp13_ = metadata;
#line 157 "/shotwell/src/camera/GPhoto.vala"
		if (NULL == _tmp13_) {
#line 158 "/shotwell/src/camera/GPhoto.vala"
			result = NULL;
#line 158 "/shotwell/src/camera/GPhoto.vala"
			_media_metadata_unref0 (metadata);
#line 158 "/shotwell/src/camera/GPhoto.vala"
...
#line 159 "/shotwell/src/camera/GPhoto.vala"
		_tmp14_ = metadata;
#line 159 "/shotwell/src/camera/GPhoto.vala"
		_tmp15_ = photo_metadata_get_preview_count (_tmp14_);
#line 159 "/shotwell/src/camera/GPhoto.vala"
		if (((guint) 0) == _tmp15_) {
#line 160 "/shotwell/src/camera/GPhoto.vala"
			result = NULL;
#line 160 "/shotwell/src/camera/GPhoto.vala"
			_media_metadata_unref0 (metadata);
#line 160 "/shotwell/src/camera/GPhoto.vala"
...
#line 161 "/shotwell/src/camera/GPhoto.vala"
		_tmp16_ = metadata;
#line 161 "/shotwell/src/camera/GPhoto.vala"
		_tmp17_ = metadata;
#line 161 "/shotwell/src/camera/GPhoto.vala"
...
#line 161 "/shotwell/src/camera/GPhoto.vala"
		preview = _tmp19_;
#line 162 "/shotwell/src/camera/GPhoto.vala"
		_tmp21_ = preview;
#line 162 "/shotwell/src/camera/GPhoto.vala"
...
#line 165 "/shotwell/src/camera/GPhoto.vala"
	_tmp25_ = _vala_raw;
#line 165 "/shotwell/src/camera/GPhoto.vala"
	_tmp25__length1 = _vala_raw_length1;
#line 165 "/shotwell/src/camera/GPhoto.vala"
	if (_tmp25_ == NULL) {
#line 166 "/shotwell/src/camera/GPhoto.vala"
		_vala_raw_length = (gsize) 0;
#line 167 "/shotwell/src/camera/GPhoto.vala"
		result = NULL;
#line 167 "/shotwell/src/camera/GPhoto.vala"
		if (raw) {
#line 167 "/shotwell/src/camera/GPhoto.vala"
...
#line 170 "/shotwell/src/camera/GPhoto.vala"
	_tmp26_ = _vala_raw;
#line 170 "/shotwell/src/camera/GPhoto.vala"
	_tmp26__length1 = _vala_raw_length1;
#line 170 "/shotwell/src/camera/GPhoto.vala"
	_vala_raw_length = (gsize) _tmp26__length1;
#line 176 "/shotwell/src/camera/GPhoto.vala"
...
#line 1665 "GPhoto.c"
		{
			gsize i = 0UL;
			gsize _tmp28_;
#line 177 "/shotwell/src/camera/GPhoto.vala"
...
#line 178 "/shotwell/src/camera/GPhoto.vala"
					_tmp34_ = _vala_raw;
#line 178 "/shotwell/src/camera/GPhoto.vala"
...
#line 1743 "GPhoto.c"
						const gchar* _tmp40_;
						gsize _tmp41_;
#line 179 "/shotwell/src/camera/GPhoto.vala"
						_tmp40_ = filename;
#line 179 "/shotwell/src/camera/GPhoto.vala"
						g_debug ("GPhoto.vala:179: Adjusted length of thumbnail for: %s", _tmp40_);
#line 180 "/shotwell/src/camera/GPhoto.vala"
						_tmp41_ = i;
#line 180 "/shotwell/src/camera/GPhoto.vala"
						_vala_raw_length = _tmp41_ + 2;
#line 181 "/shotwell/src/camera/GPhoto.vala"
						break;
#line 1756 "GPhoto.c"
					}
				}
...
#line 186 "/shotwell/src/camera/GPhoto.vala"
	mins = _tmp44_;
#line 187 "/shotwell/src/camera/GPhoto.vala"
	_tmp46_ = mins;
#line 187 "/shotwell/src/camera/GPhoto.vala"
...
GdkPixbuf* gp_load_image (GPContext* context, Camera* camera, const gchar* folder, const gchar* filename, GError** error) {
	...
	GdkPixbuf* _tmp9_;
	GError * _inner_error_ = NULL;
#line 190 "/shotwell/src/camera/GPhoto.vala"
	g_return_val_if_fail (context != NULL, NULL);
#line 190 "/shotwell/src/camera/GPhoto.vala"
	g_return_val_if_fail (camera != NULL, NULL);
#line 190 "/shotwell/src/camera/GPhoto.vala"
...
#line 190 "/shotwell/src/camera/GPhoto.vala"
	g_return_val_if_fail (filename != NULL, NULL);
#line 192 "/shotwell/src/camera/GPhoto.vala"
	_tmp0_ = context;
#line 192 "/shotwell/src/camera/GPhoto.vala"
	_tmp1_ = camera;
#line 192 "/shotwell/src/camera/GPhoto.vala"
...
#line 193 "/shotwell/src/camera/GPhoto.vala"
	_tmp5_ = ins;
#line 193 "/shotwell/src/camera/GPhoto.vala"
	if (_tmp5_ == NULL) {
#line 194 "/shotwell/src/camera/GPhoto.vala"
		result = NULL;
#line 194 "/shotwell/src/camera/GPhoto.vala"
...
#line 196 "/shotwell/src/camera/GPhoto.vala"
	_tmp7_ = ins;
#line 196 "/shotwell/src/camera/GPhoto.vala"
...
void gp_save_image (GPContext* context, Camera* camera, const gchar* folder, const gchar* filename, GFile* dest_file, GError** error) {
	...
	int _tmp26_;
	GError * _inner_error_ = NULL;
#line 199 "/shotwell/src/camera/GPhoto.vala"
	g_return_if_fail (context != NULL);
#line 199 "/shotwell/src/camera/GPhoto.vala"
...
#line 200 "/shotwell/src/camera/GPhoto.vala"
	_tmp0_ = dest_file;
#line 200 "/shotwell/src/camera/GPhoto.vala"
...
#line 200 "/shotwell/src/camera/GPhoto.vala"
	fd = _tmp4_;
#line 201 "/shotwell/src/camera/GPhoto.vala"
	_tmp5_ = fd;
#line 201 "/shotwell/src/camera/GPhoto.vala"
	if (_tmp5_ < 0) {
#line 1964 "GPhoto.c"
		...
		GError* _tmp10_;
		GError* _tmp11_;
#line 202 "/shotwell/src/camera/GPhoto.vala"
		_tmp6_ = errno;
#line 202 "/shotwell/src/camera/GPhoto.vala"
		_tmp7_ = dest_file;
#line 202 "/shotwell/src/camera/GPhoto.vala"
...
#line 206 "/shotwell/src/camera/GPhoto.vala"
	_tmp12_ = fd;
#line 206 "/shotwell/src/camera/GPhoto.vala"
...
#line 206 "/shotwell/src/camera/GPhoto.vala"
	res = _tmp14_;
#line 207 "/shotwell/src/camera/GPhoto.vala"
	_tmp15_ = res;
#line 207 "/shotwell/src/camera/GPhoto.vala"
	if (_tmp15_ != GP_OK) {
#line 2007 "GPhoto.c"
		...
		const gchar* _tmp18_;
		GError* _tmp19_;
#line 208 "/shotwell/src/camera/GPhoto.vala"
		_tmp16_ = res;
#line 208 "/shotwell/src/camera/GPhoto.vala"
		_tmp17_ = res;
#line 208 "/shotwell/src/camera/GPhoto.vala"
...
#line 211 "/shotwell/src/camera/GPhoto.vala"
	_tmp20_ = camera;
#line 211 "/shotwell/src/camera/GPhoto.vala"
	_tmp21_ = folder;
#line 211 "/shotwell/src/camera/GPhoto.vala"
...
#line 211 "/shotwell/src/camera/GPhoto.vala"
	res = _tmp25_;
#line 212 "/shotwell/src/camera/GPhoto.vala"
	_tmp26_ = res;
#line 212 "/shotwell/src/camera/GPhoto.vala"
	if (_tmp26_ != GP_OK) {
#line 2048 "GPhoto.c"
		...
		const gchar* _tmp31_;
		GError* _tmp32_;
#line 213 "/shotwell/src/camera/GPhoto.vala"
		_tmp27_ = res;
#line 213 "/shotwell/src/camera/GPhoto.vala"
		_tmp28_ = folder;
#line 213 "/shotwell/src/camera/GPhoto.vala"
...
PhotoMetadata* gp_load_metadata (GPContext* context, Camera* camera, const gchar* folder, const gchar* filename, GError** error) {
	...
	GError * _inner_error_ = NULL;
#line 218 "/shotwell/src/camera/GPhoto.vala"
	g_return_val_if_fail (context != NULL, NULL);
#line 218 "/shotwell/src/camera/GPhoto.vala"
	g_return_val_if_fail (camera != NULL, NULL);
#line 218 "/shotwell/src/camera/GPhoto.vala"
...
#line 218 "/shotwell/src/camera/GPhoto.vala"
	g_return_val_if_fail (filename != NULL, NULL);
#line 220 "/shotwell/src/camera/GPhoto.vala"
	camera_raw = NULL;
#line 220 "/shotwell/src/camera/GPhoto.vala"
...
#line 2111 "GPhoto.c"
	{
		...
		guint8* _tmp7_;
		gint _tmp7__length1;
#line 222 "/shotwell/src/camera/GPhoto.vala"
		_tmp1_ = context;
#line 222 "/shotwell/src/camera/GPhoto.vala"
		_tmp2_ = camera;
#line 222 "/shotwell/src/camera/GPhoto.vala"
...
#line 222 "/shotwell/src/camera/GPhoto.vala"
		_camera_raw_size_ = camera_raw_length1;
#line 221 "/shotwell/src/camera/GPhoto.vala"
		_tmp0_ = (g_free (_tmp0_), NULL);
#line 2163 "GPhoto.c"
	}
	goto __finally63;
...
#line 221 "/shotwell/src/camera/GPhoto.vala"
		_inner_error_ = NULL;
#line 224 "/shotwell/src/camera/GPhoto.vala"
		_tmp8_ = camera;
#line 224 "/shotwell/src/camera/GPhoto.vala"
		_tmp9_ = context;
#line 224 "/shotwell/src/camera/GPhoto.vala"
...
#line 227 "/shotwell/src/camera/GPhoto.vala"
	_tmp14_ = camera_raw;
#line 227 "/shotwell/src/camera/GPhoto.vala"
...
#line 227 "/shotwell/src/camera/GPhoto.vala"
	if (_tmp13_) {
#line 228 "/shotwell/src/camera/GPhoto.vala"
		result = NULL;
#line 228 "/shotwell/src/camera/GPhoto.vala"
		camera_raw = (g_free (camera_raw), NULL);
#line 228 "/shotwell/src/camera/GPhoto.vala"
...
#line 230 "/shotwell/src/camera/GPhoto.vala"
	_tmp16_ = photo_metadata_new ();
#line 230 "/shotwell/src/camera/GPhoto.vala"
	metadata = _tmp16_;
#line 231 "/shotwell/src/camera/GPhoto.vala"
	_tmp17_ = metadata;
#line 231 "/shotwell/src/camera/GPhoto.vala"
	_tmp18_ = camera_raw;
#line 231 "/shotwell/src/camera/GPhoto.vala"
...
#line 233 "/shotwell/src/camera/GPhoto.vala"
	result = metadata;
#line 233 "/shotwell/src/camera/GPhoto.vala"
	camera_raw = (g_free (camera_raw), NULL);
#line 233 "/shotwell/src/camera/GPhoto.vala"
...
static guint8* _vala_array_dup24 (guint8* self, int length) {
#line 260 "/shotwell/src/camera/GPhoto.vala"
	return g_memdup (self, length * sizeof (guint8));
#line 2273 "GPhoto.c"
}
...
GInputStream* gp_load_file_into_stream (GPContext* context, Camera* camera, const gchar* folder, const gchar* filename, CameraFileType filetype, GError** error) {
	...
	GError * _inner_error_ = NULL;
#line 238 "/shotwell/src/camera/GPhoto.vala"
	g_return_val_if_fail (context != NULL, NULL);
#line 238 "/shotwell/src/camera/GPhoto.vala"
	g_return_val_if_fail (camera != NULL, NULL);
#line 238 "/shotwell/src/camera/GPhoto.vala"
...
#line 238 "/shotwell/src/camera/GPhoto.vala"
	g_return_val_if_fail (filename != NULL, NULL);
#line 241 "/shotwell/src/camera/GPhoto.vala"
...
#line 241 "/shotwell/src/camera/GPhoto.vala"
	res = _tmp1_;
#line 242 "/shotwell/src/camera/GPhoto.vala"
	_tmp2_ = res;
#line 242 "/shotwell/src/camera/GPhoto.vala"
	if (_tmp2_ != GP_OK) {
#line 2339 "GPhoto.c"
		...
		const gchar* _tmp5_;
		GError* _tmp6_;
#line 243 "/shotwell/src/camera/GPhoto.vala"
		_tmp3_ = res;
#line 243 "/shotwell/src/camera/GPhoto.vala"
		_tmp4_ = res;
#line 243 "/shotwell/src/camera/GPhoto.vala"
...
#line 245 "/shotwell/src/camera/GPhoto.vala"
	_tmp7_ = camera;
#line 245 "/shotwell/src/camera/GPhoto.vala"
	_tmp8_ = folder;
#line 245 "/shotwell/src/camera/GPhoto.vala"
...
#line 245 "/shotwell/src/camera/GPhoto.vala"
	res = _tmp12_;
#line 246 "/shotwell/src/camera/GPhoto.vala"
	_tmp13_ = res;
#line 246 "/shotwell/src/camera/GPhoto.vala"
	if (_tmp13_ != GP_OK) {
#line 2380 "GPhoto.c"
		...
		const gchar* _tmp18_;
		GError* _tmp19_;
#line 247 "/shotwell/src/camera/GPhoto.vala"
		_tmp14_ = res;
#line 247 "/shotwell/src/camera/GPhoto.vala"
		_tmp15_ = folder;
#line 247 "/shotwell/src/camera/GPhoto.vala"
...
#line 255 "/shotwell/src/camera/GPhoto.vala"
...
#line 255 "/shotwell/src/camera/GPhoto.vala"
	res = _tmp22_;
#line 256 "/shotwell/src/camera/GPhoto.vala"
	_tmp23_ = res;
#line 256 "/shotwell/src/camera/GPhoto.vala"
	if (_tmp23_ == GP_OK) {
#line 2421 "GPhoto.c"
...
#line 257 "/shotwell/src/camera/GPhoto.vala"
		_tmp24_ = data_len;
#line 257 "/shotwell/src/camera/GPhoto.vala"
...
#line 258 "/shotwell/src/camera/GPhoto.vala"
		_tmp26_ = buffer;
#line 258 "/shotwell/src/camera/GPhoto.vala"
...
#line 264 "/shotwell/src/camera/GPhoto.vala"
...
#line 264 "/shotwell/src/camera/GPhoto.vala"
	temp = _tmp35_;
#line 265 "/shotwell/src/camera/GPhoto.vala"
	_tmp36_ = temp;
#line 265 "/shotwell/src/camera/GPhoto.vala"
...
#line 265 "/shotwell/src/camera/GPhoto.vala"
	_g_free0 (_tmp38_);
#line 266 "/shotwell/src/camera/GPhoto.vala"
	_tmp40_ = res;
#line 266 "/shotwell/src/camera/GPhoto.vala"
	if (_tmp40_ != GP_OK) {
#line 2507 "GPhoto.c"
		...
		GError* _tmp49_;
		GError* _tmp50_;
#line 267 "/shotwell/src/camera/GPhoto.vala"
		_tmp41_ = res;
#line 267 "/shotwell/src/camera/GPhoto.vala"
		_tmp42_ = folder;
#line 267 "/shotwell/src/camera/GPhoto.vala"
...
#line 270 "/shotwell/src/camera/GPhoto.vala"
	_tmp52_ = temp;
#line 270 "/shotwell/src/camera/GPhoto.vala"
...
void gp_on_mins_destroyed (void* data) {
	void* _tmp0_;
#line 274 "/shotwell/src/camera/GPhoto.vala"
	_tmp0_ = data;
#line 274 "/shotwell/src/camera/GPhoto.vala"
	g_free (_tmp0_);
#line 2594 "GPhoto.c"
...
guint8* gp_load_file_into_buffer (GPContext* context, Camera* camera, const gchar* folder, const gchar* filename, CameraFileType filetype, int* result_length1, GError** error) {
	...
	GError * _inner_error_ = NULL;
#line 278 "/shotwell/src/camera/GPhoto.vala"
	g_return_val_if_fail (context != NULL, NULL);
#line 278 "/shotwell/src/camera/GPhoto.vala"
	g_return_val_if_fail (camera != NULL, NULL);
#line 278 "/shotwell/src/camera/GPhoto.vala"
...
#line 278 "/shotwell/src/camera/GPhoto.vala"
	g_return_val_if_fail (filename != NULL, NULL);
#line 281 "/shotwell/src/camera/GPhoto.vala"
	_tmp1_ = gp_file_new (&_tmp0_);
#line 281 "/shotwell/src/camera/GPhoto.vala"
	_gp_file_unref0 (camera_file);
#line 281 "/shotwell/src/camera/GPhoto.vala"
...
#line 281 "/shotwell/src/camera/GPhoto.vala"
	res = _tmp1_;
#line 282 "/shotwell/src/camera/GPhoto.vala"
	_tmp2_ = res;
#line 282 "/shotwell/src/camera/GPhoto.vala"
	if (_tmp2_ != GP_OK) {
#line 2653 "GPhoto.c"
		...
		const gchar* _tmp5_;
		GError* _tmp6_;
#line 283 "/shotwell/src/camera/GPhoto.vala"
		_tmp3_ = res;
#line 283 "/shotwell/src/camera/GPhoto.vala"
		_tmp4_ = res;
#line 283 "/shotwell/src/camera/GPhoto.vala"
...
#line 285 "/shotwell/src/camera/GPhoto.vala"
	_tmp7_ = camera;
#line 285 "/shotwell/src/camera/GPhoto.vala"
	_tmp8_ = folder;
#line 285 "/shotwell/src/camera/GPhoto.vala"
...
#line 285 "/shotwell/src/camera/GPhoto.vala"
	res = _tmp13_;
#line 286 "/shotwell/src/camera/GPhoto.vala"
	_tmp14_ = res;
#line 286 "/shotwell/src/camera/GPhoto.vala"
	if (_tmp14_ != GP_OK) {
#line 2696 "GPhoto.c"
		...
		const gchar* _tmp19_;
		GError* _tmp20_;
#line 287 "/shotwell/src/camera/GPhoto.vala"
		_tmp15_ = res;
#line 287 "/shotwell/src/camera/GPhoto.vala"
		_tmp16_ = folder;
#line 287 "/shotwell/src/camera/GPhoto.vala"
...
#line 294 "/shotwell/src/camera/GPhoto.vala"
	_tmp21_ = camera_file;
#line 294 "/shotwell/src/camera/GPhoto.vala"
...
#line 294 "/shotwell/src/camera/GPhoto.vala"
	res = _tmp24_;
#line 295 "/shotwell/src/camera/GPhoto.vala"
	_tmp25_ = res;
#line 295 "/shotwell/src/camera/GPhoto.vala"
	if (_tmp25_ != GP_OK) {
#line 2739 "GPhoto.c"
		guint8* _tmp26_;
		gint _tmp26__length1;
#line 296 "/shotwell/src/camera/GPhoto.vala"
		_tmp26_ = NULL;
#line 296 "/shotwell/src/camera/GPhoto.vala"
		_tmp26__length1 = 0;
#line 296 "/shotwell/src/camera/GPhoto.vala"
...
#line 298 "/shotwell/src/camera/GPhoto.vala"
	_tmp27_ = data_len;
#line 298 "/shotwell/src/camera/GPhoto.vala"
...
#line 298 "/shotwell/src/camera/GPhoto.vala"
	_buffer_size_ = buffer_length1;
#line 299 "/shotwell/src/camera/GPhoto.vala"
	_tmp29_ = buffer;
#line 299 "/shotwell/src/camera/GPhoto.vala"
	_tmp29__length1 = buffer_length1;
#line 299 "/shotwell/src/camera/GPhoto.vala"
...
#line 301 "/shotwell/src/camera/GPhoto.vala"
	_tmp32_ = buffer;
#line 301 "/shotwell/src/camera/GPhoto.vala"
