...
static void _event_page_on_events_altered_data_collection_items_altered (DataCollection* _sender, GeeMap* items, gpointer self) {
#line 40 "/shotwell/src/events/EventPage.vala"
	event_page_on_events_altered ((EventPage*) self, items);
#line 941 "EventPage.c"
}


static void _event_page_on_make_primary_gsimple_action_activate_callback (GSimpleAction* action, GVariant* parameter, gpointer self) {
#line 50 "/shotwell/src/events/EventPage.vala"
...
#line 962 "EventPage.c"
}


static gpointer _g_object_ref0 (gpointer self) {
#line 13 "/shotwell/src/events/EventPage.vala"
	return self ? g_object_ref (self) : NULL;
#line 969 "EventPage.c"
}
...
#line 14 "/shotwell/src/events/EventPage.vala"
	return result;
#line 978 "EventPage.c"
}
...
#line 10 "/shotwell/src/events/EventPage.vala"
	g_return_val_if_fail (IS_EVENT (page_event), NULL);
#line 11 "/shotwell/src/events/EventPage.vala"
	_tmp0_ = page_event;
#line 11 "/shotwell/src/events/EventPage.vala"
...
#line 16 "/shotwell/src/events/EventPage.vala"
...
#line 18 "/shotwell/src/events/EventPage.vala"
	_tmp8_ = event_global;
#line 18 "/shotwell/src/events/EventPage.vala"
...
Event* event_page_get_event (EventPage* self) {
	...
	Event* _tmp0_;
	Event* _tmp1_;
#line 21 "/shotwell/src/events/EventPage.vala"
	g_return_val_if_fail (IS_EVENT_PAGE (self), NULL);
#line 22 "/shotwell/src/events/EventPage.vala"
...
static gboolean event_page_real_on_app_key_pressed (Page* base, GdkEventKey* event) {
	...
	GdkEventKey* _tmp7_;
	gboolean _tmp8_;
#line 25 "/shotwell/src/events/EventPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_EVENT_PAGE, EventPage);
#line 25 "/shotwell/src/events/EventPage.vala"
	g_return_val_if_fail (event != NULL, FALSE);
#line 30 "/shotwell/src/events/EventPage.vala"
	_tmp0_ = event;
#line 30 "/shotwell/src/events/EventPage.vala"
...
#line 1080 "EventPage.c"
		ViewCollection* _tmp3_;
		ViewCollection* _tmp4_;
		gint _tmp5_;
		gboolean _tmp6_;
#line 31 "/shotwell/src/events/EventPage.vala"
...
#line 31 "/shotwell/src/events/EventPage.vala"
		if (_tmp6_) {
#line 32 "/shotwell/src/events/EventPage.vala"
			result = TRUE;
#line 32 "/shotwell/src/events/EventPage.vala"
			return result;
#line 1101 "EventPage.c"
		}
	}
#line 36 "/shotwell/src/events/EventPage.vala"
	_tmp7_ = event;
#line 36 "/shotwell/src/events/EventPage.vala"
...
static void event_page_real_init_collect_ui_filenames (Page* base, GeeList* ui_filenames) {
	...
	GeeList* _tmp0_;
	GeeList* _tmp1_;
#line 44 "/shotwell/src/events/EventPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_EVENT_PAGE, EventPage);
#line 44 "/shotwell/src/events/EventPage.vala"
	g_return_if_fail (GEE_IS_LIST (ui_filenames));
#line 45 "/shotwell/src/events/EventPage.vala"
	_tmp0_ = ui_filenames;
#line 45 "/shotwell/src/events/EventPage.vala"
...
static void event_page_real_add_actions (Page* base, GActionMap* map) {
	...
	GActionMap* _tmp0_;
	GActionMap* _tmp1_;
#line 56 "/shotwell/src/events/EventPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_EVENT_PAGE, EventPage);
#line 56 "/shotwell/src/events/EventPage.vala"
	g_return_if_fail (G_IS_ACTION_MAP (map));
#line 57 "/shotwell/src/events/EventPage.vala"
	_tmp0_ = map;
#line 57 "/shotwell/src/events/EventPage.vala"
...
static void event_page_real_remove_actions (Page* base, GActionMap* map) {
	EventPage * self;
	GActionMap* _tmp0_;
#line 62 "/shotwell/src/events/EventPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_EVENT_PAGE, EventPage);
#line 62 "/shotwell/src/events/EventPage.vala"
	g_return_if_fail (G_IS_ACTION_MAP (map));
#line 63 "/shotwell/src/events/EventPage.vala"
	_tmp0_ = map;
#line 63 "/shotwell/src/events/EventPage.vala"
...
#line 1167 "EventPage.c"
	{
		GActionEntry* entry_collection = NULL;
		gint entry_collection_length1 = 0;
		gint _entry_collection_size_ = 0;
		gint entry_it = 0;
#line 64 "/shotwell/src/events/EventPage.vala"
		entry_collection = EVENT_PAGE_entries;
#line 64 "/shotwell/src/events/EventPage.vala"
...
#line 1179 "EventPage.c"
			GActionEntry entry = {0};
#line 64 "/shotwell/src/events/EventPage.vala"
			entry = entry_collection[entry_it];
#line 1183 "EventPage.c"
			{
				GActionMap* _tmp1_;
				GActionEntry _tmp2_;
				const gchar* _tmp3_;
#line 65 "/shotwell/src/events/EventPage.vala"
				_tmp1_ = map;
#line 65 "/shotwell/src/events/EventPage.vala"
				_tmp2_ = entry;
#line 65 "/shotwell/src/events/EventPage.vala"
...
static void event_page_real_init_actions (Page* base, gint selected_count, gint count) {
	...
	gint _tmp0_;
	gint _tmp1_;
#line 69 "/shotwell/src/events/EventPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_EVENT_PAGE, EventPage);
#line 70 "/shotwell/src/events/EventPage.vala"
...
static void event_page_real_get_config_photos_sort (MediaPage* base, gboolean* sort_order, gint* sort_by) {
	...
	gint _tmp3_ = 0;
#line 86 "/shotwell/src/events/EventPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_EVENT_PAGE, EventPage);
#line 87 "/shotwell/src/events/EventPage.vala"
...
#line 1270 "EventPage.c"
	}
#line 86 "/shotwell/src/events/EventPage.vala"
	if (sort_by) {
#line 86 "/shotwell/src/events/EventPage.vala"
		*sort_by = _vala_sort_by;
#line 1276 "EventPage.c"
	}
}
...
static void event_page_real_set_config_photos_sort (MediaPage* base, gboolean sort_order, gint sort_by) {
	...
	gboolean _tmp2_;
	gint _tmp3_;
#line 90 "/shotwell/src/events/EventPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_EVENT_PAGE, EventPage);
#line 91 "/shotwell/src/events/EventPage.vala"
	_tmp0_ = config_facade_get_instance ();
#line 91 "/shotwell/src/events/EventPage.vala"
	_tmp1_ = _tmp0_;
#line 91 "/shotwell/src/events/EventPage.vala"
...
static void event_page_on_events_altered (EventPage* self, GeeMap* map) {
	...
	Event* _tmp1_;
	gboolean _tmp2_;
#line 94 "/shotwell/src/events/EventPage.vala"
	g_return_if_fail (IS_EVENT_PAGE (self));
#line 94 "/shotwell/src/events/EventPage.vala"
	g_return_if_fail (GEE_IS_MAP (map));
#line 95 "/shotwell/src/events/EventPage.vala"
	_tmp0_ = map;
#line 95 "/shotwell/src/events/EventPage.vala"
...
#line 95 "/shotwell/src/events/EventPage.vala"
	if (_tmp2_) {
#line 1321 "EventPage.c"
		Event* _tmp3_;
		gchar* _tmp4_;
		gchar* _tmp5_;
#line 96 "/shotwell/src/events/EventPage.vala"
...
static void event_page_real_on_edit_comment (MediaPage* base) {
	...
	gint _tmp2_;
	gboolean _tmp3_;
#line 99 "/shotwell/src/events/EventPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_EVENT_PAGE, EventPage);
#line 100 "/shotwell/src/events/EventPage.vala"
...
#line 101 "/shotwell/src/events/EventPage.vala"
...
#line 103 "/shotwell/src/events/EventPage.vala"
		_tmp9_ = edit_comment_dialog;
#line 103 "/shotwell/src/events/EventPage.vala"
		_tmp10_ = edit_comment_dialog_execute (_tmp9_);
#line 103 "/shotwell/src/events/EventPage.vala"
		new_comment = _tmp10_;
#line 104 "/shotwell/src/events/EventPage.vala"
		_tmp11_ = new_comment;
#line 104 "/shotwell/src/events/EventPage.vala"
		if (_tmp11_ == NULL) {
#line 105 "/shotwell/src/events/EventPage.vala"
			_g_free0 (new_comment);
#line 105 "/shotwell/src/events/EventPage.vala"
			_multi_text_entry_dialog_mediator_unref0 (edit_comment_dialog);
#line 105 "/shotwell/src/events/EventPage.vala"
			return;
#line 1408 "EventPage.c"
		}
#line 107 "/shotwell/src/events/EventPage.vala"
...
#line 107 "/shotwell/src/events/EventPage.vala"
		command = _tmp14_;
#line 108 "/shotwell/src/events/EventPage.vala"
...
#line 109 "/shotwell/src/events/EventPage.vala"
...
#line 109 "/shotwell/src/events/EventPage.vala"
		return;
#line 1436 "EventPage.c"
	}
#line 112 "/shotwell/src/events/EventPage.vala"
...
static void event_page_on_make_primary (EventPage* self) {
	...
	DataSource* _tmp9_;
	MediaSource* _tmp10_;
#line 115 "/shotwell/src/events/EventPage.vala"
	g_return_if_fail (IS_EVENT_PAGE (self));
#line 116 "/shotwell/src/events/EventPage.vala"
	_tmp0_ = page_get_view (G_TYPE_CHECK_INSTANCE_CAST (self, TYPE_PAGE, Page));
#line 116 "/shotwell/src/events/EventPage.vala"
	_tmp1_ = _tmp0_;
#line 116 "/shotwell/src/events/EventPage.vala"
...
#line 116 "/shotwell/src/events/EventPage.vala"
	if (_tmp3_) {
#line 117 "/shotwell/src/events/EventPage.vala"
		return;
#line 1472 "EventPage.c"
	}
#line 119 "/shotwell/src/events/EventPage.vala"
	_tmp4_ = self->priv->page_event;
#line 119 "/shotwell/src/events/EventPage.vala"
...
static void event_page_on_rename (EventPage* self) {
	...
	Event* _tmp2_;
#line 122 "/shotwell/src/events/EventPage.vala"
	g_return_if_fail (IS_EVENT_PAGE (self));
#line 123 "/shotwell/src/events/EventPage.vala"
...
#line 123 "/shotwell/src/events/EventPage.vala"
	_g_object_unref0 (_tmp1_);
#line 1516 "EventPage.c"
}


static void event_page_class_init (EventPageClass * klass) {
#line 7 "/shotwell/src/events/EventPage.vala"
...
#line 41 "/shotwell/src/events/EventPage.vala"
...
#line 8 "/shotwell/src/events/EventPage.vala"
	_g_object_unref0 (self->priv->page_event);
#line 7 "/shotwell/src/events/EventPage.vala"
...
#line 146 "/shotwell/src/events/EventPage.vala"
	self = (NoEventPage*) collection_page_construct (object_type, NO_EVENT_PAGE_NAME);
#line 148 "/shotwell/src/events/EventPage.vala"
...
#line 149 "/shotwell/src/events/EventPage.vala"
...
#line 150 "/shotwell/src/events/EventPage.vala"
...
#line 145 "/shotwell/src/events/EventPage.vala"
	_view_manager_unref0 (filter);
#line 145 "/shotwell/src/events/EventPage.vala"
	return self;
#line 1656 "EventPage.c"
}
...
static void no_event_page_real_get_config_photos_sort (MediaPage* base, gboolean* sort_order, gint* sort_by) {
	...
	gboolean _tmp2_ = FALSE;
	gint _tmp3_ = 0;
#line 153 "/shotwell/src/events/EventPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_NO_EVENT_PAGE, NoEventPage);
#line 154 "/shotwell/src/events/EventPage.vala"
	_tmp0_ = config_facade_get_instance ();
#line 154 "/shotwell/src/events/EventPage.vala"
	_tmp1_ = _tmp0_;
#line 154 "/shotwell/src/events/EventPage.vala"
...
#line 153 "/shotwell/src/events/EventPage.vala"
		*sort_order = _vala_sort_order;
#line 1693 "EventPage.c"
	}
#line 153 "/shotwell/src/events/EventPage.vala"
	if (sort_by) {
#line 153 "/shotwell/src/events/EventPage.vala"
		*sort_by = _vala_sort_by;
#line 1699 "EventPage.c"
	}
}
...
static void no_event_page_real_set_config_photos_sort (MediaPage* base, gboolean sort_order, gint sort_by) {
	...
	gboolean _tmp2_;
	gint _tmp3_;
#line 157 "/shotwell/src/events/EventPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_NO_EVENT_PAGE, NoEventPage);
#line 158 "/shotwell/src/events/EventPage.vala"
	_tmp0_ = config_facade_get_instance ();
#line 158 "/shotwell/src/events/EventPage.vala"
	_tmp1_ = _tmp0_;
#line 158 "/shotwell/src/events/EventPage.vala"
...
static NoEventPageNoEventViewManager* no_event_page_no_event_view_manager_construct (GType object_type, NoEventPage* page) {
	...
	NoEventPage* _tmp0_;
#line 132 "/shotwell/src/events/EventPage.vala"
	g_return_val_if_fail (IS_NO_EVENT_PAGE (page), NULL);
#line 133 "/shotwell/src/events/EventPage.vala"
	_tmp0_ = page;
#line 133 "/shotwell/src/events/EventPage.vala"
...
#line 1771 "EventPage.c"
		...
		DataSource* _tmp4_;
		gboolean _tmp5_;
#line 139 "/shotwell/src/events/EventPage.vala"
		_tmp4_ = source;
#line 139 "/shotwell/src/events/EventPage.vala"
...
static void no_event_page_class_init (NoEventPageClass * klass) {
	Alteration* _tmp0_;
#line 127 "/shotwell/src/events/EventPage.vala"
