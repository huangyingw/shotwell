...
SidebarGrouping* sidebar_grouping_construct (GType object_type, const gchar* name, const gchar* icon, const gchar* tooltip) {
	...
	const gchar* _tmp4_;
	gchar* _tmp5_;
#line 15 "/shotwell/src/sidebar/common.vala"
	g_return_val_if_fail (name != NULL, NULL);
#line 15 "/shotwell/src/sidebar/common.vala"
	self = (SidebarGrouping*) g_object_new (object_type, NULL);
#line 16 "/shotwell/src/sidebar/common.vala"
	_tmp0_ = name;
#line 16 "/shotwell/src/sidebar/common.vala"
...
#line 17 "/shotwell/src/sidebar/common.vala"
	_tmp2_ = icon;
#line 17 "/shotwell/src/sidebar/common.vala"
...
#line 18 "/shotwell/src/sidebar/common.vala"
	_tmp4_ = tooltip;
#line 18 "/shotwell/src/sidebar/common.vala"
...
static void sidebar_grouping_real_rename (SidebarRenameableEntry* base, const gchar* name) {
	...
	gchar* _tmp1_;
	const gchar* _tmp2_;
#line 21 "/shotwell/src/sidebar/common.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, SIDEBAR_TYPE_GROUPING, SidebarGrouping);
#line 21 "/shotwell/src/sidebar/common.vala"
	g_return_if_fail (name != NULL);
#line 22 "/shotwell/src/sidebar/common.vala"
	_tmp0_ = name;
#line 22 "/shotwell/src/sidebar/common.vala"
	_tmp1_ = g_strdup (_tmp0_);
#line 22 "/shotwell/src/sidebar/common.vala"
...
#line 22 "/shotwell/src/sidebar/common.vala"
	self->priv->name = _tmp1_;
#line 23 "/shotwell/src/sidebar/common.vala"
	_tmp2_ = name;
#line 23 "/shotwell/src/sidebar/common.vala"
...
#line 26 "/shotwell/src/sidebar/common.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, SIDEBAR_TYPE_GROUPING, SidebarGrouping);
#line 27 "/shotwell/src/sidebar/common.vala"
	result = FALSE;
#line 27 "/shotwell/src/sidebar/common.vala"
	return result;
#line 436 "common.c"
...
static gchar* sidebar_grouping_real_get_sidebar_name (SidebarEntry* base) {
	...
	const gchar* _tmp0_;
	gchar* _tmp1_;
#line 30 "/shotwell/src/sidebar/common.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, SIDEBAR_TYPE_GROUPING, SidebarGrouping);
#line 31 "/shotwell/src/sidebar/common.vala"
...
static gchar* sidebar_grouping_real_get_sidebar_tooltip (SidebarEntry* base) {
	...
	const gchar* _tmp0_;
	gchar* _tmp1_;
#line 34 "/shotwell/src/sidebar/common.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, SIDEBAR_TYPE_GROUPING, SidebarGrouping);
#line 35 "/shotwell/src/sidebar/common.vala"
...
static gchar* sidebar_grouping_real_get_sidebar_icon (SidebarEntry* base) {
	...
	const gchar* _tmp0_;
	gchar* _tmp1_;
#line 38 "/shotwell/src/sidebar/common.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, SIDEBAR_TYPE_GROUPING, SidebarGrouping);
#line 39 "/shotwell/src/sidebar/common.vala"
...
static gchar* sidebar_grouping_real_to_string (SidebarEntry* base) {
	...
	const gchar* _tmp0_;
	gchar* _tmp1_;
#line 42 "/shotwell/src/sidebar/common.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, SIDEBAR_TYPE_GROUPING, SidebarGrouping);
#line 43 "/shotwell/src/sidebar/common.vala"
	_tmp0_ = self->priv->name;
#line 43 "/shotwell/src/sidebar/common.vala"
	_tmp1_ = g_strdup (_tmp0_);
#line 43 "/shotwell/src/sidebar/common.vala"
...
static gboolean sidebar_grouping_real_expand_on_select (SidebarExpandableEntry* base) {
	SidebarGrouping * self;
	gboolean result = FALSE;
#line 46 "/shotwell/src/sidebar/common.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, SIDEBAR_TYPE_GROUPING, SidebarGrouping);
#line 47 "/shotwell/src/sidebar/common.vala"
	result = TRUE;
#line 47 "/shotwell/src/sidebar/common.vala"
	return result;
#line 525 "common.c"
...
#line 8 "/shotwell/src/sidebar/common.vala"
...
#line 11 "/shotwell/src/sidebar/common.vala"
	_g_free0 (self->priv->name);
#line 12 "/shotwell/src/sidebar/common.vala"
	_g_free0 (self->priv->tooltip);
#line 13 "/shotwell/src/sidebar/common.vala"
	_g_free0 (self->priv->icon);
#line 8 "/shotwell/src/sidebar/common.vala"
...
#line 58 "/shotwell/src/sidebar/common.vala"
...
static gchar* sidebar_simple_page_entry_real_get_sidebar_name (SidebarSimplePageEntry* self) {
#line 61 "/shotwell/src/sidebar/common.vala"
...
static gchar* sidebar_simple_page_entry_real_get_sidebar_tooltip (SidebarSimplePageEntry* self) {
	gchar* result = NULL;
	gchar* _tmp0_;
#line 64 "/shotwell/src/sidebar/common.vala"
...
gchar* sidebar_simple_page_entry_get_sidebar_tooltip (SidebarSimplePageEntry* self) {
#line 63 "/shotwell/src/sidebar/common.vala"
	g_return_val_if_fail (SIDEBAR_IS_SIMPLE_PAGE_ENTRY (self), NULL);
#line 63 "/shotwell/src/sidebar/common.vala"
...
static gchar* sidebar_simple_page_entry_real_get_sidebar_icon (SidebarSimplePageEntry* self) {
#line 67 "/shotwell/src/sidebar/common.vala"
...
static gchar* sidebar_simple_page_entry_real_to_string (SidebarSimplePageEntry* self) {
	gchar* result = NULL;
	gchar* _tmp0_;
#line 70 "/shotwell/src/sidebar/common.vala"
	_tmp0_ = sidebar_simple_page_entry_get_sidebar_name (self);
#line 70 "/shotwell/src/sidebar/common.vala"
	result = _tmp0_;
#line 70 "/shotwell/src/sidebar/common.vala"
...
gchar* sidebar_simple_page_entry_to_string (SidebarSimplePageEntry* self) {
#line 69 "/shotwell/src/sidebar/common.vala"
	g_return_val_if_fail (SIDEBAR_IS_SIMPLE_PAGE_ENTRY (self), NULL);
#line 69 "/shotwell/src/sidebar/common.vala"
...
static Page* sidebar_simple_page_entry_real_create_page (SidebarSimplePageEntry* self) {
#line 73 "/shotwell/src/sidebar/common.vala"
...
#line 85 "/shotwell/src/sidebar/common.vala"
...
static Page* sidebar_simple_page_entry_real_get_page (SidebarPageRepresentative* base) {
	...
	Page* _tmp3_;
	Page* _tmp4_;
#line 79 "/shotwell/src/sidebar/common.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, SIDEBAR_TYPE_SIMPLE_PAGE_ENTRY, SidebarSimplePageEntry);
#line 80 "/shotwell/src/sidebar/common.vala"
	_tmp0_ = self->priv->page;
#line 80 "/shotwell/src/sidebar/common.vala"
	if (_tmp0_ == NULL) {
#line 759 "common.c"
...
static void sidebar_simple_page_entry_real_pruned (SidebarEntry* base, SidebarTree* tree) {
	...
	Page* _tmp1_;
	Page* _tmp2_;
#line 88 "/shotwell/src/sidebar/common.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, SIDEBAR_TYPE_SIMPLE_PAGE_ENTRY, SidebarSimplePageEntry);
#line 88 "/shotwell/src/sidebar/common.vala"
	g_return_if_fail (SIDEBAR_IS_TREE (tree));
#line 89 "/shotwell/src/sidebar/common.vala"
	_tmp0_ = self->priv->page;
#line 89 "/shotwell/src/sidebar/common.vala"
	if (_tmp0_ == NULL) {
#line 90 "/shotwell/src/sidebar/common.vala"
		return;
#line 801 "common.c"
	}
#line 92 "/shotwell/src/sidebar/common.vala"
...
static GtkMenu* sidebar_simple_page_entry_real_get_sidebar_context_menu (SidebarContextable* base, GdkEventButton* event) {
	...
	GtkMenu* _tmp2_;
	GtkMenu* _tmp3_;
#line 97 "/shotwell/src/sidebar/common.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, SIDEBAR_TYPE_SIMPLE_PAGE_ENTRY, SidebarSimplePageEntry);
#line 98 "/shotwell/src/sidebar/common.vala"
...
#line 54 "/shotwell/src/sidebar/common.vala"
...
#line 56 "/shotwell/src/sidebar/common.vala"
	self->priv->page = NULL;
#line 916 "common.c"
}
...
#line 105 "/shotwell/src/sidebar/common.vala"
	return result;
#line 957 "common.c"
}
...
SidebarRootOnlyBranch* sidebar_root_only_branch_construct (GType object_type, SidebarEntry* root) {
	...
	SidebarEntry* _tmp0_;
#line 104 "/shotwell/src/sidebar/common.vala"
...
static gint sidebar_root_only_branch_null_comparator (SidebarEntry* a, SidebarEntry* b) {
	...
	SidebarEntry* _tmp1_;
	SidebarEntry* _tmp2_;
#line 108 "/shotwell/src/sidebar/common.vala"
	g_return_val_if_fail (SIDEBAR_IS_ENTRY (a), 0);
#line 108 "/shotwell/src/sidebar/common.vala"
	g_return_val_if_fail (SIDEBAR_IS_ENTRY (b), 0);
#line 109 "/shotwell/src/sidebar/common.vala"
	_tmp1_ = a;
#line 109 "/shotwell/src/sidebar/common.vala"
	_tmp2_ = b;
#line 109 "/shotwell/src/sidebar/common.vala"
...
#line 103 "/shotwell/src/sidebar/common.vala"
...
SidebarHeader* sidebar_header_construct (GType object_type, const gchar* name, gboolean emphasized) {
	...
	const gchar* _tmp0_;
	gboolean _tmp1_;
#line 123 "/shotwell/src/sidebar/common.vala"
	g_return_val_if_fail (name != NULL, NULL);
#line 124 "/shotwell/src/sidebar/common.vala"
	_tmp0_ = name;
#line 124 "/shotwell/src/sidebar/common.vala"
	self = (SidebarHeader*) sidebar_grouping_construct (object_type, _tmp0_, NULL, NULL);
#line 125 "/shotwell/src/sidebar/common.vala"
	_tmp1_ = emphasized;
#line 125 "/shotwell/src/sidebar/common.vala"
...
static gboolean sidebar_header_real_is_emphasized (SidebarEmphasizableEntry* base) {
	...
	gboolean result = FALSE;
	gboolean _tmp0_;
#line 128 "/shotwell/src/sidebar/common.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, SIDEBAR_TYPE_HEADER, SidebarHeader);
#line 129 "/shotwell/src/sidebar/common.vala"
...
#line 120 "/shotwell/src/sidebar/common.vala"
...
GtkMenu* sidebar_contextable_get_sidebar_context_menu (SidebarContextable* self, GdkEventButton* event) {
#line 135 "/shotwell/src/sidebar/common.vala"
...
#line 133 "/shotwell/src/sidebar/common.vala"
