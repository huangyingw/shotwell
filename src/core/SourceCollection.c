...
SourceCollection* source_collection_construct (GType object_type, const gchar* name) {
	...
	const gchar* _tmp0_;
#line 50 "/shotwell/src/core/SourceCollection.vala"
	g_return_val_if_fail (name != NULL, NULL);
#line 51 "/shotwell/src/core/SourceCollection.vala"
	_tmp0_ = name;
#line 51 "/shotwell/src/core/SourceCollection.vala"
...
#line 54 "/shotwell/src/core/SourceCollection.vala"
...
#line 56 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (GEE_IS_COLLECTION (unlinking));
#line 57 "/shotwell/src/core/SourceCollection.vala"
	_tmp0_ = unlinking;
#line 57 "/shotwell/src/core/SourceCollection.vala"
...
static void source_collection_real_notify_items_relinked (SourceCollection* self, GeeCollection* relinked) {
	GeeCollection* _tmp0_;
#line 60 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (GEE_IS_COLLECTION (relinked));
#line 61 "/shotwell/src/core/SourceCollection.vala"
	_tmp0_ = relinked;
#line 61 "/shotwell/src/core/SourceCollection.vala"
...
static void source_collection_real_notify_item_destroyed (SourceCollection* self, DataSource* source) {
	DataSource* _tmp0_;
#line 64 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (IS_DATA_SOURCE (source));
#line 65 "/shotwell/src/core/SourceCollection.vala"
	_tmp0_ = source;
#line 65 "/shotwell/src/core/SourceCollection.vala"
...
static void source_collection_real_notify_items_destroyed (SourceCollection* self, GeeCollection* destroyed) {
	GeeCollection* _tmp0_;
#line 68 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (GEE_IS_COLLECTION (destroyed));
#line 69 "/shotwell/src/core/SourceCollection.vala"
	_tmp0_ = destroyed;
#line 69 "/shotwell/src/core/SourceCollection.vala"
...
static void source_collection_real_notify_unlinked_destroyed (SourceCollection* self, DataSource* unlinked) {
	DataSource* _tmp0_;
#line 73 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (IS_DATA_SOURCE (unlinked));
#line 74 "/shotwell/src/core/SourceCollection.vala"
	_tmp0_ = unlinked;
#line 74 "/shotwell/src/core/SourceCollection.vala"
...
#line 77 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (IS_SOURCE_BACKLINK (backlink));
#line 77 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (GEE_IS_COLLECTION (sources));
#line 79 "/shotwell/src/core/SourceCollection.vala"
	_tmp0_ = backlink;
#line 79 "/shotwell/src/core/SourceCollection.vala"
	_tmp1_ = sources;
#line 79 "/shotwell/src/core/SourceCollection.vala"
...
static gboolean source_collection_real_valid_type (DataCollection* base, DataObject* object) {
	...
	DataObject* _tmp0_;
#line 82 "/shotwell/src/core/SourceCollection.vala"
...
#line 83 "/shotwell/src/core/SourceCollection.vala"
	_tmp0_ = object;
#line 83 "/shotwell/src/core/SourceCollection.vala"
...
#line 93 "/shotwell/src/core/SourceCollection.vala"
	return result;
...
#line 95 "/shotwell/src/core/SourceCollection.vala"
	return result;
...
#line 98 "/shotwell/src/core/SourceCollection.vala"
...
gint source_collection_destroy_marked (SourceCollection* self, Marker* marker, gboolean delete_backing, ProgressMonitor monitor, void* monitor_target, GeeList* not_removed) {
	...
	gint _tmp34_;
	gint _tmp35_;
#line 88 "/shotwell/src/core/SourceCollection.vala"
...
#line 90 "/shotwell/src/core/SourceCollection.vala"
...
#line 90 "/shotwell/src/core/SourceCollection.vala"
	counter = _tmp3_;
#line 92 "/shotwell/src/core/SourceCollection.vala"
...
#line 99 "/shotwell/src/core/SourceCollection.vala"
			_tmp23_ = source;
#line 99 "/shotwell/src/core/SourceCollection.vala"
...
#line 100 "/shotwell/src/core/SourceCollection.vala"
	_tmp24_ = counter;
#line 100 "/shotwell/src/core/SourceCollection.vala"
...
#line 103 "/shotwell/src/core/SourceCollection.vala"
	_tmp26_ = counter;
#line 103 "/shotwell/src/core/SourceCollection.vala"
...
#line 105 "/shotwell/src/core/SourceCollection.vala"
	_tmp28_ = not_removed;
#line 105 "/shotwell/src/core/SourceCollection.vala"
	if (NULL != _tmp28_) {
...
#line 106 "/shotwell/src/core/SourceCollection.vala"
		_tmp29_ = not_removed;
#line 106 "/shotwell/src/core/SourceCollection.vala"
		_tmp30_ = counter;
#line 106 "/shotwell/src/core/SourceCollection.vala"
...
#line 109 "/shotwell/src/core/SourceCollection.vala"
	_tmp32_ = counter;
#line 109 "/shotwell/src/core/SourceCollection.vala"
...
#line 112 "/shotwell/src/core/SourceCollection.vala"
	g_return_val_if_fail (IS_SOURCE_COLLECTION (self), FALSE);
#line 112 "/shotwell/src/core/SourceCollection.vala"
	g_return_val_if_fail (IS_DATA_OBJECT (object), FALSE);
#line 112 "/shotwell/src/core/SourceCollection.vala"
	g_return_val_if_fail ((user == NULL) || G_IS_OBJECT (user), FALSE);
#line 113 "/shotwell/src/core/SourceCollection.vala"
	success = FALSE;
#line 758 "SourceCollection.c"
	{
		...
		DataObject* _tmp1_;
		gboolean _tmp2_;
#line 115 "/shotwell/src/core/SourceCollection.vala"
		_tmp1_ = object;
#line 115 "/shotwell/src/core/SourceCollection.vala"
...
#line 776 "SourceCollection.c"
	...
	{
		GError* err = NULL;
#line 114 "/shotwell/src/core/SourceCollection.vala"
		err = _inner_error_;
#line 114 "/shotwell/src/core/SourceCollection.vala"
		_inner_error_ = NULL;
#line 117 "/shotwell/src/core/SourceCollection.vala"
		success = FALSE;
#line 114 "/shotwell/src/core/SourceCollection.vala"
		_g_error_free0 (err);
...
#line 120 "/shotwell/src/core/SourceCollection.vala"
	_tmp5_ = success;
#line 120 "/shotwell/src/core/SourceCollection.vala"
	if (!_tmp5_) {
...
#line 823 "SourceCollection.c"
		...
		GeeArrayList* _tmp8_;
		DataObject* _tmp9_;
#line 121 "/shotwell/src/core/SourceCollection.vala"
		_tmp7_ = user;
#line 121 "/shotwell/src/core/SourceCollection.vala"
...
#line 124 "/shotwell/src/core/SourceCollection.vala"
	_tmp11_ = object;
#line 124 "/shotwell/src/core/SourceCollection.vala"
	_tmp12_ = user;
#line 124 "/shotwell/src/core/SourceCollection.vala"
...
static gboolean source_collection_destroy_source (SourceCollection* self, DataObject* object, GObject* user) {
	...
	GObject* _tmp4_;
	GeeArrayList* _tmp5_;
#line 127 "/shotwell/src/core/SourceCollection.vala"
	g_return_val_if_fail (IS_SOURCE_COLLECTION (self), FALSE);
#line 127 "/shotwell/src/core/SourceCollection.vala"
	g_return_val_if_fail (IS_DATA_OBJECT (object), FALSE);
#line 127 "/shotwell/src/core/SourceCollection.vala"
	g_return_val_if_fail ((user == NULL) || G_IS_OBJECT (user), FALSE);
#line 128 "/shotwell/src/core/SourceCollection.vala"
	_tmp0_ = object;
#line 128 "/shotwell/src/core/SourceCollection.vala"
	_tmp1_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp0_, TYPE_DATA_SOURCE, DataSource));
#line 128 "/shotwell/src/core/SourceCollection.vala"
	source = _tmp1_;
#line 130 "/shotwell/src/core/SourceCollection.vala"
	data_source_internal_mark_for_destroy (source);
#line 131 "/shotwell/src/core/SourceCollection.vala"
	data_source_destroy (source);
#line 133 "/shotwell/src/core/SourceCollection.vala"
	_tmp2_ = user;
#line 133 "/shotwell/src/core/SourceCollection.vala"
...
#line 134 "/shotwell/src/core/SourceCollection.vala"
	_tmp4_ = user;
#line 134 "/shotwell/src/core/SourceCollection.vala"
...
#line 136 "/shotwell/src/core/SourceCollection.vala"
	result = TRUE;
#line 136 "/shotwell/src/core/SourceCollection.vala"
	_g_object_unref0 (source);
#line 136 "/shotwell/src/core/SourceCollection.vala"
...
#line 142 "/shotwell/src/core/SourceCollection.vala"
	return result;
...
void source_collection_internal_backlink_set (SourceCollection* self, DataSource* source, SourceBacklink* backlink) {
	...
	DataSource* _tmp4_;
#line 140 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (IS_SOURCE_COLLECTION (self));
#line 140 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (IS_DATA_SOURCE (source));
#line 140 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (IS_SOURCE_BACKLINK (backlink));
#line 141 "/shotwell/src/core/SourceCollection.vala"
...
#line 146 "/shotwell/src/core/SourceCollection.vala"
...
void source_collection_internal_backlink_removed (SourceCollection* self, DataSource* source, SourceBacklink* backlink) {
	...
	DataSource* _tmp3_;
	gboolean _tmp4_;
#line 150 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (IS_SOURCE_COLLECTION (self));
#line 150 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (IS_DATA_SOURCE (source));
#line 150 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (IS_SOURCE_BACKLINK (backlink));
#line 151 "/shotwell/src/core/SourceCollection.vala"
	_tmp0_ = self->priv->backlinks;
#line 151 "/shotwell/src/core/SourceCollection.vala"
	_vala_assert (_tmp0_ != NULL, "backlinks != null");
#line 153 "/shotwell/src/core/SourceCollection.vala"
...
#line 153 "/shotwell/src/core/SourceCollection.vala"
	removed = _tmp4_;
#line 154 "/shotwell/src/core/SourceCollection.vala"
...
static gboolean source_collection_real_has_backlink (SourceCollection* self, SourceBacklink* backlink) {
	...
	gboolean _tmp0_ = FALSE;
	GeeMultiMap* _tmp1_;
#line 157 "/shotwell/src/core/SourceCollection.vala"
	g_return_val_if_fail (IS_SOURCE_BACKLINK (backlink), FALSE);
#line 158 "/shotwell/src/core/SourceCollection.vala"
	_tmp1_ = self->priv->backlinks;
#line 158 "/shotwell/src/core/SourceCollection.vala"
	if (_tmp1_ != NULL) {
...
#line 163 "/shotwell/src/core/SourceCollection.vala"
	return result;
...
GeeCollection* source_collection_unlink_marked (SourceCollection* self, Marker* marker, ProgressMonitor monitor, void* monitor_target) {
	...
	Marker* _tmp9_;
	Marker* _tmp10_;
#line 161 "/shotwell/src/core/SourceCollection.vala"
	g_return_val_if_fail (IS_SOURCE_COLLECTION (self), NULL);
#line 161 "/shotwell/src/core/SourceCollection.vala"
	g_return_val_if_fail (IS_MARKER (marker), NULL);
#line 162 "/shotwell/src/core/SourceCollection.vala"
...
#line 165 "/shotwell/src/core/SourceCollection.vala"
	_tmp4_ = list;
#line 165 "/shotwell/src/core/SourceCollection.vala"
...
#line 165 "/shotwell/src/core/SourceCollection.vala"
	if (_tmp6_ == 0) {
#line 166 "/shotwell/src/core/SourceCollection.vala"
		result = NULL;
#line 166 "/shotwell/src/core/SourceCollection.vala"
...
#line 172 "/shotwell/src/core/SourceCollection.vala"
...
static gboolean source_collection_prepare_for_unlink (SourceCollection* self, DataObject* object, GObject* user) {
	...
	DataSource* _tmp1_;
	GObject* _tmp2_;
#line 175 "/shotwell/src/core/SourceCollection.vala"
	g_return_val_if_fail (IS_SOURCE_COLLECTION (self), FALSE);
#line 175 "/shotwell/src/core/SourceCollection.vala"
	g_return_val_if_fail (IS_DATA_OBJECT (object), FALSE);
#line 175 "/shotwell/src/core/SourceCollection.vala"
	g_return_val_if_fail ((user == NULL) || G_IS_OBJECT (user), FALSE);
#line 176 "/shotwell/src/core/SourceCollection.vala"
	_tmp0_ = object;
#line 176 "/shotwell/src/core/SourceCollection.vala"
	_tmp1_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp0_, TYPE_DATA_SOURCE, DataSource));
#line 176 "/shotwell/src/core/SourceCollection.vala"
	source = _tmp1_;
#line 178 "/shotwell/src/core/SourceCollection.vala"
	data_source_notify_unlinking (source, self);
#line 179 "/shotwell/src/core/SourceCollection.vala"
	_tmp2_ = user;
#line 179 "/shotwell/src/core/SourceCollection.vala"
...
#line 181 "/shotwell/src/core/SourceCollection.vala"
	result = TRUE;
#line 181 "/shotwell/src/core/SourceCollection.vala"
	_g_object_unref0 (source);
#line 181 "/shotwell/src/core/SourceCollection.vala"
...
void source_collection_relink (SourceCollection* self, DataSource* source) {
	...
	DataSource* _tmp5_;
#line 184 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (IS_SOURCE_COLLECTION (self));
#line 184 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (IS_DATA_SOURCE (source));
#line 185 "/shotwell/src/core/SourceCollection.vala"
	_tmp0_ = source;
#line 185 "/shotwell/src/core/SourceCollection.vala"
	data_source_notify_relinking (_tmp0_, self);
#line 187 "/shotwell/src/core/SourceCollection.vala"
	_tmp1_ = source;
#line 187 "/shotwell/src/core/SourceCollection.vala"
...
#line 188 "/shotwell/src/core/SourceCollection.vala"
	_tmp2_ = source;
#line 188 "/shotwell/src/core/SourceCollection.vala"
...
#line 190 "/shotwell/src/core/SourceCollection.vala"
	_tmp5_ = source;
#line 190 "/shotwell/src/core/SourceCollection.vala"
...
#line 193 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (IS_SOURCE_COLLECTION (self));
#line 193 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (GEE_IS_COLLECTION (relink));
#line 194 "/shotwell/src/core/SourceCollection.vala"
	_tmp0_ = relink;
#line 194 "/shotwell/src/core/SourceCollection.vala"
...
#line 194 "/shotwell/src/core/SourceCollection.vala"
	if (_tmp2_ == 0) {
#line 195 "/shotwell/src/core/SourceCollection.vala"
		return;
#line 1218 "SourceCollection.c"
	}
	{
		...
		GeeCollection* _tmp3_;
		GeeIterator* _tmp4_;
#line 197 "/shotwell/src/core/SourceCollection.vala"
		_tmp3_ = relink;
#line 197 "/shotwell/src/core/SourceCollection.vala"
...
#line 198 "/shotwell/src/core/SourceCollection.vala"
			_tmp9_ = source;
#line 198 "/shotwell/src/core/SourceCollection.vala"
...
#line 200 "/shotwell/src/core/SourceCollection.vala"
	_tmp10_ = relink;
#line 200 "/shotwell/src/core/SourceCollection.vala"
...
#line 201 "/shotwell/src/core/SourceCollection.vala"
	_tmp13_ = relink;
#line 201 "/shotwell/src/core/SourceCollection.vala"
...
#line 1279 "SourceCollection.c"
	{
		...
		GeeIterator* _tmp15_;
#line 203 "/shotwell/src/core/SourceCollection.vala"
		_tmp14_ = relink;
#line 203 "/shotwell/src/core/SourceCollection.vala"
...
#line 204 "/shotwell/src/core/SourceCollection.vala"
			_tmp20_ = source;
#line 204 "/shotwell/src/core/SourceCollection.vala"
...
#line 207 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (IS_SOURCE_BACKLINK (backlink));
#line 208 "/shotwell/src/core/SourceCollection.vala"
	_tmp0_ = self->priv->backlinks;
#line 208 "/shotwell/src/core/SourceCollection.vala"
	if (_tmp0_ == NULL) {
#line 209 "/shotwell/src/core/SourceCollection.vala"
		return;
#line 1349 "SourceCollection.c"
	}
#line 212 "/shotwell/src/core/SourceCollection.vala"
	_tmp1_ = gee_array_list_new (TYPE_DATA_SOURCE, (GBoxedCopyFunc) g_object_ref, (GDestroyNotify) g_object_unref, NULL, NULL, NULL);
#line 212 "/shotwell/src/core/SourceCollection.vala"
	sources = _tmp1_;
#line 213 "/shotwell/src/core/SourceCollection.vala"
	_tmp2_ = sources;
#line 213 "/shotwell/src/core/SourceCollection.vala"
...
#line 1369 "SourceCollection.c"
	{
		...
		gint _tmp11_;
		gint _source_index = 0;
#line 215 "/shotwell/src/core/SourceCollection.vala"
		_tmp7_ = sources;
#line 215 "/shotwell/src/core/SourceCollection.vala"
...
#line 216 "/shotwell/src/core/SourceCollection.vala"
			_tmp18_ = source;
#line 216 "/shotwell/src/core/SourceCollection.vala"
			_tmp19_ = backlink;
#line 216 "/shotwell/src/core/SourceCollection.vala"
...
#line 218 "/shotwell/src/core/SourceCollection.vala"
	_tmp20_ = backlink;
#line 218 "/shotwell/src/core/SourceCollection.vala"
	_tmp21_ = sources;
#line 218 "/shotwell/src/core/SourceCollection.vala"
...
static void source_collection_real_items_unlinking (SourceCollection* self, GeeCollection* unlinking) {
#line 20 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (GEE_IS_COLLECTION (unlinking));
...
static void source_collection_real_items_relinked (SourceCollection* self, GeeCollection* relinked) {
#line 25 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (GEE_IS_COLLECTION (relinked));
...
static void source_collection_real_item_destroyed (SourceCollection* self, DataSource* source) {
#line 30 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (IS_DATA_SOURCE (source));
...
static void source_collection_real_items_destroyed (SourceCollection* self, GeeCollection* destroyed) {
#line 35 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (GEE_IS_COLLECTION (destroyed));
...
static void source_collection_real_unlinked_destroyed (SourceCollection* self, DataSource* source) {
#line 40 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (IS_DATA_SOURCE (source));
...
static void source_collection_real_backlink_removed (SourceCollection* self, SourceBacklink* backlink, GeeCollection* sources) {
#line 44 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (IS_SOURCE_BACKLINK (backlink));
#line 44 "/shotwell/src/core/SourceCollection.vala"
	g_return_if_fail (GEE_IS_COLLECTION (sources));
...
#line 7 "/shotwell/src/core/SourceCollection.vala"
...
#line 8 "/shotwell/src/core/SourceCollection.vala"
...
static void source_collection_destroy_counter_instance_init (SourceCollectionDestroyCounter * self) {
	GeeArrayList* _tmp0_;
	GeeArrayList* _tmp1_;
#line 10 "/shotwell/src/core/SourceCollection.vala"
	_tmp0_ = gee_array_list_new (TYPE_DATA_SOURCE, (GBoxedCopyFunc) g_object_ref, (GDestroyNotify) g_object_unref, NULL, NULL, NULL);
#line 10 "/shotwell/src/core/SourceCollection.vala"
	self->notify_list = _tmp0_;
#line 11 "/shotwell/src/core/SourceCollection.vala"
...
#line 9 "/shotwell/src/core/SourceCollection.vala"
	_g_object_unref0 (self->remove_marker);
#line 10 "/shotwell/src/core/SourceCollection.vala"
...
#line 48 "/shotwell/src/core/SourceCollection.vala"
