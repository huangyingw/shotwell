...
DataObject* data_object_construct (GType object_type, gint64 object_id) {
	...
	gint64 _tmp0_ = 0LL;
	gint64 _tmp1_;
#line 38 "/shotwell/src/core/DataObject.vala"
	self = (DataObject*) g_object_new (object_type, NULL);
#line 39 "/shotwell/src/core/DataObject.vala"
	_tmp1_ = object_id;
#line 39 "/shotwell/src/core/DataObject.vala"
...
#line 42 "/shotwell/src/core/DataObject.vala"
	g_return_if_fail (IS_ALTERATION (alteration));
#line 43 "/shotwell/src/core/DataObject.vala"
...
#line 189 "DataObject.c"
		...
		Alteration* _tmp2_;
#line 44 "/shotwell/src/core/DataObject.vala"
...
static void data_object_real_notify_membership_changed (DataObject* self, DataCollection* collection) {
#line 56 "/shotwell/src/core/DataObject.vala"
...
static void data_object_real_notify_collection_property_set (DataObject* self, const gchar* name, GValue* old, GValue* val) {
#line 61 "/shotwell/src/core/DataObject.vala"
...
static void data_object_real_notify_collection_property_cleared (DataObject* self, const gchar* name) {
#line 66 "/shotwell/src/core/DataObject.vala"
	g_return_if_fail (name != NULL);
...
static gchar* data_object_real_get_name (DataObject* self) {
#line 69 "/shotwell/src/core/DataObject.vala"
...
static gchar* data_object_real_to_string (DataObject* self) {
#line 71 "/shotwell/src/core/DataObject.vala"
...
#line 74 "/shotwell/src/core/DataObject.vala"
...
DataCollection* data_object_get_membership (DataObject* self) {
	...
	DataCollection* _tmp0_;
	DataCollection* _tmp1_;
#line 73 "/shotwell/src/core/DataObject.vala"
	g_return_val_if_fail (IS_DATA_OBJECT (self), NULL);
#line 74 "/shotwell/src/core/DataObject.vala"
	_tmp0_ = self->priv->member_of;
#line 74 "/shotwell/src/core/DataObject.vala"
...
gboolean data_object_has_membership (DataObject* self) {
	...
	DataCollection* _tmp0_;
#line 77 "/shotwell/src/core/DataObject.vala"
	g_return_val_if_fail (IS_DATA_OBJECT (self), FALSE);
#line 78 "/shotwell/src/core/DataObject.vala"
	_tmp0_ = self->priv->member_of;
#line 78 "/shotwell/src/core/DataObject.vala"
	result = _tmp0_ != NULL;
#line 78 "/shotwell/src/core/DataObject.vala"
...
void data_object_internal_set_membership (DataObject* self, DataCollection* collection, gint64 ordinal) {
	...
	gint64 _tmp3_;
#line 83 "/shotwell/src/core/DataObject.vala"
	g_return_if_fail (IS_DATA_OBJECT (self));
#line 83 "/shotwell/src/core/DataObject.vala"
	g_return_if_fail (IS_DATA_COLLECTION (collection));
#line 84 "/shotwell/src/core/DataObject.vala"
	_tmp0_ = self->priv->member_of;
#line 84 "/shotwell/src/core/DataObject.vala"
	_vala_assert (_tmp0_ == NULL, "member_of == null");
#line 86 "/shotwell/src/core/DataObject.vala"
	_tmp1_ = collection;
#line 86 "/shotwell/src/core/DataObject.vala"
...
#line 87 "/shotwell/src/core/DataObject.vala"
	_tmp3_ = ordinal;
#line 87 "/shotwell/src/core/DataObject.vala"
...
void data_object_internal_set_ordinal (DataObject* self, gint64 ordinal) {
	DataCollection* _tmp0_;
	gint64 _tmp1_;
#line 96 "/shotwell/src/core/DataObject.vala"
	g_return_if_fail (IS_DATA_OBJECT (self));
#line 97 "/shotwell/src/core/DataObject.vala"
	_tmp0_ = self->priv->member_of;
#line 97 "/shotwell/src/core/DataObject.vala"
	_vala_assert (_tmp0_ == NULL, "member_of == null");
#line 99 "/shotwell/src/core/DataObject.vala"
	_tmp1_ = ordinal;
#line 99 "/shotwell/src/core/DataObject.vala"
...
void data_object_internal_clear_membership (DataObject* self) {
#line 104 "/shotwell/src/core/DataObject.vala"
	g_return_if_fail (IS_DATA_OBJECT (self));
#line 105 "/shotwell/src/core/DataObject.vala"
	_data_collection_unref0 (self->priv->member_of);
#line 105 "/shotwell/src/core/DataObject.vala"
	self->priv->member_of = NULL;
#line 106 "/shotwell/src/core/DataObject.vala"
...
inline gint64 data_object_internal_get_ordinal (DataObject* self) {
	gint64 result = 0LL;
	gint64 _tmp0_;
#line 110 "/shotwell/src/core/DataObject.vala"
	g_return_val_if_fail (IS_DATA_OBJECT (self), 0LL);
#line 111 "/shotwell/src/core/DataObject.vala"
...
inline gint64 data_object_get_object_id (DataObject* self) {
	gint64 result = 0LL;
	gint64 _tmp0_;
#line 114 "/shotwell/src/core/DataObject.vala"
	g_return_val_if_fail (IS_DATA_OBJECT (self), 0LL);
#line 115 "/shotwell/src/core/DataObject.vala"
...
static void _vala_GValue_free (GValue* self) {
#line 124 "/shotwell/src/core/DataObject.vala"
	g_value_unset (self);
#line 124 "/shotwell/src/core/DataObject.vala"
	g_free (self);
...
void data_object_get_collection_property (DataObject* self, const gchar* name, GValue* def, GValue* result) {
	...
	GValue* _tmp7_;
	GValue _tmp10_ = {0};
#line 118 "/shotwell/src/core/DataObject.vala"
	g_return_if_fail (IS_DATA_OBJECT (self));
#line 118 "/shotwell/src/core/DataObject.vala"
	g_return_if_fail (name != NULL);
#line 119 "/shotwell/src/core/DataObject.vala"
	_tmp0_ = self->priv->member_of;
#line 119 "/shotwell/src/core/DataObject.vala"
	if (_tmp0_ == NULL) {
#line 453 "DataObject.c"
		GValue* _tmp1_;
		GValue _tmp2_ = {0};
#line 120 "/shotwell/src/core/DataObject.vala"
		_tmp1_ = def;
#line 120 "/shotwell/src/core/DataObject.vala"
...
#line 122 "/shotwell/src/core/DataObject.vala"
...
void data_object_set_collection_property (DataObject* self, const gchar* name, GValue* val, ValueEqualFunc value_equals, void* value_equals_target) {
	DataCollection* _tmp0_;
#line 127 "/shotwell/src/core/DataObject.vala"
	g_return_if_fail (IS_DATA_OBJECT (self));
#line 127 "/shotwell/src/core/DataObject.vala"
	g_return_if_fail (name != NULL);
#line 127 "/shotwell/src/core/DataObject.vala"
	g_return_if_fail (val != NULL);
#line 128 "/shotwell/src/core/DataObject.vala"
	_tmp0_ = self->priv->member_of;
#line 128 "/shotwell/src/core/DataObject.vala"
	if (_tmp0_ != NULL) {
#line 537 "DataObject.c"
		...
		void* _tmp4__target;
#line 129 "/shotwell/src/core/DataObject.vala"
		_tmp1_ = self->priv->member_of;
#line 129 "/shotwell/src/core/DataObject.vala"
		_tmp2_ = name;
#line 129 "/shotwell/src/core/DataObject.vala"
...
void data_object_clear_collection_property (DataObject* self, const gchar* name) {
	DataCollection* _tmp0_;
#line 132 "/shotwell/src/core/DataObject.vala"
	g_return_if_fail (IS_DATA_OBJECT (self));
#line 132 "/shotwell/src/core/DataObject.vala"
	g_return_if_fail (name != NULL);
#line 133 "/shotwell/src/core/DataObject.vala"
	_tmp0_ = self->priv->member_of;
#line 133 "/shotwell/src/core/DataObject.vala"
	if (_tmp0_ != NULL) {
#line 570 "DataObject.c"
		DataCollection* _tmp1_;
		const gchar* _tmp2_;
#line 134 "/shotwell/src/core/DataObject.vala"
		_tmp1_ = self->priv->member_of;
#line 134 "/shotwell/src/core/DataObject.vala"
		_tmp2_ = name;
#line 134 "/shotwell/src/core/DataObject.vala"
...
#line 21 "/shotwell/src/core/DataObject.vala"
...
#line 32 "/shotwell/src/core/DataObject.vala"
	self->priv->object_id = DATA_OBJECT_INVALID_OBJECT_ID;
#line 33 "/shotwell/src/core/DataObject.vala"
	self->priv->member_of = NULL;
#line 34 "/shotwell/src/core/DataObject.vala"
	self->priv->ordinal = DATA_COLLECTION_INVALID_OBJECT_ORDINAL;
