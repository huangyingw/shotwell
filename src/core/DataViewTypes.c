...
#line 11 "/shotwell/src/core/DataViewTypes.vala"
	g_return_val_if_fail (IS_THUMBNAIL_SOURCE (source), NULL);
#line 12 "/shotwell/src/core/DataViewTypes.vala"
	_tmp0_ = source;
#line 12 "/shotwell/src/core/DataViewTypes.vala"
...
static void thumbnail_view_real_notify_thumbnail_altered (ThumbnailView* self) {
#line 17 "/shotwell/src/core/DataViewTypes.vala"
...
void thumbnail_view_notify_thumbnail_altered (ThumbnailView* self) {
#line 15 "/shotwell/src/core/DataViewTypes.vala"
...
#line 7 "/shotwell/src/core/DataViewTypes.vala"
...
PhotoView* photo_view_construct (GType object_type, PhotoSource* source) {
	PhotoView * self = NULL;
	PhotoSource* _tmp0_;
#line 22 "/shotwell/src/core/DataViewTypes.vala"
	g_return_val_if_fail (IS_PHOTO_SOURCE (source), NULL);
#line 23 "/shotwell/src/core/DataViewTypes.vala"
	_tmp0_ = source;
#line 23 "/shotwell/src/core/DataViewTypes.vala"
...
PhotoSource* photo_view_get_photo_source (PhotoView* self) {
	...
	DataSource* _tmp0_;
#line 26 "/shotwell/src/core/DataViewTypes.vala"
	g_return_val_if_fail (IS_PHOTO_VIEW (self), NULL);
#line 27 "/shotwell/src/core/DataViewTypes.vala"
...
#line 21 "/shotwell/src/core/DataViewTypes.vala"
...
VideoView* video_view_construct (GType object_type, VideoSource* source) {
	VideoView * self = NULL;
	VideoSource* _tmp0_;
#line 32 "/shotwell/src/core/DataViewTypes.vala"
	g_return_val_if_fail (IS_VIDEO_SOURCE (source), NULL);
#line 33 "/shotwell/src/core/DataViewTypes.vala"
	_tmp0_ = source;
#line 33 "/shotwell/src/core/DataViewTypes.vala"
...
VideoSource* video_view_get_video_source (VideoView* self) {
	...
	DataSource* _tmp0_;
#line 36 "/shotwell/src/core/DataViewTypes.vala"
	g_return_val_if_fail (IS_VIDEO_VIEW (self), NULL);
#line 37 "/shotwell/src/core/DataViewTypes.vala"
	_tmp0_ = data_view_get_source (G_TYPE_CHECK_INSTANCE_CAST (self, TYPE_DATA_VIEW, DataView));
#line 37 "/shotwell/src/core/DataViewTypes.vala"
...
#line 31 "/shotwell/src/core/DataViewTypes.vala"
...
EventView* event_view_construct (GType object_type, EventSource* source) {
	EventView * self = NULL;
	EventSource* _tmp0_;
#line 42 "/shotwell/src/core/DataViewTypes.vala"
	g_return_val_if_fail (IS_EVENT_SOURCE (source), NULL);
#line 43 "/shotwell/src/core/DataViewTypes.vala"
	_tmp0_ = source;
#line 43 "/shotwell/src/core/DataViewTypes.vala"
...
EventSource* event_view_get_event_source (EventView* self) {
	...
	DataSource* _tmp0_;
#line 46 "/shotwell/src/core/DataViewTypes.vala"
	g_return_val_if_fail (IS_EVENT_VIEW (self), NULL);
#line 47 "/shotwell/src/core/DataViewTypes.vala"
	_tmp0_ = data_view_get_source (G_TYPE_CHECK_INSTANCE_CAST (self, TYPE_DATA_VIEW, DataView));
#line 47 "/shotwell/src/core/DataViewTypes.vala"
...
#line 41 "/shotwell/src/core/DataViewTypes.vala"
