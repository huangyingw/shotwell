...
SingletonCollection* singleton_collection_construct (GType object_type, GType g_type, GBoxedCopyFunc g_dup_func, GDestroyNotify g_destroy_func, gconstpointer object) {
	...
	gpointer _tmp1_;
#line 65 "/shotwell/src/core/util.vala"
...
#line 66 "/shotwell/src/core/util.vala"
	_tmp0_ = object;
#line 66 "/shotwell/src/core/util.vala"
...
static void singleton_collection_real_clear (GeeAbstractCollection* base) {
	SingletonCollection * self;
#line 79 "/shotwell/src/core/util.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_SINGLETON_COLLECTION, SingletonCollection);
#line 80 "/shotwell/src/core/util.vala"
...
#line 83 "/shotwell/src/core/util.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_SINGLETON_COLLECTION, SingletonCollection);
#line 84 "/shotwell/src/core/util.vala"
...
#line 87 "/shotwell/src/core/util.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_SINGLETON_COLLECTION, SingletonCollection);
#line 88 "/shotwell/src/core/util.vala"
...
static gboolean singleton_collection_real_remove (GeeAbstractCollection* base, gconstpointer item) {
	...
	gconstpointer _tmp0_;
	gconstpointer _tmp1_;
#line 91 "/shotwell/src/core/util.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_SINGLETON_COLLECTION, SingletonCollection);
#line 92 "/shotwell/src/core/util.vala"
	_tmp0_ = item;
#line 92 "/shotwell/src/core/util.vala"
	_tmp1_ = self->priv->object;
#line 92 "/shotwell/src/core/util.vala"
	if (_tmp0_ == _tmp1_) {
#line 93 "/shotwell/src/core/util.vala"
		((self->priv->object == NULL) || (self->priv->g_destroy_func == NULL)) ? NULL : (self->priv->object = (self->priv->g_destroy_func (self->priv->object), NULL));
#line 93 "/shotwell/src/core/util.vala"
		self->priv->object = NULL;
#line 95 "/shotwell/src/core/util.vala"
		result = TRUE;
#line 95 "/shotwell/src/core/util.vala"
		return result;
#line 394 "util.c"
	}
#line 98 "/shotwell/src/core/util.vala"
	result = FALSE;
#line 98 "/shotwell/src/core/util.vala"
	return result;
#line 400 "util.c"
...
static gboolean singleton_collection_real_get_read_only (GeeAbstractCollection* base) {
	gboolean result;
	SingletonCollection* self;
#line 70 "/shotwell/src/core/util.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_SINGLETON_COLLECTION, SingletonCollection);
#line 70 "/shotwell/src/core/util.vala"
	result = FALSE;
#line 70 "/shotwell/src/core/util.vala"
...
static gint singleton_collection_real_get_size (GeeAbstractCollection* base) {
	...
	gint _tmp0_ = 0;
	gconstpointer _tmp1_;
#line 102 "/shotwell/src/core/util.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_SINGLETON_COLLECTION, SingletonCollection);
#line 103 "/shotwell/src/core/util.vala"
	_tmp1_ = self->priv->object;
#line 103 "/shotwell/src/core/util.vala"
	if (_tmp1_ != NULL) {
#line 103 "/shotwell/src/core/util.vala"
...
#line 20 "/shotwell/src/core/util.vala"
...
#line 19 "/shotwell/src/core/util.vala"
...
static gpointer singleton_collection_singleton_iterator_real_get (GeeIterator* base) {
	...
	gconstpointer _tmp0_;
	gpointer _tmp1_;
#line 35 "/shotwell/src/core/util.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, SINGLETON_COLLECTION_TYPE_SINGLETON_ITERATOR, SingletonCollectionSingletonIterator);
#line 36 "/shotwell/src/core/util.vala"
...
static gboolean singleton_collection_singleton_iterator_real_has_next (GeeIterator* base) {
	SingletonCollectionSingletonIterator * self;
	gboolean result = FALSE;
#line 39 "/shotwell/src/core/util.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, SINGLETON_COLLECTION_TYPE_SINGLETON_ITERATOR, SingletonCollectionSingletonIterator);
#line 40 "/shotwell/src/core/util.vala"
	result = FALSE;
#line 40 "/shotwell/src/core/util.vala"
	return result;
#line 545 "util.c"
...
static gboolean singleton_collection_singleton_iterator_real_next (GeeIterator* base) {
	...
	gconstpointer _tmp2_;
	gpointer _tmp3_;
#line 43 "/shotwell/src/core/util.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, SINGLETON_COLLECTION_TYPE_SINGLETON_ITERATOR, SingletonCollectionSingletonIterator);
#line 44 "/shotwell/src/core/util.vala"
	_tmp0_ = self->priv->done;
#line 44 "/shotwell/src/core/util.vala"
	if (_tmp0_) {
#line 45 "/shotwell/src/core/util.vala"
		result = FALSE;
#line 45 "/shotwell/src/core/util.vala"
		return result;
#line 566 "util.c"
	}
#line 47 "/shotwell/src/core/util.vala"
	self->priv->done = TRUE;
#line 48 "/shotwell/src/core/util.vala"
	_tmp1_ = self->priv->c;
#line 48 "/shotwell/src/core/util.vala"
	_tmp2_ = _tmp1_->priv->object;
#line 48 "/shotwell/src/core/util.vala"
...
#line 50 "/shotwell/src/core/util.vala"
	result = TRUE;
#line 50 "/shotwell/src/core/util.vala"
	return result;
#line 584 "util.c"
...
static void singleton_collection_singleton_iterator_real_remove (GeeIterator* base) {
	SingletonCollectionSingletonIterator * self;
	gboolean _tmp0_;
#line 53 "/shotwell/src/core/util.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, SINGLETON_COLLECTION_TYPE_SINGLETON_ITERATOR, SingletonCollectionSingletonIterator);
#line 54 "/shotwell/src/core/util.vala"
	_tmp0_ = self->priv->done;
#line 54 "/shotwell/src/core/util.vala"
	if (!_tmp0_) {
#line 597 "util.c"
		SingletonCollection* _tmp1_;
#line 55 "/shotwell/src/core/util.vala"
		_tmp1_ = self->priv->c;
#line 55 "/shotwell/src/core/util.vala"
...
#line 56 "/shotwell/src/core/util.vala"
		((self->priv->current == NULL) || (self->priv->g_destroy_func == NULL)) ? NULL : (self->priv->current = (self->priv->g_destroy_func (self->priv->current), NULL));
#line 56 "/shotwell/src/core/util.vala"
		self->priv->current = NULL;
#line 609 "util.c"
	}
#line 59 "/shotwell/src/core/util.vala"
	self->priv->done = TRUE;
#line 613 "util.c"
}
...
static gboolean singleton_collection_singleton_iterator_real_get_read_only (GeeIterator* base) {
	...
	SingletonCollectionSingletonIterator* self;
	gboolean _tmp0_;
#line 24 "/shotwell/src/core/util.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, SINGLETON_COLLECTION_TYPE_SINGLETON_ITERATOR, SingletonCollectionSingletonIterator);
#line 24 "/shotwell/src/core/util.vala"
	_tmp0_ = self->priv->done;
#line 24 "/shotwell/src/core/util.vala"
...
static gboolean singleton_collection_singleton_iterator_real_get_valid (GeeIterator* base) {
	...
	SingletonCollectionSingletonIterator* self;
	gboolean _tmp0_;
#line 28 "/shotwell/src/core/util.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, SINGLETON_COLLECTION_TYPE_SINGLETON_ITERATOR, SingletonCollectionSingletonIterator);
#line 28 "/shotwell/src/core/util.vala"
	_tmp0_ = self->priv->done;
#line 28 "/shotwell/src/core/util.vala"
...
#line 14 "/shotwell/src/core/util.vala"
...
#line 16 "/shotwell/src/core/util.vala"
	self->priv->done = FALSE;
#line 17 "/shotwell/src/core/util.vala"
	self->priv->current = NULL;
#line 736 "util.c"
}
...
#line 15 "/shotwell/src/core/util.vala"
	_g_object_unref0 (self->priv->c);
#line 17 "/shotwell/src/core/util.vala"
	((self->priv->current == NULL) || (self->priv->g_destroy_func == NULL)) ? NULL : (self->priv->current = (self->priv->g_destroy_func (self->priv->current), NULL));
#line 14 "/shotwell/src/core/util.vala"
...
#line 13 "/shotwell/src/core/util.vala"
...
#line 63 "/shotwell/src/core/util.vala"
	((self->priv->object == NULL) || (self->priv->g_destroy_func == NULL)) ? NULL : (self->priv->object = (self->priv->g_destroy_func (self->priv->object), NULL));
#line 13 "/shotwell/src/core/util.vala"
...
void marker_mark (Marker* self, DataObject* object) {
#line 113 "/shotwell/src/core/util.vala"
...
void marker_unmark (Marker* self, DataObject* object) {
#line 115 "/shotwell/src/core/util.vala"
	g_return_if_fail (IS_MARKER (self));
#line 115 "/shotwell/src/core/util.vala"
...
gboolean marker_toggle (Marker* self, DataObject* object) {
#line 117 "/shotwell/src/core/util.vala"
...
void marker_mark_many (Marker* self, GeeCollection* list) {
#line 119 "/shotwell/src/core/util.vala"
	g_return_if_fail (IS_MARKER (self));
#line 119 "/shotwell/src/core/util.vala"
...
void marker_unmark_many (Marker* self, GeeCollection* list) {
#line 121 "/shotwell/src/core/util.vala"
	g_return_if_fail (IS_MARKER (self));
#line 121 "/shotwell/src/core/util.vala"
...
void marker_mark_all (Marker* self) {
#line 123 "/shotwell/src/core/util.vala"
	g_return_if_fail (IS_MARKER (self));
#line 123 "/shotwell/src/core/util.vala"
...
gint marker_get_count (Marker* self) {
#line 127 "/shotwell/src/core/util.vala"
...
GeeCollection* marker_get_all (Marker* self) {
#line 130 "/shotwell/src/core/util.vala"
...
#line 112 "/shotwell/src/core/util.vala"
...
UnknownTotalMonitor* unknown_total_monitor_construct (GType object_type, guint64 total, ProgressMonitor wrapped_monitor, void* wrapped_monitor_target) {
	...
	void* _tmp1__target;
#line 147 "/shotwell/src/core/util.vala"
	self = (UnknownTotalMonitor*) g_type_create_instance (object_type);
#line 148 "/shotwell/src/core/util.vala"
	_tmp0_ = total;
#line 148 "/shotwell/src/core/util.vala"
	self->priv->total = _tmp0_;
#line 149 "/shotwell/src/core/util.vala"
...
gboolean unknown_total_monitor_monitor (UnknownTotalMonitor* self, guint64 count, guint64 total) {
	...
	guint64 _tmp2_;
	gboolean _tmp3_;
#line 152 "/shotwell/src/core/util.vala"
	g_return_val_if_fail (IS_UNKNOWN_TOTAL_MONITOR (self), FALSE);
#line 153 "/shotwell/src/core/util.vala"
...
#line 143 "/shotwell/src/core/util.vala"
...
AggregateProgressMonitor* aggregate_progress_monitor_construct (GType object_type, guint64 grand_total, ProgressMonitor wrapped_monitor, void* wrapped_monitor_target) {
	...
	ProgressMonitor _tmp1_;
	void* _tmp1__target;
#line 165 "/shotwell/src/core/util.vala"
	self = (AggregateProgressMonitor*) g_type_create_instance (object_type);
#line 166 "/shotwell/src/core/util.vala"
	_tmp0_ = grand_total;
#line 166 "/shotwell/src/core/util.vala"
	self->priv->grand_total = _tmp0_;
#line 167 "/shotwell/src/core/util.vala"
	_tmp1_ = wrapped_monitor;
#line 167 "/shotwell/src/core/util.vala"
	_tmp1__target = wrapped_monitor_target;
#line 167 "/shotwell/src/core/util.vala"
...
void aggregate_progress_monitor_next_step (AggregateProgressMonitor* self, const gchar* name) {
	...
	gchar* _tmp5_;
	gchar* _tmp6_;
#line 170 "/shotwell/src/core/util.vala"
	g_return_if_fail (IS_AGGREGATE_PROGRESS_MONITOR (self));
#line 170 "/shotwell/src/core/util.vala"
	g_return_if_fail (name != NULL);
#line 171 "/shotwell/src/core/util.vala"
	_tmp0_ = name;
#line 171 "/shotwell/src/core/util.vala"
...
#line 171 "/shotwell/src/core/util.vala"
	_g_free0 (_tmp3_);
#line 172 "/shotwell/src/core/util.vala"
...
gboolean aggregate_progress_monitor_monitor (AggregateProgressMonitor* self, guint64 count, guint64 total) {
	...
	guint64 _tmp12_;
	gboolean _tmp13_;
#line 175 "/shotwell/src/core/util.vala"
	g_return_val_if_fail (IS_AGGREGATE_PROGRESS_MONITOR (self), FALSE);
#line 177 "/shotwell/src/core/util.vala"
...
#line 178 "/shotwell/src/core/util.vala"
...
#line 1486 "util.c"
		guint64 _tmp8_;
#line 179 "/shotwell/src/core/util.vala"
		_tmp8_ = self->priv->grand_total;
#line 179 "/shotwell/src/core/util.vala"
		self->priv->aggregate_count = _tmp8_;
#line 1492 "util.c"
	}
#line 182 "/shotwell/src/core/util.vala"
	_tmp9_ = count;
#line 182 "/shotwell/src/core/util.vala"
	self->priv->last_count = _tmp9_;
#line 184 "/shotwell/src/core/util.vala"
...
#line 159 "/shotwell/src/core/util.vala"
	value->data[0].v_pointer = NULL;
#line 1519 "util.c"
}
...
#line 162 "/shotwell/src/core/util.vala"
	self->priv->aggregate_count = (guint64) 0;
#line 163 "/shotwell/src/core/util.vala"
	self->priv->last_count = G_MAXUINT64;
#line 159 "/shotwell/src/core/util.vala"
	self->ref_count = 1;
#line 1716 "util.c"
...
gboolean null_progress_monitor (guint64 count, guint64 total) {
	gboolean result = FALSE;
#line 190 "/shotwell/src/core/util.vala"
	result = TRUE;
#line 190 "/shotwell/src/core/util.vala"
	return result;
#line 1775 "util.c"
...
gdouble degrees_to_radians (gdouble theta) {
	gdouble result = 0.0;
	gdouble _tmp0_;
#line 195 "/shotwell/src/core/util.vala"
	_tmp0_ = theta;
#line 195 "/shotwell/src/core/util.vala"
