...
#line 17 "/shotwell/src/core/DatabaseSourceCollection.vala"
	return result;
...
DatabaseSourceCollection* database_source_collection_construct (GType object_type, const gchar* name, GetSourceDatabaseKey source_key_func, void* source_key_func_target) {
	...
	void* _tmp1__target;
#line 20 "/shotwell/src/core/DatabaseSourceCollection.vala"
	g_return_val_if_fail (name != NULL, NULL);
#line 21 "/shotwell/src/core/DatabaseSourceCollection.vala"
	_tmp0_ = name;
#line 21 "/shotwell/src/core/DatabaseSourceCollection.vala"
	self = (DatabaseSourceCollection*) source_collection_construct (object_type, _tmp0_);
#line 23 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
#line 28 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
static void database_source_collection_real_notify_items_added (DataCollection* base, GeeIterable* added) {
	...
	GeeIterable* _tmp17_;
#line 26 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
#line 391 "DatabaseSourceCollection.c"
	{
		...
		GeeIterable* _tmp0_;
		GeeIterator* _tmp1_;
#line 27 "/shotwell/src/core/DatabaseSourceCollection.vala"
		_tmp0_ = added;
#line 27 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
#line 28 "/shotwell/src/core/DatabaseSourceCollection.vala"
			source = _tmp7_;
#line 29 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
#line 29 "/shotwell/src/core/DatabaseSourceCollection.vala"
			key = _tmp10_;
#line 31 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
#line 33 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
#line 36 "/shotwell/src/core/DatabaseSourceCollection.vala"
	_tmp17_ = added;
#line 36 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
static void database_source_collection_real_notify_items_removed (DataCollection* base, GeeIterable* removed) {
	DatabaseSourceCollection * self;
	GeeIterable* _tmp13_;
#line 39 "/shotwell/src/core/DatabaseSourceCollection.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DATABASE_SOURCE_COLLECTION, DatabaseSourceCollection);
#line 39 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
#line 497 "DatabaseSourceCollection.c"
	{
		...
		GeeIterable* _tmp0_;
		GeeIterator* _tmp1_;
#line 40 "/shotwell/src/core/DatabaseSourceCollection.vala"
		_tmp0_ = removed;
#line 40 "/shotwell/src/core/DatabaseSourceCollection.vala"
		_tmp1_ = gee_iterable_iterator (_tmp0_);
#line 40 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
#line 40 "/shotwell/src/core/DatabaseSourceCollection.vala"
			object = (DataObject*) _tmp5_;
#line 41 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
#line 41 "/shotwell/src/core/DatabaseSourceCollection.vala"
			key = _tmp8_;
#line 43 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
#line 43 "/shotwell/src/core/DatabaseSourceCollection.vala"
			is_removed = _tmp11_;
#line 44 "/shotwell/src/core/DatabaseSourceCollection.vala"
			_tmp12_ = is_removed;
#line 44 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
#line 47 "/shotwell/src/core/DatabaseSourceCollection.vala"
	_tmp13_ = removed;
#line 47 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
DataSource* database_source_collection_fetch_by_key (DatabaseSourceCollection* self, gint64 key) {
	...
	gint64 _tmp1_;
	gpointer _tmp2_;
#line 50 "/shotwell/src/core/DatabaseSourceCollection.vala"
	g_return_val_if_fail (IS_DATABASE_SOURCE_COLLECTION (self), NULL);
#line 51 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
#line 15 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
DatabaseSourceHoldingTank* database_source_holding_tank_construct (GType object_type, SourceCollection* sources, SourceHoldingTankCheckToKeep check_to_keep, void* check_to_keep_target, GetSourceDatabaseKey get_key, void* get_key_target) {
	...
	void* _tmp2__target;
#line 60 "/shotwell/src/core/DatabaseSourceCollection.vala"
	g_return_val_if_fail (IS_SOURCE_COLLECTION (sources), NULL);
#line 62 "/shotwell/src/core/DatabaseSourceCollection.vala"
	_tmp0_ = sources;
#line 62 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
#line 64 "/shotwell/src/core/DatabaseSourceCollection.vala"
	_tmp2_ = get_key;
#line 64 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
DataSource* database_source_holding_tank_get_by_id (DatabaseSourceHoldingTank* self, gint64 id) {
	...
	gint64 _tmp1_;
	gpointer _tmp2_;
#line 67 "/shotwell/src/core/DatabaseSourceCollection.vala"
	g_return_val_if_fail (IS_DATABASE_SOURCE_HOLDING_TANK (self), NULL);
#line 68 "/shotwell/src/core/DatabaseSourceCollection.vala"
	_tmp0_ = self->priv->map;
#line 68 "/shotwell/src/core/DatabaseSourceCollection.vala"
	_tmp1_ = id;
#line 68 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
#line 71 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
#line 73 "/shotwell/src/core/DatabaseSourceCollection.vala"
	_tmp0_ = added;
#line 73 "/shotwell/src/core/DatabaseSourceCollection.vala"
	if (_tmp0_ != NULL) {
#line 727 "DatabaseSourceCollection.c"
		{
			...
			GeeIterator* _tmp2_;
#line 74 "/shotwell/src/core/DatabaseSourceCollection.vala"
			_tmp1_ = added;
#line 74 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
#line 75 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
#line 78 "/shotwell/src/core/DatabaseSourceCollection.vala"
	_tmp12_ = removed;
#line 78 "/shotwell/src/core/DatabaseSourceCollection.vala"
	if (_tmp12_ != NULL) {
#line 795 "DatabaseSourceCollection.c"
		{
			...
			GeeIterator* _tmp14_;
#line 79 "/shotwell/src/core/DatabaseSourceCollection.vala"
			_tmp13_ = removed;
#line 79 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
#line 80 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
#line 83 "/shotwell/src/core/DatabaseSourceCollection.vala"
	_tmp23_ = added;
#line 83 "/shotwell/src/core/DatabaseSourceCollection.vala"
	_tmp24_ = removed;
#line 83 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
#line 55 "/shotwell/src/core/DatabaseSourceCollection.vala"
...
#line 57 "/shotwell/src/core/DatabaseSourceCollection.vala"
	_tmp0_ = gee_hash_map_new (G_TYPE_INT64, (GBoxedCopyFunc) _int64_dup, (GDestroyNotify) g_free, TYPE_DATA_SOURCE, (GBoxedCopyFunc) g_object_ref, (GDestroyNotify) g_object_unref, _int64_hash_gee_hash_data_func, NULL, NULL, _int64_equal_gee_equal_data_func, NULL, NULL, NULL, NULL, NULL);
#line 57 "/shotwell/src/core/DatabaseSourceCollection.vala"
	self->priv->map = _tmp0_;
