/* DataSet.c generated by valac 0.36.6, the Vala compiler
...
DataSet* data_set_construct (GType object_type) {
	DataSet* self = NULL;
#line 35 "/shotwell/src/core/DataSet.vala"
	self = (DataSet*) g_type_create_instance (object_type);
#line 36 "/shotwell/src/core/DataSet.vala"
...
static gint64 data_set_order_added_comparator (DataSet* self, void* a, void* b) {
	...
	void* _tmp2_;
	gint64 _tmp3_;
#line 39 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (IS_DATA_SET (self), 0LL);
#line 40 "/shotwell/src/core/DataSet.vala"
	_tmp0_ = a;
#line 40 "/shotwell/src/core/DataSet.vala"
...
#line 43 "/shotwell/src/core/DataSet.vala"
...
#line 45 "/shotwell/src/core/DataSet.vala"
	result = FALSE;
#line 45 "/shotwell/src/core/DataSet.vala"
	return result;
#line 224 "DataSet.c"
...
static gint64 data_set_comparator_wrapper (DataSet* self, void* a, void* b) {
	...
	gint64 _tmp7_;
	gint64 _tmp11_;
#line 48 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (IS_DATA_SET (self), 0LL);
#line 49 "/shotwell/src/core/DataSet.vala"
	_tmp0_ = a;
#line 49 "/shotwell/src/core/DataSet.vala"
	_tmp1_ = b;
#line 49 "/shotwell/src/core/DataSet.vala"
	if (_tmp0_ == _tmp1_) {
#line 50 "/shotwell/src/core/DataSet.vala"
		result = (gint64) 0;
#line 50 "/shotwell/src/core/DataSet.vala"
		return result;
#line 249 "DataSet.c"
	}
#line 54 "/shotwell/src/core/DataSet.vala"
	_result_ = (gint64) 0;
#line 56 "/shotwell/src/core/DataSet.vala"
...
#line 259 "DataSet.c"
		...
		void* _tmp5_;
		gint64 _tmp6_;
#line 57 "/shotwell/src/core/DataSet.vala"
...
#line 59 "/shotwell/src/core/DataSet.vala"
	_tmp7_ = _result_;
#line 59 "/shotwell/src/core/DataSet.vala"
	if (_tmp7_ == ((gint64) 0)) {
#line 283 "DataSet.c"
		...
		void* _tmp9_;
		gint64 _tmp10_;
#line 60 "/shotwell/src/core/DataSet.vala"
		_tmp8_ = a;
#line 60 "/shotwell/src/core/DataSet.vala"
		_tmp9_ = b;
#line 60 "/shotwell/src/core/DataSet.vala"
...
#line 62 "/shotwell/src/core/DataSet.vala"
	_tmp11_ = _result_;
#line 62 "/shotwell/src/core/DataSet.vala"
	_vala_assert (_tmp11_ != ((gint64) 0), "result != 0");
#line 64 "/shotwell/src/core/DataSet.vala"
	result = _result_;
#line 64 "/shotwell/src/core/DataSet.vala"
	return result;
#line 305 "DataSet.c"
...
gboolean data_set_contains (DataSet* self, DataObject* object) {
	...
	DataObject* _tmp1_;
	gboolean _tmp2_;
#line 67 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (IS_DATA_SET (self), FALSE);
#line 67 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (IS_DATA_OBJECT (object), FALSE);
#line 68 "/shotwell/src/core/DataSet.vala"
...
inline gint data_set_get_count (DataSet* self) {
	...
	SortedList* _tmp0_;
	gint _tmp1_;
#line 71 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (IS_DATA_SET (self), 0);
#line 72 "/shotwell/src/core/DataSet.vala"
...
#line 77 "/shotwell/src/core/DataSet.vala"
	return result;
#line 355 "DataSet.c"
}
...
#line 78 "/shotwell/src/core/DataSet.vala"
	return result;
#line 364 "DataSet.c"
}
...
void data_set_reset_comparator (DataSet* self) {
	SortedList* _tmp0_;
#line 75 "/shotwell/src/core/DataSet.vala"
	g_return_if_fail (IS_DATA_SET (self));
#line 76 "/shotwell/src/core/DataSet.vala"
...
Comparator data_set_get_comparator (DataSet* self, void** result_target) {
	...
	Comparator _tmp1_;
	void* _tmp1__target;
#line 81 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (IS_DATA_SET (self), NULL);
#line 82 "/shotwell/src/core/DataSet.vala"
...
ComparatorPredicate data_set_get_comparator_predicate (DataSet* self, void** result_target) {
	...
	void* _tmp1__target;
#line 85 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (IS_DATA_SET (self), NULL);
#line 86 "/shotwell/src/core/DataSet.vala"
...
#line 92 "/shotwell/src/core/DataSet.vala"
	return result;
#line 445 "DataSet.c"
}
...
void data_set_set_comparator (DataSet* self, Comparator user_comparator, void* user_comparator_target, ComparatorPredicate comparator_predicate, void* comparator_predicate_target) {
	...
	void* _tmp1__target;
	SortedList* _tmp2_;
#line 89 "/shotwell/src/core/DataSet.vala"
	g_return_if_fail (IS_DATA_SET (self));
#line 90 "/shotwell/src/core/DataSet.vala"
...
#line 91 "/shotwell/src/core/DataSet.vala"
...
GeeList* data_set_get_all (DataSet* self) {
	...
	GeeList* _tmp1_;
	GeeList* _tmp2_;
#line 95 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (IS_DATA_SET (self), NULL);
#line 96 "/shotwell/src/core/DataSet.vala"
	_tmp0_ = self->priv->list;
#line 96 "/shotwell/src/core/DataSet.vala"
...
DataSet* data_set_copy (DataSet* self) {
	...
	GeeHashSet* _tmp3_;
	GeeHashSet* _tmp4_;
#line 99 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (IS_DATA_SET (self), NULL);
#line 100 "/shotwell/src/core/DataSet.vala"
	_tmp0_ = data_set_new ();
#line 100 "/shotwell/src/core/DataSet.vala"
	clone = _tmp0_;
#line 101 "/shotwell/src/core/DataSet.vala"
...
#line 102 "/shotwell/src/core/DataSet.vala"
...
#line 104 "/shotwell/src/core/DataSet.vala"
	result = clone;
#line 104 "/shotwell/src/core/DataSet.vala"
	return result;
#line 534 "DataSet.c"
...
DataObject* data_set_get_at (DataSet* self, gint index) {
	...
	gint _tmp1_;
	gpointer _tmp2_;
#line 107 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (IS_DATA_SET (self), NULL);
#line 108 "/shotwell/src/core/DataSet.vala"
	_tmp0_ = self->priv->list;
#line 108 "/shotwell/src/core/DataSet.vala"
	_tmp1_ = index;
#line 108 "/shotwell/src/core/DataSet.vala"
...
gint data_set_index_of (DataSet* self, DataObject* object) {
	...
	GEqualFunc _tmp2_;
	gint _tmp3_;
#line 111 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (IS_DATA_SET (self), 0);
#line 111 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (IS_DATA_OBJECT (object), 0);
#line 112 "/shotwell/src/core/DataSet.vala"
	_tmp0_ = self->priv->list;
#line 112 "/shotwell/src/core/DataSet.vala"
	_tmp1_ = object;
#line 112 "/shotwell/src/core/DataSet.vala"
...
gboolean data_set_add (DataSet* self, DataObject* object) {
	...
	DataObject* _tmp4_;
	gboolean _tmp5_;
#line 116 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (IS_DATA_SET (self), FALSE);
#line 116 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (IS_DATA_OBJECT (object), FALSE);
#line 117 "/shotwell/src/core/DataSet.vala"
	_tmp0_ = self->priv->list;
#line 117 "/shotwell/src/core/DataSet.vala"
	_tmp1_ = object;
#line 117 "/shotwell/src/core/DataSet.vala"
...
#line 117 "/shotwell/src/core/DataSet.vala"
	if (!_tmp2_) {
#line 118 "/shotwell/src/core/DataSet.vala"
		result = FALSE;
#line 118 "/shotwell/src/core/DataSet.vala"
		return result;
#line 609 "DataSet.c"
	}
#line 120 "/shotwell/src/core/DataSet.vala"
...
#line 619 "DataSet.c"
		SortedList* _tmp6_;
		DataObject* _tmp7_;
#line 122 "/shotwell/src/core/DataSet.vala"
		_tmp6_ = self->priv->list;
#line 122 "/shotwell/src/core/DataSet.vala"
		_tmp7_ = object;
#line 122 "/shotwell/src/core/DataSet.vala"
		gee_collection_remove (G_TYPE_CHECK_INSTANCE_CAST (_tmp6_, GEE_TYPE_COLLECTION, GeeCollection), _tmp7_);
#line 124 "/shotwell/src/core/DataSet.vala"
		result = FALSE;
#line 124 "/shotwell/src/core/DataSet.vala"
		return result;
#line 632 "DataSet.c"
	}
#line 127 "/shotwell/src/core/DataSet.vala"
	result = TRUE;
#line 127 "/shotwell/src/core/DataSet.vala"
	return result;
#line 638 "DataSet.c"
...
gboolean data_set_add_many (DataSet* self, GeeCollection* objects) {
	...
	gboolean _tmp9_;
#line 131 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (IS_DATA_SET (self), FALSE);
#line 131 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (GEE_IS_COLLECTION (objects), FALSE);
#line 132 "/shotwell/src/core/DataSet.vala"
	_tmp0_ = objects;
#line 132 "/shotwell/src/core/DataSet.vala"
...
#line 132 "/shotwell/src/core/DataSet.vala"
	count = _tmp2_;
#line 133 "/shotwell/src/core/DataSet.vala"
	_tmp3_ = count;
#line 133 "/shotwell/src/core/DataSet.vala"
	if (_tmp3_ == 0) {
#line 134 "/shotwell/src/core/DataSet.vala"
		result = TRUE;
#line 134 "/shotwell/src/core/DataSet.vala"
		return result;
#line 675 "DataSet.c"
	}
#line 136 "/shotwell/src/core/DataSet.vala"
...
#line 136 "/shotwell/src/core/DataSet.vala"
	if (!_tmp6_) {
#line 137 "/shotwell/src/core/DataSet.vala"
		result = FALSE;
#line 137 "/shotwell/src/core/DataSet.vala"
		return result;
#line 689 "DataSet.c"
	}
#line 139 "/shotwell/src/core/DataSet.vala"
...
#line 141 "/shotwell/src/core/DataSet.vala"
...
#line 143 "/shotwell/src/core/DataSet.vala"
		result = FALSE;
#line 143 "/shotwell/src/core/DataSet.vala"
		return result;
#line 712 "DataSet.c"
	}
#line 146 "/shotwell/src/core/DataSet.vala"
	result = TRUE;
#line 146 "/shotwell/src/core/DataSet.vala"
	return result;
#line 718 "DataSet.c"
...
gboolean data_set_remove (DataSet* self, DataObject* object) {
	...
	DataObject* _tmp4_;
	gboolean _tmp5_;
#line 149 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (IS_DATA_SET (self), FALSE);
#line 149 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (IS_DATA_OBJECT (object), FALSE);
#line 150 "/shotwell/src/core/DataSet.vala"
	success = TRUE;
#line 152 "/shotwell/src/core/DataSet.vala"
	_tmp0_ = self->priv->list;
#line 152 "/shotwell/src/core/DataSet.vala"
	_tmp1_ = object;
#line 152 "/shotwell/src/core/DataSet.vala"
...
#line 152 "/shotwell/src/core/DataSet.vala"
	if (!_tmp2_) {
#line 153 "/shotwell/src/core/DataSet.vala"
		success = FALSE;
#line 747 "DataSet.c"
	}
#line 155 "/shotwell/src/core/DataSet.vala"
	_tmp3_ = self->priv->hash_set;
#line 155 "/shotwell/src/core/DataSet.vala"
	_tmp4_ = object;
#line 155 "/shotwell/src/core/DataSet.vala"
...
#line 155 "/shotwell/src/core/DataSet.vala"
	if (!_tmp5_) {
#line 156 "/shotwell/src/core/DataSet.vala"
		success = FALSE;
#line 759 "DataSet.c"
	}
#line 158 "/shotwell/src/core/DataSet.vala"
	result = success;
#line 158 "/shotwell/src/core/DataSet.vala"
	return result;
#line 765 "DataSet.c"
...
gboolean data_set_remove_many (DataSet* self, GeeCollection* objects) {
	...
	gboolean _tmp5_;
#line 161 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (IS_DATA_SET (self), FALSE);
#line 161 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (GEE_IS_COLLECTION (objects), FALSE);
#line 162 "/shotwell/src/core/DataSet.vala"
	success = TRUE;
#line 164 "/shotwell/src/core/DataSet.vala"
	_tmp0_ = self->priv->list;
#line 164 "/shotwell/src/core/DataSet.vala"
	_tmp1_ = objects;
#line 164 "/shotwell/src/core/DataSet.vala"
...
#line 164 "/shotwell/src/core/DataSet.vala"
	if (!_tmp2_) {
#line 165 "/shotwell/src/core/DataSet.vala"
		success = FALSE;
#line 794 "DataSet.c"
	}
#line 167 "/shotwell/src/core/DataSet.vala"
	_tmp3_ = self->priv->hash_set;
#line 167 "/shotwell/src/core/DataSet.vala"
	_tmp4_ = objects;
#line 167 "/shotwell/src/core/DataSet.vala"
...
#line 167 "/shotwell/src/core/DataSet.vala"
	if (!_tmp5_) {
#line 168 "/shotwell/src/core/DataSet.vala"
		success = FALSE;
#line 806 "DataSet.c"
	}
#line 170 "/shotwell/src/core/DataSet.vala"
	result = success;
#line 170 "/shotwell/src/core/DataSet.vala"
	return result;
#line 812 "DataSet.c"
...
gboolean data_set_resort_object (DataSet* self, DataObject* object, Alteration* alteration) {
	...
	DataObject* _tmp9_;
	gboolean _tmp10_;
#line 174 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (IS_DATA_SET (self), FALSE);
#line 174 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail (IS_DATA_OBJECT (object), FALSE);
#line 174 "/shotwell/src/core/DataSet.vala"
	g_return_val_if_fail ((alteration == NULL) || IS_ALTERATION (alteration), FALSE);
#line 175 "/shotwell/src/core/DataSet.vala"
...
#line 851 "DataSet.c"
		...
		Alteration* _tmp6_;
		gboolean _tmp7_;
#line 176 "/shotwell/src/core/DataSet.vala"
...
#line 175 "/shotwell/src/core/DataSet.vala"
	if (_tmp0_) {
#line 177 "/shotwell/src/core/DataSet.vala"
		result = FALSE;
#line 177 "/shotwell/src/core/DataSet.vala"
		return result;
#line 881 "DataSet.c"
	}
#line 180 "/shotwell/src/core/DataSet.vala"
...
#line 29 "/shotwell/src/core/DataSet.vala"
...
#line 30 "/shotwell/src/core/DataSet.vala"
...
#line 31 "/shotwell/src/core/DataSet.vala"
...
#line 32 "/shotwell/src/core/DataSet.vala"
	self->priv->user_comparator = NULL;
#line 32 "/shotwell/src/core/DataSet.vala"
	self->priv->user_comparator_target = self;
#line 33 "/shotwell/src/core/DataSet.vala"
