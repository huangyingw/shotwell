...
static void _config_facade_on_color_name_changed_configuration_facade_bg_color_name_changed (ConfigurationFacade* _sender, gpointer self) {
#line 55 "/shotwell/src/config/Config.vala"
...
#line 53 "/shotwell/src/config/Config.vala"
...
#line 52 "/shotwell/src/config/Config.vala"
	return self;
#line 498 "Config.c"
}
...
#line 62 "/shotwell/src/config/Config.vala"
...
ConfigFacade* config_facade_get_instance (void) {
	...
	ConfigFacade* _tmp2_;
	ConfigFacade* _tmp3_;
#line 59 "/shotwell/src/config/Config.vala"
	_tmp0_ = config_facade_instance;
#line 59 "/shotwell/src/config/Config.vala"
	if (_tmp0_ == NULL) {
#line 525 "Config.c"
		ConfigFacade* _tmp1_;
#line 60 "/shotwell/src/config/Config.vala"
...
static void config_facade_on_color_name_changed (ConfigFacade* self) {
#line 65 "/shotwell/src/config/Config.vala"
	g_return_if_fail (CONFIG_IS_FACADE (self));
#line 66 "/shotwell/src/config/Config.vala"
...
static void config_facade_set_text_colors (ConfigFacade* self, GdkRGBA* bg_color) {
	GdkRGBA _tmp0_;
	gdouble _tmp1_;
#line 69 "/shotwell/src/config/Config.vala"
	g_return_if_fail (CONFIG_IS_FACADE (self));
#line 69 "/shotwell/src/config/Config.vala"
	g_return_if_fail (bg_color != NULL);
#line 73 "/shotwell/src/config/Config.vala"
	_tmp0_ = *bg_color;
#line 73 "/shotwell/src/config/Config.vala"
	_tmp1_ = _tmp0_.red;
#line 73 "/shotwell/src/config/Config.vala"
...
#line 77 "/shotwell/src/config/Config.vala"
...
static void config_facade_get_colors (ConfigFacade* self) {
	...
	const gchar* _tmp4_;
	GdkRGBA _tmp5_ = {0};
#line 86 "/shotwell/src/config/Config.vala"
	g_return_if_fail (CONFIG_IS_FACADE (self));
#line 87 "/shotwell/src/config/Config.vala"
...
#line 89 "/shotwell/src/config/Config.vala"
...
#line 653 "Config.c"
		gchar* _tmp3_;
#line 90 "/shotwell/src/config/Config.vala"
...
#line 92 "/shotwell/src/config/Config.vala"
...
void config_facade_get_bg_color (ConfigFacade* self, GdkRGBA* result) {
	...
	const gchar* _tmp2_;
	GdkRGBA _tmp3_ = {0};
#line 95 "/shotwell/src/config/Config.vala"
	g_return_if_fail (CONFIG_IS_FACADE (self));
#line 96 "/shotwell/src/config/Config.vala"
	_tmp0_ = self->priv->bg_color;
#line 96 "/shotwell/src/config/Config.vala"
	_tmp1_ = is_string_empty (_tmp0_);
#line 96 "/shotwell/src/config/Config.vala"
	if (_tmp1_) {
#line 97 "/shotwell/src/config/Config.vala"
		config_facade_get_colors (self);
#line 688 "Config.c"
	}
#line 99 "/shotwell/src/config/Config.vala"
...
void config_facade_get_selected_color (ConfigFacade* self, gboolean in_focus, GdkRGBA* result) {
	gboolean _tmp0_;
#line 102 "/shotwell/src/config/Config.vala"
	g_return_if_fail (CONFIG_IS_FACADE (self));
#line 103 "/shotwell/src/config/Config.vala"
	_tmp0_ = in_focus;
#line 103 "/shotwell/src/config/Config.vala"
	if (_tmp0_) {
#line 710 "Config.c"
		...
		const gchar* _tmp3_;
		GdkRGBA _tmp4_ = {0};
#line 104 "/shotwell/src/config/Config.vala"
		_tmp1_ = self->priv->selected_color;
#line 104 "/shotwell/src/config/Config.vala"
		_tmp2_ = is_string_empty (_tmp1_);
#line 104 "/shotwell/src/config/Config.vala"
		if (_tmp2_) {
#line 105 "/shotwell/src/config/Config.vala"
			config_facade_get_colors (self);
#line 723 "Config.c"
		}
#line 107 "/shotwell/src/config/Config.vala"
...
#line 733 "Config.c"
		...
		const gchar* _tmp7_;
		GdkRGBA _tmp8_ = {0};
#line 109 "/shotwell/src/config/Config.vala"
		_tmp5_ = self->priv->unfocused_selected_color;
#line 109 "/shotwell/src/config/Config.vala"
		_tmp6_ = is_string_empty (_tmp5_);
#line 109 "/shotwell/src/config/Config.vala"
		if (_tmp6_) {
#line 110 "/shotwell/src/config/Config.vala"
			config_facade_get_colors (self);
#line 747 "Config.c"
		}
#line 112 "/shotwell/src/config/Config.vala"
...
void config_facade_get_unselected_color (ConfigFacade* self, GdkRGBA* result) {
	...
	const gchar* _tmp2_;
	GdkRGBA _tmp3_ = {0};
#line 116 "/shotwell/src/config/Config.vala"
	g_return_if_fail (CONFIG_IS_FACADE (self));
#line 117 "/shotwell/src/config/Config.vala"
	_tmp0_ = self->priv->unselected_color;
#line 117 "/shotwell/src/config/Config.vala"
	_tmp1_ = is_string_empty (_tmp0_);
#line 117 "/shotwell/src/config/Config.vala"
	if (_tmp1_) {
#line 118 "/shotwell/src/config/Config.vala"
		config_facade_get_colors (self);
#line 777 "Config.c"
	}
#line 120 "/shotwell/src/config/Config.vala"
...
void config_facade_get_border_color (ConfigFacade* self, GdkRGBA* result) {
	...
	const gchar* _tmp2_;
	GdkRGBA _tmp3_ = {0};
#line 123 "/shotwell/src/config/Config.vala"
	g_return_if_fail (CONFIG_IS_FACADE (self));
#line 124 "/shotwell/src/config/Config.vala"
	_tmp0_ = self->priv->border_color;
#line 124 "/shotwell/src/config/Config.vala"
	_tmp1_ = is_string_empty (_tmp0_);
#line 124 "/shotwell/src/config/Config.vala"
	if (_tmp1_) {
#line 125 "/shotwell/src/config/Config.vala"
		config_facade_get_colors (self);
#line 806 "Config.c"
	}
#line 127 "/shotwell/src/config/Config.vala"
...
void config_facade_set_bg_color (ConfigFacade* self, GdkRGBA* color) {
	...
	const gchar* _tmp3_;
	GdkRGBA _tmp4_;
#line 130 "/shotwell/src/config/Config.vala"
	g_return_if_fail (CONFIG_IS_FACADE (self));
#line 130 "/shotwell/src/config/Config.vala"
	g_return_if_fail (color != NULL);
#line 131 "/shotwell/src/config/Config.vala"
	_tmp0_ = *color;
#line 131 "/shotwell/src/config/Config.vala"
	_tmp1_ = _tmp0_.red;
#line 131 "/shotwell/src/config/Config.vala"
	col_tmp = (guint8) (_tmp1_ * 255.0);
#line 133 "/shotwell/src/config/Config.vala"
	_tmp2_ = g_strdup_printf ("#%02X%02X%02X", (guint) col_tmp, (guint) col_tmp, (guint) col_tmp);
#line 133 "/shotwell/src/config/Config.vala"
	_g_free0 (self->priv->bg_color);
#line 133 "/shotwell/src/config/Config.vala"
	self->priv->bg_color = _tmp2_;
#line 134 "/shotwell/src/config/Config.vala"
...
#line 136 "/shotwell/src/config/Config.vala"
	_tmp4_ = *color;
#line 136 "/shotwell/src/config/Config.vala"
...
void config_facade_commit_bg_color (ConfigFacade* self) {
	const gchar* _tmp0_;
#line 139 "/shotwell/src/config/Config.vala"
	g_return_if_fail (CONFIG_IS_FACADE (self));
#line 140 "/shotwell/src/config/Config.vala"
	_tmp0_ = self->priv->bg_color;
#line 140 "/shotwell/src/config/Config.vala"
...
#line 18 "/shotwell/src/config/Config.vala"
...
#line 42 "/shotwell/src/config/Config.vala"
	self->priv->bg_color = NULL;
#line 43 "/shotwell/src/config/Config.vala"
	self->priv->selected_color = NULL;
#line 44 "/shotwell/src/config/Config.vala"
	self->priv->unselected_color = NULL;
#line 45 "/shotwell/src/config/Config.vala"
	self->priv->unfocused_selected_color = NULL;
#line 46 "/shotwell/src/config/Config.vala"
