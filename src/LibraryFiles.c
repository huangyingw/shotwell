...
#line 33 "/shotwell/src/LibraryFiles.vala"
...
#line 13 "/shotwell/src/LibraryFiles.vala"
	g_return_val_if_fail (basename != NULL, NULL);
#line 13 "/shotwell/src/LibraryFiles.vala"
	g_return_val_if_fail ((metadata == NULL) || IS_MEDIA_METADATA (metadata), NULL);
#line 18 "/shotwell/src/LibraryFiles.vala"
	_tmp0_ = ts;
#line 18 "/shotwell/src/LibraryFiles.vala"
	timestamp = _tmp0_;
#line 19 "/shotwell/src/LibraryFiles.vala"
	_tmp1_ = metadata;
#line 19 "/shotwell/src/LibraryFiles.vala"
	if (_tmp1_ != NULL) {
...
#line 20 "/shotwell/src/LibraryFiles.vala"
		_tmp2_ = metadata;
#line 20 "/shotwell/src/LibraryFiles.vala"
		_tmp3_ = media_metadata_get_creation_date_time (_tmp2_);
#line 20 "/shotwell/src/LibraryFiles.vala"
		date_time = _tmp3_;
#line 21 "/shotwell/src/LibraryFiles.vala"
		_tmp4_ = date_time;
#line 21 "/shotwell/src/LibraryFiles.vala"
		if (_tmp4_ != NULL) {
#line 241 "LibraryFiles.c"
			...
			time_t _tmp6_;
#line 22 "/shotwell/src/LibraryFiles.vala"
			_tmp5_ = date_time;
#line 22 "/shotwell/src/LibraryFiles.vala"
...
#line 250 "LibraryFiles.c"
			...
			time_t _tmp7_;
#line 23 "/shotwell/src/LibraryFiles.vala"
			_tmp7_ = timestamp;
#line 23 "/shotwell/src/LibraryFiles.vala"
			if (_tmp7_ == ((time_t) 0)) {
#line 257 "LibraryFiles.c"
				time_t _tmp8_;
#line 24 "/shotwell/src/LibraryFiles.vala"
				_tmp8_ = time (NULL);
#line 24 "/shotwell/src/LibraryFiles.vala"
				timestamp = _tmp8_;
...
#line 28 "/shotwell/src/LibraryFiles.vala"
	_tmp9_ = timestamp;
#line 28 "/shotwell/src/LibraryFiles.vala"
...
#line 276 "LibraryFiles.c"
	{
		GFile* _tmp11_;
#line 30 "/shotwell/src/LibraryFiles.vala"
		_tmp11_ = dir;
#line 30 "/shotwell/src/LibraryFiles.vala"
...
#line 285 "LibraryFiles.c"
	...
	__catch462_g_error:
	{
		GError* err = NULL;
		GError* _tmp12_;
#line 29 "/shotwell/src/LibraryFiles.vala"
		err = _inner_error_;
#line 29 "/shotwell/src/LibraryFiles.vala"
		_inner_error_ = NULL;
#line 32 "/shotwell/src/LibraryFiles.vala"
		_tmp12_ = err;
#line 32 "/shotwell/src/LibraryFiles.vala"
...
#line 39 "/shotwell/src/LibraryFiles.vala"
	_tmp15_ = basename;
#line 39 "/shotwell/src/LibraryFiles.vala"
	_tmp16_ = g_strdup (_tmp15_);
#line 39 "/shotwell/src/LibraryFiles.vala"
	newbasename = _tmp16_;
#line 40 "/shotwell/src/LibraryFiles.vala"
...
#line 349 "LibraryFiles.c"
		const gchar* _tmp21_;
		gchar* _tmp22_;
#line 41 "/shotwell/src/LibraryFiles.vala"
		_tmp21_ = newbasename;
#line 41 "/shotwell/src/LibraryFiles.vala"
...
#line 43 "/shotwell/src/LibraryFiles.vala"
	_tmp24_ = dir;
#line 43 "/shotwell/src/LibraryFiles.vala"
	_tmp25_ = newbasename;
#line 43 "/shotwell/src/LibraryFiles.vala"
...
GFile* library_files_duplicate (GFile* src, GFileProgressCallback progress_callback, void* progress_callback_target, gboolean blacklist, GError** error) {
	...
	gboolean _tmp37_;
	GError * _inner_error_ = NULL;
#line 47 "/shotwell/src/LibraryFiles.vala"
	g_return_val_if_fail (G_IS_FILE (src), NULL);
#line 48 "/shotwell/src/LibraryFiles.vala"
	timestamp = (time_t) 0;
#line 431 "LibraryFiles.c"
	{
		...
		GFile* _tmp1_;
		time_t _tmp2_;
#line 50 "/shotwell/src/LibraryFiles.vala"
		_tmp1_ = src;
#line 50 "/shotwell/src/LibraryFiles.vala"
...
#line 449 "LibraryFiles.c"
	...
	__catch463_g_error:
	{
		...
		GError* _tmp6_;
		const gchar* _tmp7_;
#line 49 "/shotwell/src/LibraryFiles.vala"
		err = _inner_error_;
#line 49 "/shotwell/src/LibraryFiles.vala"
		_inner_error_ = NULL;
#line 52 "/shotwell/src/LibraryFiles.vala"
		_tmp3_ = src;
#line 52 "/shotwell/src/LibraryFiles.vala"
...
#line 55 "/shotwell/src/LibraryFiles.vala"
	metadata = NULL;
#line 56 "/shotwell/src/LibraryFiles.vala"
	_tmp8_ = src;
#line 56 "/shotwell/src/LibraryFiles.vala"
...
#line 499 "LibraryFiles.c"
		...
		GFile* _tmp10_;
		VideoReader* _tmp11_;
#line 57 "/shotwell/src/LibraryFiles.vala"
		_tmp10_ = src;
#line 57 "/shotwell/src/LibraryFiles.vala"
...
#line 59 "/shotwell/src/LibraryFiles.vala"
			_tmp13_ = reader;
#line 59 "/shotwell/src/LibraryFiles.vala"
...
#line 58 "/shotwell/src/LibraryFiles.vala"
...
#line 64 "/shotwell/src/LibraryFiles.vala"
		_tmp16_ = src;
#line 64 "/shotwell/src/LibraryFiles.vala"
...
#line 67 "/shotwell/src/LibraryFiles.vala"
			_tmp24_ = reader;
#line 67 "/shotwell/src/LibraryFiles.vala"
...
#line 66 "/shotwell/src/LibraryFiles.vala"
...
#line 74 "/shotwell/src/LibraryFiles.vala"
	_tmp27_ = src;
#line 74 "/shotwell/src/LibraryFiles.vala"
...
#line 75 "/shotwell/src/LibraryFiles.vala"
	_tmp35_ = dest;
#line 75 "/shotwell/src/LibraryFiles.vala"
	if (_tmp35_ == NULL) {
#line 685 "LibraryFiles.c"
		GError* _tmp36_;
#line 76 "/shotwell/src/LibraryFiles.vala"
...
#line 78 "/shotwell/src/LibraryFiles.vala"
	_tmp37_ = blacklist;
#line 78 "/shotwell/src/LibraryFiles.vala"
	if (_tmp37_) {
#line 705 "LibraryFiles.c"
		GFile* _tmp38_;
#line 79 "/shotwell/src/LibraryFiles.vala"
		_tmp38_ = dest;
#line 79 "/shotwell/src/LibraryFiles.vala"
...
#line 711 "LibraryFiles.c"
	}
	{
		...
		void* _tmp41__target;
		gboolean _tmp42_;
#line 82 "/shotwell/src/LibraryFiles.vala"
		_tmp39_ = src;
#line 82 "/shotwell/src/LibraryFiles.vala"
		_tmp40_ = dest;
#line 82 "/shotwell/src/LibraryFiles.vala"
...
#line 83 "/shotwell/src/LibraryFiles.vala"
		_tmp42_ = blacklist;
#line 83 "/shotwell/src/LibraryFiles.vala"
		if (_tmp42_) {
#line 738 "LibraryFiles.c"
			GFile* _tmp43_;
#line 84 "/shotwell/src/LibraryFiles.vala"
			_tmp43_ = dest;
#line 84 "/shotwell/src/LibraryFiles.vala"
...
#line 744 "LibraryFiles.c"
	...
	__catch466_g_error:
	{
		...
		gboolean _tmp50_;
#line 81 "/shotwell/src/LibraryFiles.vala"
		err = _inner_error_;
#line 81 "/shotwell/src/LibraryFiles.vala"
		_inner_error_ = NULL;
#line 86 "/shotwell/src/LibraryFiles.vala"
		_tmp44_ = src;
#line 86 "/shotwell/src/LibraryFiles.vala"
...
#line 86 "/shotwell/src/LibraryFiles.vala"
		_g_free0 (_tmp46_);
#line 87 "/shotwell/src/LibraryFiles.vala"
		_tmp50_ = blacklist;
#line 87 "/shotwell/src/LibraryFiles.vala"
		if (_tmp50_) {
...
#line 829 "LibraryFiles.c"
			GFile* _tmp57_;
#line 88 "/shotwell/src/LibraryFiles.vala"
			_tmp57_ = dest;
#line 88 "/shotwell/src/LibraryFiles.vala"
			library_monitor_unblacklist_file (_tmp57_);
#line 835 "LibraryFiles.c"
		}
#line 81 "/shotwell/src/LibraryFiles.vala"
		_g_error_free0 (err);
...
#line 852 "LibraryFiles.c"
	}
	{
		...
		guint32 _tmp64_;
		gboolean _tmp65_;
#line 93 "/shotwell/src/LibraryFiles.vala"
		_tmp58_ = dest;
#line 93 "/shotwell/src/LibraryFiles.vala"
...
#line 93 "/shotwell/src/LibraryFiles.vala"
		if (G_UNLIKELY (_inner_error_ != NULL)) {
#line 873 "LibraryFiles.c"
			goto __catch467_g_error;
		}
#line 94 "/shotwell/src/LibraryFiles.vala"
		_tmp60_ = info;
#line 94 "/shotwell/src/LibraryFiles.vala"
		_tmp61_ = g_file_info_get_attribute_uint32 (_tmp60_, G_FILE_ATTRIBUTE_UNIX_MODE);
#line 94 "/shotwell/src/LibraryFiles.vala"
		mode = _tmp61_ | 0600;
#line 95 "/shotwell/src/LibraryFiles.vala"
		_tmp63_ = dest;
#line 95 "/shotwell/src/LibraryFiles.vala"
		_tmp64_ = mode;
#line 95 "/shotwell/src/LibraryFiles.vala"
...
#line 95 "/shotwell/src/LibraryFiles.vala"
		if (!_tmp62_) {
#line 96 "/shotwell/src/LibraryFiles.vala"
			g_warning ("LibraryFiles.vala:96: Could not make file writable");
#line 901 "LibraryFiles.c"
		}
#line 92 "/shotwell/src/LibraryFiles.vala"
		_g_object_unref0 (info);
...
#line 92 "/shotwell/src/LibraryFiles.vala"
		_inner_error_ = NULL;
#line 99 "/shotwell/src/LibraryFiles.vala"
		_tmp66_ = err;
#line 99 "/shotwell/src/LibraryFiles.vala"
		_tmp67_ = _tmp66_->message;
#line 99 "/shotwell/src/LibraryFiles.vala"
		g_warning ("LibraryFiles.vala:99: Could not make file writable: %s", _tmp67_);
#line 92 "/shotwell/src/LibraryFiles.vala"
		_g_error_free0 (err);
...
#line 92 "/shotwell/src/LibraryFiles.vala"
		return NULL;
#line 938 "LibraryFiles.c"
	}
#line 102 "/shotwell/src/LibraryFiles.vala"
	result = dest;
#line 102 "/shotwell/src/LibraryFiles.vala"
	_media_metadata_unref0 (metadata);
#line 102 "/shotwell/src/LibraryFiles.vala"
	return result;
#line 946 "LibraryFiles.c"
}
