...
static void _direct_window_on_photo_changed_data_collection_items_altered (DataCollection* _sender, GeeMap* items, gpointer self) {
#line 12 "/shotwell/src/direct/DirectWindow.vala"
...
static void _direct_window_on_photo_changed_view_collection_items_state_changed (ViewCollection* _sender, GeeIterable* changed, gpointer self) {
#line 13 "/shotwell/src/direct/DirectWindow.vala"
	direct_window_on_photo_changed ((DirectWindow*) self);
...
DirectWindow* direct_window_construct (GType object_type, GFile* file) {
	...
	GMenuModel* _tmp17_;
	GMenuModel* _tmp18_;
#line 10 "/shotwell/src/direct/DirectWindow.vala"
	g_return_val_if_fail (G_IS_FILE (file), NULL);
#line 10 "/shotwell/src/direct/DirectWindow.vala"
	self = (DirectWindow*) app_window_construct (object_type);
#line 11 "/shotwell/src/direct/DirectWindow.vala"
	_tmp0_ = file;
#line 11 "/shotwell/src/direct/DirectWindow.vala"
...
#line 15 "/shotwell/src/direct/DirectWindow.vala"
...
#line 25 "/shotwell/src/direct/DirectWindow.vala"
...
#line 27 "/shotwell/src/direct/DirectWindow.vala"
...
#line 29 "/shotwell/src/direct/DirectWindow.vala"
...
#line 33 "/shotwell/src/direct/DirectWindow.vala"
...
DirectPhotoPage* direct_window_get_direct_page (DirectWindow* self) {
	...
	Page* _tmp0_;
#line 36 "/shotwell/src/direct/DirectWindow.vala"
	g_return_val_if_fail (IS_DIRECT_WINDOW (self), NULL);
#line 37 "/shotwell/src/direct/DirectWindow.vala"
...
void direct_window_update_title (DirectWindow* self, GFile* file, gboolean modified) {
	...
	gchar* _tmp10_;
	gchar* _tmp11_;
#line 40 "/shotwell/src/direct/DirectWindow.vala"
	g_return_if_fail (IS_DIRECT_WINDOW (self));
#line 40 "/shotwell/src/direct/DirectWindow.vala"
	g_return_if_fail (G_IS_FILE (file));
#line 41 "/shotwell/src/direct/DirectWindow.vala"
	_tmp1_ = modified;
#line 41 "/shotwell/src/direct/DirectWindow.vala"
	if (_tmp1_) {
#line 41 "/shotwell/src/direct/DirectWindow.vala"
...
#line 45 "/shotwell/src/direct/DirectWindow.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DIRECT_WINDOW, DirectWindow);
#line 46 "/shotwell/src/direct/DirectWindow.vala"
...
#line 46 "/shotwell/src/direct/DirectWindow.vala"
	file = _tmp3_;
#line 48 "/shotwell/src/direct/DirectWindow.vala"
...
static gchar* direct_window_real_get_app_role (AppWindow* base) {
	...
	gchar* result = NULL;
	gchar* _tmp0_;
#line 51 "/shotwell/src/direct/DirectWindow.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DIRECT_WINDOW, DirectWindow);
#line 52 "/shotwell/src/direct/DirectWindow.vala"
...
static void direct_window_on_photo_changed (DirectWindow* self) {
	...
	Photo* _tmp1_;
	Photo* _tmp2_;
#line 55 "/shotwell/src/direct/DirectWindow.vala"
	g_return_if_fail (IS_DIRECT_WINDOW (self));
#line 56 "/shotwell/src/direct/DirectWindow.vala"
...
#line 56 "/shotwell/src/direct/DirectWindow.vala"
	photo = _tmp1_;
#line 57 "/shotwell/src/direct/DirectWindow.vala"
	_tmp2_ = photo;
#line 57 "/shotwell/src/direct/DirectWindow.vala"
	if (_tmp2_ != NULL) {
#line 667 "DirectWindow.c"
		...
		Photo* _tmp6_;
		gboolean _tmp7_;
#line 58 "/shotwell/src/direct/DirectWindow.vala"
		_tmp3_ = photo;
#line 58 "/shotwell/src/direct/DirectWindow.vala"
...
static void direct_window_real_on_quit (AppWindow* base) {
	...
	gboolean _tmp6_;
	Dimensions _tmp7_;
#line 61 "/shotwell/src/direct/DirectWindow.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DIRECT_WINDOW, DirectWindow);
#line 62 "/shotwell/src/direct/DirectWindow.vala"
	_tmp0_ = direct_window_get_direct_page (self);
#line 62 "/shotwell/src/direct/DirectWindow.vala"
	_tmp1_ = _tmp0_;
#line 62 "/shotwell/src/direct/DirectWindow.vala"
...
#line 62 "/shotwell/src/direct/DirectWindow.vala"
	if (_tmp3_) {
#line 63 "/shotwell/src/direct/DirectWindow.vala"
		return;
#line 721 "DirectWindow.c"
	}
#line 65 "/shotwell/src/direct/DirectWindow.vala"
...
#line 65 "/shotwell/src/direct/DirectWindow.vala"
	_g_object_unref0 (_tmp5_);
#line 67 "/shotwell/src/direct/DirectWindow.vala"
...
#line 70 "/shotwell/src/direct/DirectWindow.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DIRECT_WINDOW, DirectWindow);
#line 70 "/shotwell/src/direct/DirectWindow.vala"
	g_return_val_if_fail (event != NULL, FALSE);
#line 71 "/shotwell/src/direct/DirectWindow.vala"
	_tmp0_ = direct_window_get_direct_page (self);
#line 71 "/shotwell/src/direct/DirectWindow.vala"
	_tmp1_ = _tmp0_;
#line 71 "/shotwell/src/direct/DirectWindow.vala"
...
#line 71 "/shotwell/src/direct/DirectWindow.vala"
	if (_tmp3_) {
#line 72 "/shotwell/src/direct/DirectWindow.vala"
		result = TRUE;
#line 72 "/shotwell/src/direct/DirectWindow.vala"
		return result;
#line 769 "DirectWindow.c"
	}
#line 74 "/shotwell/src/direct/DirectWindow.vala"
...
static gboolean direct_window_real_button_press_event (GtkWidget* base, GdkEventButton* event) {
	...
	GdkEventType _tmp1_;
#line 77 "/shotwell/src/direct/DirectWindow.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DIRECT_WINDOW, DirectWindow);
#line 77 "/shotwell/src/direct/DirectWindow.vala"
	g_return_val_if_fail (event != NULL, FALSE);
#line 78 "/shotwell/src/direct/DirectWindow.vala"
	_tmp0_ = event;
#line 78 "/shotwell/src/direct/DirectWindow.vala"
	_tmp1_ = _tmp0_->type;
#line 78 "/shotwell/src/direct/DirectWindow.vala"
	if (_tmp1_ == GDK_2BUTTON_PRESS) {
#line 79 "/shotwell/src/direct/DirectWindow.vala"
		app_window_on_fullscreen (G_TYPE_CHECK_INSTANCE_CAST (self, TYPE_APP_WINDOW, AppWindow));
#line 81 "/shotwell/src/direct/DirectWindow.vala"
		result = TRUE;
#line 81 "/shotwell/src/direct/DirectWindow.vala"
		return result;
#line 817 "DirectWindow.c"
	}
#line 84 "/shotwell/src/direct/DirectWindow.vala"
	result = FALSE;
#line 84 "/shotwell/src/direct/DirectWindow.vala"
	return result;
...
#line 87 "/shotwell/src/direct/DirectWindow.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DIRECT_WINDOW, DirectWindow);
#line 87 "/shotwell/src/direct/DirectWindow.vala"
	g_return_val_if_fail (event != NULL, FALSE);
#line 89 "/shotwell/src/direct/DirectWindow.vala"
	_tmp0_ = event;
#line 89 "/shotwell/src/direct/DirectWindow.vala"
...
#line 90 "/shotwell/src/direct/DirectWindow.vala"
		app_window_on_quit (G_TYPE_CHECK_INSTANCE_CAST (self, TYPE_APP_WINDOW, AppWindow));
#line 92 "/shotwell/src/direct/DirectWindow.vala"
		result = TRUE;
#line 92 "/shotwell/src/direct/DirectWindow.vala"
		return result;
#line 852 "DirectWindow.c"
	}
#line 96 "/shotwell/src/direct/DirectWindow.vala"
...
#line 7 "/shotwell/src/direct/DirectWindow.vala"
...
#line 8 "/shotwell/src/direct/DirectWindow.vala"
	_g_object_unref0 (self->priv->direct_photo_page);
#line 7 "/shotwell/src/direct/DirectWindow.vala"
