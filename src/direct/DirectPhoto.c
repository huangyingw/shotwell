...
static DirectPhoto* direct_photo_construct (GType object_type, PhotoRow* row) {
	...
	PhotoRow* _tmp0_;
#line 17 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_val_if_fail (IS_PHOTO_ROW (row), NULL);
#line 18 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp0_ = row;
#line 18 "/shotwell/src/direct/DirectPhoto.vala"
...
void direct_photo_fixup_orientation_after_reimport (DirectPhoto* self, Orientation dest) {
	...
	Orientation _tmp3_;
#line 35 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_if_fail (IS_DIRECT_PHOTO (self));
#line 36 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp0_ = G_TYPE_CHECK_INSTANCE_CAST (self, TYPE_PHOTO, Photo)->row;
#line 36 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp1_ = dest;
#line 36 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp0_->orientation = _tmp1_;
#line 37 "/shotwell/src/direct/DirectPhoto.vala"
...
void direct_photo_init (GFile* initial_file) {
	...
	DirectPhoto* _tmp9_;
#line 40 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_if_fail (G_IS_FILE (initial_file));
#line 41 "/shotwell/src/direct/DirectPhoto.vala"
	photo_init_photo ();
#line 43 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp0_ = initial_file;
#line 43 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 45 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 45 "/shotwell/src/direct/DirectPhoto.vala"
	reason = _tmp5_;
#line 46 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp6_ = reason;
#line 46 "/shotwell/src/direct/DirectPhoto.vala"
	if (_tmp6_ != NULL) {
#line 1218 "DirectPhoto.c"
		const gchar* _tmp7_;
#line 47 "/shotwell/src/direct/DirectPhoto.vala"
		_tmp7_ = reason;
#line 47 "/shotwell/src/direct/DirectPhoto.vala"
		g_warning ("DirectPhoto.vala:47: fetch error: %s", _tmp7_);
#line 1224 "DirectPhoto.c"
	}
#line 48 "/shotwell/src/direct/DirectPhoto.vala"
...
void direct_photo_terminate (void) {
#line 52 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 57 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_if_fail (IS_DIRECT_PHOTO (self));
#line 1251 "DirectPhoto.c"
	{
		...
		Dimensions _tmp4_ = {0};
#line 59 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 59 "/shotwell/src/direct/DirectPhoto.vala"
		_tmp3_->dim = _tmp4_;
#line 58 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 58 "/shotwell/src/direct/DirectPhoto.vala"
		_inner_error_ = NULL;
#line 62 "/shotwell/src/direct/DirectPhoto.vala"
...
ImportResult direct_photo_demand_load (DirectPhoto* self) {
	...
	GError * _inner_error_ = NULL;
#line 67 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_val_if_fail (IS_DIRECT_PHOTO (self), 0);
#line 68 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp0_ = self->priv->loaded;
#line 68 "/shotwell/src/direct/DirectPhoto.vala"
	if (_tmp0_) {
#line 69 "/shotwell/src/direct/DirectPhoto.vala"
		direct_photo_save_dims (self);
#line 70 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 75 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 76 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 1354 "DirectPhoto.c"
	...
	__catch46_g_error:
	{
		...
		GError* _tmp3_;
		const gchar* _tmp4_;
#line 74 "/shotwell/src/direct/DirectPhoto.vala"
		err = _inner_error_;
#line 74 "/shotwell/src/direct/DirectPhoto.vala"
		_inner_error_ = NULL;
#line 78 "/shotwell/src/direct/DirectPhoto.vala"
		_tmp3_ = err;
#line 78 "/shotwell/src/direct/DirectPhoto.vala"
		_tmp4_ = _tmp3_->message;
#line 78 "/shotwell/src/direct/DirectPhoto.vala"
		g_warning ("DirectPhoto.vala:78: Database error on re-importing image: %s", _tmp4_);
#line 79 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 82 "/shotwell/src/direct/DirectPhoto.vala"
	self->priv->loaded = TRUE;
#line 83 "/shotwell/src/direct/DirectPhoto.vala"
	direct_photo_save_dims (self);
#line 84 "/shotwell/src/direct/DirectPhoto.vala"
	result = IMPORT_RESULT_SUCCESS;
#line 84 "/shotwell/src/direct/DirectPhoto.vala"
	_photo_reimport_master_state_unref0 (reimport_state);
#line 84 "/shotwell/src/direct/DirectPhoto.vala"
...
ImportResult direct_photo_internal_import (GFile* file, DirectPhoto* * photo) {
	...
	PhotoRow* _tmp7_;
	DirectPhoto* _tmp8_;
#line 89 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_val_if_fail (G_IS_FILE (file), 0);
#line 90 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp0_ = file;
#line 90 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 90 "/shotwell/src/direct/DirectPhoto.vala"
	params = _tmp2_;
#line 91 "/shotwell/src/direct/DirectPhoto.vala"
	photo_create_pre_import (params);
#line 92 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 94 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp7_ = params->row;
#line 94 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 94 "/shotwell/src/direct/DirectPhoto.vala"
	_vala_photo = _tmp8_;
#line 96 "/shotwell/src/direct/DirectPhoto.vala"
	result = IMPORT_RESULT_SUCCESS;
#line 96 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 1489 "DirectPhoto.c"
		...
		GdkPixbuf* _tmp3_;
		GdkPixbuf* _tmp4_;
#line 101 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 103 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 1518 "DirectPhoto.c"
			...
			GdkPixbuf* _tmp7_;
			GdkPixbuf* _tmp8_;
#line 104 "/shotwell/src/direct/DirectPhoto.vala"
			_tmp6_ = *scaling;
#line 104 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 107 "/shotwell/src/direct/DirectPhoto.vala"
...
static void direct_photo_real_rotate (Photo* base, Rotation rotation) {
	DirectPhoto * self;
	Rotation _tmp0_;
#line 110 "/shotwell/src/direct/DirectPhoto.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DIRECT_PHOTO, DirectPhoto);
#line 111 "/shotwell/src/direct/DirectPhoto.vala"
	G_TYPE_CHECK_INSTANCE_CAST (self, TYPE_PHOTO, Photo)->can_rotate_now = FALSE;
#line 112 "/shotwell/src/direct/DirectPhoto.vala"
	g_signal_emit (self, direct_photo_signals[DIRECT_PHOTO_CAN_ROTATE_CHANGED_SIGNAL], 0, FALSE);
#line 113 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp0_ = rotation;
#line 113 "/shotwell/src/direct/DirectPhoto.vala"
...
static GdkPixbuf* direct_photo_real_get_pixbuf (PhotoSource* base, Scaling* scaling, GError** error) {
	...
	GdkPixbuf* _tmp1_;
	GError * _inner_error_ = NULL;
#line 116 "/shotwell/src/direct/DirectPhoto.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DIRECT_PHOTO, DirectPhoto);
#line 116 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_val_if_fail (scaling != NULL, NULL);
#line 117 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp0_ = *scaling;
#line 117 "/shotwell/src/direct/DirectPhoto.vala"
...
static GdkPixbuf* direct_photo_real_get_thumbnail (ThumbnailSource* base, gint scale, GError** error) {
	...
	GError * _inner_error_ = NULL;
#line 123 "/shotwell/src/direct/DirectPhoto.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DIRECT_PHOTO, DirectPhoto);
#line 124 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp0_ = photo_source_get_metadata (G_TYPE_CHECK_INSTANCE_CAST (self, TYPE_PHOTO_SOURCE, PhotoSource));
#line 124 "/shotwell/src/direct/DirectPhoto.vala"
	metadata = _tmp0_;
#line 126 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp3_ = metadata;
#line 126 "/shotwell/src/direct/DirectPhoto.vala"
	if (_tmp3_ == NULL) {
#line 126 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 1660 "DirectPhoto.c"
		...
		Orientation _tmp12_;
		GdkPixbuf* _tmp13_;
#line 127 "/shotwell/src/direct/DirectPhoto.vala"
		_tmp7_ = metadata;
#line 127 "/shotwell/src/direct/DirectPhoto.vala"
...
static void direct_photo_real_notify_altered (DataObject* base, Alteration* alteration) {
	DirectPhoto * self;
	Alteration* _tmp0_;
#line 130 "/shotwell/src/direct/DirectPhoto.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DIRECT_PHOTO, DirectPhoto);
#line 130 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_if_fail (IS_ALTERATION (alteration));
#line 131 "/shotwell/src/direct/DirectPhoto.vala"
	_g_object_unref0 (self->priv->preview);
#line 131 "/shotwell/src/direct/DirectPhoto.vala"
	self->priv->preview = NULL;
#line 133 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp0_ = alteration;
#line 133 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 136 "/shotwell/src/direct/DirectPhoto.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DIRECT_PHOTO, DirectPhoto);
#line 138 "/shotwell/src/direct/DirectPhoto.vala"
	result = FALSE;
#line 138 "/shotwell/src/direct/DirectPhoto.vala"
	return result;
...
static void direct_photo_real_set_user_metadata_for_export (Photo* base, PhotoMetadata* metadata) {
	DirectPhoto * self;
#line 141 "/shotwell/src/direct/DirectPhoto.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DIRECT_PHOTO, DirectPhoto);
#line 141 "/shotwell/src/direct/DirectPhoto.vala"
...
static void direct_photo_real_apply_user_metadata_for_reimport (Photo* base, PhotoMetadata* metadata) {
	DirectPhoto * self;
#line 145 "/shotwell/src/direct/DirectPhoto.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DIRECT_PHOTO, DirectPhoto);
#line 145 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_if_fail (IS_PHOTO_METADATA (metadata));
...
static gboolean direct_photo_real_is_trashed (MediaSource* base) {
	DirectPhoto * self;
	gboolean result = FALSE;
#line 148 "/shotwell/src/direct/DirectPhoto.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DIRECT_PHOTO, DirectPhoto);
#line 150 "/shotwell/src/direct/DirectPhoto.vala"
	result = FALSE;
#line 150 "/shotwell/src/direct/DirectPhoto.vala"
	return result;
...
static gboolean direct_photo_real_is_offline (MediaSource* base) {
	DirectPhoto * self;
	gboolean result = FALSE;
#line 153 "/shotwell/src/direct/DirectPhoto.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DIRECT_PHOTO, DirectPhoto);
#line 155 "/shotwell/src/direct/DirectPhoto.vala"
	result = FALSE;
#line 155 "/shotwell/src/direct/DirectPhoto.vala"
	return result;
...
static void direct_photo_real_trash (MediaSource* base) {
	DirectPhoto * self;
#line 158 "/shotwell/src/direct/DirectPhoto.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DIRECT_PHOTO, DirectPhoto);
...
static void direct_photo_real_untrash (MediaSource* base) {
	DirectPhoto * self;
#line 162 "/shotwell/src/direct/DirectPhoto.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DIRECT_PHOTO, DirectPhoto);
...
static void direct_photo_real_mark_offline (MediaSource* base) {
	DirectPhoto * self;
#line 166 "/shotwell/src/direct/DirectPhoto.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DIRECT_PHOTO, DirectPhoto);
...
static void direct_photo_real_mark_online (MediaSource* base) {
	DirectPhoto * self;
#line 170 "/shotwell/src/direct/DirectPhoto.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DIRECT_PHOTO, DirectPhoto);
...
#line 7 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 14 "/shotwell/src/direct/DirectPhoto.vala"
	self->priv->preview = NULL;
#line 15 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 178 "/shotwell/src/direct/DirectPhoto.vala"
	return result;
...
#line 183 "/shotwell/src/direct/DirectPhoto.vala"
	return result;
...
static void _direct_photo_source_collection_on_file_discovered_directory_monitor_file_discovered (DirectoryMonitor* _sender, GFile* file, GFileInfo* info, gpointer self) {
#line 187 "/shotwell/src/direct/DirectPhoto.vala"
...
static void _direct_photo_source_collection_on_discovery_completed_directory_monitor_discovery_completed (DirectoryMonitor* _sender, gpointer self) {
#line 188 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 182 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 186 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp0_ = initial_file;
#line 186 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 190 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 198 "/shotwell/src/direct/DirectPhoto.vala"
...
static gint64 direct_photo_source_collection_get_direct_key (DataSource* source) {
	...
	PhotoID _tmp3_;
	gint64 _tmp4_;
#line 197 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 198 "/shotwell/src/direct/DirectPhoto.vala"
	photo = _tmp1_;
#line 199 "/shotwell/src/direct/DirectPhoto.vala"
	photo_get_photo_id (G_TYPE_CHECK_INSTANCE_CAST (photo, TYPE_PHOTO, Photo), &_tmp2_);
#line 199 "/shotwell/src/direct/DirectPhoto.vala"
	photo_id = _tmp2_;
#line 201 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp3_ = photo_id;
#line 201 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp4_ = _tmp3_.id;
#line 201 "/shotwell/src/direct/DirectPhoto.vala"
...
static void direct_photo_source_collection_real_notify_items_added (DataCollection* base, GeeIterable* added) {
	DirectPhotoSourceCollection * self;
	GeeIterable* _tmp16_;
#line 204 "/shotwell/src/direct/DirectPhoto.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DIRECT_PHOTO_SOURCE_COLLECTION, DirectPhotoSourceCollection);
#line 204 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 2064 "DirectPhoto.c"
	{
		...
		GeeIterable* _tmp0_;
		GeeIterator* _tmp1_;
#line 205 "/shotwell/src/direct/DirectPhoto.vala"
		_tmp0_ = added;
#line 205 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 211 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 214 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp16_ = added;
#line 214 "/shotwell/src/direct/DirectPhoto.vala"
...
static void direct_photo_source_collection_real_notify_items_removed (DataCollection* base, GeeIterable* removed) {
	DirectPhotoSourceCollection * self;
	GeeIterable* _tmp14_;
#line 217 "/shotwell/src/direct/DirectPhoto.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_DIRECT_PHOTO_SOURCE_COLLECTION, DirectPhotoSourceCollection);
#line 217 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 2166 "DirectPhoto.c"
	{
		...
		GeeIterable* _tmp0_;
		GeeIterator* _tmp1_;
#line 218 "/shotwell/src/direct/DirectPhoto.vala"
		_tmp0_ = removed;
#line 218 "/shotwell/src/direct/DirectPhoto.vala"
		_tmp1_ = gee_iterable_iterator (_tmp0_);
#line 218 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 218 "/shotwell/src/direct/DirectPhoto.vala"
			object = (DataObject*) _tmp5_;
#line 219 "/shotwell/src/direct/DirectPhoto.vala"
			_tmp6_ = object;
#line 219 "/shotwell/src/direct/DirectPhoto.vala"
			_tmp7_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp6_, TYPE_DIRECT_PHOTO, DirectPhoto));
#line 219 "/shotwell/src/direct/DirectPhoto.vala"
			photo = _tmp7_;
#line 220 "/shotwell/src/direct/DirectPhoto.vala"
			_tmp8_ = photo;
#line 220 "/shotwell/src/direct/DirectPhoto.vala"
			_tmp9_ = media_source_get_file (G_TYPE_CHECK_INSTANCE_CAST (_tmp8_, TYPE_MEDIA_SOURCE, MediaSource));
#line 220 "/shotwell/src/direct/DirectPhoto.vala"
			file = _tmp9_;
#line 222 "/shotwell/src/direct/DirectPhoto.vala"
			_tmp10_ = self->priv->file_map;
#line 222 "/shotwell/src/direct/DirectPhoto.vala"
			_tmp11_ = file;
#line 222 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 222 "/shotwell/src/direct/DirectPhoto.vala"
			is_removed = _tmp12_;
#line 223 "/shotwell/src/direct/DirectPhoto.vala"
			_tmp13_ = is_removed;
#line 223 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 226 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp14_ = removed;
#line 226 "/shotwell/src/direct/DirectPhoto.vala"
...
gboolean direct_photo_source_collection_has_source_for_file (DirectPhotoSourceCollection* self, GFile* file) {
	...
	GFile* _tmp1_;
	gboolean _tmp2_;
#line 229 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_val_if_fail (IS_DIRECT_PHOTO_SOURCE_COLLECTION (self), FALSE);
#line 229 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_val_if_fail (G_IS_FILE (file), FALSE);
#line 230 "/shotwell/src/direct/DirectPhoto.vala"
...
static void direct_photo_source_collection_on_file_discovered (DirectPhotoSourceCollection* self, GFile* file, GFileInfo* info) {
	...
	gint _tmp12_;
	gint _tmp13_;
#line 233 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_if_fail (IS_DIRECT_PHOTO_SOURCE_COLLECTION (self));
#line 233 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_if_fail (G_IS_FILE (file));
#line 233 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_if_fail (G_IS_FILE_INFO (info));
#line 235 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp0_ = file;
#line 235 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp1_ = direct_photo_source_collection_has_source_for_file (self, _tmp0_);
#line 235 "/shotwell/src/direct/DirectPhoto.vala"
	if (_tmp1_) {
#line 236 "/shotwell/src/direct/DirectPhoto.vala"
		return;
#line 2309 "DirectPhoto.c"
	}
#line 239 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp2_ = file;
#line 239 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp3_ = photo_file_format_is_file_supported (_tmp2_);
#line 239 "/shotwell/src/direct/DirectPhoto.vala"
	if (!_tmp3_) {
#line 240 "/shotwell/src/direct/DirectPhoto.vala"
		return;
#line 2319 "DirectPhoto.c"
	}
#line 243 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp4_ = file;
#line 243 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 243 "/shotwell/src/direct/DirectPhoto.vala"
	reason = _tmp6_;
#line 244 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp7_ = reason;
#line 244 "/shotwell/src/direct/DirectPhoto.vala"
	if (_tmp7_ != NULL) {
#line 2335 "DirectPhoto.c"
		const gchar* _tmp8_;
#line 245 "/shotwell/src/direct/DirectPhoto.vala"
		_tmp8_ = reason;
#line 245 "/shotwell/src/direct/DirectPhoto.vala"
		g_warning ("DirectPhoto.vala:245: Error fetching file: %s", _tmp8_);
#line 2341 "DirectPhoto.c"
	}
#line 246 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp9_ = self->priv->prepared_photos;
#line 246 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp10_ = photo;
#line 246 "/shotwell/src/direct/DirectPhoto.vala"
	gee_collection_add (_tmp9_, _tmp10_);
#line 247 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 248 "/shotwell/src/direct/DirectPhoto.vala"
...
static void direct_photo_source_collection_on_discovery_completed (DirectPhotoSourceCollection* self) {
#line 251 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_if_fail (IS_DIRECT_PHOTO_SOURCE_COLLECTION (self));
#line 252 "/shotwell/src/direct/DirectPhoto.vala"
	direct_photo_source_collection_flush_prepared_photos (self);
...
#line 255 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_if_fail (IS_DIRECT_PHOTO_SOURCE_COLLECTION (self));
#line 256 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 256 "/shotwell/src/direct/DirectPhoto.vala"
	_g_object_unref0 (_tmp2_);
#line 257 "/shotwell/src/direct/DirectPhoto.vala"
...
gboolean direct_photo_source_collection_has_file (DirectPhotoSourceCollection* self, GFile* file) {
	...
	GFile* _tmp1_;
	gboolean _tmp2_;
#line 260 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_val_if_fail (IS_DIRECT_PHOTO_SOURCE_COLLECTION (self), FALSE);
#line 260 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_val_if_fail (G_IS_FILE (file), FALSE);
#line 261 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp0_ = self->priv->file_map;
#line 261 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp1_ = file;
#line 261 "/shotwell/src/direct/DirectPhoto.vala"
...
void direct_photo_source_collection_reimport_photo (DirectPhotoSourceCollection* self, DirectPhoto* photo) {
	...
	gchar* _tmp5_;
	gchar* _tmp6_;
#line 264 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_if_fail (IS_DIRECT_PHOTO_SOURCE_COLLECTION (self));
#line 264 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_if_fail (IS_DIRECT_PHOTO (photo));
#line 265 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp0_ = photo;
#line 265 "/shotwell/src/direct/DirectPhoto.vala"
	photo_discard_prefetched (G_TYPE_CHECK_INSTANCE_CAST (_tmp0_, TYPE_PHOTO, Photo));
#line 267 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp1_ = photo;
#line 267 "/shotwell/src/direct/DirectPhoto.vala"
...
gchar* direct_photo_source_collection_fetch (DirectPhotoSourceCollection* self, GFile* file, DirectPhoto* * photo, gboolean reimport) {
	...
	GError * _inner_error_ = NULL;
#line 271 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_val_if_fail (IS_DIRECT_PHOTO_SOURCE_COLLECTION (self), NULL);
#line 271 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_val_if_fail (G_IS_FILE (file), NULL);
#line 273 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp0_ = self->priv->file_map;
#line 273 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp1_ = file;
#line 273 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 274 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp3_ = _vala_photo;
#line 274 "/shotwell/src/direct/DirectPhoto.vala"
	if (_tmp3_ != NULL) {
#line 2497 "DirectPhoto.c"
		gchar* reason = NULL;
		gboolean _tmp4_;
#line 275 "/shotwell/src/direct/DirectPhoto.vala"
		reason = NULL;
#line 277 "/shotwell/src/direct/DirectPhoto.vala"
		_tmp4_ = reimport;
#line 277 "/shotwell/src/direct/DirectPhoto.vala"
		if (_tmp4_) {
#line 2506 "DirectPhoto.c"
			{
				...
				gboolean _tmp15_;
#line 279 "/shotwell/src/direct/DirectPhoto.vala"
				ori_tmp = ORIENTATION_TOP_LEFT;
#line 280 "/shotwell/src/direct/DirectPhoto.vala"
				should_restore_ori = FALSE;
#line 282 "/shotwell/src/direct/DirectPhoto.vala"
				_tmp6_ = _vala_photo;
#line 282 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 283 "/shotwell/src/direct/DirectPhoto.vala"
					_tmp8_ = _vala_photo;
#line 283 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 2544 "DirectPhoto.c"
					DirectPhoto* _tmp10_;
					Orientation _tmp11_;
#line 284 "/shotwell/src/direct/DirectPhoto.vala"
					_tmp10_ = _vala_photo;
#line 284 "/shotwell/src/direct/DirectPhoto.vala"
					_tmp11_ = photo_get_orientation (G_TYPE_CHECK_INSTANCE_CAST (_tmp10_, TYPE_PHOTO, Photo));
#line 284 "/shotwell/src/direct/DirectPhoto.vala"
					ori_tmp = _tmp11_;
#line 285 "/shotwell/src/direct/DirectPhoto.vala"
					should_restore_ori = TRUE;
#line 2555 "DirectPhoto.c"
				}
#line 289 "/shotwell/src/direct/DirectPhoto.vala"
				_tmp13_ = _vala_photo;
#line 289 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 2576 "DirectPhoto.c"
					...
					gboolean _tmp18_;
#line 290 "/shotwell/src/direct/DirectPhoto.vala"
					_tmp16_ = _vala_photo;
#line 290 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 291 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 2597 "DirectPhoto.c"
						DirectPhoto* _tmp19_;
						Orientation _tmp20_;
#line 292 "/shotwell/src/direct/DirectPhoto.vala"
						_tmp19_ = _vala_photo;
#line 292 "/shotwell/src/direct/DirectPhoto.vala"
						_tmp20_ = ori_tmp;
#line 292 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 2606 "DirectPhoto.c"
					...
					gchar* _tmp21_;
#line 296 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 278 "/shotwell/src/direct/DirectPhoto.vala"
				_photo_reimport_master_state_unref0 (reimport_state);
...
#line 278 "/shotwell/src/direct/DirectPhoto.vala"
				_inner_error_ = NULL;
#line 299 "/shotwell/src/direct/DirectPhoto.vala"
				_tmp22_ = err;
#line 299 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 303 "/shotwell/src/direct/DirectPhoto.vala"
		result = reason;
#line 303 "/shotwell/src/direct/DirectPhoto.vala"
		if (photo) {
#line 303 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 308 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp25_ = file;
#line 308 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 308 "/shotwell/src/direct/DirectPhoto.vala"
	_result_ = _tmp27_;
#line 310 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp29_ = _result_;
#line 310 "/shotwell/src/direct/DirectPhoto.vala"
...
gboolean direct_photo_source_collection_has_file_source (DirectPhotoSourceCollection* self, GFile* file) {
	...
	GFile* _tmp1_;
	gboolean _tmp2_;
#line 313 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_val_if_fail (IS_DIRECT_PHOTO_SOURCE_COLLECTION (self), FALSE);
#line 313 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_val_if_fail (G_IS_FILE (file), FALSE);
#line 314 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp0_ = self->priv->file_map;
#line 314 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp1_ = file;
#line 314 "/shotwell/src/direct/DirectPhoto.vala"
...
DirectPhoto* direct_photo_source_collection_get_file_source (DirectPhotoSourceCollection* self, GFile* file) {
	...
	GFile* _tmp1_;
	gpointer _tmp2_;
#line 317 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_val_if_fail (IS_DIRECT_PHOTO_SOURCE_COLLECTION (self), NULL);
#line 317 "/shotwell/src/direct/DirectPhoto.vala"
	g_return_val_if_fail (G_IS_FILE (file), NULL);
#line 318 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp0_ = self->priv->file_map;
#line 318 "/shotwell/src/direct/DirectPhoto.vala"
	_tmp1_ = file;
#line 318 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 175 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 177 "/shotwell/src/direct/DirectPhoto.vala"
...
#line 180 "/shotwell/src/direct/DirectPhoto.vala"
	_g_object_unref0 (self->priv->monitor);
#line 175 "/shotwell/src/direct/DirectPhoto.vala"
