...
#line 64 "/shotwell/src/TimedQueue.vala"
	return result;
...
#line 66 "/shotwell/src/TimedQueue.vala"
	return result;
...
TimedQueue* timed_queue_construct (GType object_type, GType g_type, GBoxedCopyFunc g_dup_func, GDestroyNotify g_destroy_func, guint hold_msec, DequeuedCallback callback, void* callback_target, GeeEqualDataFunc equal_func, void* equal_func_target, GDestroyNotify equal_func_target_destroy_notify, gint priority) {
	...
	gint _tmp10_;
	guint _tmp11_;
#line 52 "/shotwell/src/TimedQueue.vala"
...
#line 54 "/shotwell/src/TimedQueue.vala"
	_tmp0_ = hold_msec;
#line 54 "/shotwell/src/TimedQueue.vala"
	self->priv->hold_msec = _tmp0_;
#line 55 "/shotwell/src/TimedQueue.vala"
	_tmp1_ = callback;
#line 55 "/shotwell/src/TimedQueue.vala"
...
#line 57 "/shotwell/src/TimedQueue.vala"
	_tmp2_ = equal_func;
#line 57 "/shotwell/src/TimedQueue.vala"
...
#line 58 "/shotwell/src/TimedQueue.vala"
		_tmp3_ = equal_func;
#line 58 "/shotwell/src/TimedQueue.vala"
...
#line 60 "/shotwell/src/TimedQueue.vala"
...
#line 62 "/shotwell/src/TimedQueue.vala"
	_tmp7_ = priority;
#line 62 "/shotwell/src/TimedQueue.vala"
...
guint timed_queue_get_dequeue_spacing_msec (TimedQueue* self) {
	guint result = 0U;
	guint _tmp0_;
#line 74 "/shotwell/src/TimedQueue.vala"
	g_return_val_if_fail (IS_TIMED_QUEUE (self), 0U);
#line 75 "/shotwell/src/TimedQueue.vala"
...
void timed_queue_set_dequeue_spacing_msec (TimedQueue* self, guint msec) {
	...
	gint _tmp6_;
	guint _tmp7_;
#line 78 "/shotwell/src/TimedQueue.vala"
	g_return_if_fail (IS_TIMED_QUEUE (self));
#line 79 "/shotwell/src/TimedQueue.vala"
	_tmp0_ = msec;
#line 79 "/shotwell/src/TimedQueue.vala"
	_tmp1_ = self->priv->dequeue_spacing_msec;
#line 79 "/shotwell/src/TimedQueue.vala"
	if (_tmp0_ == _tmp1_) {
#line 80 "/shotwell/src/TimedQueue.vala"
		return;
#line 430 "TimedQueue.c"
	}
#line 82 "/shotwell/src/TimedQueue.vala"
	_tmp2_ = self->priv->timer_id;
#line 82 "/shotwell/src/TimedQueue.vala"
	if (_tmp2_ != ((guint) 0)) {
#line 436 "TimedQueue.c"
		guint _tmp3_;
#line 83 "/shotwell/src/TimedQueue.vala"
		_tmp3_ = self->priv->timer_id;
#line 83 "/shotwell/src/TimedQueue.vala"
		g_source_remove (_tmp3_);
#line 442 "TimedQueue.c"
	}
#line 85 "/shotwell/src/TimedQueue.vala"
	_tmp4_ = msec;
#line 85 "/shotwell/src/TimedQueue.vala"
	self->priv->dequeue_spacing_msec = _tmp4_;
#line 87 "/shotwell/src/TimedQueue.vala"
...
static guint timed_queue_get_heartbeat_timeout (TimedQueue* self) {
	...
	guint _tmp1_;
	guint _tmp4_;
#line 90 "/shotwell/src/TimedQueue.vala"
	g_return_val_if_fail (IS_TIMED_QUEUE (self), 0U);
#line 91 "/shotwell/src/TimedQueue.vala"
	_tmp1_ = self->priv->dequeue_spacing_msec;
#line 91 "/shotwell/src/TimedQueue.vala"
	if (_tmp1_ == ((guint) 0)) {
#line 471 "TimedQueue.c"
		guint _tmp2_;
#line 92 "/shotwell/src/TimedQueue.vala"
...
#line 477 "TimedQueue.c"
		...
		guint _tmp3_;
#line 93 "/shotwell/src/TimedQueue.vala"
...
#line 97 "/shotwell/src/TimedQueue.vala"
...
void timed_queue_notify_dequeued (TimedQueue* self, gconstpointer item) {
#line 96 "/shotwell/src/TimedQueue.vala"
	g_return_if_fail (IS_TIMED_QUEUE (self));
#line 96 "/shotwell/src/TimedQueue.vala"
...
gboolean timed_queue_is_paused (TimedQueue* self) {
	...
	gboolean _tmp0_;
#line 100 "/shotwell/src/TimedQueue.vala"
	g_return_val_if_fail (IS_TIMED_QUEUE (self), FALSE);
#line 101 "/shotwell/src/TimedQueue.vala"
...
void timed_queue_pause (TimedQueue* self) {
	gboolean _tmp0_;
#line 104 "/shotwell/src/TimedQueue.vala"
	g_return_if_fail (IS_TIMED_QUEUE (self));
#line 105 "/shotwell/src/TimedQueue.vala"
	_tmp0_ = self->priv->paused_state;
#line 105 "/shotwell/src/TimedQueue.vala"
	if (_tmp0_) {
#line 106 "/shotwell/src/TimedQueue.vala"
		return;
#line 546 "TimedQueue.c"
	}
#line 108 "/shotwell/src/TimedQueue.vala"
	self->priv->paused_state = TRUE;
#line 110 "/shotwell/src/TimedQueue.vala"
...
void timed_queue_unpause (TimedQueue* self) {
	gboolean _tmp0_;
#line 113 "/shotwell/src/TimedQueue.vala"
	g_return_if_fail (IS_TIMED_QUEUE (self));
#line 114 "/shotwell/src/TimedQueue.vala"
	_tmp0_ = self->priv->paused_state;
#line 114 "/shotwell/src/TimedQueue.vala"
	if (!_tmp0_) {
#line 115 "/shotwell/src/TimedQueue.vala"
		return;
#line 566 "TimedQueue.c"
	}
#line 117 "/shotwell/src/TimedQueue.vala"
	self->priv->paused_state = FALSE;
#line 119 "/shotwell/src/TimedQueue.vala"
...
static void timed_queue_real_clear (TimedQueue* self) {
	SortedList* _tmp0_;
#line 123 "/shotwell/src/TimedQueue.vala"
...
void timed_queue_clear (TimedQueue* self) {
#line 122 "/shotwell/src/TimedQueue.vala"
	g_return_if_fail (IS_TIMED_QUEUE (self));
#line 122 "/shotwell/src/TimedQueue.vala"
...
static gboolean timed_queue_real_contains (TimedQueue* self, gconstpointer item) {
	gboolean result = FALSE;
	{
		...
		SortedList* _tmp0_;
		GeeIterator* _tmp1_;
#line 127 "/shotwell/src/TimedQueue.vala"
		_tmp0_ = self->priv->queue;
#line 127 "/shotwell/src/TimedQueue.vala"
...
#line 128 "/shotwell/src/TimedQueue.vala"
...
#line 128 "/shotwell/src/TimedQueue.vala"
			if (_tmp10_) {
#line 129 "/shotwell/src/TimedQueue.vala"
				result = TRUE;
#line 129 "/shotwell/src/TimedQueue.vala"
...
#line 132 "/shotwell/src/TimedQueue.vala"
	result = FALSE;
#line 132 "/shotwell/src/TimedQueue.vala"
	return result;
...
gboolean timed_queue_contains (TimedQueue* self, gconstpointer item) {
#line 126 "/shotwell/src/TimedQueue.vala"
	g_return_val_if_fail (IS_TIMED_QUEUE (self), FALSE);
#line 126 "/shotwell/src/TimedQueue.vala"
...
static gboolean timed_queue_real_enqueue (TimedQueue* self, gconstpointer item) {
	...
	gboolean _tmp5_;
	gboolean _tmp6_;
#line 136 "/shotwell/src/TimedQueue.vala"
	_tmp0_ = self->priv->queue;
#line 136 "/shotwell/src/TimedQueue.vala"
	_tmp1_ = item;
#line 136 "/shotwell/src/TimedQueue.vala"
...
gboolean timed_queue_enqueue (TimedQueue* self, gconstpointer item) {
#line 135 "/shotwell/src/TimedQueue.vala"
	g_return_val_if_fail (IS_TIMED_QUEUE (self), FALSE);
#line 135 "/shotwell/src/TimedQueue.vala"
...
static gboolean timed_queue_real_enqueue_many (TimedQueue* self, GeeCollection* items) {
	...
	gboolean _tmp15_;
#line 139 "/shotwell/src/TimedQueue.vala"
	g_return_val_if_fail (GEE_IS_COLLECTION (items), FALSE);
#line 140 "/shotwell/src/TimedQueue.vala"
	_tmp0_ = timed_queue_calc_ready_time (self);
#line 140 "/shotwell/src/TimedQueue.vala"
	ready_time = _tmp0_;
#line 142 "/shotwell/src/TimedQueue.vala"
...
#line 747 "TimedQueue.c"
	{
		...
		GeeIterator* _tmp3_;
#line 143 "/shotwell/src/TimedQueue.vala"
		_tmp2_ = items;
#line 143 "/shotwell/src/TimedQueue.vala"
...
#line 143 "/shotwell/src/TimedQueue.vala"
			item = _tmp7_;
#line 144 "/shotwell/src/TimedQueue.vala"
			_tmp8_ = elements;
#line 144 "/shotwell/src/TimedQueue.vala"
			_tmp9_ = item;
#line 144 "/shotwell/src/TimedQueue.vala"
...
#line 146 "/shotwell/src/TimedQueue.vala"
...
static gboolean timed_queue_real_remove_first (TimedQueue* self, gconstpointer item) {
	...
	SortedList* _tmp0_;
	GeeIterator* _tmp1_;
#line 150 "/shotwell/src/TimedQueue.vala"
	_tmp0_ = self->priv->queue;
#line 150 "/shotwell/src/TimedQueue.vala"
	_tmp1_ = gee_iterable_iterator (G_TYPE_CHECK_INSTANCE_CAST (_tmp0_, GEE_TYPE_ITERABLE, GeeIterable));
#line 150 "/shotwell/src/TimedQueue.vala"
	iter = _tmp1_;
#line 151 "/shotwell/src/TimedQueue.vala"
	while (TRUE) {
...
#line 152 "/shotwell/src/TimedQueue.vala"
		_tmp4_ = iter;
#line 152 "/shotwell/src/TimedQueue.vala"
		_tmp5_ = gee_iterator_get (_tmp4_);
#line 152 "/shotwell/src/TimedQueue.vala"
		e = (TimedQueueElement*) _tmp5_;
#line 153 "/shotwell/src/TimedQueue.vala"
		_tmp6_ = self->priv->equal_func;
#line 153 "/shotwell/src/TimedQueue.vala"
		_tmp6__target = self->priv->equal_func_target;
#line 153 "/shotwell/src/TimedQueue.vala"
...
#line 889 "TimedQueue.c"
			GeeIterator* _tmp11_;
#line 154 "/shotwell/src/TimedQueue.vala"
			_tmp11_ = iter;
#line 154 "/shotwell/src/TimedQueue.vala"
			gee_iterator_remove (_tmp11_);
#line 156 "/shotwell/src/TimedQueue.vala"
			result = TRUE;
#line 156 "/shotwell/src/TimedQueue.vala"
			_timed_queue_element_unref0 (e);
#line 156 "/shotwell/src/TimedQueue.vala"
...
#line 160 "/shotwell/src/TimedQueue.vala"
	result = FALSE;
#line 160 "/shotwell/src/TimedQueue.vala"
	_g_object_unref0 (iter);
#line 160 "/shotwell/src/TimedQueue.vala"
...
gboolean timed_queue_remove_first (TimedQueue* self, gconstpointer item) {
#line 149 "/shotwell/src/TimedQueue.vala"
	g_return_val_if_fail (IS_TIMED_QUEUE (self), FALSE);
#line 149 "/shotwell/src/TimedQueue.vala"
...
static gulong timed_queue_calc_ready_time (TimedQueue* self) {
	...
	gulong _tmp0_;
	guint _tmp1_;
#line 169 "/shotwell/src/TimedQueue.vala"
	g_return_val_if_fail (IS_TIMED_QUEUE (self), 0UL);
#line 170 "/shotwell/src/TimedQueue.vala"
	_tmp0_ = now_ms ();
#line 170 "/shotwell/src/TimedQueue.vala"
...
static gboolean timed_queue_on_heartbeat (TimedQueue* self) {
	...
	gboolean _tmp0_;
	gulong now = 0UL;
#line 173 "/shotwell/src/TimedQueue.vala"
	g_return_val_if_fail (IS_TIMED_QUEUE (self), FALSE);
#line 174 "/shotwell/src/TimedQueue.vala"
	_tmp0_ = self->priv->paused_state;
#line 174 "/shotwell/src/TimedQueue.vala"
	if (_tmp0_) {
#line 175 "/shotwell/src/TimedQueue.vala"
		result = TRUE;
#line 175 "/shotwell/src/TimedQueue.vala"
		return result;
#line 960 "TimedQueue.c"
	}
#line 177 "/shotwell/src/TimedQueue.vala"
	now = (gulong) 0;
#line 964 "TimedQueue.c"
	{
		gboolean _tmp1_ = FALSE;
#line 179 "/shotwell/src/TimedQueue.vala"
		_tmp1_ = TRUE;
#line 179 "/shotwell/src/TimedQueue.vala"
		while (TRUE) {
...
#line 179 "/shotwell/src/TimedQueue.vala"
			_tmp1_ = FALSE;
#line 180 "/shotwell/src/TimedQueue.vala"
...
#line 180 "/shotwell/src/TimedQueue.vala"
			if (_tmp4_ == 0) {
#line 181 "/shotwell/src/TimedQueue.vala"
				break;
#line 1010 "TimedQueue.c"
			}
#line 183 "/shotwell/src/TimedQueue.vala"
			_tmp5_ = self->priv->queue;
#line 183 "/shotwell/src/TimedQueue.vala"
			_tmp6_ = sorted_list_get_at (_tmp5_, 0);
#line 183 "/shotwell/src/TimedQueue.vala"
			head = (TimedQueueElement*) _tmp6_;
#line 184 "/shotwell/src/TimedQueue.vala"
			_tmp7_ = head;
#line 184 "/shotwell/src/TimedQueue.vala"
			_vala_assert (_tmp7_ != NULL, "head != null");
#line 186 "/shotwell/src/TimedQueue.vala"
			_tmp8_ = now;
#line 186 "/shotwell/src/TimedQueue.vala"
			if (_tmp8_ == ((gulong) 0)) {
#line 1026 "TimedQueue.c"
				gulong _tmp9_;
#line 187 "/shotwell/src/TimedQueue.vala"
				_tmp9_ = now_ms ();
#line 187 "/shotwell/src/TimedQueue.vala"
				now = _tmp9_;
#line 1032 "TimedQueue.c"
			}
#line 189 "/shotwell/src/TimedQueue.vala"
			_tmp10_ = head;
#line 189 "/shotwell/src/TimedQueue.vala"
...
#line 189 "/shotwell/src/TimedQueue.vala"
			if (_tmp11_ > _tmp12_) {
#line 190 "/shotwell/src/TimedQueue.vala"
				_timed_queue_element_unref0 (head);
#line 190 "/shotwell/src/TimedQueue.vala"
				break;
#line 1046 "TimedQueue.c"
			}
#line 193 "/shotwell/src/TimedQueue.vala"
...
#line 208 "/shotwell/src/TimedQueue.vala"
	result = TRUE;
#line 208 "/shotwell/src/TimedQueue.vala"
	return result;
...
gint timed_queue_get_size (TimedQueue* self) {
#line 164 "/shotwell/src/TimedQueue.vala"
...
#line 164 "/shotwell/src/TimedQueue.vala"
	self = base;
#line 165 "/shotwell/src/TimedQueue.vala"
	_tmp0_ = self->priv->queue;
#line 165 "/shotwell/src/TimedQueue.vala"
...
static TimedQueueElement* timed_queue_element_construct (GType object_type, GType g_type, GBoxedCopyFunc g_dup_func, GDestroyNotify g_destroy_func, gconstpointer item, gulong ready) {
	...
	gpointer _tmp1_;
	gulong _tmp2_;
#line 26 "/shotwell/src/TimedQueue.vala"
...
#line 26 "/shotwell/src/TimedQueue.vala"
	self->priv->g_destroy_func = g_destroy_func;
#line 27 "/shotwell/src/TimedQueue.vala"
	_tmp0_ = item;
#line 27 "/shotwell/src/TimedQueue.vala"
...
#line 27 "/shotwell/src/TimedQueue.vala"
	self->item = _tmp1_;
#line 28 "/shotwell/src/TimedQueue.vala"
	_tmp2_ = ready;
#line 28 "/shotwell/src/TimedQueue.vala"
	self->ready = _tmp2_;
#line 26 "/shotwell/src/TimedQueue.vala"
...
static gint64 timed_queue_element_comparator (void* a, void* b) {
	...
	void* _tmp2_;
	gulong _tmp3_;
#line 32 "/shotwell/src/TimedQueue.vala"
	_tmp0_ = a;
#line 32 "/shotwell/src/TimedQueue.vala"
...
#line 22 "/shotwell/src/TimedQueue.vala"
...
#line 23 "/shotwell/src/TimedQueue.vala"
...
#line 21 "/shotwell/src/TimedQueue.vala"
	value->data[0].v_pointer = NULL;
...
#line 40 "/shotwell/src/TimedQueue.vala"
	self->priv->timer_id = (guint) 0;
#line 42 "/shotwell/src/TimedQueue.vala"
	self->priv->dequeue_spacing_msec = (guint) 0;
#line 43 "/shotwell/src/TimedQueue.vala"
	self->priv->last_dequeue = (gulong) 0;
#line 44 "/shotwell/src/TimedQueue.vala"
	self->priv->paused_state = FALSE;
#line 21 "/shotwell/src/TimedQueue.vala"
	self->ref_count = 1;
...
#line 21 "/shotwell/src/TimedQueue.vala"
	g_signal_handlers_destroy (self);
#line 70 "/shotwell/src/TimedQueue.vala"
	_tmp0_ = self->priv->timer_id;
#line 70 "/shotwell/src/TimedQueue.vala"
	if (_tmp0_ != ((guint) 0)) {
#line 1710 "TimedQueue.c"
		guint _tmp1_;
#line 71 "/shotwell/src/TimedQueue.vala"
		_tmp1_ = self->priv->timer_id;
#line 71 "/shotwell/src/TimedQueue.vala"
		g_source_remove (_tmp1_);
#line 1716 "TimedQueue.c"
	}
#line 38 "/shotwell/src/TimedQueue.vala"
	(self->priv->equal_func_target_destroy_notify == NULL) ? NULL : (self->priv->equal_func_target_destroy_notify (self->priv->equal_func_target), NULL);
#line 38 "/shotwell/src/TimedQueue.vala"
	self->priv->equal_func = NULL;
#line 38 "/shotwell/src/TimedQueue.vala"
...
#line 38 "/shotwell/src/TimedQueue.vala"
	self->priv->equal_func_target_destroy_notify = NULL;
#line 41 "/shotwell/src/TimedQueue.vala"
	_g_object_unref0 (self->priv->queue);
...
HashTimedQueue* hash_timed_queue_construct (GType object_type, GType g_type, GBoxedCopyFunc g_dup_func, GDestroyNotify g_destroy_func, guint hold_msec, DequeuedCallback callback, void* callback_target, GeeHashDataFunc hash_func, void* hash_func_target, GDestroyNotify hash_func_target_destroy_notify, GeeEqualDataFunc equal_func, void* equal_func_target, GDestroyNotify equal_func_target_destroy_notify, gint priority) {
	...
	GeeHashMap* _tmp6_;
#line 220 "/shotwell/src/TimedQueue.vala"
	_tmp0_ = hold_msec;
#line 220 "/shotwell/src/TimedQueue.vala"
	_tmp1_ = callback;
#line 220 "/shotwell/src/TimedQueue.vala"
...
#line 220 "/shotwell/src/TimedQueue.vala"
	self->priv->g_destroy_func = g_destroy_func;
#line 222 "/shotwell/src/TimedQueue.vala"
	_tmp4_ = hash_func;
#line 222 "/shotwell/src/TimedQueue.vala"
...
#line 217 "/shotwell/src/TimedQueue.vala"
...
static void hash_timed_queue_real_notify_dequeued (TimedQueue* base, gconstpointer item) {
	...
	gconstpointer _tmp0_;
	gconstpointer _tmp1_;
#line 225 "/shotwell/src/TimedQueue.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_HASH_TIMED_QUEUE, HashTimedQueue);
#line 226 "/shotwell/src/TimedQueue.vala"
	_tmp0_ = item;
#line 226 "/shotwell/src/TimedQueue.vala"
	hash_timed_queue_removed (self, _tmp0_);
#line 228 "/shotwell/src/TimedQueue.vala"
	_tmp1_ = item;
#line 228 "/shotwell/src/TimedQueue.vala"
...
static gboolean hash_timed_queue_real_contains (TimedQueue* base, gconstpointer item) {
	...
	gconstpointer _tmp1_;
	gboolean _tmp2_;
#line 237 "/shotwell/src/TimedQueue.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_HASH_TIMED_QUEUE, HashTimedQueue);
#line 238 "/shotwell/src/TimedQueue.vala"
	_tmp0_ = self->priv->item_count;
#line 238 "/shotwell/src/TimedQueue.vala"
	_tmp1_ = item;
#line 238 "/shotwell/src/TimedQueue.vala"
...
#line 241 "/shotwell/src/TimedQueue.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_HASH_TIMED_QUEUE, HashTimedQueue);
#line 242 "/shotwell/src/TimedQueue.vala"
	_tmp0_ = item;
#line 242 "/shotwell/src/TimedQueue.vala"
...
#line 242 "/shotwell/src/TimedQueue.vala"
	if (!_tmp1_) {
#line 243 "/shotwell/src/TimedQueue.vala"
		result = FALSE;
#line 243 "/shotwell/src/TimedQueue.vala"
		return result;
#line 1952 "TimedQueue.c"
	}
#line 245 "/shotwell/src/TimedQueue.vala"
...
#line 247 "/shotwell/src/TimedQueue.vala"
	result = TRUE;
#line 247 "/shotwell/src/TimedQueue.vala"
	return result;
...
static gboolean hash_timed_queue_real_enqueue_many (TimedQueue* base, GeeCollection* items) {
	...
	gboolean _tmp1_;
#line 250 "/shotwell/src/TimedQueue.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_HASH_TIMED_QUEUE, HashTimedQueue);
#line 250 "/shotwell/src/TimedQueue.vala"
	g_return_val_if_fail (GEE_IS_COLLECTION (items), FALSE);
#line 251 "/shotwell/src/TimedQueue.vala"
	_tmp0_ = items;
#line 251 "/shotwell/src/TimedQueue.vala"
...
#line 251 "/shotwell/src/TimedQueue.vala"
	if (!_tmp1_) {
#line 252 "/shotwell/src/TimedQueue.vala"
		result = FALSE;
#line 252 "/shotwell/src/TimedQueue.vala"
		return result;
#line 2013 "TimedQueue.c"
	}
	{
		...
		GeeCollection* _tmp2_;
		GeeIterator* _tmp3_;
#line 254 "/shotwell/src/TimedQueue.vala"
		_tmp2_ = items;
#line 254 "/shotwell/src/TimedQueue.vala"
		_tmp3_ = gee_iterable_iterator (G_TYPE_CHECK_INSTANCE_CAST (_tmp2_, GEE_TYPE_ITERABLE, GeeIterable));
#line 254 "/shotwell/src/TimedQueue.vala"
...
#line 254 "/shotwell/src/TimedQueue.vala"
			item = _tmp7_;
#line 255 "/shotwell/src/TimedQueue.vala"
			_tmp9_ = self->priv->item_count;
#line 255 "/shotwell/src/TimedQueue.vala"
			_tmp10_ = item;
#line 255 "/shotwell/src/TimedQueue.vala"
...
#line 257 "/shotwell/src/TimedQueue.vala"
	result = TRUE;
#line 257 "/shotwell/src/TimedQueue.vala"
	return result;
...
#line 260 "/shotwell/src/TimedQueue.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_HASH_TIMED_QUEUE, HashTimedQueue);
#line 261 "/shotwell/src/TimedQueue.vala"
	_tmp0_ = item;
#line 261 "/shotwell/src/TimedQueue.vala"
...
#line 261 "/shotwell/src/TimedQueue.vala"
	if (!_tmp1_) {
#line 262 "/shotwell/src/TimedQueue.vala"
		result = FALSE;
#line 262 "/shotwell/src/TimedQueue.vala"
		return result;
#line 2121 "TimedQueue.c"
	}
#line 264 "/shotwell/src/TimedQueue.vala"
	_tmp2_ = item;
#line 264 "/shotwell/src/TimedQueue.vala"
	hash_timed_queue_removed (self, _tmp2_);
#line 266 "/shotwell/src/TimedQueue.vala"
	result = TRUE;
#line 266 "/shotwell/src/TimedQueue.vala"
	return result;
...
static void hash_timed_queue_removed (HashTimedQueue* self, gconstpointer item) {
	...
	gint _tmp7_;
	gint _tmp8_;
#line 269 "/shotwell/src/TimedQueue.vala"
	g_return_if_fail (IS_HASH_TIMED_QUEUE (self));
#line 272 "/shotwell/src/TimedQueue.vala"
	_tmp0_ = self->priv->item_count;
#line 272 "/shotwell/src/TimedQueue.vala"
	_tmp1_ = item;
#line 272 "/shotwell/src/TimedQueue.vala"
...
#line 272 "/shotwell/src/TimedQueue.vala"
	if (!_tmp2_) {
#line 273 "/shotwell/src/TimedQueue.vala"
		return;
#line 2158 "TimedQueue.c"
	}
#line 275 "/shotwell/src/TimedQueue.vala"
	_tmp3_ = self->priv->item_count;
#line 275 "/shotwell/src/TimedQueue.vala"
	_tmp4_ = item;
#line 275 "/shotwell/src/TimedQueue.vala"
...
#line 276 "/shotwell/src/TimedQueue.vala"
	_tmp6_ = count;
#line 276 "/shotwell/src/TimedQueue.vala"
	_vala_assert (_tmp6_ > 0, "count > 0");
#line 278 "/shotwell/src/TimedQueue.vala"
	_tmp7_ = count;
#line 278 "/shotwell/src/TimedQueue.vala"
	count = _tmp7_ - 1;
#line 278 "/shotwell/src/TimedQueue.vala"
...
#line 2180 "TimedQueue.c"
		GeeHashMap* _tmp9_;
		gconstpointer _tmp10_;
#line 279 "/shotwell/src/TimedQueue.vala"
		_tmp9_ = self->priv->item_count;
#line 279 "/shotwell/src/TimedQueue.vala"
		_tmp10_ = item;
#line 279 "/shotwell/src/TimedQueue.vala"
...
#line 2189 "TimedQueue.c"
		...
		gint _tmp13_;
#line 281 "/shotwell/src/TimedQueue.vala"
...
#line 214 "/shotwell/src/TimedQueue.vala"
...
#line 215 "/shotwell/src/TimedQueue.vala"
	_g_object_unref0 (self->priv->item_count);
#line 214 "/shotwell/src/TimedQueue.vala"
