/* MediaMetadata.c generated by valac 0.36.6, the Vala compiler
...
#line 8 "/shotwell/src/MediaMetadata.vala"
...
static void media_metadata_real_read_from_file (MediaMetadata* self, GFile* file, GError** error) {
#line 11 "/shotwell/src/MediaMetadata.vala"
...
static MetadataDateTime* media_metadata_real_get_creation_date_time (MediaMetadata* self) {
#line 13 "/shotwell/src/MediaMetadata.vala"
...
static gchar* media_metadata_real_get_title (MediaMetadata* self) {
#line 15 "/shotwell/src/MediaMetadata.vala"
...
static gchar* media_metadata_real_get_comment (MediaMetadata* self) {
#line 17 "/shotwell/src/MediaMetadata.vala"
...
#line 7 "/shotwell/src/MediaMetadata.vala"
...
void metadata_rational_init (MetadataRational *self, gint numerator, gint denominator) {
	gint _tmp0_;
	gint _tmp1_;
#line 24 "/shotwell/src/MediaMetadata.vala"
	memset (self, 0, sizeof (MetadataRational));
#line 25 "/shotwell/src/MediaMetadata.vala"
	_tmp0_ = numerator;
#line 25 "/shotwell/src/MediaMetadata.vala"
	(*self).numerator = _tmp0_;
#line 26 "/shotwell/src/MediaMetadata.vala"
	_tmp1_ = denominator;
#line 26 "/shotwell/src/MediaMetadata.vala"
...
static gboolean metadata_rational_is_component_valid (MetadataRational *self, gint component) {
	...
	gint _tmp1_;
#line 30 "/shotwell/src/MediaMetadata.vala"
	_tmp1_ = component;
#line 30 "/shotwell/src/MediaMetadata.vala"
	if (_tmp1_ >= 0) {
...
gboolean metadata_rational_is_valid (MetadataRational *self) {
	...
	gint _tmp1_;
	gboolean _tmp2_;
#line 34 "/shotwell/src/MediaMetadata.vala"
...
gchar* metadata_rational_to_string (MetadataRational *self) {
	...
	gchar* _tmp0_ = NULL;
	gboolean _tmp1_;
#line 38 "/shotwell/src/MediaMetadata.vala"
...
#line 20 "/shotwell/src/MediaMetadata.vala"
...
MetadataDateTime* metadata_date_time_construct (GType object_type, time_t timestamp) {
	...
	time_t _tmp0_;
#line 51 "/shotwell/src/MediaMetadata.vala"
	self = (MetadataDateTime*) g_type_create_instance (object_type);
#line 52 "/shotwell/src/MediaMetadata.vala"
	_tmp0_ = timestamp;
#line 52 "/shotwell/src/MediaMetadata.vala"
...
#line 55 "/shotwell/src/MediaMetadata.vala"
	g_return_val_if_fail (label != NULL, NULL);
#line 55 "/shotwell/src/MediaMetadata.vala"
	self = (MetadataDateTime*) g_type_create_instance (object_type);
#line 56 "/shotwell/src/MediaMetadata.vala"
	_tmp0_ = label;
#line 56 "/shotwell/src/MediaMetadata.vala"
...
#line 688 "MediaMetadata.c"
		const gchar* _tmp3_;
		GError* _tmp4_;
#line 57 "/shotwell/src/MediaMetadata.vala"
		_tmp3_ = label;
#line 57 "/shotwell/src/MediaMetadata.vala"
...
MetadataDateTime* metadata_date_time_construct_from_iptc (GType object_type, const gchar* date, const gchar* time, GError** error) {
	...
	GError* _tmp0_;
	GError * _inner_error_ = NULL;
#line 60 "/shotwell/src/MediaMetadata.vala"
	g_return_val_if_fail (date != NULL, NULL);
#line 60 "/shotwell/src/MediaMetadata.vala"
	g_return_val_if_fail (time != NULL, NULL);
#line 60 "/shotwell/src/MediaMetadata.vala"
	self = (MetadataDateTime*) g_type_create_instance (object_type);
#line 62 "/shotwell/src/MediaMetadata.vala"
...
MetadataDateTime* metadata_date_time_construct_from_xmp (GType object_type, const gchar* label, GError** error) {
	...
	glong _tmp5_;
	GError * _inner_error_ = NULL;
#line 65 "/shotwell/src/MediaMetadata.vala"
	g_return_val_if_fail (label != NULL, NULL);
#line 65 "/shotwell/src/MediaMetadata.vala"
	self = (MetadataDateTime*) g_type_create_instance (object_type);
#line 66 "/shotwell/src/MediaMetadata.vala"
	g_get_current_time (&time_val);
#line 67 "/shotwell/src/MediaMetadata.vala"
	_tmp0_ = label;
#line 67 "/shotwell/src/MediaMetadata.vala"
...
#line 794 "MediaMetadata.c"
		const gchar* _tmp2_;
		GError* _tmp3_;
#line 68 "/shotwell/src/MediaMetadata.vala"
		_tmp2_ = label;
#line 68 "/shotwell/src/MediaMetadata.vala"
...
#line 70 "/shotwell/src/MediaMetadata.vala"
	_tmp4_ = time_val;
#line 70 "/shotwell/src/MediaMetadata.vala"
...
time_t metadata_date_time_get_timestamp (MetadataDateTime* self) {
	time_t result = 0;
	time_t _tmp0_;
#line 73 "/shotwell/src/MediaMetadata.vala"
	g_return_val_if_fail (IS_METADATA_DATE_TIME (self), 0);
#line 74 "/shotwell/src/MediaMetadata.vala"
...
gchar* metadata_date_time_get_exif_label (MetadataDateTime* self) {
	...
	time_t _tmp0_;
	gchar* _tmp1_;
#line 77 "/shotwell/src/MediaMetadata.vala"
	g_return_val_if_fail (IS_METADATA_DATE_TIME (self), NULL);
#line 78 "/shotwell/src/MediaMetadata.vala"
	_tmp0_ = self->priv->timestamp;
#line 78 "/shotwell/src/MediaMetadata.vala"
...
gchar* metadata_date_time_get_xmp_label (MetadataDateTime* self) {
	...
	time_t _tmp0_;
	gchar* _tmp1_;
#line 83 "/shotwell/src/MediaMetadata.vala"
	g_return_val_if_fail (IS_METADATA_DATE_TIME (self), NULL);
#line 84 "/shotwell/src/MediaMetadata.vala"
	g_get_current_time (&time_val);
#line 85 "/shotwell/src/MediaMetadata.vala"
	_tmp0_ = self->priv->timestamp;
#line 85 "/shotwell/src/MediaMetadata.vala"
	time_val.tv_sec = (glong) _tmp0_;
#line 86 "/shotwell/src/MediaMetadata.vala"
	time_val.tv_usec = (glong) 0;
#line 88 "/shotwell/src/MediaMetadata.vala"
...
gboolean metadata_date_time_from_exif_date_time (const gchar* date_time, time_t* timestamp) {
	...
	gint _tmp25_;
	time_t _tmp26_;
#line 91 "/shotwell/src/MediaMetadata.vala"
	g_return_val_if_fail (date_time != NULL, FALSE);
#line 92 "/shotwell/src/MediaMetadata.vala"
	_vala_timestamp = (time_t) 0;
#line 94 "/shotwell/src/MediaMetadata.vala"
	memset (&tm, 0, sizeof (struct tm));
#line 97 "/shotwell/src/MediaMetadata.vala"
	_tmp0_ = date_time;
#line 97 "/shotwell/src/MediaMetadata.vala"
...
#line 927 "MediaMetadata.c"
		...
		const gchar* _tmp5_;
		gint _tmp6_;
#line 100 "/shotwell/src/MediaMetadata.vala"
		_tmp2_ = date_time;
#line 100 "/shotwell/src/MediaMetadata.vala"
		_tmp3_ = g_strdup (_tmp2_);
#line 100 "/shotwell/src/MediaMetadata.vala"
		tmp = _tmp3_;
#line 101 "/shotwell/src/MediaMetadata.vala"
		_tmp4_ = tmp;
#line 101 "/shotwell/src/MediaMetadata.vala"
		g_strcanon (_tmp4_, "0123456789", ' ');
#line 102 "/shotwell/src/MediaMetadata.vala"
		_tmp5_ = tmp;
#line 102 "/shotwell/src/MediaMetadata.vala"
		_tmp6_ = sscanf (_tmp5_, "%4d%2d%2d%2d%2d%2d", &tm.tm_year, &tm.tm_mon, &tm.tm_mday, &tm.tm_hour, &tm.tm_min, &tm.tm_sec);
#line 102 "/shotwell/src/MediaMetadata.vala"
		if (_tmp6_ != 6) {
#line 104 "/shotwell/src/MediaMetadata.vala"
			result = FALSE;
#line 104 "/shotwell/src/MediaMetadata.vala"
			_g_free0 (tmp);
#line 104 "/shotwell/src/MediaMetadata.vala"
...
#line 108 "/shotwell/src/MediaMetadata.vala"
	_tmp12_ = tm;
#line 108 "/shotwell/src/MediaMetadata.vala"
...
#line 108 "/shotwell/src/MediaMetadata.vala"
	if (_tmp7_) {
#line 109 "/shotwell/src/MediaMetadata.vala"
		result = FALSE;
#line 109 "/shotwell/src/MediaMetadata.vala"
		if (timestamp) {
#line 109 "/shotwell/src/MediaMetadata.vala"
...
#line 111 "/shotwell/src/MediaMetadata.vala"
	_tmp24_ = tm.tm_year;
#line 111 "/shotwell/src/MediaMetadata.vala"
	tm.tm_year = _tmp24_ - 1900;
#line 112 "/shotwell/src/MediaMetadata.vala"
	_tmp25_ = tm.tm_mon;
#line 112 "/shotwell/src/MediaMetadata.vala"
	tm.tm_mon = _tmp25_ - 1;
#line 113 "/shotwell/src/MediaMetadata.vala"
	tm.tm_isdst = -1;
#line 115 "/shotwell/src/MediaMetadata.vala"
	_tmp26_ = mktime (&tm);
#line 115 "/shotwell/src/MediaMetadata.vala"
	_vala_timestamp = _tmp26_;
#line 117 "/shotwell/src/MediaMetadata.vala"
	result = TRUE;
#line 117 "/shotwell/src/MediaMetadata.vala"
	if (timestamp) {
#line 117 "/shotwell/src/MediaMetadata.vala"
...
gchar* metadata_date_time_to_exif_date_time (time_t timestamp) {
	...
	struct tm _tmp1_ = {0};
	gchar* _tmp2_;
#line 121 "/shotwell/src/MediaMetadata.vala"
	_tmp0_ = timestamp;
#line 121 "/shotwell/src/MediaMetadata.vala"
...
gchar* metadata_date_time_to_string (MetadataDateTime* self) {
	...
	time_t _tmp0_;
	gchar* _tmp1_;
#line 124 "/shotwell/src/MediaMetadata.vala"
	g_return_val_if_fail (IS_METADATA_DATE_TIME (self), NULL);
#line 125 "/shotwell/src/MediaMetadata.vala"
	_tmp0_ = self->priv->timestamp;
#line 125 "/shotwell/src/MediaMetadata.vala"
	_tmp1_ = metadata_date_time_to_exif_date_time (_tmp0_);
#line 125 "/shotwell/src/MediaMetadata.vala"
...
#line 47 "/shotwell/src/MediaMetadata.vala"
	value->data[0].v_pointer = NULL;
