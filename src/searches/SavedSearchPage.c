/* SavedSearchPage.c generated by valac 0.36.6, the Vala compiler
...
#line 12 "/shotwell/src/searches/SavedSearchPage.vala"
...
SavedSearchManager* saved_search_manager_construct (GType object_type, SavedSearchPage* owner, SavedSearch* search) {
	...
	SavedSearchPage* _tmp0_;
	SavedSearch* _tmp1_;
	SavedSearch* _tmp2_;
#line 10 "/shotwell/src/searches/SavedSearchPage.vala"
	g_return_val_if_fail (IS_SAVED_SEARCH_PAGE (owner), NULL);
#line 10 "/shotwell/src/searches/SavedSearchPage.vala"
	g_return_val_if_fail (IS_SAVED_SEARCH (search), NULL);
#line 11 "/shotwell/src/searches/SavedSearchPage.vala"
	_tmp0_ = owner;
#line 11 "/shotwell/src/searches/SavedSearchPage.vala"
...
static gboolean saved_search_manager_real_include_in_view (ViewManager* base, DataSource* source) {
	...
	DataSource* _tmp1_;
	gboolean _tmp2_;
#line 15 "/shotwell/src/searches/SavedSearchPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_SAVED_SEARCH_MANAGER, SavedSearchManager);
#line 15 "/shotwell/src/searches/SavedSearchPage.vala"
	g_return_val_if_fail (IS_DATA_SOURCE (source), FALSE);
#line 16 "/shotwell/src/searches/SavedSearchPage.vala"
...
#line 8 "/shotwell/src/searches/SavedSearchPage.vala"
...
#line 9 "/shotwell/src/searches/SavedSearchPage.vala"
	_g_object_unref0 (self->priv->search);
#line 8 "/shotwell/src/searches/SavedSearchPage.vala"
...
static void _saved_search_page_on_rename_search_gsimple_action_activate_callback (GSimpleAction* action, GVariant* parameter, gpointer self) {
#line 50 "/shotwell/src/searches/SavedSearchPage.vala"
...
SavedSearchPage* saved_search_page_construct (GType object_type, SavedSearch* search) {
	...
	SavedSearch* _tmp3_;
	SavedSearch* _tmp4_;
#line 26 "/shotwell/src/searches/SavedSearchPage.vala"
	g_return_val_if_fail (IS_SAVED_SEARCH (search), NULL);
#line 27 "/shotwell/src/searches/SavedSearchPage.vala"
	_tmp0_ = search;
#line 27 "/shotwell/src/searches/SavedSearchPage.vala"
...
#line 27 "/shotwell/src/searches/SavedSearchPage.vala"
	_g_free0 (_tmp2_);
#line 28 "/shotwell/src/searches/SavedSearchPage.vala"
	_tmp3_ = search;
#line 28 "/shotwell/src/searches/SavedSearchPage.vala"
...
#line 986 "SavedSearchPage.c"
	{
		...
		GeeIterator* _tmp9_;
		GeeIterator* _tmp10_;
#line 31 "/shotwell/src/searches/SavedSearchPage.vala"
...
#line 1015 "SavedSearchPage.c"
			...
			SavedSearch* _tmp18_;
			SavedSearchManager* _tmp19_;
			SavedSearchManager* _tmp20_;
			ViewCollectionMonitor* _tmp21_;
			ViewCollectionMonitor* _tmp22_;
#line 31 "/shotwell/src/searches/SavedSearchPage.vala"
			_tmp11_ = _sources_it;
#line 31 "/shotwell/src/searches/SavedSearchPage.vala"
...
#line 32 "/shotwell/src/searches/SavedSearchPage.vala"
...
#line 34 "/shotwell/src/searches/SavedSearchPage.vala"
...
static void saved_search_page_real_get_config_photos_sort (MediaPage* base, gboolean* sort_order, gint* sort_by) {
	...
	gint _tmp3_ = 0;
#line 37 "/shotwell/src/searches/SavedSearchPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_SAVED_SEARCH_PAGE, SavedSearchPage);
#line 38 "/shotwell/src/searches/SavedSearchPage.vala"
...
static void saved_search_page_real_set_config_photos_sort (MediaPage* base, gboolean sort_order, gint sort_by) {
	...
	gboolean _tmp2_;
	gint _tmp3_;
#line 41 "/shotwell/src/searches/SavedSearchPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_SAVED_SEARCH_PAGE, SavedSearchPage);
#line 42 "/shotwell/src/searches/SavedSearchPage.vala"
	_tmp0_ = config_facade_get_instance ();
#line 42 "/shotwell/src/searches/SavedSearchPage.vala"
	_tmp1_ = _tmp0_;
#line 42 "/shotwell/src/searches/SavedSearchPage.vala"
...
static void saved_search_page_real_init_collect_ui_filenames (Page* base, GeeList* ui_filenames) {
	...
	GeeList* _tmp0_;
	GeeList* _tmp1_;
#line 45 "/shotwell/src/searches/SavedSearchPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_SAVED_SEARCH_PAGE, SavedSearchPage);
#line 45 "/shotwell/src/searches/SavedSearchPage.vala"
	g_return_if_fail (GEE_IS_LIST (ui_filenames));
#line 46 "/shotwell/src/searches/SavedSearchPage.vala"
	_tmp0_ = ui_filenames;
#line 46 "/shotwell/src/searches/SavedSearchPage.vala"
...
#line 47 "/shotwell/src/searches/SavedSearchPage.vala"
	_tmp1_ = ui_filenames;
#line 47 "/shotwell/src/searches/SavedSearchPage.vala"
...
static void saved_search_page_real_add_actions (Page* base, GActionMap* map) {
	...
	GActionMap* _tmp0_;
	GActionMap* _tmp1_;
#line 56 "/shotwell/src/searches/SavedSearchPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_SAVED_SEARCH_PAGE, SavedSearchPage);
#line 56 "/shotwell/src/searches/SavedSearchPage.vala"
	g_return_if_fail (G_IS_ACTION_MAP (map));
#line 57 "/shotwell/src/searches/SavedSearchPage.vala"
	_tmp0_ = map;
#line 57 "/shotwell/src/searches/SavedSearchPage.vala"
...
#line 59 "/shotwell/src/searches/SavedSearchPage.vala"
	_tmp1_ = map;
#line 59 "/shotwell/src/searches/SavedSearchPage.vala"
...
static void saved_search_page_real_remove_actions (Page* base, GActionMap* map) {
	SavedSearchPage * self;
	GActionMap* _tmp0_;
#line 62 "/shotwell/src/searches/SavedSearchPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_SAVED_SEARCH_PAGE, SavedSearchPage);
#line 62 "/shotwell/src/searches/SavedSearchPage.vala"
	g_return_if_fail (G_IS_ACTION_MAP (map));
#line 63 "/shotwell/src/searches/SavedSearchPage.vala"
	_tmp0_ = map;
#line 63 "/shotwell/src/searches/SavedSearchPage.vala"
...
#line 1202 "SavedSearchPage.c"
	{
		...
		gint entry_it = 0;
#line 64 "/shotwell/src/searches/SavedSearchPage.vala"
...
#line 1218 "SavedSearchPage.c"
			{
				...
				GActionEntry _tmp2_;
				const gchar* _tmp3_;
#line 65 "/shotwell/src/searches/SavedSearchPage.vala"
				_tmp1_ = map;
#line 65 "/shotwell/src/searches/SavedSearchPage.vala"
				_tmp2_ = entry;
#line 65 "/shotwell/src/searches/SavedSearchPage.vala"
...
static void saved_search_page_on_delete_search (SavedSearchPage* self) {
	SavedSearch* _tmp0_;
	gboolean _tmp1_;
#line 70 "/shotwell/src/searches/SavedSearchPage.vala"
	g_return_if_fail (IS_SAVED_SEARCH_PAGE (self));
#line 71 "/shotwell/src/searches/SavedSearchPage.vala"
	_tmp0_ = self->priv->search;
#line 71 "/shotwell/src/searches/SavedSearchPage.vala"
...
#line 72 "/shotwell/src/searches/SavedSearchPage.vala"
...
static void saved_search_page_on_rename_search (SavedSearchPage* self) {
	...
	SavedSearch* _tmp2_;
#line 75 "/shotwell/src/searches/SavedSearchPage.vala"
	g_return_if_fail (IS_SAVED_SEARCH_PAGE (self));
#line 76 "/shotwell/src/searches/SavedSearchPage.vala"
...
#line 79 "/shotwell/src/searches/SavedSearchPage.vala"
	g_return_if_fail (IS_SAVED_SEARCH_PAGE (self));
#line 80 "/shotwell/src/searches/SavedSearchPage.vala"
	_tmp0_ = self->priv->search;
#line 80 "/shotwell/src/searches/SavedSearchPage.vala"
	_tmp1_ = saved_search_dialog_new_edit_existing (_tmp0_);
#line 80 "/shotwell/src/searches/SavedSearchPage.vala"
	ssd = _tmp1_;
#line 81 "/shotwell/src/searches/SavedSearchPage.vala"
...
#line 21 "/shotwell/src/searches/SavedSearchPage.vala"
...
#line 24 "/shotwell/src/searches/SavedSearchPage.vala"
	_g_object_unref0 (self->priv->search);
#line 21 "/shotwell/src/searches/SavedSearchPage.vala"
