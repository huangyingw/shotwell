/* Slideshow.c generated by valac 0.36.6, the Vala compiler
...
static void _vala_array_add33 (gchar** * array, int* length, int* size, gchar* value) {
#line 11 "/shotwell/src/slideshow/Slideshow.vala"
	if ((*length) == (*size)) {
#line 11 "/shotwell/src/slideshow/Slideshow.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 11 "/shotwell/src/slideshow/Slideshow.vala"
...
static void _vala_array_add34 (gchar** * array, int* length, int* size, gchar* value) {
#line 12 "/shotwell/src/slideshow/Slideshow.vala"
	if ((*length) == (*size)) {
#line 12 "/shotwell/src/slideshow/Slideshow.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 12 "/shotwell/src/slideshow/Slideshow.vala"
...
static void _vala_array_add35 (gchar** * array, int* length, int* size, gchar* value) {
#line 13 "/shotwell/src/slideshow/Slideshow.vala"
	if ((*length) == (*size)) {
#line 13 "/shotwell/src/slideshow/Slideshow.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 13 "/shotwell/src/slideshow/Slideshow.vala"
...
static void _vala_array_add36 (gchar** * array, int* length, int* size, gchar* value) {
#line 14 "/shotwell/src/slideshow/Slideshow.vala"
	if ((*length) == (*size)) {
#line 14 "/shotwell/src/slideshow/Slideshow.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 14 "/shotwell/src/slideshow/Slideshow.vala"
...
static void _vala_array_add37 (gchar** * array, int* length, int* size, gchar* value) {
#line 15 "/shotwell/src/slideshow/Slideshow.vala"
	if ((*length) == (*size)) {
#line 15 "/shotwell/src/slideshow/Slideshow.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 15 "/shotwell/src/slideshow/Slideshow.vala"
...
static void _vala_array_add38 (gchar** * array, int* length, int* size, gchar* value) {
#line 16 "/shotwell/src/slideshow/Slideshow.vala"
	if ((*length) == (*size)) {
#line 16 "/shotwell/src/slideshow/Slideshow.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 16 "/shotwell/src/slideshow/Slideshow.vala"
...
static void _vala_array_add39 (gchar** * array, int* length, int* size, gchar* value) {
#line 17 "/shotwell/src/slideshow/Slideshow.vala"
	if ((*length) == (*size)) {
#line 17 "/shotwell/src/slideshow/Slideshow.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 17 "/shotwell/src/slideshow/Slideshow.vala"
...
static void _vala_array_add40 (gchar** * array, int* length, int* size, gchar* value) {
#line 18 "/shotwell/src/slideshow/Slideshow.vala"
	if ((*length) == (*size)) {
#line 18 "/shotwell/src/slideshow/Slideshow.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 18 "/shotwell/src/slideshow/Slideshow.vala"
...
static void _vala_array_add41 (gchar** * array, int* length, int* size, gchar* value) {
#line 19 "/shotwell/src/slideshow/Slideshow.vala"
	if ((*length) == (*size)) {
#line 19 "/shotwell/src/slideshow/Slideshow.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 19 "/shotwell/src/slideshow/Slideshow.vala"
...
static void _vala_array_add42 (gchar** * array, int* length, int* size, gchar* value) {
#line 20 "/shotwell/src/slideshow/Slideshow.vala"
	if ((*length) == (*size)) {
#line 20 "/shotwell/src/slideshow/Slideshow.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 20 "/shotwell/src/slideshow/Slideshow.vala"
...
#line 10 "/shotwell/src/slideshow/Slideshow.vala"
...
#line 22 "/shotwell/src/slideshow/Slideshow.vala"
	_tmp21_ = core_ids;
#line 22 "/shotwell/src/slideshow/Slideshow.vala"
	_tmp21__length1 = core_ids_length1;
#line 22 "/shotwell/src/slideshow/Slideshow.vala"
	plugins_register_extension_point (SPIT_TRANSITIONS_TYPE_DESCRIPTOR, _ ("Slideshow Transitions"), RESOURCES_ICON_SLIDESHOW_EXTENSION_POINT, _tmp21_, _tmp21__length1);
#line 24 "/shotwell/src/slideshow/Slideshow.vala"
	transition_effects_manager_init ();
#line 9 "/shotwell/src/slideshow/Slideshow.vala"
	core_ids = (_vala_array_free (core_ids, core_ids_length1, (GDestroyNotify) g_free), NULL);
#line 346 "Slideshow.c"
}


void slideshow_terminate (void) {
#line 28 "/shotwell/src/slideshow/Slideshow.vala"
	transition_effects_manager_terminate ();
#line 353 "Slideshow.c"
}
