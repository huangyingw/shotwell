...
#line 12 "/shotwell/src/MediaViewTracker.vala"
	g_return_val_if_fail (IS_VIEW_COLLECTION (collection), NULL);
#line 13 "/shotwell/src/MediaViewTracker.vala"
	_tmp0_ = collection;
#line 13 "/shotwell/src/MediaViewTracker.vala"
	self = (MediaViewTracker*) core_view_tracker_construct (object_type, _tmp0_);
#line 15 "/shotwell/src/MediaViewTracker.vala"
	_tmp1_ = self->all;
#line 15 "/shotwell/src/MediaViewTracker.vala"
	_tmp2_ = self->visible;
#line 15 "/shotwell/src/MediaViewTracker.vala"
...
#line 7 "/shotwell/src/MediaViewTracker.vala"
...
static void media_view_tracker_instance_init (MediaViewTracker * self) {
	...
	MediaAccumulator* _tmp1_;
	MediaAccumulator* _tmp2_;
#line 8 "/shotwell/src/MediaViewTracker.vala"
	_tmp0_ = media_accumulator_new ();
#line 8 "/shotwell/src/MediaViewTracker.vala"
	self->all = _tmp0_;
#line 9 "/shotwell/src/MediaViewTracker.vala"
	_tmp1_ = media_accumulator_new ();
#line 9 "/shotwell/src/MediaViewTracker.vala"
	self->visible = _tmp1_;
#line 10 "/shotwell/src/MediaViewTracker.vala"
...
#line 31 "/shotwell/src/MediaViewTracker.vala"
...
static gboolean media_accumulator_real_include (CoreTrackerAccumulator* base, DataObject* object) {
	...
	Flaggable* _tmp20_;
#line 26 "/shotwell/src/MediaViewTracker.vala"
...
#line 31 "/shotwell/src/MediaViewTracker.vala"
	photo = _tmp4_;
#line 32 "/shotwell/src/MediaViewTracker.vala"
	_tmp5_ = photo;
#line 32 "/shotwell/src/MediaViewTracker.vala"
	if (_tmp5_ != NULL) {
...
#line 33 "/shotwell/src/MediaViewTracker.vala"
		_tmp6_ = photo;
#line 33 "/shotwell/src/MediaViewTracker.vala"
...
#line 502 "MediaViewTracker.c"
			gint _tmp8_;
#line 34 "/shotwell/src/MediaViewTracker.vala"
			_tmp8_ = self->raw;
#line 34 "/shotwell/src/MediaViewTracker.vala"
			self->raw = _tmp8_ + 1;
#line 508 "MediaViewTracker.c"
		}
#line 37 "/shotwell/src/MediaViewTracker.vala"
		_tmp10_ = photo;
#line 37 "/shotwell/src/MediaViewTracker.vala"
...
#line 518 "MediaViewTracker.c"
			...
			Photo* _tmp12_;
			gboolean _tmp13_;
#line 38 "/shotwell/src/MediaViewTracker.vala"
			_tmp12_ = photo;
#line 38 "/shotwell/src/MediaViewTracker.vala"
...
#line 532 "MediaViewTracker.c"
			gint _tmp14_;
#line 39 "/shotwell/src/MediaViewTracker.vala"
			_tmp14_ = self->photos;
#line 39 "/shotwell/src/MediaViewTracker.vala"
...
#line 538 "MediaViewTracker.c"
		...
		DataSource* _tmp15_;
#line 41 "/shotwell/src/MediaViewTracker.vala"
		_tmp15_ = source;
#line 41 "/shotwell/src/MediaViewTracker.vala"
		if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp15_, TYPE_VIDEO_SOURCE)) {
#line 546 "MediaViewTracker.c"
			gint _tmp16_;
#line 42 "/shotwell/src/MediaViewTracker.vala"
			_tmp16_ = self->videos;
#line 42 "/shotwell/src/MediaViewTracker.vala"
...
#line 582 "MediaViewTracker.c"
		gint _tmp23_;
#line 47 "/shotwell/src/MediaViewTracker.vala"
		_tmp23_ = self->flagged;
#line 47 "/shotwell/src/MediaViewTracker.vala"
		self->flagged = _tmp23_ + 1;
#line 588 "MediaViewTracker.c"
	}
#line 50 "/shotwell/src/MediaViewTracker.vala"
	result = TRUE;
#line 50 "/shotwell/src/MediaViewTracker.vala"
...
static gboolean media_accumulator_real_uninclude (CoreTrackerAccumulator* base, DataObject* object) {
	...
	Flaggable* _tmp33_;
#line 53 "/shotwell/src/MediaViewTracker.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_MEDIA_ACCUMULATOR, MediaAccumulator);
#line 53 "/shotwell/src/MediaViewTracker.vala"
	g_return_val_if_fail (IS_DATA_OBJECT (object), FALSE);
#line 54 "/shotwell/src/MediaViewTracker.vala"
	_tmp0_ = object;
#line 54 "/shotwell/src/MediaViewTracker.vala"
	_tmp1_ = data_view_get_source (G_TYPE_CHECK_INSTANCE_CAST (_tmp0_, TYPE_DATA_VIEW, DataView));
#line 54 "/shotwell/src/MediaViewTracker.vala"
	source = _tmp1_;
#line 56 "/shotwell/src/MediaViewTracker.vala"
	_tmp2_ = self->total;
#line 56 "/shotwell/src/MediaViewTracker.vala"
	if (_tmp2_ < 1) {
#line 635 "MediaViewTracker.c"
		...
		gchar* _tmp10_;
		gchar* _tmp11_;
#line 57 "/shotwell/src/MediaViewTracker.vala"
		_tmp3_ = object;
#line 57 "/shotwell/src/MediaViewTracker.vala"
...
#line 57 "/shotwell/src/MediaViewTracker.vala"
		_g_free0 (_tmp5_);
#line 59 "/shotwell/src/MediaViewTracker.vala"
		result = FALSE;
#line 59 "/shotwell/src/MediaViewTracker.vala"
		_g_object_unref0 (source);
#line 59 "/shotwell/src/MediaViewTracker.vala"
...
#line 61 "/shotwell/src/MediaViewTracker.vala"
	_tmp12_ = self->total;
#line 61 "/shotwell/src/MediaViewTracker.vala"
	self->total = _tmp12_ - 1;
#line 63 "/shotwell/src/MediaViewTracker.vala"
	_tmp13_ = source;
#line 63 "/shotwell/src/MediaViewTracker.vala"
	_tmp14_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp13_, TYPE_PHOTO) ? ((Photo*) _tmp13_) : NULL);
#line 63 "/shotwell/src/MediaViewTracker.vala"
	photo = _tmp14_;
#line 64 "/shotwell/src/MediaViewTracker.vala"
	_tmp15_ = photo;
#line 64 "/shotwell/src/MediaViewTracker.vala"
	if (_tmp15_ != NULL) {
...
#line 65 "/shotwell/src/MediaViewTracker.vala"
		_tmp16_ = photo;
#line 65 "/shotwell/src/MediaViewTracker.vala"
...
#line 705 "MediaViewTracker.c"
			gint _tmp18_;
			gint _tmp19_;
#line 66 "/shotwell/src/MediaViewTracker.vala"
			_tmp18_ = self->raw;
#line 66 "/shotwell/src/MediaViewTracker.vala"
			_vala_assert (_tmp18_ > 0, "raw > 0");
#line 67 "/shotwell/src/MediaViewTracker.vala"
			_tmp19_ = self->raw;
#line 67 "/shotwell/src/MediaViewTracker.vala"
			self->raw = _tmp19_ - 1;
#line 716 "MediaViewTracker.c"
		}
#line 70 "/shotwell/src/MediaViewTracker.vala"
		_tmp21_ = photo;
#line 70 "/shotwell/src/MediaViewTracker.vala"
...
#line 726 "MediaViewTracker.c"
			...
			Photo* _tmp23_;
			gboolean _tmp24_;
#line 71 "/shotwell/src/MediaViewTracker.vala"
			_tmp23_ = photo;
#line 71 "/shotwell/src/MediaViewTracker.vala"
...
#line 740 "MediaViewTracker.c"
			gint _tmp25_;
			gint _tmp26_;
#line 72 "/shotwell/src/MediaViewTracker.vala"
			_tmp25_ = self->photos;
#line 72 "/shotwell/src/MediaViewTracker.vala"
			_vala_assert (_tmp25_ > 0, "photos > 0");
#line 73 "/shotwell/src/MediaViewTracker.vala"
			_tmp26_ = self->photos;
#line 73 "/shotwell/src/MediaViewTracker.vala"
...
#line 751 "MediaViewTracker.c"
		...
		DataSource* _tmp27_;
#line 75 "/shotwell/src/MediaViewTracker.vala"
		_tmp27_ = source;
#line 75 "/shotwell/src/MediaViewTracker.vala"
...
#line 759 "MediaViewTracker.c"
			gint _tmp28_;
			gint _tmp29_;
#line 76 "/shotwell/src/MediaViewTracker.vala"
			_tmp28_ = self->videos;
#line 76 "/shotwell/src/MediaViewTracker.vala"
			_vala_assert (_tmp28_ > 0, "videos > 0");
#line 77 "/shotwell/src/MediaViewTracker.vala"
			_tmp29_ = self->videos;
#line 77 "/shotwell/src/MediaViewTracker.vala"
...
#line 800 "MediaViewTracker.c"
		gint _tmp36_;
		gint _tmp37_;
#line 82 "/shotwell/src/MediaViewTracker.vala"
		_tmp36_ = self->flagged;
#line 82 "/shotwell/src/MediaViewTracker.vala"
		_vala_assert (_tmp36_ > 0, "flagged > 0");
#line 83 "/shotwell/src/MediaViewTracker.vala"
		_tmp37_ = self->flagged;
#line 83 "/shotwell/src/MediaViewTracker.vala"
		self->flagged = _tmp37_ - 1;
#line 811 "MediaViewTracker.c"
	}
#line 87 "/shotwell/src/MediaViewTracker.vala"
	result = TRUE;
#line 87 "/shotwell/src/MediaViewTracker.vala"
	_g_object_unref0 (flaggable);
#line 87 "/shotwell/src/MediaViewTracker.vala"
...
static gboolean media_accumulator_real_altered (CoreTrackerAccumulator* base, DataObject* object, Alteration* alteration) {
	...
	Flaggable* _tmp6_;
	gboolean _tmp7_;
#line 90 "/shotwell/src/MediaViewTracker.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_MEDIA_ACCUMULATOR, MediaAccumulator);
#line 90 "/shotwell/src/MediaViewTracker.vala"
	g_return_val_if_fail (IS_DATA_OBJECT (object), FALSE);
#line 90 "/shotwell/src/MediaViewTracker.vala"
	g_return_val_if_fail (IS_ALTERATION (alteration), FALSE);
#line 93 "/shotwell/src/MediaViewTracker.vala"
	_tmp0_ = alteration;
#line 93 "/shotwell/src/MediaViewTracker.vala"
	_tmp1_ = alteration_has_detail (_tmp0_, "metadata", "flagged");
#line 93 "/shotwell/src/MediaViewTracker.vala"
	if (!_tmp1_) {
#line 94 "/shotwell/src/MediaViewTracker.vala"
		result = FALSE;
#line 94 "/shotwell/src/MediaViewTracker.vala"
		return result;
#line 855 "MediaViewTracker.c"
	}
#line 96 "/shotwell/src/MediaViewTracker.vala"
	_tmp2_ = object;
#line 96 "/shotwell/src/MediaViewTracker.vala"
...
#line 96 "/shotwell/src/MediaViewTracker.vala"
	flaggable = _tmp4_;
#line 97 "/shotwell/src/MediaViewTracker.vala"
	_tmp5_ = flaggable;
#line 97 "/shotwell/src/MediaViewTracker.vala"
	if (_tmp5_ == NULL) {
#line 98 "/shotwell/src/MediaViewTracker.vala"
		result = FALSE;
#line 98 "/shotwell/src/MediaViewTracker.vala"
		_g_object_unref0 (flaggable);
#line 98 "/shotwell/src/MediaViewTracker.vala"
...
#line 100 "/shotwell/src/MediaViewTracker.vala"
	_tmp6_ = flaggable;
#line 100 "/shotwell/src/MediaViewTracker.vala"
...
#line 889 "MediaViewTracker.c"
		gint _tmp8_;
#line 101 "/shotwell/src/MediaViewTracker.vala"
		_tmp8_ = self->flagged;
#line 101 "/shotwell/src/MediaViewTracker.vala"
...
#line 895 "MediaViewTracker.c"
		...
		gint _tmp9_;
		gint _tmp10_;
#line 103 "/shotwell/src/MediaViewTracker.vala"
		_tmp9_ = self->flagged;
#line 103 "/shotwell/src/MediaViewTracker.vala"
		_vala_assert (_tmp9_ > 0, "flagged > 0");
#line 104 "/shotwell/src/MediaViewTracker.vala"
		_tmp10_ = self->flagged;
#line 104 "/shotwell/src/MediaViewTracker.vala"
		self->flagged = _tmp10_ - 1;
#line 907 "MediaViewTracker.c"
	}
#line 107 "/shotwell/src/MediaViewTracker.vala"
	result = TRUE;
#line 107 "/shotwell/src/MediaViewTracker.vala"
	_g_object_unref0 (flaggable);
#line 107 "/shotwell/src/MediaViewTracker.vala"
...
gchar* media_accumulator_to_string (MediaAccumulator* self) {
	...
	gint _tmp3_;
	gchar* _tmp4_;
#line 110 "/shotwell/src/MediaViewTracker.vala"
	g_return_val_if_fail (IS_MEDIA_ACCUMULATOR (self), NULL);
#line 111 "/shotwell/src/MediaViewTracker.vala"
	_tmp0_ = self->photos;
#line 111 "/shotwell/src/MediaViewTracker.vala"
	_tmp1_ = self->videos;
#line 111 "/shotwell/src/MediaViewTracker.vala"
...
#line 19 "/shotwell/src/MediaViewTracker.vala"
...
#line 20 "/shotwell/src/MediaViewTracker.vala"
	self->total = 0;
#line 21 "/shotwell/src/MediaViewTracker.vala"
	self->photos = 0;
#line 22 "/shotwell/src/MediaViewTracker.vala"
	self->videos = 0;
#line 23 "/shotwell/src/MediaViewTracker.vala"
	self->raw = 0;
#line 24 "/shotwell/src/MediaViewTracker.vala"
	self->flagged = 0;
