...
static void _library_trash_sidebar_entry_on_trashcan_contents_altered_media_source_collection_trashcan_contents_altered (MediaSourceCollection* _sender, GeeCollection* added, GeeCollection* removed, gpointer self) {
#line 16 "/shotwell/src/library/TrashSidebarEntry.vala"
...
#line 9 "/shotwell/src/library/TrashSidebarEntry.vala"
...
#line 400 "TrashSidebarEntry.c"
	{
		...
		GeeIterator* _tmp4_;
		GeeIterator* _tmp5_;
#line 10 "/shotwell/src/library/TrashSidebarEntry.vala"
...
#line 11 "/shotwell/src/library/TrashSidebarEntry.vala"
...
static gchar* library_trash_sidebar_entry_real_get_sidebar_name (SidebarSimplePageEntry* base) {
	...
	gchar* result = NULL;
	gchar* _tmp0_;
#line 25 "/shotwell/src/library/TrashSidebarEntry.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, LIBRARY_TYPE_TRASH_SIDEBAR_ENTRY, LibraryTrashSidebarEntry);
#line 26 "/shotwell/src/library/TrashSidebarEntry.vala"
...
static gchar* library_trash_sidebar_entry_real_get_sidebar_icon (SidebarSimplePageEntry* base) {
	...
	gchar* result = NULL;
	gchar* _tmp0_;
#line 29 "/shotwell/src/library/TrashSidebarEntry.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, LIBRARY_TYPE_TRASH_SIDEBAR_ENTRY, LibraryTrashSidebarEntry);
#line 30 "/shotwell/src/library/TrashSidebarEntry.vala"
...
static gchar* library_trash_sidebar_entry_get_current_icon (void) {
	...
	gchar* _tmp13_;
	{
		...
		GeeIterator* _tmp4_;
		GeeIterator* _tmp5_;
#line 34 "/shotwell/src/library/TrashSidebarEntry.vala"
		_tmp0_ = media_collection_registry_get_instance ();
#line 34 "/shotwell/src/library/TrashSidebarEntry.vala"
		_tmp1_ = _tmp0_;
#line 34 "/shotwell/src/library/TrashSidebarEntry.vala"
...
#line 34 "/shotwell/src/library/TrashSidebarEntry.vala"
			media_sources = (MediaSourceCollection*) _tmp9_;
#line 35 "/shotwell/src/library/TrashSidebarEntry.vala"
			_tmp10_ = media_sources;
#line 35 "/shotwell/src/library/TrashSidebarEntry.vala"
...
#line 578 "TrashSidebarEntry.c"
				gchar* _tmp12_;
#line 36 "/shotwell/src/library/TrashSidebarEntry.vala"
...
#line 39 "/shotwell/src/library/TrashSidebarEntry.vala"
...
#line 42 "/shotwell/src/library/TrashSidebarEntry.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, LIBRARY_TYPE_TRASH_SIDEBAR_ENTRY, LibraryTrashSidebarEntry);
#line 42 "/shotwell/src/library/TrashSidebarEntry.vala"
	g_return_val_if_fail (GEE_IS_LIST (media), FALSE);
#line 43 "/shotwell/src/library/TrashSidebarEntry.vala"
...
#line 45 "/shotwell/src/library/TrashSidebarEntry.vala"
	result = TRUE;
#line 45 "/shotwell/src/library/TrashSidebarEntry.vala"
	return result;
...
static gboolean library_trash_sidebar_entry_real_internal_drop_received_arbitrary (SidebarInternalDropTargetEntry* base, GtkSelectionData* data) {
	LibraryTrashSidebarEntry * self;
	gboolean result = FALSE;
#line 48 "/shotwell/src/library/TrashSidebarEntry.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, LIBRARY_TYPE_TRASH_SIDEBAR_ENTRY, LibraryTrashSidebarEntry);
#line 48 "/shotwell/src/library/TrashSidebarEntry.vala"
	g_return_val_if_fail (data != NULL, FALSE);
#line 49 "/shotwell/src/library/TrashSidebarEntry.vala"
	result = FALSE;
#line 49 "/shotwell/src/library/TrashSidebarEntry.vala"
	return result;
...
static Page* library_trash_sidebar_entry_real_create_page (SidebarSimplePageEntry* base) {
	...
	Page* result = NULL;
	TrashPage* _tmp0_;
#line 52 "/shotwell/src/library/TrashSidebarEntry.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, LIBRARY_TYPE_TRASH_SIDEBAR_ENTRY, LibraryTrashSidebarEntry);
#line 53 "/shotwell/src/library/TrashSidebarEntry.vala"
...
static void library_trash_sidebar_entry_on_trashcan_contents_altered (LibraryTrashSidebarEntry* self) {
	gchar* _tmp0_;
	gchar* _tmp1_;
#line 56 "/shotwell/src/library/TrashSidebarEntry.vala"
	g_return_if_fail (LIBRARY_IS_TRASH_SIDEBAR_ENTRY (self));
#line 57 "/shotwell/src/library/TrashSidebarEntry.vala"
	_tmp0_ = library_trash_sidebar_entry_get_current_icon ();
#line 57 "/shotwell/src/library/TrashSidebarEntry.vala"
	_tmp1_ = _tmp0_;
#line 57 "/shotwell/src/library/TrashSidebarEntry.vala"
...
#line 7 "/shotwell/src/library/TrashSidebarEntry.vala"
...
#line 730 "TrashSidebarEntry.c"
	{
		...
		GeeIterator* _tmp4_;
		GeeIterator* _tmp5_;
#line 15 "/shotwell/src/library/TrashSidebarEntry.vala"
		_tmp0_ = media_collection_registry_get_instance ();
#line 15 "/shotwell/src/library/TrashSidebarEntry.vala"
		_tmp1_ = _tmp0_;
#line 15 "/shotwell/src/library/TrashSidebarEntry.vala"
