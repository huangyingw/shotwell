...
static void _library_last_import_sidebar_entry_on_import_rolls_altered_media_source_collection_import_roll_altered (MediaSourceCollection* _sender, gpointer self) {
#line 17 "/shotwell/src/library/LastImportSidebarEntry.vala"
...
LibraryLastImportSidebarEntry* library_last_import_sidebar_entry_construct (GType object_type) {
	...
	ImportID* _tmp13_;
	ImportID* _tmp14_;
#line 8 "/shotwell/src/library/LastImportSidebarEntry.vala"
...
#line 337 "LastImportSidebarEntry.c"
	{
		...
		GeeIterator* _tmp4_;
		GeeIterator* _tmp5_;
#line 9 "/shotwell/src/library/LastImportSidebarEntry.vala"
...
#line 10 "/shotwell/src/library/LastImportSidebarEntry.vala"
...
#line 12 "/shotwell/src/library/LastImportSidebarEntry.vala"
...
static gchar* library_last_import_sidebar_entry_real_get_sidebar_name (SidebarSimplePageEntry* base) {
	...
	gchar* result = NULL;
	gchar* _tmp0_;
#line 20 "/shotwell/src/library/LastImportSidebarEntry.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, LIBRARY_TYPE_LAST_IMPORT_SIDEBAR_ENTRY, LibraryLastImportSidebarEntry);
#line 21 "/shotwell/src/library/LastImportSidebarEntry.vala"
...
static gchar* library_last_import_sidebar_entry_real_get_sidebar_icon (SidebarSimplePageEntry* base) {
	...
	gchar* result = NULL;
	gchar* _tmp0_;
#line 24 "/shotwell/src/library/LastImportSidebarEntry.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, LIBRARY_TYPE_LAST_IMPORT_SIDEBAR_ENTRY, LibraryLastImportSidebarEntry);
#line 25 "/shotwell/src/library/LastImportSidebarEntry.vala"
...
#line 28 "/shotwell/src/library/LastImportSidebarEntry.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, LIBRARY_TYPE_LAST_IMPORT_SIDEBAR_ENTRY, LibraryLastImportSidebarEntry);
#line 29 "/shotwell/src/library/LastImportSidebarEntry.vala"
...
static void library_last_import_sidebar_entry_on_import_rolls_altered (LibraryLastImportSidebarEntry* self) {
	...
	ImportID* _tmp2_;
	ImportID* _tmp3_;
#line 32 "/shotwell/src/library/LastImportSidebarEntry.vala"
	g_return_if_fail (LIBRARY_IS_LAST_IMPORT_SIDEBAR_ENTRY (self));
#line 33 "/shotwell/src/library/LastImportSidebarEntry.vala"
	_tmp0_ = media_collection_registry_get_instance ();
#line 33 "/shotwell/src/library/LastImportSidebarEntry.vala"
	_tmp1_ = _tmp0_;
#line 33 "/shotwell/src/library/LastImportSidebarEntry.vala"
...
#line 7 "/shotwell/src/library/LastImportSidebarEntry.vala"
...
#line 526 "LastImportSidebarEntry.c"
	{
		...
		GeeIterator* _tmp4_;
		GeeIterator* _tmp5_;
#line 16 "/shotwell/src/library/LastImportSidebarEntry.vala"
		_tmp0_ = media_collection_registry_get_instance ();
#line 16 "/shotwell/src/library/LastImportSidebarEntry.vala"
		_tmp1_ = _tmp0_;
#line 16 "/shotwell/src/library/LastImportSidebarEntry.vala"
