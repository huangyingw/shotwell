...
#line 30 "/shotwell/src/library/Branch.vala"
	return result;
#line 1000 "Branch.c"
}
...
static void _library_branch_on_flagged_visibility_changed_library_hideable_page_entry_visibility_changed (LibraryHideablePageEntry* _sender, gboolean visible, gpointer self) {
#line 43 "/shotwell/src/library/Branch.vala"
...
static void _library_branch_on_last_imported_visibility_changed_library_hideable_page_entry_visibility_changed (LibraryHideablePageEntry* _sender, gboolean visible, gpointer self) {
#line 46 "/shotwell/src/library/Branch.vala"
...
static void _library_branch_on_import_queue_visibility_changed_library_hideable_page_entry_visibility_changed (LibraryHideablePageEntry* _sender, gboolean visible, gpointer self) {
#line 49 "/shotwell/src/library/Branch.vala"
...
static void _library_branch_on_offline_visibility_changed_library_hideable_page_entry_visibility_changed (LibraryHideablePageEntry* _sender, gboolean visible, gpointer self) {
#line 52 "/shotwell/src/library/Branch.vala"
...
#line 33 "/shotwell/src/library/Branch.vala"
...
#line 34 "/shotwell/src/library/Branch.vala"
...
#line 35 "/shotwell/src/library/Branch.vala"
...
#line 36 "/shotwell/src/library/Branch.vala"
...
#line 37 "/shotwell/src/library/Branch.vala"
...
#line 38 "/shotwell/src/library/Branch.vala"
...
#line 40 "/shotwell/src/library/Branch.vala"
...
#line 41 "/shotwell/src/library/Branch.vala"
...
#line 44 "/shotwell/src/library/Branch.vala"
...
#line 47 "/shotwell/src/library/Branch.vala"
...
#line 50 "/shotwell/src/library/Branch.vala"
...
#line 53 "/shotwell/src/library/Branch.vala"
	library_branch_on_offline_visibility_changed (self);
#line 29 "/shotwell/src/library/Branch.vala"
	return self;
#line 1144 "Branch.c"
}
...
static void library_branch_insert (LibraryBranch* self, SidebarEntry* entry, gint position) {
	...
	SidebarEntry* _tmp3_;
	SidebarEntry* _tmp4_;
#line 56 "/shotwell/src/library/Branch.vala"
	g_return_if_fail (LIBRARY_IS_BRANCH (self));
#line 56 "/shotwell/src/library/Branch.vala"
	g_return_if_fail (SIDEBAR_IS_ENTRY (entry));
#line 57 "/shotwell/src/library/Branch.vala"
	_tmp0_ = entry;
#line 57 "/shotwell/src/library/Branch.vala"
	_tmp1_ = position;
#line 57 "/shotwell/src/library/Branch.vala"
...
#line 58 "/shotwell/src/library/Branch.vala"
...
#line 61 "/shotwell/src/library/Branch.vala"
	g_return_if_fail (LIBRARY_IS_BRANCH (self));
#line 62 "/shotwell/src/library/Branch.vala"
...
#line 65 "/shotwell/src/library/Branch.vala"
	g_return_if_fail (LIBRARY_IS_BRANCH (self));
#line 66 "/shotwell/src/library/Branch.vala"
...
#line 69 "/shotwell/src/library/Branch.vala"
	g_return_if_fail (LIBRARY_IS_BRANCH (self));
#line 70 "/shotwell/src/library/Branch.vala"
...
#line 73 "/shotwell/src/library/Branch.vala"
	g_return_if_fail (LIBRARY_IS_BRANCH (self));
#line 74 "/shotwell/src/library/Branch.vala"
...
static void library_branch_update_entry_visibility (LibraryBranch* self, LibraryHideablePageEntry* entry, gint position) {
	...
	gboolean _tmp1_;
	gboolean _tmp2_;
#line 77 "/shotwell/src/library/Branch.vala"
	g_return_if_fail (LIBRARY_IS_BRANCH (self));
#line 77 "/shotwell/src/library/Branch.vala"
	g_return_if_fail (LIBRARY_IS_HIDEABLE_PAGE_ENTRY (entry));
#line 78 "/shotwell/src/library/Branch.vala"
	_tmp0_ = entry;
#line 78 "/shotwell/src/library/Branch.vala"
...
#line 1249 "Branch.c"
		...
		gboolean _tmp4_;
#line 79 "/shotwell/src/library/Branch.vala"
		_tmp3_ = entry;
#line 79 "/shotwell/src/library/Branch.vala"
...
#line 1258 "Branch.c"
			...
			gint _tmp6_;
#line 80 "/shotwell/src/library/Branch.vala"
			_tmp5_ = entry;
#line 80 "/shotwell/src/library/Branch.vala"
			_tmp6_ = position;
#line 80 "/shotwell/src/library/Branch.vala"
...
#line 1267 "Branch.c"
		...
		gboolean _tmp8_;
#line 81 "/shotwell/src/library/Branch.vala"
		_tmp7_ = entry;
#line 81 "/shotwell/src/library/Branch.vala"
...
#line 82 "/shotwell/src/library/Branch.vala"
			_tmp9_ = entry;
#line 82 "/shotwell/src/library/Branch.vala"
...
#line 10 "/shotwell/src/library/Branch.vala"
...
LibraryFlaggedSidebarEntry* library_branch_get_flagged_entry (LibraryBranch* self) {
	...
	LibraryFlaggedSidebarEntry* _tmp0_;
#line 11 "/shotwell/src/library/Branch.vala"
	g_return_val_if_fail (LIBRARY_IS_BRANCH (self), NULL);
#line 11 "/shotwell/src/library/Branch.vala"
	_tmp0_ = self->priv->_flagged_entry;
#line 11 "/shotwell/src/library/Branch.vala"
...
LibraryLastImportSidebarEntry* library_branch_get_last_imported_entry (LibraryBranch* self) {
	...
	LibraryLastImportSidebarEntry* _tmp0_;
#line 12 "/shotwell/src/library/Branch.vala"
	g_return_val_if_fail (LIBRARY_IS_BRANCH (self), NULL);
#line 12 "/shotwell/src/library/Branch.vala"
	_tmp0_ = self->priv->_last_imported_entry;
#line 12 "/shotwell/src/library/Branch.vala"
...
LibraryImportQueueSidebarEntry* library_branch_get_import_queue_entry (LibraryBranch* self) {
	...
	LibraryImportQueueSidebarEntry* _tmp0_;
#line 13 "/shotwell/src/library/Branch.vala"
	g_return_val_if_fail (LIBRARY_IS_BRANCH (self), NULL);
#line 13 "/shotwell/src/library/Branch.vala"
	_tmp0_ = self->priv->_import_queue_entry;
#line 13 "/shotwell/src/library/Branch.vala"
...
LibraryOfflineSidebarEntry* library_branch_get_offline_entry (LibraryBranch* self) {
	...
	LibraryOfflineSidebarEntry* _tmp0_;
#line 14 "/shotwell/src/library/Branch.vala"
	g_return_val_if_fail (LIBRARY_IS_BRANCH (self), NULL);
#line 14 "/shotwell/src/library/Branch.vala"
	_tmp0_ = self->priv->_offline_entry;
#line 14 "/shotwell/src/library/Branch.vala"
...
#line 15 "/shotwell/src/library/Branch.vala"
	g_return_val_if_fail (LIBRARY_IS_BRANCH (self), NULL);
#line 15 "/shotwell/src/library/Branch.vala"
...
#line 7 "/shotwell/src/library/Branch.vala"
...
#line 93 "/shotwell/src/library/Branch.vala"
...
static gchar* library_photos_entry_real_get_sidebar_icon (SidebarSimplePageEntry* base) {
	...
	gchar* result = NULL;
	gchar* _tmp0_;
#line 100 "/shotwell/src/library/Branch.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, LIBRARY_TYPE_PHOTOS_ENTRY, LibraryPhotosEntry);
#line 101 "/shotwell/src/library/Branch.vala"
...
#line 104 "/shotwell/src/library/Branch.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, LIBRARY_TYPE_PHOTOS_ENTRY, LibraryPhotosEntry);
#line 105 "/shotwell/src/library/Branch.vala"
...
#line 91 "/shotwell/src/library/Branch.vala"
...
#line 125 "/shotwell/src/library/Branch.vala"
...
gboolean library_hideable_page_entry_get_visible (LibraryHideablePageEntry* self) {
	gboolean result;
	gboolean _tmp0_;
#line 115 "/shotwell/src/library/Branch.vala"
...
void library_hideable_page_entry_set_visible (LibraryHideablePageEntry* self, gboolean value) {
	...
	gboolean _tmp2_;
	gboolean _tmp3_;
#line 116 "/shotwell/src/library/Branch.vala"
	g_return_if_fail (LIBRARY_IS_HIDEABLE_PAGE_ENTRY (self));
#line 117 "/shotwell/src/library/Branch.vala"
	_tmp0_ = value;
#line 117 "/shotwell/src/library/Branch.vala"
	_tmp1_ = self->priv->show_entry;
#line 117 "/shotwell/src/library/Branch.vala"
	if (_tmp0_ == _tmp1_) {
#line 118 "/shotwell/src/library/Branch.vala"
		return;
#line 1859 "Branch.c"
	}
#line 120 "/shotwell/src/library/Branch.vala"
	_tmp2_ = value;
#line 120 "/shotwell/src/library/Branch.vala"
	self->priv->show_entry = _tmp2_;
#line 121 "/shotwell/src/library/Branch.vala"
	_tmp3_ = value;
#line 121 "/shotwell/src/library/Branch.vala"
...
#line 109 "/shotwell/src/library/Branch.vala"
...
#line 113 "/shotwell/src/library/Branch.vala"
...
#line 133 "/shotwell/src/library/Branch.vala"
...
#line 1973 "Branch.c"
	{
		...
		GeeIterator* _tmp4_;
		GeeIterator* _tmp5_;
#line 135 "/shotwell/src/library/Branch.vala"
...
#line 136 "/shotwell/src/library/Branch.vala"
...
#line 132 "/shotwell/src/library/Branch.vala"
	return self;
#line 2067 "Branch.c"
}
...
static void library_main_page_real_get_config_photos_sort (MediaPage* base, gboolean* sort_order, gint* sort_by) {
	...
	gint _tmp3_ = 0;
#line 139 "/shotwell/src/library/Branch.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, LIBRARY_TYPE_MAIN_PAGE, LibraryMainPage);
#line 140 "/shotwell/src/library/Branch.vala"
...
static void library_main_page_real_set_config_photos_sort (MediaPage* base, gboolean sort_order, gint sort_by) {
	...
	gboolean _tmp2_;
	gint _tmp3_;
#line 143 "/shotwell/src/library/Branch.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, LIBRARY_TYPE_MAIN_PAGE, LibraryMainPage);
#line 144 "/shotwell/src/library/Branch.vala"
	_tmp0_ = config_facade_get_instance ();
#line 144 "/shotwell/src/library/Branch.vala"
	_tmp1_ = _tmp0_;
#line 144 "/shotwell/src/library/Branch.vala"
...
#line 129 "/shotwell/src/library/Branch.vala"
