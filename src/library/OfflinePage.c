...
static void _offline_page_on_offline_contents_altered_media_source_collection_offline_contents_altered (MediaSourceCollection* _sender, GeeCollection* added, GeeCollection* removed, gpointer self) {
#line 45 "/shotwell/src/library/OfflinePage.vala"
...
static void _offline_page_on_remove_from_library_gsimple_action_activate_callback (GSimpleAction* action, GVariant* parameter, gpointer self) {
#line 55 "/shotwell/src/library/OfflinePage.vala"
...
#line 29 "/shotwell/src/library/OfflinePage.vala"
	self = (OfflinePage*) checkerboard_page_construct (object_type, OFFLINE_PAGE_NAME);
#line 31 "/shotwell/src/library/OfflinePage.vala"
...
#line 32 "/shotwell/src/library/OfflinePage.vala"
	page_init_toolbar (G_TYPE_CHECK_INSTANCE_CAST (self, TYPE_PAGE, Page), "OfflineToolbar");
#line 34 "/shotwell/src/library/OfflinePage.vala"
...
#line 37 "/shotwell/src/library/OfflinePage.vala"
...
#line 38 "/shotwell/src/library/OfflinePage.vala"
	_tmp4_ = video_global;
#line 38 "/shotwell/src/library/OfflinePage.vala"
...
#line 40 "/shotwell/src/library/OfflinePage.vala"
...
#line 41 "/shotwell/src/library/OfflinePage.vala"
	_tmp8_ = video_global;
#line 41 "/shotwell/src/library/OfflinePage.vala"
...
#line 28 "/shotwell/src/library/OfflinePage.vala"
	return self;
...
#line 52 "/shotwell/src/library/OfflinePage.vala"
	_tmp1_ = ui_filenames;
#line 52 "/shotwell/src/library/OfflinePage.vala"
...
static void offline_page_real_add_actions (Page* base, GActionMap* map) {
	...
	GActionMap* _tmp0_;
	GActionMap* _tmp1_;
#line 59 "/shotwell/src/library/OfflinePage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_OFFLINE_PAGE, OfflinePage);
#line 59 "/shotwell/src/library/OfflinePage.vala"
	g_return_if_fail (G_IS_ACTION_MAP (map));
#line 60 "/shotwell/src/library/OfflinePage.vala"
	_tmp0_ = map;
#line 60 "/shotwell/src/library/OfflinePage.vala"
...
#line 62 "/shotwell/src/library/OfflinePage.vala"
	_tmp1_ = map;
#line 62 "/shotwell/src/library/OfflinePage.vala"
...
static void offline_page_real_remove_actions (Page* base, GActionMap* map) {
	OfflinePage * self;
	GActionMap* _tmp0_;
#line 65 "/shotwell/src/library/OfflinePage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_OFFLINE_PAGE, OfflinePage);
#line 65 "/shotwell/src/library/OfflinePage.vala"
	g_return_if_fail (G_IS_ACTION_MAP (map));
#line 66 "/shotwell/src/library/OfflinePage.vala"
	_tmp0_ = map;
#line 66 "/shotwell/src/library/OfflinePage.vala"
...
#line 1002 "OfflinePage.c"
	{
		...
		gint entry_it = 0;
#line 67 "/shotwell/src/library/OfflinePage.vala"
...
#line 1018 "OfflinePage.c"
			{
				...
				GActionEntry _tmp2_;
				const gchar* _tmp3_;
#line 68 "/shotwell/src/library/OfflinePage.vala"
				_tmp1_ = map;
#line 68 "/shotwell/src/library/OfflinePage.vala"
				_tmp2_ = entry;
#line 68 "/shotwell/src/library/OfflinePage.vala"
...
#line 73 "/shotwell/src/library/OfflinePage.vala"
...
#line 72 "/shotwell/src/library/OfflinePage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_OFFLINE_PAGE, OfflinePage);
#line 73 "/shotwell/src/library/OfflinePage.vala"
...
static void offline_page_real_update_actions (Page* base, gint selected_count, gint count) {
	...
	gint _tmp1_;
	gint _tmp2_;
#line 76 "/shotwell/src/library/OfflinePage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_OFFLINE_PAGE, OfflinePage);
#line 77 "/shotwell/src/library/OfflinePage.vala"
	_tmp0_ = selected_count;
#line 77 "/shotwell/src/library/OfflinePage.vala"
	page_set_action_sensitive (G_TYPE_CHECK_INSTANCE_CAST (self, TYPE_PAGE, Page), "RemoveFromLibrary", _tmp0_ > 0);
#line 79 "/shotwell/src/library/OfflinePage.vala"
...
#line 82 "/shotwell/src/library/OfflinePage.vala"
...
#line 84 "/shotwell/src/library/OfflinePage.vala"
	_tmp0_ = added;
#line 84 "/shotwell/src/library/OfflinePage.vala"
	if (_tmp0_ != NULL) {
#line 1098 "OfflinePage.c"
		{
			...
			GeeIterator* _tmp2_;
#line 85 "/shotwell/src/library/OfflinePage.vala"
			_tmp1_ = added;
#line 85 "/shotwell/src/library/OfflinePage.vala"
...
#line 86 "/shotwell/src/library/OfflinePage.vala"
...
#line 89 "/shotwell/src/library/OfflinePage.vala"
	_tmp12_ = removed;
#line 89 "/shotwell/src/library/OfflinePage.vala"
	if (_tmp12_ != NULL) {
#line 1167 "OfflinePage.c"
		...
		Marker* _tmp31_;
#line 90 "/shotwell/src/library/OfflinePage.vala"
...
#line 1188 "OfflinePage.c"
		{
			...
			GeeIterator* _tmp18_;
#line 91 "/shotwell/src/library/OfflinePage.vala"
			_tmp17_ = removed;
#line 91 "/shotwell/src/library/OfflinePage.vala"
...
#line 92 "/shotwell/src/library/OfflinePage.vala"
				_tmp23_ = marker;
#line 92 "/shotwell/src/library/OfflinePage.vala"
...
#line 93 "/shotwell/src/library/OfflinePage.vala"
...
#line 117 "/shotwell/src/library/OfflinePage.vala"
	return result;
...
static void offline_page_on_remove_from_library (OfflinePage* self) {
	...
	AppWindow* _tmp40_;
	AppWindow* _tmp41_;
#line 97 "/shotwell/src/library/OfflinePage.vala"
	g_return_if_fail (IS_OFFLINE_PAGE (self));
#line 98 "/shotwell/src/library/OfflinePage.vala"
	_tmp0_ = page_get_view (G_TYPE_CHECK_INSTANCE_CAST (self, TYPE_PAGE, Page));
#line 98 "/shotwell/src/library/OfflinePage.vala"
	_tmp1_ = _tmp0_;
#line 98 "/shotwell/src/library/OfflinePage.vala"
...
#line 98 "/shotwell/src/library/OfflinePage.vala"
	sources = _tmp3_;
#line 100 "/shotwell/src/library/OfflinePage.vala"
	_tmp4_ = sources;
#line 100 "/shotwell/src/library/OfflinePage.vala"
...
#line 100 "/shotwell/src/library/OfflinePage.vala"
	if (_tmp6_ == 0) {
#line 101 "/shotwell/src/library/OfflinePage.vala"
		_g_object_unref0 (sources);
#line 101 "/shotwell/src/library/OfflinePage.vala"
		return;
#line 1340 "OfflinePage.c"
	}
#line 103 "/shotwell/src/library/OfflinePage.vala"
...
#line 103 "/shotwell/src/library/OfflinePage.vala"
	if (_tmp13_) {
#line 104 "/shotwell/src/library/OfflinePage.vala"
		_g_object_unref0 (sources);
#line 104 "/shotwell/src/library/OfflinePage.vala"
		return;
#line 1364 "OfflinePage.c"
	}
#line 106 "/shotwell/src/library/OfflinePage.vala"
...
#line 108 "/shotwell/src/library/OfflinePage.vala"
	progress = NULL;
#line 109 "/shotwell/src/library/OfflinePage.vala"
	_tmp16_ = sources;
#line 109 "/shotwell/src/library/OfflinePage.vala"
...
#line 110 "/shotwell/src/library/OfflinePage.vala"
...
#line 116 "/shotwell/src/library/OfflinePage.vala"
	_tmp27_ = progress;
#line 116 "/shotwell/src/library/OfflinePage.vala"
	if (_tmp27_ != NULL) {
...
#line 118 "/shotwell/src/library/OfflinePage.vala"
...
#line 120 "/shotwell/src/library/OfflinePage.vala"
...
#line 121 "/shotwell/src/library/OfflinePage.vala"
...
#line 124 "/shotwell/src/library/OfflinePage.vala"
	_tmp38_ = progress;
#line 124 "/shotwell/src/library/OfflinePage.vala"
	if (_tmp38_ != NULL) {
#line 1471 "OfflinePage.c"
		ProgressDialog* _tmp39_;
#line 125 "/shotwell/src/library/OfflinePage.vala"
		_tmp39_ = progress;
#line 125 "/shotwell/src/library/OfflinePage.vala"
		progress_dialog_close (_tmp39_);
#line 1477 "OfflinePage.c"
	}
#line 127 "/shotwell/src/library/OfflinePage.vala"
...
#line 131 "/shotwell/src/library/OfflinePage.vala"
...
#line 130 "/shotwell/src/library/OfflinePage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_OFFLINE_PAGE, OfflinePage);
#line 131 "/shotwell/src/library/OfflinePage.vala"
...
static OfflinePageOfflineView* offline_page_offline_view_construct (GType object_type, MediaSource* source) {
	...
	MediaSource* _tmp3_;
	gboolean _tmp4_;
#line 11 "/shotwell/src/library/OfflinePage.vala"
	g_return_val_if_fail (IS_MEDIA_SOURCE (source), NULL);
#line 12 "/shotwell/src/library/OfflinePage.vala"
	_tmp0_ = source;
#line 12 "/shotwell/src/library/OfflinePage.vala"
...
#line 14 "/shotwell/src/library/OfflinePage.vala"
	_tmp3_ = source;
#line 14 "/shotwell/src/library/OfflinePage.vala"
...
#line 10 "/shotwell/src/library/OfflinePage.vala"
...
#line 18 "/shotwell/src/library/OfflinePage.vala"
...
#line 7 "/shotwell/src/library/OfflinePage.vala"
...
#line 25 "/shotwell/src/library/OfflinePage.vala"
...
#line 46 "/shotwell/src/library/OfflinePage.vala"
	_tmp2_ = video_global;
#line 46 "/shotwell/src/library/OfflinePage.vala"
...
#line 26 "/shotwell/src/library/OfflinePage.vala"
	_core_tracker_unref0 (self->priv->tracker);
#line 7 "/shotwell/src/library/OfflinePage.vala"
