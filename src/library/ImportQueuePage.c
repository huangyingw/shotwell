...
static void _import_queue_page_on_stop_gsimple_action_activate_callback (GSimpleAction* action, GVariant* parameter, gpointer self) {
#line 62 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 47 "/shotwell/src/library/ImportQueuePage.vala"
	_tmp5_ = self->priv->progress_bar;
#line 47 "/shotwell/src/library/ImportQueuePage.vala"
	gtk_progress_bar_set_show_text (_tmp5_, TRUE);
#line 49 "/shotwell/src/library/ImportQueuePage.vala"
	gtk_toolbar_insert (toolbar, progress_item, -1);
#line 24 "/shotwell/src/library/ImportQueuePage.vala"
...
static void import_queue_page_real_add_actions (Page* base, GActionMap* map) {
	...
	GActionMap* _tmp0_;
	GActionMap* _tmp1_;
#line 66 "/shotwell/src/library/ImportQueuePage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_IMPORT_QUEUE_PAGE, ImportQueuePage);
#line 66 "/shotwell/src/library/ImportQueuePage.vala"
	g_return_if_fail (G_IS_ACTION_MAP (map));
#line 67 "/shotwell/src/library/ImportQueuePage.vala"
	_tmp0_ = map;
#line 67 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 69 "/shotwell/src/library/ImportQueuePage.vala"
	_tmp1_ = map;
#line 69 "/shotwell/src/library/ImportQueuePage.vala"
...
static void import_queue_page_real_remove_actions (Page* base, GActionMap* map) {
	ImportQueuePage * self;
	GActionMap* _tmp0_;
#line 72 "/shotwell/src/library/ImportQueuePage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_IMPORT_QUEUE_PAGE, ImportQueuePage);
#line 72 "/shotwell/src/library/ImportQueuePage.vala"
	g_return_if_fail (G_IS_ACTION_MAP (map));
#line 73 "/shotwell/src/library/ImportQueuePage.vala"
	_tmp0_ = map;
#line 73 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 696 "ImportQueuePage.c"
	{
		...
		gint entry_it = 0;
#line 74 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 712 "ImportQueuePage.c"
			{
				...
				GActionEntry _tmp2_;
				const gchar* _tmp3_;
#line 75 "/shotwell/src/library/ImportQueuePage.vala"
				_tmp1_ = map;
#line 75 "/shotwell/src/library/ImportQueuePage.vala"
				_tmp2_ = entry;
#line 75 "/shotwell/src/library/ImportQueuePage.vala"
...
static void _import_queue_page_on_starting_batch_import_starting (BatchImport* _sender, gpointer self) {
#line 82 "/shotwell/src/library/ImportQueuePage.vala"
...
static void _import_queue_page_on_preparing_batch_import_preparing (BatchImport* _sender, gpointer self) {
#line 83 "/shotwell/src/library/ImportQueuePage.vala"
...
static void _import_queue_page_on_progress_batch_import_progress (BatchImport* _sender, guint64 completed_bytes, guint64 total_bytes, gpointer self) {
#line 84 "/shotwell/src/library/ImportQueuePage.vala"
...
static void _import_queue_page_on_imported_batch_import_imported (BatchImport* _sender, MediaSource* source, GdkPixbuf* pixbuf, gint to_follow, gpointer self) {
#line 85 "/shotwell/src/library/ImportQueuePage.vala"
...
static void _import_queue_page_on_import_complete_batch_import_import_complete (BatchImport* _sender, ImportManifest* manifest, BatchImportRoll* import_roll, gpointer self) {
#line 86 "/shotwell/src/library/ImportQueuePage.vala"
...
static void _import_queue_page_on_fatal_error_batch_import_fatal_error (BatchImport* _sender, ImportResult _result_, const gchar* message, gpointer self) {
#line 87 "/shotwell/src/library/ImportQueuePage.vala"
...
void import_queue_page_enqueue_and_schedule (ImportQueuePage* self, BatchImport* batch_import, gboolean allow_user_cancel) {
	...
	gint _tmp16_;
	gint _tmp17_;
#line 79 "/shotwell/src/library/ImportQueuePage.vala"
	g_return_if_fail (IS_IMPORT_QUEUE_PAGE (self));
#line 79 "/shotwell/src/library/ImportQueuePage.vala"
	g_return_if_fail (IS_BATCH_IMPORT (batch_import));
#line 80 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 89 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 831 "ImportQueuePage.c"
		GeeHashSet* _tmp10_;
		BatchImport* _tmp11_;
#line 90 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 92 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 860 "ImportQueuePage.c"
		BatchImport* _tmp18_;
#line 96 "/shotwell/src/library/ImportQueuePage.vala"
		_tmp18_ = batch_import;
#line 96 "/shotwell/src/library/ImportQueuePage.vala"
		batch_import_schedule (_tmp18_);
#line 866 "ImportQueuePage.c"
	}
#line 98 "/shotwell/src/library/ImportQueuePage.vala"
...
gint import_queue_page_get_batch_count (ImportQueuePage* self) {
	...
	gint _tmp1_;
	gint _tmp2_;
#line 101 "/shotwell/src/library/ImportQueuePage.vala"
	g_return_val_if_fail (IS_IMPORT_QUEUE_PAGE (self), 0);
#line 102 "/shotwell/src/library/ImportQueuePage.vala"
	_tmp0_ = self->priv->queue;
#line 102 "/shotwell/src/library/ImportQueuePage.vala"
...
static void import_queue_page_update_stop_action (ImportQueuePage* self) {
	...
	BatchImport* _tmp2_;
	gboolean _tmp3_;
#line 105 "/shotwell/src/library/ImportQueuePage.vala"
	g_return_if_fail (IS_IMPORT_QUEUE_PAGE (self));
#line 106 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 119 "/shotwell/src/library/ImportQueuePage.vala"
...
static void import_queue_page_on_stop (ImportQueuePage* self) {
	...
	AppWindow* _tmp3_;
	AppWindow* _tmp4_;
#line 109 "/shotwell/src/library/ImportQueuePage.vala"
	g_return_if_fail (IS_IMPORT_QUEUE_PAGE (self));
#line 110 "/shotwell/src/library/ImportQueuePage.vala"
	import_queue_page_update_stop_action (self);
#line 112 "/shotwell/src/library/ImportQueuePage.vala"
	_tmp0_ = self->priv->queue;
#line 112 "/shotwell/src/library/ImportQueuePage.vala"
	_tmp1_ = gee_abstract_collection_get_size (G_TYPE_CHECK_INSTANCE_CAST (_tmp0_, GEE_TYPE_ABSTRACT_COLLECTION, GeeAbstractCollection));
#line 112 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 112 "/shotwell/src/library/ImportQueuePage.vala"
	if (_tmp2_ == 0) {
#line 113 "/shotwell/src/library/ImportQueuePage.vala"
		return;
#line 961 "ImportQueuePage.c"
	}
#line 115 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 116 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 120 "/shotwell/src/library/ImportQueuePage.vala"
...
static void import_queue_page_on_starting (ImportQueuePage* self, BatchImport* batch_import) {
	BatchImport* _tmp0_;
	BatchImport* _tmp1_;
#line 123 "/shotwell/src/library/ImportQueuePage.vala"
	g_return_if_fail (IS_IMPORT_QUEUE_PAGE (self));
#line 123 "/shotwell/src/library/ImportQueuePage.vala"
	g_return_if_fail (IS_BATCH_IMPORT (batch_import));
#line 124 "/shotwell/src/library/ImportQueuePage.vala"
	import_queue_page_update_stop_action (self);
#line 125 "/shotwell/src/library/ImportQueuePage.vala"
	_tmp0_ = batch_import;
#line 125 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 128 "/shotwell/src/library/ImportQueuePage.vala"
	g_return_if_fail (IS_IMPORT_QUEUE_PAGE (self));
#line 129 "/shotwell/src/library/ImportQueuePage.vala"
	_tmp0_ = self->priv->progress_bar;
#line 129 "/shotwell/src/library/ImportQueuePage.vala"
	gtk_progress_bar_set_text (_tmp0_, _ ("Preparing to import…"));
#line 130 "/shotwell/src/library/ImportQueuePage.vala"
...
static void import_queue_page_on_progress (ImportQueuePage* self, guint64 completed_bytes, guint64 total_bytes) {
	...
	gdouble pct = 0.0;
	GtkProgressBar* _tmp5_;
#line 133 "/shotwell/src/library/ImportQueuePage.vala"
	g_return_if_fail (IS_IMPORT_QUEUE_PAGE (self));
#line 134 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 135 "/shotwell/src/library/ImportQueuePage.vala"
		_tmp0_ = 0.0;
#line 1112 "ImportQueuePage.c"
	}
#line 134 "/shotwell/src/library/ImportQueuePage.vala"
	pct = _tmp0_;
#line 136 "/shotwell/src/library/ImportQueuePage.vala"
	_tmp5_ = self->priv->progress_bar;
#line 136 "/shotwell/src/library/ImportQueuePage.vala"
...
static void import_queue_page_on_imported (ImportQueuePage* self, ThumbnailSource* source, GdkPixbuf* pixbuf, gint to_follow) {
	...
	gchar* _tmp27_;
	gchar* _tmp28_;
#line 143 "/shotwell/src/library/ImportQueuePage.vala"
	g_return_if_fail (IS_IMPORT_QUEUE_PAGE (self));
#line 143 "/shotwell/src/library/ImportQueuePage.vala"
	g_return_if_fail (IS_THUMBNAIL_SOURCE (source));
#line 143 "/shotwell/src/library/ImportQueuePage.vala"
	g_return_if_fail (GDK_IS_PIXBUF (pixbuf));
#line 145 "/shotwell/src/library/ImportQueuePage.vala"
	_tmp1_ = to_follow;
#line 145 "/shotwell/src/library/ImportQueuePage.vala"
	if (_tmp1_ > 0) {
#line 145 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 145 "/shotwell/src/library/ImportQueuePage.vala"
	if (_tmp0_) {
#line 146 "/shotwell/src/library/ImportQueuePage.vala"
		return;
#line 1166 "ImportQueuePage.c"
	}
#line 148 "/shotwell/src/library/ImportQueuePage.vala"
	_tmp3_ = pixbuf;
#line 148 "/shotwell/src/library/ImportQueuePage.vala"
	_tmp4_ = pixbuf;
#line 148 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 151 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 152 "/shotwell/src/library/ImportQueuePage.vala"
	_tmp9_ = source;
#line 152 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 1213 "ImportQueuePage.c"
		...
		VideoView* _tmp20_;
		gboolean _tmp21_;
#line 153 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 155 "/shotwell/src/library/ImportQueuePage.vala"
	_tmp22_ = self->priv->progress_bar;
#line 155 "/shotwell/src/library/ImportQueuePage.vala"
	gtk_progress_bar_set_ellipsize (_tmp22_, PANGO_ELLIPSIZE_MIDDLE);
#line 156 "/shotwell/src/library/ImportQueuePage.vala"
...
static void import_queue_page_on_import_complete (ImportQueuePage* self, BatchImport* batch_import, ImportManifest* manifest, BatchImportRoll* import_roll) {
	...
	gint _tmp29_;
	BatchImport* _tmp39_;
#line 159 "/shotwell/src/library/ImportQueuePage.vala"
	g_return_if_fail (IS_IMPORT_QUEUE_PAGE (self));
#line 159 "/shotwell/src/library/ImportQueuePage.vala"
	g_return_if_fail (IS_BATCH_IMPORT (batch_import));
#line 159 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 161 "/shotwell/src/library/ImportQueuePage.vala"
	_tmp0_ = batch_import;
#line 161 "/shotwell/src/library/ImportQueuePage.vala"
	_tmp1_ = self->priv->current_batch;
#line 161 "/shotwell/src/library/ImportQueuePage.vala"
	_vala_assert (_tmp0_ == _tmp1_, "batch_import == current_batch");
#line 162 "/shotwell/src/library/ImportQueuePage.vala"
	_g_object_unref0 (self->priv->current_batch);
#line 162 "/shotwell/src/library/ImportQueuePage.vala"
	self->priv->current_batch = NULL;
#line 164 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 165 "/shotwell/src/library/ImportQueuePage.vala"
	_tmp5_ = self->priv->queue;
#line 165 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 167 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 167 "/shotwell/src/library/ImportQueuePage.vala"
	removed = _tmp11_;
#line 168 "/shotwell/src/library/ImportQueuePage.vala"
	_tmp12_ = removed;
#line 168 "/shotwell/src/library/ImportQueuePage.vala"
	_vala_assert (_tmp12_, "removed");
#line 171 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 174 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 175 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 176 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 177 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 178 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 179 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 182 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 1400 "ImportQueuePage.c"
		...
		gpointer _tmp31_;
		BatchImport* _tmp32_;
#line 183 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 1438 "ImportQueuePage.c"
			AppWindow* _tmp37_;
			AppWindow* _tmp38_;
#line 199 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 201 "/shotwell/src/library/ImportQueuePage.vala"
		self->priv->stopped = FALSE;
#line 1453 "ImportQueuePage.c"
	}
#line 204 "/shotwell/src/library/ImportQueuePage.vala"
	import_queue_page_update_stop_action (self);
#line 207 "/shotwell/src/library/ImportQueuePage.vala"
...
static void import_queue_page_on_fatal_error (ImportQueuePage* self, ImportResult _result_, const gchar* message) {
	const gchar* _tmp0_;
#line 210 "/shotwell/src/library/ImportQueuePage.vala"
	g_return_if_fail (IS_IMPORT_QUEUE_PAGE (self));
#line 210 "/shotwell/src/library/ImportQueuePage.vala"
	g_return_if_fail (message != NULL);
#line 211 "/shotwell/src/library/ImportQueuePage.vala"
	_tmp0_ = message;
#line 211 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 7 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 10 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 11 "/shotwell/src/library/ImportQueuePage.vala"
...
#line 12 "/shotwell/src/library/ImportQueuePage.vala"
	self->priv->current_batch = NULL;
#line 13 "/shotwell/src/library/ImportQueuePage.vala"
	_tmp2_ = (GtkProgressBar*) gtk_progress_bar_new ();
#line 13 "/shotwell/src/library/ImportQueuePage.vala"
	g_object_ref_sink (_tmp2_);
#line 13 "/shotwell/src/library/ImportQueuePage.vala"
	self->priv->progress_bar = _tmp2_;
#line 14 "/shotwell/src/library/ImportQueuePage.vala"
	self->priv->stopped = FALSE;
