...
static void _trash_page_on_delete_gsimple_action_activate_callback (GSimpleAction* action, GVariant* parameter, gpointer self) {
#line 50 "/shotwell/src/library/TrashPage.vala"
...
static void _trash_page_on_trashcan_contents_altered_media_source_collection_trashcan_contents_altered (MediaSourceCollection* _sender, GeeCollection* added, GeeCollection* removed, gpointer self) {
#line 38 "/shotwell/src/library/TrashPage.vala"
...
#line 29 "/shotwell/src/library/TrashPage.vala"
	self = (TrashPage*) checkerboard_page_construct (object_type, TRASH_PAGE_NAME);
#line 31 "/shotwell/src/library/TrashPage.vala"
...
#line 32 "/shotwell/src/library/TrashPage.vala"
...
#line 33 "/shotwell/src/library/TrashPage.vala"
	page_init_toolbar (G_TYPE_CHECK_INSTANCE_CAST (self, TYPE_PAGE, Page), "TrashToolbar");
#line 35 "/shotwell/src/library/TrashPage.vala"
...
#line 39 "/shotwell/src/library/TrashPage.vala"
	_tmp4_ = video_global;
#line 39 "/shotwell/src/library/TrashPage.vala"
...
#line 40 "/shotwell/src/library/TrashPage.vala"
...
#line 41 "/shotwell/src/library/TrashPage.vala"
	_tmp8_ = video_global;
#line 41 "/shotwell/src/library/TrashPage.vala"
...
#line 28 "/shotwell/src/library/TrashPage.vala"
	return self;
...
#line 47 "/shotwell/src/library/TrashPage.vala"
	_tmp1_ = ui_filenames;
#line 47 "/shotwell/src/library/TrashPage.vala"
...
static void trash_page_real_add_actions (Page* base, GActionMap* map) {
	...
	GActionMap* _tmp0_;
	GActionMap* _tmp1_;
#line 55 "/shotwell/src/library/TrashPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_TRASH_PAGE, TrashPage);
#line 55 "/shotwell/src/library/TrashPage.vala"
	g_return_if_fail (G_IS_ACTION_MAP (map));
#line 56 "/shotwell/src/library/TrashPage.vala"
	_tmp0_ = map;
#line 56 "/shotwell/src/library/TrashPage.vala"
...
#line 58 "/shotwell/src/library/TrashPage.vala"
	_tmp1_ = map;
#line 58 "/shotwell/src/library/TrashPage.vala"
...
static void trash_page_real_remove_actions (Page* base, GActionMap* map) {
	TrashPage * self;
	GActionMap* _tmp0_;
#line 61 "/shotwell/src/library/TrashPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_TRASH_PAGE, TrashPage);
#line 61 "/shotwell/src/library/TrashPage.vala"
	g_return_if_fail (G_IS_ACTION_MAP (map));
#line 62 "/shotwell/src/library/TrashPage.vala"
	_tmp0_ = map;
#line 62 "/shotwell/src/library/TrashPage.vala"
...
#line 1018 "TrashPage.c"
	{
		...
		gint entry_it = 0;
#line 63 "/shotwell/src/library/TrashPage.vala"
...
#line 1034 "TrashPage.c"
			{
				...
				GActionEntry _tmp2_;
				const gchar* _tmp3_;
#line 64 "/shotwell/src/library/TrashPage.vala"
				_tmp1_ = map;
#line 64 "/shotwell/src/library/TrashPage.vala"
				_tmp2_ = entry;
#line 64 "/shotwell/src/library/TrashPage.vala"
...
#line 69 "/shotwell/src/library/TrashPage.vala"
...
#line 68 "/shotwell/src/library/TrashPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_TRASH_PAGE, TrashPage);
#line 69 "/shotwell/src/library/TrashPage.vala"
...
#line 84 "/shotwell/src/library/TrashPage.vala"
...
#line 86 "/shotwell/src/library/TrashPage.vala"
	_tmp0_ = added;
#line 86 "/shotwell/src/library/TrashPage.vala"
	if (_tmp0_ != NULL) {
#line 1125 "TrashPage.c"
		{
			...
			GeeIterator* _tmp2_;
#line 87 "/shotwell/src/library/TrashPage.vala"
			_tmp1_ = added;
#line 87 "/shotwell/src/library/TrashPage.vala"
...
#line 88 "/shotwell/src/library/TrashPage.vala"
...
#line 91 "/shotwell/src/library/TrashPage.vala"
	_tmp12_ = removed;
#line 91 "/shotwell/src/library/TrashPage.vala"
	if (_tmp12_ != NULL) {
#line 1194 "TrashPage.c"
		...
		Marker* _tmp31_;
#line 92 "/shotwell/src/library/TrashPage.vala"
...
#line 1215 "TrashPage.c"
		{
			...
			GeeIterator* _tmp18_;
#line 93 "/shotwell/src/library/TrashPage.vala"
			_tmp17_ = removed;
#line 93 "/shotwell/src/library/TrashPage.vala"
...
#line 94 "/shotwell/src/library/TrashPage.vala"
				_tmp23_ = marker;
#line 94 "/shotwell/src/library/TrashPage.vala"
...
#line 95 "/shotwell/src/library/TrashPage.vala"
...
#line 99 "/shotwell/src/library/TrashPage.vala"
	g_return_if_fail (IS_TRASH_PAGE (self));
#line 100 "/shotwell/src/library/TrashPage.vala"
	_tmp0_ = page_get_view (G_TYPE_CHECK_INSTANCE_CAST (self, TYPE_PAGE, Page));
#line 100 "/shotwell/src/library/TrashPage.vala"
	_tmp1_ = _tmp0_;
#line 100 "/shotwell/src/library/TrashPage.vala"
...
#line 100 "/shotwell/src/library/TrashPage.vala"
	if (_tmp3_) {
#line 101 "/shotwell/src/library/TrashPage.vala"
		return;
#line 1328 "TrashPage.c"
	}
#line 103 "/shotwell/src/library/TrashPage.vala"
...
static gchar* trash_page_real_get_view_empty_message (CheckerboardPage* base) {
	...
	gchar* result = NULL;
	gchar* _tmp0_;
#line 107 "/shotwell/src/library/TrashPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_TRASH_PAGE, TrashPage);
#line 108 "/shotwell/src/library/TrashPage.vala"
...
#line 111 "/shotwell/src/library/TrashPage.vala"
	g_return_if_fail (IS_TRASH_PAGE (self));
#line 113 "/shotwell/src/library/TrashPage.vala"
...
#line 112 "/shotwell/src/library/TrashPage.vala"
...
#line 117 "/shotwell/src/library/TrashPage.vala"
...
#line 116 "/shotwell/src/library/TrashPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_TRASH_PAGE, TrashPage);
#line 117 "/shotwell/src/library/TrashPage.vala"
...
static TrashPageTrashView* trash_page_trash_view_construct (GType object_type, MediaSource* source) {
	...
	MediaSource* _tmp3_;
	gboolean _tmp4_;
#line 11 "/shotwell/src/library/TrashPage.vala"
	g_return_val_if_fail (IS_MEDIA_SOURCE (source), NULL);
#line 12 "/shotwell/src/library/TrashPage.vala"
	_tmp0_ = source;
#line 12 "/shotwell/src/library/TrashPage.vala"
...
#line 14 "/shotwell/src/library/TrashPage.vala"
	_tmp3_ = source;
#line 14 "/shotwell/src/library/TrashPage.vala"
...
#line 10 "/shotwell/src/library/TrashPage.vala"
...
#line 18 "/shotwell/src/library/TrashPage.vala"
...
#line 7 "/shotwell/src/library/TrashPage.vala"
...
#line 25 "/shotwell/src/library/TrashPage.vala"
...
#line 26 "/shotwell/src/library/TrashPage.vala"
	_core_tracker_unref0 (self->priv->tracker);
#line 7 "/shotwell/src/library/TrashPage.vala"
