...
static void _last_import_page_on_import_rolls_altered_media_source_collection_import_roll_altered (MediaSourceCollection* _sender, gpointer self) {
#line 41 "/shotwell/src/library/LastImportPage.vala"
...
#line 28 "/shotwell/src/library/LastImportPage.vala"
...
#line 721 "LastImportPage.c"
	{
		...
		GeeIterator* _tmp4_;
		GeeIterator* _tmp5_;
#line 31 "/shotwell/src/library/LastImportPage.vala"
...
#line 32 "/shotwell/src/library/LastImportPage.vala"
			_tmp10_ = col;
#line 32 "/shotwell/src/library/LastImportPage.vala"
...
#line 36 "/shotwell/src/library/LastImportPage.vala"
	last_import_page_on_import_rolls_altered (self);
#line 27 "/shotwell/src/library/LastImportPage.vala"
	return self;
...
#line 45 "/shotwell/src/library/LastImportPage.vala"
	g_return_if_fail (IS_LAST_IMPORT_PAGE (self));
#line 47 "/shotwell/src/library/LastImportPage.vala"
	_tmp0_ = media_collection_registry_get_instance ();
#line 47 "/shotwell/src/library/LastImportPage.vala"
	_tmp1_ = _tmp0_;
#line 47 "/shotwell/src/library/LastImportPage.vala"
...
#line 50 "/shotwell/src/library/LastImportPage.vala"
...
#line 51 "/shotwell/src/library/LastImportPage.vala"
...
#line 52 "/shotwell/src/library/LastImportPage.vala"
...
#line 54 "/shotwell/src/library/LastImportPage.vala"
		_import_id_free0 (current_last_import_id);
#line 54 "/shotwell/src/library/LastImportPage.vala"
		return;
#line 859 "LastImportPage.c"
	}
#line 57 "/shotwell/src/library/LastImportPage.vala"
...
#line 57 "/shotwell/src/library/LastImportPage.vala"
	if (_tmp10_ == _tmp12_) {
#line 58 "/shotwell/src/library/LastImportPage.vala"
		_import_id_free0 (current_last_import_id);
#line 58 "/shotwell/src/library/LastImportPage.vala"
		return;
#line 875 "LastImportPage.c"
	}
#line 60 "/shotwell/src/library/LastImportPage.vala"
	_tmp13_ = current_last_import_id;
#line 60 "/shotwell/src/library/LastImportPage.vala"
	self->priv->last_import_id = *_tmp13_;
#line 62 "/shotwell/src/library/LastImportPage.vala"
...
#line 63 "/shotwell/src/library/LastImportPage.vala"
...
#line 897 "LastImportPage.c"
	{
		...
		GeeIterator* _tmp22_;
		GeeIterator* _tmp23_;
#line 65 "/shotwell/src/library/LastImportPage.vala"
...
#line 66 "/shotwell/src/library/LastImportPage.vala"
...
static void last_import_page_real_get_config_photos_sort (MediaPage* base, gboolean* sort_order, gint* sort_by) {
	...
	gint _tmp3_ = 0;
#line 71 "/shotwell/src/library/LastImportPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_LAST_IMPORT_PAGE, LastImportPage);
#line 72 "/shotwell/src/library/LastImportPage.vala"
...
static void last_import_page_real_set_config_photos_sort (MediaPage* base, gboolean sort_order, gint sort_by) {
	...
	gboolean _tmp2_;
	gint _tmp3_;
#line 75 "/shotwell/src/library/LastImportPage.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_LAST_IMPORT_PAGE, LastImportPage);
#line 76 "/shotwell/src/library/LastImportPage.vala"
	_tmp0_ = config_facade_get_instance ();
#line 76 "/shotwell/src/library/LastImportPage.vala"
	_tmp1_ = _tmp0_;
#line 76 "/shotwell/src/library/LastImportPage.vala"
...
static LastImportPageLastImportViewManager* last_import_page_last_import_view_manager_construct (GType object_type, LastImportPage* owner, ImportID* import_id) {
	...
	ImportID _tmp1_;
#line 13 "/shotwell/src/library/LastImportPage.vala"
	g_return_val_if_fail (IS_LAST_IMPORT_PAGE (owner), NULL);
#line 13 "/shotwell/src/library/LastImportPage.vala"
	g_return_val_if_fail (import_id != NULL, NULL);
#line 14 "/shotwell/src/library/LastImportPage.vala"
	_tmp0_ = owner;
#line 14 "/shotwell/src/library/LastImportPage.vala"
...
#line 16 "/shotwell/src/library/LastImportPage.vala"
	_tmp1_ = *import_id;
#line 16 "/shotwell/src/library/LastImportPage.vala"
...
static gboolean last_import_page_last_import_view_manager_real_include_in_view (ViewManager* base, DataSource* source) {
	...
	ImportID _tmp3_;
	gint64 _tmp4_;
#line 19 "/shotwell/src/library/LastImportPage.vala"
...
#line 20 "/shotwell/src/library/LastImportPage.vala"
	_tmp0_ = source;
#line 20 "/shotwell/src/library/LastImportPage.vala"
...
#line 10 "/shotwell/src/library/LastImportPage.vala"
...
#line 7 "/shotwell/src/library/LastImportPage.vala"
	last_import_page_parent_class = g_type_class_peek_parent (klass);
#line 7 "/shotwell/src/library/LastImportPage.vala"
	g_type_class_add_private (klass, sizeof (LastImportPagePrivate));
#line 7 "/shotwell/src/library/LastImportPage.vala"
	((MediaPageClass *) klass)->get_config_photos_sort = (void (*) (MediaPage *, gboolean*, gint*)) last_import_page_real_get_config_photos_sort;
#line 7 "/shotwell/src/library/LastImportPage.vala"
...
#line 24 "/shotwell/src/library/LastImportPage.vala"
	import_id_init (&self->priv->last_import_id, IMPORT_ID_INVALID);
#line 25 "/shotwell/src/library/LastImportPage.vala"
...
#line 1190 "LastImportPage.c"
	{
		...
		GeeIterator* _tmp4_;
		GeeIterator* _tmp5_;
#line 40 "/shotwell/src/library/LastImportPage.vala"
		_tmp0_ = media_collection_registry_get_instance ();
#line 40 "/shotwell/src/library/LastImportPage.vala"
		_tmp1_ = _tmp0_;
#line 40 "/shotwell/src/library/LastImportPage.vala"
