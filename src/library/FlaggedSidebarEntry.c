...
static void _library_flagged_sidebar_entry_on_flagged_contents_altered_media_source_collection_flagged_contents_altered (MediaSourceCollection* _sender, gpointer self) {
#line 17 "/shotwell/src/library/FlaggedSidebarEntry.vala"
...
LibraryFlaggedSidebarEntry* library_flagged_sidebar_entry_construct (GType object_type) {
	...
	gint _tmp11_;
#line 8 "/shotwell/src/library/FlaggedSidebarEntry.vala"
...
#line 452 "FlaggedSidebarEntry.c"
	{
		...
		GeeIterator* _tmp4_;
		GeeIterator* _tmp5_;
#line 9 "/shotwell/src/library/FlaggedSidebarEntry.vala"
...
#line 10 "/shotwell/src/library/FlaggedSidebarEntry.vala"
...
#line 12 "/shotwell/src/library/FlaggedSidebarEntry.vala"
...
static gchar* library_flagged_sidebar_entry_real_get_sidebar_name (SidebarSimplePageEntry* base) {
	...
	gchar* result = NULL;
	gchar* _tmp0_;
#line 20 "/shotwell/src/library/FlaggedSidebarEntry.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, LIBRARY_TYPE_FLAGGED_SIDEBAR_ENTRY, LibraryFlaggedSidebarEntry);
#line 21 "/shotwell/src/library/FlaggedSidebarEntry.vala"
...
static gchar* library_flagged_sidebar_entry_real_get_sidebar_icon (SidebarSimplePageEntry* base) {
	...
	gchar* result = NULL;
	gchar* _tmp0_;
#line 24 "/shotwell/src/library/FlaggedSidebarEntry.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, LIBRARY_TYPE_FLAGGED_SIDEBAR_ENTRY, LibraryFlaggedSidebarEntry);
#line 25 "/shotwell/src/library/FlaggedSidebarEntry.vala"
...
static Page* library_flagged_sidebar_entry_real_create_page (SidebarSimplePageEntry* base) {
	...
	Page* result = NULL;
	FlaggedPage* _tmp0_;
#line 28 "/shotwell/src/library/FlaggedSidebarEntry.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, LIBRARY_TYPE_FLAGGED_SIDEBAR_ENTRY, LibraryFlaggedSidebarEntry);
#line 29 "/shotwell/src/library/FlaggedSidebarEntry.vala"
...
#line 32 "/shotwell/src/library/FlaggedSidebarEntry.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, LIBRARY_TYPE_FLAGGED_SIDEBAR_ENTRY, LibraryFlaggedSidebarEntry);
#line 32 "/shotwell/src/library/FlaggedSidebarEntry.vala"
	g_return_val_if_fail (GEE_IS_LIST (media), FALSE);
#line 33 "/shotwell/src/library/FlaggedSidebarEntry.vala"
...
#line 35 "/shotwell/src/library/FlaggedSidebarEntry.vala"
	result = TRUE;
#line 35 "/shotwell/src/library/FlaggedSidebarEntry.vala"
	return result;
...
static gboolean library_flagged_sidebar_entry_real_internal_drop_received_arbitrary (SidebarInternalDropTargetEntry* base, GtkSelectionData* data) {
	LibraryFlaggedSidebarEntry * self;
	gboolean result = FALSE;
#line 38 "/shotwell/src/library/FlaggedSidebarEntry.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, LIBRARY_TYPE_FLAGGED_SIDEBAR_ENTRY, LibraryFlaggedSidebarEntry);
#line 38 "/shotwell/src/library/FlaggedSidebarEntry.vala"
	g_return_val_if_fail (data != NULL, FALSE);
#line 39 "/shotwell/src/library/FlaggedSidebarEntry.vala"
	result = FALSE;
#line 39 "/shotwell/src/library/FlaggedSidebarEntry.vala"
	return result;
...
static void library_flagged_sidebar_entry_on_flagged_contents_altered (LibraryFlaggedSidebarEntry* self) {
	gint _tmp0_;
#line 42 "/shotwell/src/library/FlaggedSidebarEntry.vala"
	g_return_if_fail (LIBRARY_IS_FLAGGED_SIDEBAR_ENTRY (self));
#line 43 "/shotwell/src/library/FlaggedSidebarEntry.vala"
...
static gint library_flagged_sidebar_entry_get_total_flagged (LibraryFlaggedSidebarEntry* self) {
	gint result = 0;
	gint total = 0;
#line 46 "/shotwell/src/library/FlaggedSidebarEntry.vala"
	g_return_val_if_fail (LIBRARY_IS_FLAGGED_SIDEBAR_ENTRY (self), 0);
#line 47 "/shotwell/src/library/FlaggedSidebarEntry.vala"
	total = 0;
#line 653 "FlaggedSidebarEntry.c"
	{
		...
		GeeIterator* _tmp4_;
		GeeIterator* _tmp5_;
#line 48 "/shotwell/src/library/FlaggedSidebarEntry.vala"
		_tmp0_ = media_collection_registry_get_instance ();
#line 48 "/shotwell/src/library/FlaggedSidebarEntry.vala"
		_tmp1_ = _tmp0_;
#line 48 "/shotwell/src/library/FlaggedSidebarEntry.vala"
...
#line 48 "/shotwell/src/library/FlaggedSidebarEntry.vala"
			media_sources = (MediaSourceCollection*) _tmp9_;
#line 49 "/shotwell/src/library/FlaggedSidebarEntry.vala"
			_tmp10_ = total;
#line 49 "/shotwell/src/library/FlaggedSidebarEntry.vala"
...
#line 51 "/shotwell/src/library/FlaggedSidebarEntry.vala"
	result = total;
#line 51 "/shotwell/src/library/FlaggedSidebarEntry.vala"
	return result;
...
#line 7 "/shotwell/src/library/FlaggedSidebarEntry.vala"
	library_flagged_sidebar_entry_parent_class = g_type_class_peek_parent (klass);
#line 7 "/shotwell/src/library/FlaggedSidebarEntry.vala"
	((SidebarSimplePageEntryClass *) klass)->get_sidebar_name = (gchar* (*) (SidebarSimplePageEntry *)) library_flagged_sidebar_entry_real_get_sidebar_name;
#line 7 "/shotwell/src/library/FlaggedSidebarEntry.vala"
	((SidebarSimplePageEntryClass *) klass)->get_sidebar_icon = (gchar* (*) (SidebarSimplePageEntry *)) library_flagged_sidebar_entry_real_get_sidebar_icon;
#line 7 "/shotwell/src/library/FlaggedSidebarEntry.vala"
...
#line 776 "FlaggedSidebarEntry.c"
	{
		...
		GeeIterator* _tmp4_;
		GeeIterator* _tmp5_;
#line 16 "/shotwell/src/library/FlaggedSidebarEntry.vala"
		_tmp0_ = media_collection_registry_get_instance ();
#line 16 "/shotwell/src/library/FlaggedSidebarEntry.vala"
		_tmp1_ = _tmp0_;
#line 16 "/shotwell/src/library/FlaggedSidebarEntry.vala"
