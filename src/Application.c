...
void application_set_raw_thumbs_fix_required (Application* self, gboolean should_fixup) {
	gboolean _tmp0_;
#line 24 "/shotwell/src/Application.vala"
	g_return_if_fail (IS_APPLICATION (self));
#line 25 "/shotwell/src/Application.vala"
	_tmp0_ = should_fixup;
#line 25 "/shotwell/src/Application.vala"
...
gboolean application_get_raw_thumbs_fix_required (Application* self) {
	...
	gboolean _tmp0_;
#line 28 "/shotwell/src/Application.vala"
	g_return_val_if_fail (IS_APPLICATION (self), FALSE);
#line 29 "/shotwell/src/Application.vala"
...
#line 33 "/shotwell/src/Application.vala"
...
#line 32 "/shotwell/src/Application.vala"
...
#line 65 "/shotwell/src/Application.vala"
	return result;
...
static void _application_on_activated_g_application_activate (GApplication* _sender, gpointer self) {
#line 68 "/shotwell/src/Application.vala"
...
static void _application_on_activated_g_application_startup (GApplication* _sender, gpointer self) {
#line 69 "/shotwell/src/Application.vala"
	application_on_activated ();
...
#line 39 "/shotwell/src/Application.vala"
	self = (Application*) g_type_create_instance (object_type);
#line 40 "/shotwell/src/Application.vala"
	_tmp0_ = is_direct;
#line 40 "/shotwell/src/Application.vala"
	if (_tmp0_) {
#line 248 "Application.c"
		GtkApplication* _tmp1_;
#line 45 "/shotwell/src/Application.vala"
...
#line 51 "/shotwell/src/Application.vala"
...
#line 57 "/shotwell/src/Application.vala"
...
#line 275 "Application.c"
	...
	{
		GError* e = NULL;
#line 56 "/shotwell/src/Application.vala"
		e = _inner_error_;
#line 56 "/shotwell/src/Application.vala"
		_inner_error_ = NULL;
#line 59 "/shotwell/src/Application.vala"
...
#line 62 "/shotwell/src/Application.vala"
	_tmp4_ = is_direct;
#line 62 "/shotwell/src/Application.vala"
	self->priv->direct = _tmp4_;
#line 64 "/shotwell/src/Application.vala"
...
void application_send_to_primary_instance (gchar** argv, int argv_length1) {
	...
	gchar** _tmp3_;
	gint _tmp3__length1;
#line 78 "/shotwell/src/Application.vala"
...
void application_present_primary_instance (void) {
	...
	Application* _tmp1_;
	GtkApplication* _tmp2_;
#line 87 "/shotwell/src/Application.vala"
	_tmp0_ = application_get_instance ();
#line 87 "/shotwell/src/Application.vala"
	_tmp1_ = _tmp0_;
#line 87 "/shotwell/src/Application.vala"
...
gboolean application_get_is_remote (void) {
	...
	gboolean _tmp3_;
	gboolean _tmp4_;
#line 91 "/shotwell/src/Application.vala"
	_tmp0_ = application_get_instance ();
#line 91 "/shotwell/src/Application.vala"
	_tmp1_ = _tmp0_;
#line 91 "/shotwell/src/Application.vala"
...
gboolean application_get_is_direct (void) {
	...
	gboolean _tmp2_;
	gboolean _tmp3_;
#line 95 "/shotwell/src/Application.vala"
	_tmp0_ = application_get_instance ();
#line 95 "/shotwell/src/Application.vala"
	_tmp1_ = _tmp0_;
#line 95 "/shotwell/src/Application.vala"
...
void application_set_accels_for_action (const gchar* action, gchar** accel, int accel_length1) {
	...
	gchar** _tmp4_;
	gint _tmp4__length1;
#line 98 "/shotwell/src/Application.vala"
	g_return_if_fail (action != NULL);
#line 99 "/shotwell/src/Application.vala"
	_tmp0_ = application_get_instance ();
#line 99 "/shotwell/src/Application.vala"
	_tmp1_ = _tmp0_;
#line 99 "/shotwell/src/Application.vala"
...
void application_set_menubar (GMenuModel* model) {
	...
	GtkApplication* _tmp2_;
	GMenuModel* _tmp3_;
#line 102 "/shotwell/src/Application.vala"
	g_return_if_fail ((model == NULL) || G_IS_MENU_MODEL (model));
#line 103 "/shotwell/src/Application.vala"
	_tmp0_ = application_get_instance ();
#line 103 "/shotwell/src/Application.vala"
	_tmp1_ = _tmp0_;
#line 103 "/shotwell/src/Application.vala"
...
#line 115 "/shotwell/src/Application.vala"
	_tmp0_ = application_get_instance ();
#line 115 "/shotwell/src/Application.vala"
	_tmp1_ = _tmp0_;
#line 115 "/shotwell/src/Application.vala"
	_application_unref0 (_tmp1_);
#line 117 "/shotwell/src/Application.vala"
...
#line 117 "/shotwell/src/Application.vala"
	lw = _tmp3_;
#line 118 "/shotwell/src/Application.vala"
	_tmp5_ = lw;
#line 118 "/shotwell/src/Application.vala"
	if (_tmp5_ != NULL) {
...
#line 119 "/shotwell/src/Application.vala"
...
#line 114 "/shotwell/src/Application.vala"
	_g_object_unref0 (lw);
...
gint application_on_command_line (GApplicationCommandLine* acl) {
	...
	gchar** _tmp3_;
	gint _tmp3__length1;
#line 131 "/shotwell/src/Application.vala"
	g_return_val_if_fail (G_IS_APPLICATION_COMMAND_LINE (acl), 0);
#line 132 "/shotwell/src/Application.vala"
	_tmp0_ = acl;
#line 132 "/shotwell/src/Application.vala"
...
#line 134 "/shotwell/src/Application.vala"
	_tmp3_ = argv;
#line 134 "/shotwell/src/Application.vala"
	_tmp3__length1 = argv_length1;
#line 134 "/shotwell/src/Application.vala"
...
#line 603 "Application.c"
		gchar** _tmp4_;
		gint _tmp4__length1;
#line 135 "/shotwell/src/Application.vala"
		_tmp4_ = argv;
#line 135 "/shotwell/src/Application.vala"
...
#line 629 "Application.c"
				{
					...
					LibraryWindow* _tmp7_;
					LibraryWindow* _tmp8_;
#line 136 "/shotwell/src/Application.vala"
...
#line 136 "/shotwell/src/Application.vala"
					lw = _tmp7_;
#line 137 "/shotwell/src/Application.vala"
					_tmp8_ = lw;
#line 137 "/shotwell/src/Application.vala"
					if (_tmp8_ != NULL) {
#line 651 "Application.c"
						...
						const gchar* _tmp10_;
#line 138 "/shotwell/src/Application.vala"
						_tmp9_ = lw;
#line 138 "/shotwell/src/Application.vala"
						_tmp10_ = s;
#line 138 "/shotwell/src/Application.vala"
...
#line 142 "/shotwell/src/Application.vala"
	application_on_activated ();
#line 143 "/shotwell/src/Application.vala"
	result = 0;
#line 143 "/shotwell/src/Application.vala"
...
void application_init (gboolean is_direct) {
	Application* _tmp0_;
#line 158 "/shotwell/src/Application.vala"
...
#line 700 "Application.c"
		gboolean _tmp1_;
		Application* _tmp2_;
#line 159 "/shotwell/src/Application.vala"
		_tmp1_ = is_direct;
#line 159 "/shotwell/src/Application.vala"
...
void application_terminate (void) {
	Application* _tmp0_;
	Application* _tmp1_;
#line 163 "/shotwell/src/Application.vala"
	_tmp0_ = application_get_instance ();
#line 163 "/shotwell/src/Application.vala"
	_tmp1_ = _tmp0_;
#line 163 "/shotwell/src/Application.vala"
...
#line 169 "/shotwell/src/Application.vala"
...
Application* application_get_instance (void) {
	...
	Application* _tmp1_;
	Application* _tmp2_;
#line 167 "/shotwell/src/Application.vala"
	_tmp0_ = application_instance;
#line 167 "/shotwell/src/Application.vala"
...
void application_start (Application* self, gchar** argv, int argv_length1) {
	...
	guint _tmp15_;
#line 172 "/shotwell/src/Application.vala"
	g_return_if_fail (IS_APPLICATION (self));
#line 173 "/shotwell/src/Application.vala"
	_tmp0_ = self->priv->running;
#line 173 "/shotwell/src/Application.vala"
	if (_tmp0_) {
#line 174 "/shotwell/src/Application.vala"
		return;
#line 783 "Application.c"
	}
#line 176 "/shotwell/src/Application.vala"
	self->priv->running = TRUE;
#line 178 "/shotwell/src/Application.vala"
	g_signal_emit (self, application_signals[APPLICATION_STARTING_SIGNAL], 0);
#line 180 "/shotwell/src/Application.vala"
...
#line 180 "/shotwell/src/Application.vala"
	_g_object_unref0 (_tmp2_);
#line 181 "/shotwell/src/Application.vala"
	_tmp3_ = self->priv->system_app;
#line 181 "/shotwell/src/Application.vala"
...
#line 182 "/shotwell/src/Application.vala"
	_tmp6_ = self->priv->system_app;
#line 182 "/shotwell/src/Application.vala"
	_tmp7_ = argv;
#line 182 "/shotwell/src/Application.vala"
...
#line 184 "/shotwell/src/Application.vala"
...
#line 821 "Application.c"
		...
		guint _tmp11_;
#line 185 "/shotwell/src/Application.vala"
...
#line 188 "/shotwell/src/Application.vala"
...
#line 189 "/shotwell/src/Application.vala"
...
#line 191 "/shotwell/src/Application.vala"
...
void application_exit (Application* self) {
	...
	gboolean _tmp1_;
	GtkApplication* _tmp3_;
#line 194 "/shotwell/src/Application.vala"
	g_return_if_fail (IS_APPLICATION (self));
#line 197 "/shotwell/src/Application.vala"
...
#line 197 "/shotwell/src/Application.vala"
	if (_tmp0_) {
#line 198 "/shotwell/src/Application.vala"
		return;
#line 875 "Application.c"
	}
#line 200 "/shotwell/src/Application.vala"
	self->priv->exiting_fired = TRUE;
#line 202 "/shotwell/src/Application.vala"
	g_signal_emit (self, application_signals[APPLICATION_EXITING_SIGNAL], 0, FALSE);
#line 204 "/shotwell/src/Application.vala"
	_tmp3_ = self->priv->system_app;
#line 204 "/shotwell/src/Application.vala"
...
void application_panic (Application* self) {
	gboolean _tmp0_;
#line 209 "/shotwell/src/Application.vala"
	g_return_if_fail (IS_APPLICATION (self));
#line 210 "/shotwell/src/Application.vala"
	_tmp0_ = self->priv->exiting_fired;
#line 210 "/shotwell/src/Application.vala"
	if (!_tmp0_) {
#line 211 "/shotwell/src/Application.vala"
		self->priv->exiting_fired = TRUE;
#line 212 "/shotwell/src/Application.vala"
		g_signal_emit (self, application_signals[APPLICATION_EXITING_SIGNAL], 0, TRUE);
#line 901 "Application.c"
	}
#line 214 "/shotwell/src/Application.vala"
	exit (1);
...
guint application_inhibit (Application* self, GtkApplicationInhibitFlags what, const gchar* reason) {
	...
	guint _tmp5_;
	guint _tmp6_;
#line 224 "/shotwell/src/Application.vala"
	g_return_val_if_fail (IS_APPLICATION (self), 0U);
#line 225 "/shotwell/src/Application.vala"
	_tmp0_ = self->priv->system_app;
#line 225 "/shotwell/src/Application.vala"
	_tmp1_ = app_window_get_instance ();
#line 225 "/shotwell/src/Application.vala"
...
void application_uninhibit (Application* self, guint cookie) {
	GtkApplication* _tmp0_;
	guint _tmp1_;
#line 232 "/shotwell/src/Application.vala"
	g_return_if_fail (IS_APPLICATION (self));
#line 233 "/shotwell/src/Application.vala"
	_tmp0_ = self->priv->system_app;
#line 233 "/shotwell/src/Application.vala"
	_tmp1_ = cookie;
#line 233 "/shotwell/src/Application.vala"
...
gint application_get_run_return_value (Application* self) {
	gint result = 0;
	gint _tmp0_;
#line 236 "/shotwell/src/Application.vala"
	g_return_val_if_fail (IS_APPLICATION (self), 0);
#line 237 "/shotwell/src/Application.vala"
...
#line 7 "/shotwell/src/Application.vala"
...
#line 9 "/shotwell/src/Application.vala"
	self->priv->system_app = NULL;
#line 10 "/shotwell/src/Application.vala"
	self->priv->system_app_run_retval = 0;
#line 22 "/shotwell/src/Application.vala"
	self->priv->fixup_raw_thumbs = FALSE;
#line 36 "/shotwell/src/Application.vala"
	self->priv->running = FALSE;
#line 37 "/shotwell/src/Application.vala"
