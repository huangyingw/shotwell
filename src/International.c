...
void international_support_init (const gchar* package_name, gchar** args, int args_length1, const gchar* locale) {
	...
	const gchar* _tmp5_;
	const gchar* _tmp6_;
#line 15 "/shotwell/src/International.vala"
	g_return_if_fail (package_name != NULL);
#line 15 "/shotwell/src/International.vala"
	g_return_if_fail (locale != NULL);
#line 16 "/shotwell/src/International.vala"
	_tmp0_ = locale;
#line 16 "/shotwell/src/International.vala"
	setlocale (LC_ALL, _tmp0_);
#line 18 "/shotwell/src/International.vala"
	_tmp1_ = package_name;
#line 18 "/shotwell/src/International.vala"
	_tmp2_ = args;
#line 18 "/shotwell/src/International.vala"
...
#line 18 "/shotwell/src/International.vala"
	_g_free0 (_tmp4_);
#line 19 "/shotwell/src/International.vala"
	_tmp5_ = package_name;
#line 19 "/shotwell/src/International.vala"
	bind_textdomain_codeset (_tmp5_, "UTF-8");
#line 20 "/shotwell/src/International.vala"
	_tmp6_ = package_name;
#line 20 "/shotwell/src/International.vala"
	textdomain (_tmp6_);
...
gchar* international_support_get_langpack_dir_path (gchar** args, int args_length1) {
	...
	GFile* _tmp11_;
	gboolean _tmp12_;
#line 24 "/shotwell/src/International.vala"
	_tmp0_ = args;
#line 24 "/shotwell/src/International.vala"
...
#line 28 "/shotwell/src/International.vala"
...
#line 138 "International.c"
		...
		gchar* _tmp15_;
#line 29 "/shotwell/src/International.vala"
