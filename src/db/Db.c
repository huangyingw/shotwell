/* Db.c generated by valac 0.36.6, the Vala compiler
...
void db_preconfigure (GFile* db_file) {
	...
	GFile* _tmp1_;
	gchar* _tmp5_;
#line 14 "/shotwell/src/db/Db.vala"
	g_return_if_fail ((db_file == NULL) || G_IS_FILE (db_file));
#line 15 "/shotwell/src/db/Db.vala"
	_tmp1_ = db_file;
#line 15 "/shotwell/src/db/Db.vala"
	if (_tmp1_ != NULL) {
#line 118 "Db.c"
...
void db_init (GError** error) {
	const gchar* _tmp0_;
	const gchar* _tmp1_;
#line 19 "/shotwell/src/db/Db.vala"
	_tmp0_ = db_filename;
#line 19 "/shotwell/src/db/Db.vala"
	_vala_assert (_tmp0_ != NULL, "filename != null");
#line 21 "/shotwell/src/db/Db.vala"
	_tmp1_ = db_filename;
#line 21 "/shotwell/src/db/Db.vala"
...
void db_terminate (void) {
#line 25 "/shotwell/src/db/Db.vala"
...
DbVerifyResult db_verify_database (gchar* * app_version, gint* schema_version) {
	...
	gint _tmp4_;
	gint _tmp7_;
#line 36 "/shotwell/src/db/Db.vala"
	_tmp0_ = version_table_get_instance ();
#line 36 "/shotwell/src/db/Db.vala"
	version_table = _tmp0_;
#line 37 "/shotwell/src/db/Db.vala"
...
#line 39 "/shotwell/src/db/Db.vala"
...
#line 215 "Db.c"
		gint _tmp5_;
		const gchar* _tmp6_;
#line 40 "/shotwell/src/db/Db.vala"
...
#line 42 "/shotwell/src/db/Db.vala"
...
#line 230 "Db.c"
		VersionTable* _tmp8_;
		gchar* _tmp9_;
#line 44 "/shotwell/src/db/Db.vala"
...
#line 276 "Db.c"
			...
			gint _tmp11_;
#line 52 "/shotwell/src/db/Db.vala"
...
#line 283 "Db.c"
				...
				DbVerifyResult _tmp14_;
#line 54 "/shotwell/src/db/Db.vala"
				_tmp12_ = _vala_schema_version;
#line 54 "/shotwell/src/db/Db.vala"
				_tmp13_ = db_upgrade_database (_tmp12_);
#line 54 "/shotwell/src/db/Db.vala"
				_result_ = _tmp13_;
#line 55 "/shotwell/src/db/Db.vala"
				_tmp14_ = _result_;
#line 55 "/shotwell/src/db/Db.vala"
				if (_tmp14_ != DB_VERIFY_RESULT_OK) {
#line 56 "/shotwell/src/db/Db.vala"
					result = _result_;
#line 56 "/shotwell/src/db/Db.vala"
					_database_table_unref0 (version_table);
#line 56 "/shotwell/src/db/Db.vala"
...
#line 59 "/shotwell/src/db/Db.vala"
...
#line 188 "/shotwell/src/db/Db.vala"
	version = 9;
#line 195 "/shotwell/src/db/Db.vala"
...
#line 214 "/shotwell/src/db/Db.vala"
	version = 11;
#line 221 "/shotwell/src/db/Db.vala"
...
#line 221 "/shotwell/src/db/Db.vala"
	if (!_tmp26_) {
#line 223 "/shotwell/src/db/Db.vala"
		result = DB_VERIFY_RESULT_UPGRADE_ERROR;
#line 223 "/shotwell/src/db/Db.vala"
		return result;
#line 635 "Db.c"
	}
#line 226 "/shotwell/src/db/Db.vala"
	version = 12;
#line 233 "/shotwell/src/db/Db.vala"
	_tmp27_ = database_table_has_column ("PhotoTable", "developer");
#line 233 "/shotwell/src/db/Db.vala"
	if (!_tmp27_) {
#line 643 "Db.c"
		gboolean _tmp28_;
#line 234 "/shotwell/src/db/Db.vala"
		g_message ("Db.vala:234: upgrade_database: adding developer column to PhotoTable");
#line 235 "/shotwell/src/db/Db.vala"
		_tmp28_ = database_table_add_column ("PhotoTable", "developer", "TEXT");
#line 235 "/shotwell/src/db/Db.vala"
		if (!_tmp28_) {
#line 236 "/shotwell/src/db/Db.vala"
			result = DB_VERIFY_RESULT_UPGRADE_ERROR;
#line 236 "/shotwell/src/db/Db.vala"
			return result;
#line 655 "Db.c"
...
#line 257 "/shotwell/src/db/Db.vala"
	version = 13;
#line 264 "/shotwell/src/db/Db.vala"
	_tmp35_ = input_version;
#line 264 "/shotwell/src/db/Db.vala"
	if (_tmp35_ < 14) {
#line 265 "/shotwell/src/db/Db.vala"
		tag_table_upgrade_for_htags ();
#line 723 "Db.c"
	}
#line 267 "/shotwell/src/db/Db.vala"
	version = 14;
#line 279 "/shotwell/src/db/Db.vala"
	version = 15;
#line 289 "/shotwell/src/db/Db.vala"
	_tmp36_ = input_version;
#line 289 "/shotwell/src/db/Db.vala"
	if (_tmp36_ < 16) {
#line 292 "/shotwell/src/db/Db.vala"
		gsettings_configuration_engine_run_gsettings_migrator ();
#line 735 "Db.c"
	}
#line 295 "/shotwell/src/db/Db.vala"
	version = 16;
#line 302 "/shotwell/src/db/Db.vala"
	_tmp37_ = database_table_has_column ("PhotoTable", "comment");
#line 302 "/shotwell/src/db/Db.vala"
	if (!_tmp37_) {
#line 743 "Db.c"
		gboolean _tmp38_;
#line 303 "/shotwell/src/db/Db.vala"
		g_message ("Db.vala:303: upgrade_database: adding comment column to PhotoTable");
#line 304 "/shotwell/src/db/Db.vala"
		_tmp38_ = database_table_add_column ("PhotoTable", "comment", "TEXT");
#line 304 "/shotwell/src/db/Db.vala"
		if (!_tmp38_) {
#line 305 "/shotwell/src/db/Db.vala"
			result = DB_VERIFY_RESULT_UPGRADE_ERROR;
#line 305 "/shotwell/src/db/Db.vala"
			return result;
#line 755 "Db.c"
...
#line 326 "/shotwell/src/db/Db.vala"
	version = 18;
#line 337 "/shotwell/src/db/Db.vala"
...
#line 804 "Db.c"
		Application* _tmp44_;
		Application* _tmp45_;
#line 338 "/shotwell/src/db/Db.vala"
...
#line 341 "/shotwell/src/db/Db.vala"
	version = 19;
#line 351 "/shotwell/src/db/Db.vala"
	version = 20;
#line 357 "/shotwell/src/db/Db.vala"
	_tmp46_ = version;
#line 357 "/shotwell/src/db/Db.vala"
	_vala_assert (_tmp46_ == DATABASE_TABLE_SCHEMA_VERSION, "version == DatabaseTable.SCHEMA_VERSION");
#line 358 "/shotwell/src/db/Db.vala"
