/* VersionTable.c generated by valac 0.36.6, the Vala compiler
...
static VersionTable* version_table_construct (GType object_type) {
	...
	gint _tmp5_;
	gint _tmp6_;
#line 10 "/shotwell/src/db/VersionTable.vala"
	self = (VersionTable*) database_table_construct (object_type);
#line 12 "/shotwell/src/db/VersionTable.vala"
...
#line 12 "/shotwell/src/db/VersionTable.vala"
	res = _tmp2_;
#line 18 "/shotwell/src/db/VersionTable.vala"
	_tmp3_ = res;
#line 18 "/shotwell/src/db/VersionTable.vala"
	_vala_assert (_tmp3_ == SQLITE_OK, "res == Sqlite.OK");
#line 20 "/shotwell/src/db/VersionTable.vala"
	_tmp4_ = stmt;
#line 20 "/shotwell/src/db/VersionTable.vala"
	_tmp5_ = sqlite3_step (_tmp4_);
#line 20 "/shotwell/src/db/VersionTable.vala"
	res = _tmp5_;
#line 21 "/shotwell/src/db/VersionTable.vala"
	_tmp6_ = res;
#line 21 "/shotwell/src/db/VersionTable.vala"
	if (_tmp6_ != SQLITE_DONE) {
#line 134 "VersionTable.c"
		gint _tmp7_;
#line 22 "/shotwell/src/db/VersionTable.vala"
		_tmp7_ = res;
#line 22 "/shotwell/src/db/VersionTable.vala"
		database_table_fatal ("create version table", _tmp7_);
#line 140 "VersionTable.c"
	}
#line 24 "/shotwell/src/db/VersionTable.vala"
...
#line 31 "/shotwell/src/db/VersionTable.vala"
...
VersionTable* version_table_get_instance (void) {
	...
	VersionTable* _tmp2_;
	VersionTable* _tmp3_;
#line 28 "/shotwell/src/db/VersionTable.vala"
	_tmp0_ = version_table_instance;
#line 28 "/shotwell/src/db/VersionTable.vala"
	if (_tmp0_ == NULL) {
#line 175 "VersionTable.c"
		VersionTable* _tmp1_;
#line 29 "/shotwell/src/db/VersionTable.vala"
...
gint version_table_get_version (VersionTable* self, gchar* * app_version) {
	...
	gint _tmp13_;
#line 34 "/shotwell/src/db/VersionTable.vala"
	g_return_val_if_fail (IS_VERSION_TABLE (self), 0);
#line 36 "/shotwell/src/db/VersionTable.vala"
	_tmp0_ = database_table_db;
#line 36 "/shotwell/src/db/VersionTable.vala"
...
#line 36 "/shotwell/src/db/VersionTable.vala"
	res = _tmp2_;
#line 38 "/shotwell/src/db/VersionTable.vala"
	_tmp3_ = res;
#line 38 "/shotwell/src/db/VersionTable.vala"
	_vala_assert (_tmp3_ == SQLITE_OK, "res == Sqlite.OK");
#line 40 "/shotwell/src/db/VersionTable.vala"
	_tmp4_ = stmt;
#line 40 "/shotwell/src/db/VersionTable.vala"
	_tmp5_ = sqlite3_step (_tmp4_);
#line 40 "/shotwell/src/db/VersionTable.vala"
	res = _tmp5_;
#line 41 "/shotwell/src/db/VersionTable.vala"
	_tmp6_ = res;
#line 41 "/shotwell/src/db/VersionTable.vala"
	if (_tmp6_ != SQLITE_ROW) {
#line 240 "VersionTable.c"
		gint _tmp7_;
#line 42 "/shotwell/src/db/VersionTable.vala"
		_tmp7_ = res;
#line 42 "/shotwell/src/db/VersionTable.vala"
		if (_tmp7_ != SQLITE_DONE) {
#line 246 "VersionTable.c"
			gint _tmp8_;
#line 43 "/shotwell/src/db/VersionTable.vala"
			_tmp8_ = res;
#line 43 "/shotwell/src/db/VersionTable.vala"
			database_table_fatal ("get_version", _tmp8_);
#line 252 "VersionTable.c"
		}
#line 45 "/shotwell/src/db/VersionTable.vala"
		_g_free0 (_vala_app_version);
#line 45 "/shotwell/src/db/VersionTable.vala"
		_vala_app_version = NULL;
#line 47 "/shotwell/src/db/VersionTable.vala"
		result = -1;
#line 47 "/shotwell/src/db/VersionTable.vala"
		_sqlite3_finalize0 (stmt);
#line 47 "/shotwell/src/db/VersionTable.vala"
...
#line 50 "/shotwell/src/db/VersionTable.vala"
	_tmp9_ = stmt;
#line 50 "/shotwell/src/db/VersionTable.vala"
...
#line 52 "/shotwell/src/db/VersionTable.vala"
	_tmp12_ = stmt;
#line 52 "/shotwell/src/db/VersionTable.vala"
...
void version_table_set_version (VersionTable* self, gint version, const gchar* app_version, const gchar* user_data) {
	...
	gint _tmp27_;
	gint _tmp28_;
#line 55 "/shotwell/src/db/VersionTable.vala"
	g_return_if_fail (IS_VERSION_TABLE (self));
#line 55 "/shotwell/src/db/VersionTable.vala"
	g_return_if_fail (app_version != NULL);
#line 59 "/shotwell/src/db/VersionTable.vala"
...
#line 347 "VersionTable.c"
		...
		gint _tmp4_;
		gint _tmp5_;
#line 61 "/shotwell/src/db/VersionTable.vala"
...
#line 61 "/shotwell/src/db/VersionTable.vala"
		res = _tmp4_;
#line 63 "/shotwell/src/db/VersionTable.vala"
		_tmp5_ = res;
#line 63 "/shotwell/src/db/VersionTable.vala"
...
#line 367 "VersionTable.c"
		...
		gint _tmp8_;
		gint _tmp9_;
#line 66 "/shotwell/src/db/VersionTable.vala"
...
#line 66 "/shotwell/src/db/VersionTable.vala"
		res = _tmp8_;
#line 68 "/shotwell/src/db/VersionTable.vala"
		_tmp9_ = res;
#line 68 "/shotwell/src/db/VersionTable.vala"
		_vala_assert (_tmp9_ == SQLITE_OK, "res == Sqlite.OK");
#line 388 "VersionTable.c"
	}
#line 71 "/shotwell/src/db/VersionTable.vala"
	_tmp10_ = stmt;
#line 71 "/shotwell/src/db/VersionTable.vala"
	_tmp11_ = version;
#line 71 "/shotwell/src/db/VersionTable.vala"
...
#line 71 "/shotwell/src/db/VersionTable.vala"
	res = _tmp12_;
#line 72 "/shotwell/src/db/VersionTable.vala"
	_tmp13_ = res;
#line 72 "/shotwell/src/db/VersionTable.vala"
	_vala_assert (_tmp13_ == SQLITE_OK, "res == Sqlite.OK");
#line 73 "/shotwell/src/db/VersionTable.vala"
	_tmp14_ = stmt;
#line 73 "/shotwell/src/db/VersionTable.vala"
	_tmp15_ = app_version;
#line 73 "/shotwell/src/db/VersionTable.vala"
...
#line 73 "/shotwell/src/db/VersionTable.vala"
	res = _tmp18_;
#line 74 "/shotwell/src/db/VersionTable.vala"
	_tmp19_ = res;
#line 74 "/shotwell/src/db/VersionTable.vala"
	_vala_assert (_tmp19_ == SQLITE_OK, "res == Sqlite.OK");
#line 75 "/shotwell/src/db/VersionTable.vala"
	_tmp20_ = stmt;
#line 75 "/shotwell/src/db/VersionTable.vala"
	_tmp21_ = user_data;
#line 75 "/shotwell/src/db/VersionTable.vala"
...
#line 75 "/shotwell/src/db/VersionTable.vala"
	res = _tmp24_;
#line 76 "/shotwell/src/db/VersionTable.vala"
	_tmp25_ = res;
#line 76 "/shotwell/src/db/VersionTable.vala"
	_vala_assert (_tmp25_ == SQLITE_OK, "res == Sqlite.OK");
#line 78 "/shotwell/src/db/VersionTable.vala"
	_tmp26_ = stmt;
#line 78 "/shotwell/src/db/VersionTable.vala"
	_tmp27_ = sqlite3_step (_tmp26_);
#line 78 "/shotwell/src/db/VersionTable.vala"
	res = _tmp27_;
#line 79 "/shotwell/src/db/VersionTable.vala"
	_tmp28_ = res;
#line 79 "/shotwell/src/db/VersionTable.vala"
...
#line 444 "VersionTable.c"
		...
		gchar* _tmp33_;
		gint _tmp34_;
#line 80 "/shotwell/src/db/VersionTable.vala"
		_tmp29_ = version;
#line 80 "/shotwell/src/db/VersionTable.vala"
		_tmp30_ = app_version;
#line 80 "/shotwell/src/db/VersionTable.vala"
...
void version_table_update_version (VersionTable* self, gint version, const gchar* app_version) {
	...
	gint _tmp15_;
	gint _tmp16_;
#line 83 "/shotwell/src/db/VersionTable.vala"
	g_return_if_fail (IS_VERSION_TABLE (self));
#line 83 "/shotwell/src/db/VersionTable.vala"
	g_return_if_fail (app_version != NULL);
#line 85 "/shotwell/src/db/VersionTable.vala"
	_tmp0_ = database_table_db;
#line 85 "/shotwell/src/db/VersionTable.vala"
...
#line 85 "/shotwell/src/db/VersionTable.vala"
	res = _tmp2_;
#line 86 "/shotwell/src/db/VersionTable.vala"
	_tmp3_ = res;
#line 86 "/shotwell/src/db/VersionTable.vala"
	_vala_assert (_tmp3_ == SQLITE_OK, "res == Sqlite.OK");
#line 88 "/shotwell/src/db/VersionTable.vala"
	_tmp4_ = stmt;
#line 88 "/shotwell/src/db/VersionTable.vala"
	_tmp5_ = version;
#line 88 "/shotwell/src/db/VersionTable.vala"
...
#line 88 "/shotwell/src/db/VersionTable.vala"
	res = _tmp6_;
#line 89 "/shotwell/src/db/VersionTable.vala"
	_tmp7_ = res;
#line 89 "/shotwell/src/db/VersionTable.vala"
	_vala_assert (_tmp7_ == SQLITE_OK, "res == Sqlite.OK");
#line 90 "/shotwell/src/db/VersionTable.vala"
	_tmp8_ = stmt;
#line 90 "/shotwell/src/db/VersionTable.vala"
	_tmp9_ = app_version;
#line 90 "/shotwell/src/db/VersionTable.vala"
...
#line 90 "/shotwell/src/db/VersionTable.vala"
	res = _tmp12_;
#line 91 "/shotwell/src/db/VersionTable.vala"
	_tmp13_ = res;
#line 91 "/shotwell/src/db/VersionTable.vala"
	_vala_assert (_tmp13_ == SQLITE_OK, "res == Sqlite.OK");
#line 93 "/shotwell/src/db/VersionTable.vala"
	_tmp14_ = stmt;
#line 93 "/shotwell/src/db/VersionTable.vala"
	_tmp15_ = sqlite3_step (_tmp14_);
#line 93 "/shotwell/src/db/VersionTable.vala"
	res = _tmp15_;
#line 94 "/shotwell/src/db/VersionTable.vala"
	_tmp16_ = res;
#line 94 "/shotwell/src/db/VersionTable.vala"
...
#line 553 "VersionTable.c"
		...
		gchar* _tmp19_;
		gint _tmp20_;
#line 95 "/shotwell/src/db/VersionTable.vala"
		_tmp17_ = version;
#line 95 "/shotwell/src/db/VersionTable.vala"
...
#line 7 "/shotwell/src/db/VersionTable.vala"
