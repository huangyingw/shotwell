/* TombstoneTable.c generated by valac 0.36.6, the Vala compiler
...
void tombstone_id_init (TombstoneID *self, gint64 id) {
	gint64 _tmp0_;
#line 12 "/shotwell/src/db/TombstoneTable.vala"
	memset (self, 0, sizeof (TombstoneID));
#line 13 "/shotwell/src/db/TombstoneTable.vala"
	_tmp0_ = id;
#line 13 "/shotwell/src/db/TombstoneTable.vala"
	(*self).id = _tmp0_;
...
gboolean tombstone_id_is_invalid (TombstoneID *self) {
	...
	gint64 _tmp0_;
#line 17 "/shotwell/src/db/TombstoneTable.vala"
	_tmp0_ = (*self).id;
#line 17 "/shotwell/src/db/TombstoneTable.vala"
...
gboolean tombstone_id_is_valid (TombstoneID *self) {
	gboolean result = FALSE;
	gint64 _tmp0_;
#line 21 "/shotwell/src/db/TombstoneTable.vala"
	_tmp0_ = (*self).id;
#line 21 "/shotwell/src/db/TombstoneTable.vala"
	result = _tmp0_ != TOMBSTONE_ID_INVALID;
#line 21 "/shotwell/src/db/TombstoneTable.vala"
...
TombstoneID* tombstone_id_dup (const TombstoneID* self) {
	TombstoneID* dup;
#line 7 "/shotwell/src/db/TombstoneTable.vala"
...
#line 25 "/shotwell/src/db/TombstoneTable.vala"
...
#line 27 "/shotwell/src/db/TombstoneTable.vala"
	_g_free0 (self->filepath);
#line 29 "/shotwell/src/db/TombstoneTable.vala"
	_g_free0 (self->md5);
...
#line 41 "/shotwell/src/db/TombstoneTable.vala"
	res = _tmp2_;
#line 51 "/shotwell/src/db/TombstoneTable.vala"
	_tmp3_ = res;
#line 51 "/shotwell/src/db/TombstoneTable.vala"
	_vala_assert (_tmp3_ == SQLITE_OK, "res == Sqlite.OK");
#line 53 "/shotwell/src/db/TombstoneTable.vala"
	_tmp4_ = stmt;
#line 53 "/shotwell/src/db/TombstoneTable.vala"
	_tmp5_ = sqlite3_step (_tmp4_);
#line 53 "/shotwell/src/db/TombstoneTable.vala"
	res = _tmp5_;
#line 54 "/shotwell/src/db/TombstoneTable.vala"
	_tmp6_ = res;
#line 54 "/shotwell/src/db/TombstoneTable.vala"
	if (_tmp6_ != SQLITE_DONE) {
#line 562 "TombstoneTable.c"
		gint _tmp7_;
#line 55 "/shotwell/src/db/TombstoneTable.vala"
		_tmp7_ = res;
#line 55 "/shotwell/src/db/TombstoneTable.vala"
...
#line 62 "/shotwell/src/db/TombstoneTable.vala"
...
#line 59 "/shotwell/src/db/TombstoneTable.vala"
	_tmp0_ = tombstone_table_instance;
#line 59 "/shotwell/src/db/TombstoneTable.vala"
	if (_tmp0_ == NULL) {
#line 601 "TombstoneTable.c"
		TombstoneTable* _tmp1_;
#line 60 "/shotwell/src/db/TombstoneTable.vala"
...
TombstoneRow* tombstone_table_add (TombstoneTable* self, const gchar* filepath, gint64 filesize, const gchar* md5, TombstoneReason reason, GError** error) {
	...
	TombstoneRow* _tmp35_;
	sqlite3* _tmp36_;
	gint64 _tmp37_;
	TombstoneRow* _tmp38_;
	const gchar* _tmp39_;
	gchar* _tmp40_;
	TombstoneRow* _tmp41_;
	gint64 _tmp42_;
	TombstoneRow* _tmp43_;
	const gchar* _tmp44_;
	gchar* _tmp45_;
	TombstoneRow* _tmp46_;
	time_t _tmp47_;
	TombstoneRow* _tmp48_;
	TombstoneReason _tmp49_;
	GError * _inner_error_ = NULL;
#line 65 "/shotwell/src/db/TombstoneTable.vala"
	g_return_val_if_fail (IS_TOMBSTONE_TABLE (self), NULL);
#line 65 "/shotwell/src/db/TombstoneTable.vala"
	g_return_val_if_fail (filepath != NULL, NULL);
#line 68 "/shotwell/src/db/TombstoneTable.vala"
	_tmp0_ = database_table_db;
#line 68 "/shotwell/src/db/TombstoneTable.vala"
...
#line 68 "/shotwell/src/db/TombstoneTable.vala"
	res = _tmp2_;
#line 72 "/shotwell/src/db/TombstoneTable.vala"
	_tmp3_ = res;
#line 72 "/shotwell/src/db/TombstoneTable.vala"
	_vala_assert (_tmp3_ == SQLITE_OK, "res == Sqlite.OK");
#line 74 "/shotwell/src/db/TombstoneTable.vala"
	_tmp4_ = now_sec ();
#line 74 "/shotwell/src/db/TombstoneTable.vala"
	time_created = (time_t) _tmp4_;
#line 76 "/shotwell/src/db/TombstoneTable.vala"
	_tmp5_ = stmt;
#line 76 "/shotwell/src/db/TombstoneTable.vala"
	_tmp6_ = filepath;
#line 76 "/shotwell/src/db/TombstoneTable.vala"
...
#line 76 "/shotwell/src/db/TombstoneTable.vala"
	res = _tmp9_;
#line 77 "/shotwell/src/db/TombstoneTable.vala"
	_tmp10_ = res;
#line 77 "/shotwell/src/db/TombstoneTable.vala"
	_vala_assert (_tmp10_ == SQLITE_OK, "res == Sqlite.OK");
#line 78 "/shotwell/src/db/TombstoneTable.vala"
	_tmp11_ = stmt;
#line 78 "/shotwell/src/db/TombstoneTable.vala"
	_tmp12_ = filesize;
#line 78 "/shotwell/src/db/TombstoneTable.vala"
...
#line 78 "/shotwell/src/db/TombstoneTable.vala"
	res = _tmp13_;
#line 79 "/shotwell/src/db/TombstoneTable.vala"
	_tmp14_ = res;
#line 79 "/shotwell/src/db/TombstoneTable.vala"
	_vala_assert (_tmp14_ == SQLITE_OK, "res == Sqlite.OK");
#line 80 "/shotwell/src/db/TombstoneTable.vala"
	_tmp15_ = stmt;
#line 80 "/shotwell/src/db/TombstoneTable.vala"
	_tmp16_ = md5;
#line 80 "/shotwell/src/db/TombstoneTable.vala"
...
#line 80 "/shotwell/src/db/TombstoneTable.vala"
	res = _tmp19_;
#line 81 "/shotwell/src/db/TombstoneTable.vala"
	_tmp20_ = res;
#line 81 "/shotwell/src/db/TombstoneTable.vala"
	_vala_assert (_tmp20_ == SQLITE_OK, "res == Sqlite.OK");
#line 82 "/shotwell/src/db/TombstoneTable.vala"
	_tmp21_ = stmt;
#line 82 "/shotwell/src/db/TombstoneTable.vala"
...
#line 82 "/shotwell/src/db/TombstoneTable.vala"
	res = _tmp23_;
#line 83 "/shotwell/src/db/TombstoneTable.vala"
	_tmp24_ = res;
#line 83 "/shotwell/src/db/TombstoneTable.vala"
	_vala_assert (_tmp24_ == SQLITE_OK, "res == Sqlite.OK");
#line 84 "/shotwell/src/db/TombstoneTable.vala"
	_tmp25_ = stmt;
#line 84 "/shotwell/src/db/TombstoneTable.vala"
	_tmp26_ = reason;
#line 84 "/shotwell/src/db/TombstoneTable.vala"
...
#line 84 "/shotwell/src/db/TombstoneTable.vala"
	res = _tmp28_;
#line 85 "/shotwell/src/db/TombstoneTable.vala"
	_tmp29_ = res;
#line 85 "/shotwell/src/db/TombstoneTable.vala"
	_vala_assert (_tmp29_ == SQLITE_OK, "res == Sqlite.OK");
#line 87 "/shotwell/src/db/TombstoneTable.vala"
	_tmp30_ = stmt;
#line 87 "/shotwell/src/db/TombstoneTable.vala"
	_tmp31_ = sqlite3_step (_tmp30_);
#line 87 "/shotwell/src/db/TombstoneTable.vala"
	res = _tmp31_;
#line 88 "/shotwell/src/db/TombstoneTable.vala"
	_tmp32_ = res;
#line 88 "/shotwell/src/db/TombstoneTable.vala"
	if (_tmp32_ != SQLITE_DONE) {
#line 781 "TombstoneTable.c"
		gint _tmp33_;
#line 89 "/shotwell/src/db/TombstoneTable.vala"
		_tmp33_ = res;
#line 89 "/shotwell/src/db/TombstoneTable.vala"
...
#line 91 "/shotwell/src/db/TombstoneTable.vala"
	_tmp34_ = tombstone_row_new ();
#line 91 "/shotwell/src/db/TombstoneTable.vala"
	row = _tmp34_;
#line 92 "/shotwell/src/db/TombstoneTable.vala"
	_tmp35_ = row;
#line 92 "/shotwell/src/db/TombstoneTable.vala"
...
#line 93 "/shotwell/src/db/TombstoneTable.vala"
	_tmp38_ = row;
#line 93 "/shotwell/src/db/TombstoneTable.vala"
	_tmp39_ = filepath;
#line 93 "/shotwell/src/db/TombstoneTable.vala"
...
#line 94 "/shotwell/src/db/TombstoneTable.vala"
	_tmp41_ = row;
#line 94 "/shotwell/src/db/TombstoneTable.vala"
	_tmp42_ = filesize;
#line 94 "/shotwell/src/db/TombstoneTable.vala"
	_tmp41_->filesize = _tmp42_;
#line 95 "/shotwell/src/db/TombstoneTable.vala"
	_tmp43_ = row;
#line 95 "/shotwell/src/db/TombstoneTable.vala"
	_tmp44_ = md5;
#line 95 "/shotwell/src/db/TombstoneTable.vala"
...
#line 95 "/shotwell/src/db/TombstoneTable.vala"
	_tmp43_->md5 = _tmp45_;
#line 96 "/shotwell/src/db/TombstoneTable.vala"
	_tmp46_ = row;
#line 96 "/shotwell/src/db/TombstoneTable.vala"
	_tmp47_ = time_created;
#line 96 "/shotwell/src/db/TombstoneTable.vala"
	_tmp46_->time_created = _tmp47_;
#line 97 "/shotwell/src/db/TombstoneTable.vala"
	_tmp48_ = row;
#line 97 "/shotwell/src/db/TombstoneTable.vala"
	_tmp49_ = reason;
#line 97 "/shotwell/src/db/TombstoneTable.vala"
	_tmp48_->reason = _tmp49_;
#line 99 "/shotwell/src/db/TombstoneTable.vala"
	result = row;
#line 99 "/shotwell/src/db/TombstoneTable.vala"
	_sqlite3_finalize0 (stmt);
#line 99 "/shotwell/src/db/TombstoneTable.vala"
...
#line 130 "/shotwell/src/db/TombstoneTable.vala"
...
TombstoneRow** tombstone_table_fetch_all (TombstoneTable* self, int* result_length1, GError** error) {
	...
	gint _tmp42_;
	gint _tmp43_;
	TombstoneRow** _tmp44_;
	gint _tmp44__length1;
	GError * _inner_error_ = NULL;
#line 102 "/shotwell/src/db/TombstoneTable.vala"
	g_return_val_if_fail (IS_TOMBSTONE_TABLE (self), NULL);
#line 103 "/shotwell/src/db/TombstoneTable.vala"
	_tmp0_ = database_table_get_row_count (G_TYPE_CHECK_INSTANCE_CAST (self, TYPE_DATABASE_TABLE, DatabaseTable));
#line 103 "/shotwell/src/db/TombstoneTable.vala"
	row_count = _tmp0_;
#line 104 "/shotwell/src/db/TombstoneTable.vala"
	_tmp1_ = row_count;
#line 104 "/shotwell/src/db/TombstoneTable.vala"
	if (_tmp1_ == 0) {
#line 910 "TombstoneTable.c"
		TombstoneRow** _tmp2_;
		gint _tmp2__length1;
#line 105 "/shotwell/src/db/TombstoneTable.vala"
		_tmp2_ = NULL;
#line 105 "/shotwell/src/db/TombstoneTable.vala"
		_tmp2__length1 = 0;
#line 105 "/shotwell/src/db/TombstoneTable.vala"
...
#line 108 "/shotwell/src/db/TombstoneTable.vala"
...
#line 108 "/shotwell/src/db/TombstoneTable.vala"
	res = _tmp5_;
#line 110 "/shotwell/src/db/TombstoneTable.vala"
	_tmp6_ = res;
#line 110 "/shotwell/src/db/TombstoneTable.vala"
	_vala_assert (_tmp6_ == SQLITE_OK, "res == Sqlite.OK");
#line 112 "/shotwell/src/db/TombstoneTable.vala"
	_tmp7_ = row_count;
#line 112 "/shotwell/src/db/TombstoneTable.vala"
...
#line 114 "/shotwell/src/db/TombstoneTable.vala"
	index = 0;
#line 955 "TombstoneTable.c"
	{
		gboolean _tmp9_ = FALSE;
#line 115 "/shotwell/src/db/TombstoneTable.vala"
		_tmp9_ = TRUE;
#line 115 "/shotwell/src/db/TombstoneTable.vala"
		while (TRUE) {
#line 962 "TombstoneTable.c"
			...
			gint _tmp35_;
			TombstoneReason _tmp36_;
			TombstoneRow** _tmp37_;
			gint _tmp37__length1;
			gint _tmp38_;
			TombstoneRow* _tmp39_;
			TombstoneRow* _tmp40_;
			TombstoneRow* _tmp41_;
#line 115 "/shotwell/src/db/TombstoneTable.vala"
			if (!_tmp9_) {
...
#line 115 "/shotwell/src/db/TombstoneTable.vala"
			_tmp9_ = FALSE;
#line 116 "/shotwell/src/db/TombstoneTable.vala"
			_tmp10_ = stmt;
#line 116 "/shotwell/src/db/TombstoneTable.vala"
			_tmp11_ = sqlite3_step (_tmp10_);
#line 116 "/shotwell/src/db/TombstoneTable.vala"
			res = _tmp11_;
#line 117 "/shotwell/src/db/TombstoneTable.vala"
			_tmp12_ = res;
#line 117 "/shotwell/src/db/TombstoneTable.vala"
			if (_tmp12_ == SQLITE_DONE) {
#line 118 "/shotwell/src/db/TombstoneTable.vala"
				break;
#line 1013 "TombstoneTable.c"
			} else {
				gint _tmp13_;
#line 119 "/shotwell/src/db/TombstoneTable.vala"
				_tmp13_ = res;
#line 119 "/shotwell/src/db/TombstoneTable.vala"
				if (_tmp13_ != SQLITE_ROW) {
#line 1020 "TombstoneTable.c"
					gint _tmp14_;
#line 120 "/shotwell/src/db/TombstoneTable.vala"
					_tmp14_ = res;
#line 120 "/shotwell/src/db/TombstoneTable.vala"
...
#line 122 "/shotwell/src/db/TombstoneTable.vala"
			_tmp15_ = tombstone_row_new ();
#line 122 "/shotwell/src/db/TombstoneTable.vala"
			row = _tmp15_;
#line 123 "/shotwell/src/db/TombstoneTable.vala"
			_tmp16_ = row;
#line 123 "/shotwell/src/db/TombstoneTable.vala"
			_tmp17_ = stmt;
#line 123 "/shotwell/src/db/TombstoneTable.vala"
...
#line 124 "/shotwell/src/db/TombstoneTable.vala"
			_tmp19_ = row;
#line 124 "/shotwell/src/db/TombstoneTable.vala"
			_tmp20_ = stmt;
#line 124 "/shotwell/src/db/TombstoneTable.vala"
...
#line 125 "/shotwell/src/db/TombstoneTable.vala"
			_tmp23_ = row;
#line 125 "/shotwell/src/db/TombstoneTable.vala"
			_tmp24_ = stmt;
#line 125 "/shotwell/src/db/TombstoneTable.vala"
...
#line 126 "/shotwell/src/db/TombstoneTable.vala"
			_tmp26_ = row;
#line 126 "/shotwell/src/db/TombstoneTable.vala"
			_tmp27_ = stmt;
#line 126 "/shotwell/src/db/TombstoneTable.vala"
...
#line 126 "/shotwell/src/db/TombstoneTable.vala"
			_tmp26_->md5 = _tmp29_;
#line 127 "/shotwell/src/db/TombstoneTable.vala"
			_tmp30_ = row;
#line 127 "/shotwell/src/db/TombstoneTable.vala"
			_tmp31_ = stmt;
#line 127 "/shotwell/src/db/TombstoneTable.vala"
...
#line 128 "/shotwell/src/db/TombstoneTable.vala"
			_tmp33_ = row;
#line 128 "/shotwell/src/db/TombstoneTable.vala"
			_tmp34_ = stmt;
#line 128 "/shotwell/src/db/TombstoneTable.vala"
...
#line 133 "/shotwell/src/db/TombstoneTable.vala"
	_tmp42_ = index;
#line 133 "/shotwell/src/db/TombstoneTable.vala"
	_tmp43_ = row_count;
#line 133 "/shotwell/src/db/TombstoneTable.vala"
	_vala_assert (_tmp42_ == _tmp43_, "index == row_count");
#line 135 "/shotwell/src/db/TombstoneTable.vala"
	_tmp44_ = rows;
#line 135 "/shotwell/src/db/TombstoneTable.vala"
...
void tombstone_table_update_file (TombstoneTable* self, TombstoneID* tombstone_id, const gchar* filepath, GError** error) {
	...
	const gchar* _tmp2_;
	GError * _inner_error_ = NULL;
#line 138 "/shotwell/src/db/TombstoneTable.vala"
	g_return_if_fail (IS_TOMBSTONE_TABLE (self));
#line 138 "/shotwell/src/db/TombstoneTable.vala"
	g_return_if_fail (tombstone_id != NULL);
#line 138 "/shotwell/src/db/TombstoneTable.vala"
	g_return_if_fail (filepath != NULL);
#line 139 "/shotwell/src/db/TombstoneTable.vala"
	_tmp0_ = *tombstone_id;
#line 139 "/shotwell/src/db/TombstoneTable.vala"
	_tmp1_ = _tmp0_.id;
#line 139 "/shotwell/src/db/TombstoneTable.vala"
...
void tombstone_table_remove (TombstoneTable* self, TombstoneID* tombstone_id, GError** error) {
	...
	gint64 _tmp1_;
	GError * _inner_error_ = NULL;
#line 142 "/shotwell/src/db/TombstoneTable.vala"
	g_return_if_fail (IS_TOMBSTONE_TABLE (self));
#line 142 "/shotwell/src/db/TombstoneTable.vala"
	g_return_if_fail (tombstone_id != NULL);
#line 143 "/shotwell/src/db/TombstoneTable.vala"
	_tmp0_ = *tombstone_id;
#line 143 "/shotwell/src/db/TombstoneTable.vala"
	_tmp1_ = _tmp0_.id;
#line 143 "/shotwell/src/db/TombstoneTable.vala"
...
#line 34 "/shotwell/src/db/TombstoneTable.vala"
