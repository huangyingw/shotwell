...
static Upgrades* upgrades_construct (GType object_type) {
	...
	gboolean _tmp4_;
	gboolean _tmp5_;
#line 15 "/shotwell/src/Upgrades.vala"
	self = (Upgrades*) g_type_create_instance (object_type);
#line 17 "/shotwell/src/Upgrades.vala"
...
#line 19 "/shotwell/src/Upgrades.vala"
...
#line 20 "/shotwell/src/Upgrades.vala"
...
void upgrades_init (void) {
	Upgrades* _tmp0_;
	Upgrades* _tmp1_;
#line 25 "/shotwell/src/Upgrades.vala"
	_tmp0_ = upgrades_instance;
#line 25 "/shotwell/src/Upgrades.vala"
	_vala_assert (_tmp0_ == NULL, "instance == null");
#line 26 "/shotwell/src/Upgrades.vala"
	_tmp1_ = upgrades_new ();
#line 26 "/shotwell/src/Upgrades.vala"
...
#line 30 "/shotwell/src/Upgrades.vala"
...
guint64 upgrades_get_step_count (Upgrades* self) {
	guint64 result = 0ULL;
	guint64 _tmp0_;
#line 34 "/shotwell/src/Upgrades.vala"
	g_return_val_if_fail (IS_UPGRADES (self), 0ULL);
#line 35 "/shotwell/src/Upgrades.vala"
...
#line 40 "/shotwell/src/Upgrades.vala"
...
void upgrades_execute (Upgrades* self, ProgressMonitor monitor, void* monitor_target) {
#line 39 "/shotwell/src/Upgrades.vala"
...
#line 41 "/shotwell/src/Upgrades.vala"
			_tmp11_ = task;
#line 41 "/shotwell/src/Upgrades.vala"
			_tmp12_ = monitor;
#line 41 "/shotwell/src/Upgrades.vala"
...
static void upgrades_add (Upgrades* self, UpgradeTask* task) {
	...
	UpgradeTask* _tmp4_;
#line 44 "/shotwell/src/Upgrades.vala"
	g_return_if_fail (IS_UPGRADES (self));
#line 44 "/shotwell/src/Upgrades.vala"
	g_return_if_fail (IS_UPGRADE_TASK (task));
#line 45 "/shotwell/src/Upgrades.vala"
	_tmp0_ = self->priv->total_steps;
#line 45 "/shotwell/src/Upgrades.vala"
	_tmp1_ = task;
#line 45 "/shotwell/src/Upgrades.vala"
...
#line 46 "/shotwell/src/Upgrades.vala"
...
#line 10 "/shotwell/src/Upgrades.vala"
...
#line 12 "/shotwell/src/Upgrades.vala"
	self->priv->total_steps = (guint64) 0;
#line 13 "/shotwell/src/Upgrades.vala"
...
guint64 upgrade_task_get_step_count (UpgradeTask* self) {
#line 55 "/shotwell/src/Upgrades.vala"
...
void upgrade_task_execute (UpgradeTask* self, ProgressMonitor monitor, void* monitor_target) {
#line 60 "/shotwell/src/Upgrades.vala"
...
#line 53 "/shotwell/src/Upgrades.vala"
...
#line 71 "/shotwell/src/Upgrades.vala"
...
#line 1113 "Upgrades.c"
	{
		...
		GFile* _tmp1_;
		guint64 _tmp2_;
#line 73 "/shotwell/src/Upgrades.vala"
...
#line 1131 "Upgrades.c"
	...
	__catch593_g_error:
	{
		...
		GError* _tmp3_;
		const gchar* _tmp4_;
#line 72 "/shotwell/src/Upgrades.vala"
		e = _inner_error_;
#line 72 "/shotwell/src/Upgrades.vala"
		_inner_error_ = NULL;
#line 75 "/shotwell/src/Upgrades.vala"
		_tmp3_ = e;
#line 75 "/shotwell/src/Upgrades.vala"
...
#line 77 "/shotwell/src/Upgrades.vala"
...
static void mimics_removal_task_real_execute (UpgradeTask* base, ProgressMonitor monitor, void* monitor_target) {
	MimicsRemovalTask * self;
	GError * _inner_error_ = NULL;
#line 80 "/shotwell/src/Upgrades.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_MIMICS_REMOVAL_TASK, MimicsRemovalTask);
#line 1181 "Upgrades.c"
	{
		...
		guint64 _tmp2_;
		GFile* _tmp3_;
#line 82 "/shotwell/src/Upgrades.vala"
...
#line 83 "/shotwell/src/Upgrades.vala"
...
#line 1209 "Upgrades.c"
	...
	__catch594_g_error:
	{
		...
		GError* _tmp4_;
		const gchar* _tmp5_;
#line 81 "/shotwell/src/Upgrades.vala"
		e = _inner_error_;
#line 81 "/shotwell/src/Upgrades.vala"
		_inner_error_ = NULL;
#line 85 "/shotwell/src/Upgrades.vala"
		_tmp4_ = e;
#line 85 "/shotwell/src/Upgrades.vala"
...
#line 66 "/shotwell/src/Upgrades.vala"
...
#line 68 "/shotwell/src/Upgrades.vala"
...
#line 68 "/shotwell/src/Upgrades.vala"
	_g_object_unref0 (_tmp1_);
#line 69 "/shotwell/src/Upgrades.vala"
...
#line 1342 "Upgrades.c"
	{
		...
		gint _tmp6_;
		gint _phr_index = 0;
#line 97 "/shotwell/src/Upgrades.vala"
...
#line 98 "/shotwell/src/Upgrades.vala"
			_tmp13_ = phr;
#line 98 "/shotwell/src/Upgrades.vala"
...
#line 1419 "Upgrades.c"
				gint _tmp16_;
#line 99 "/shotwell/src/Upgrades.vala"
...
#line 101 "/shotwell/src/Upgrades.vala"
...
static void fixup_raw_thumbnails_task_real_execute (UpgradeTask* base, ProgressMonitor monitor, void* monitor_target) {
	FixupRawThumbnailsTask * self;
#line 104 "/shotwell/src/Upgrades.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, TYPE_FIXUP_RAW_THUMBNAILS_TASK, FixupRawThumbnailsTask);
#line 105 "/shotwell/src/Upgrades.vala"
...
#line 1449 "Upgrades.c"
	{
		...
		gint _tmp6_;
		gint _phr_index = 0;
#line 107 "/shotwell/src/Upgrades.vala"
		_tmp0_ = photo_table_get_instance ();
#line 107 "/shotwell/src/Upgrades.vala"
		_tmp1_ = _tmp0_;
#line 107 "/shotwell/src/Upgrades.vala"
...
#line 107 "/shotwell/src/Upgrades.vala"
			phr = (PhotoRow*) _tmp12_;
#line 108 "/shotwell/src/Upgrades.vala"
			_tmp14_ = phr;
#line 108 "/shotwell/src/Upgrades.vala"
...
#line 109 "/shotwell/src/Upgrades.vala"
				_tmp17_ = phr;
#line 109 "/shotwell/src/Upgrades.vala"
...
#line 110 "/shotwell/src/Upgrades.vala"
...
#line 93 "/shotwell/src/Upgrades.vala"
