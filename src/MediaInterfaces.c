...
#line 54 "/shotwell/src/MediaInterfaces.vala"
...
#line 63 "/shotwell/src/MediaInterfaces.vala"
	g_return_if_fail (IS_TRANSACTION_CONTROLLER (self));
#line 262 "MediaInterfaces.c"
	{
		gint _tmp0_;
#line 64 "/shotwell/src/MediaInterfaces.vala"
...
#line 269 "MediaInterfaces.c"
		{
			gint _tmp1_;
#line 65 "/shotwell/src/MediaInterfaces.vala"
...
#line 66 "/shotwell/src/MediaInterfaces.vala"
				return;
#line 289 "MediaInterfaces.c"
			}
			{
#line 69 "/shotwell/src/MediaInterfaces.vala"
...
#line 296 "MediaInterfaces.c"
			...
			__catch572_g_error:
			{
				...
				gint _tmp3_;
				GError* _tmp4_;
#line 68 "/shotwell/src/MediaInterfaces.vala"
				err = _inner_error_;
#line 68 "/shotwell/src/MediaInterfaces.vala"
				_inner_error_ = NULL;
#line 72 "/shotwell/src/MediaInterfaces.vala"
				_tmp3_ = self->priv->count;
#line 72 "/shotwell/src/MediaInterfaces.vala"
				self->priv->count = _tmp3_ - 1;
#line 74 "/shotwell/src/MediaInterfaces.vala"
				_tmp4_ = err;
#line 74 "/shotwell/src/MediaInterfaces.vala"
				if (_tmp4_->domain == DATABASE_ERROR) {
#line 318 "MediaInterfaces.c"
					GError* _tmp5_;
#line 75 "/shotwell/src/MediaInterfaces.vala"
					_tmp5_ = err;
#line 75 "/shotwell/src/MediaInterfaces.vala"
...
#line 324 "MediaInterfaces.c"
					...
					gchar* _tmp8_;
					gchar* _tmp9_;
#line 77 "/shotwell/src/MediaInterfaces.vala"
					_tmp6_ = err;
#line 77 "/shotwell/src/MediaInterfaces.vala"
...
static void transaction_controller_real_begin_impl (TransactionController* self, GError** error) {
#line 83 "/shotwell/src/MediaInterfaces.vala"
...
void transaction_controller_commit (TransactionController* self) {
	GError * _inner_error_ = NULL;
#line 85 "/shotwell/src/MediaInterfaces.vala"
	g_return_if_fail (IS_TRANSACTION_CONTROLLER (self));
#line 414 "MediaInterfaces.c"
	{
		gint _tmp0_;
#line 86 "/shotwell/src/MediaInterfaces.vala"
		_tmp0_ = self->priv->count;
#line 86 "/shotwell/src/MediaInterfaces.vala"
		g_rec_mutex_lock (&self->priv->__lock_count);
#line 421 "MediaInterfaces.c"
		{
			...
			gint _tmp2_;
			gint _tmp3_;
#line 87 "/shotwell/src/MediaInterfaces.vala"
			_tmp1_ = self->priv->count;
#line 87 "/shotwell/src/MediaInterfaces.vala"
			_vala_assert (_tmp1_ > 0, "count > 0");
#line 88 "/shotwell/src/MediaInterfaces.vala"
			_tmp2_ = self->priv->count;
#line 88 "/shotwell/src/MediaInterfaces.vala"
...
#line 89 "/shotwell/src/MediaInterfaces.vala"
				return;
#line 449 "MediaInterfaces.c"
			}
			{
#line 93 "/shotwell/src/MediaInterfaces.vala"
...
#line 456 "MediaInterfaces.c"
			...
			__catch574_g_error:
			{
				GError* err = NULL;
				GError* _tmp5_;
#line 92 "/shotwell/src/MediaInterfaces.vala"
				err = _inner_error_;
#line 92 "/shotwell/src/MediaInterfaces.vala"
				_inner_error_ = NULL;
#line 95 "/shotwell/src/MediaInterfaces.vala"
				_tmp5_ = err;
#line 95 "/shotwell/src/MediaInterfaces.vala"
				if (_tmp5_->domain == DATABASE_ERROR) {
#line 473 "MediaInterfaces.c"
					GError* _tmp6_;
#line 96 "/shotwell/src/MediaInterfaces.vala"
					_tmp6_ = err;
#line 96 "/shotwell/src/MediaInterfaces.vala"
...
#line 479 "MediaInterfaces.c"
					...
					gchar* _tmp9_;
					gchar* _tmp10_;
#line 98 "/shotwell/src/MediaInterfaces.vala"
					_tmp7_ = err;
#line 98 "/shotwell/src/MediaInterfaces.vala"
...
static void transaction_controller_real_commit_impl (TransactionController* self, GError** error) {
#line 104 "/shotwell/src/MediaInterfaces.vala"
...
#line 51 "/shotwell/src/MediaInterfaces.vala"
...
#line 52 "/shotwell/src/MediaInterfaces.vala"
...
#line 780 "MediaInterfaces.c"
	{
		gint _tmp0_;
#line 58 "/shotwell/src/MediaInterfaces.vala"
		_tmp0_ = self->priv->count;
#line 58 "/shotwell/src/MediaInterfaces.vala"
		g_rec_mutex_lock (&self->priv->__lock_count);
#line 787 "MediaInterfaces.c"
		{
			gint _tmp1_;
#line 59 "/shotwell/src/MediaInterfaces.vala"
			_tmp1_ = self->priv->count;
#line 59 "/shotwell/src/MediaInterfaces.vala"
			_vala_assert (_tmp1_ == 0, "count == 0");
...
gboolean flaggable_is_flagged (Flaggable* self) {
#line 115 "/shotwell/src/MediaInterfaces.vala"
...
void flaggable_mark_flagged (Flaggable* self) {
#line 117 "/shotwell/src/MediaInterfaces.vala"
...
void flaggable_mark_unflagged (Flaggable* self) {
#line 119 "/shotwell/src/MediaInterfaces.vala"
	g_return_if_fail (IS_FLAGGABLE (self));
#line 119 "/shotwell/src/MediaInterfaces.vala"
...
#line 121 "/shotwell/src/MediaInterfaces.vala"
...
#line 123 "/shotwell/src/MediaInterfaces.vala"
	_tmp0_ = controller;
#line 123 "/shotwell/src/MediaInterfaces.vala"
	transaction_controller_begin (_tmp0_);
#line 125 "/shotwell/src/MediaInterfaces.vala"
	_tmp1_ = flag;
#line 125 "/shotwell/src/MediaInterfaces.vala"
	if (_tmp1_ != NULL) {
#line 905 "MediaInterfaces.c"
		{
			...
			GeeIterator* _tmp3_;
#line 126 "/shotwell/src/MediaInterfaces.vala"
			_tmp2_ = flag;
#line 126 "/shotwell/src/MediaInterfaces.vala"
...
#line 127 "/shotwell/src/MediaInterfaces.vala"
				_tmp8_ = flaggable;
#line 127 "/shotwell/src/MediaInterfaces.vala"
...
#line 130 "/shotwell/src/MediaInterfaces.vala"
	_tmp9_ = unflag;
#line 130 "/shotwell/src/MediaInterfaces.vala"
	if (_tmp9_ != NULL) {
#line 958 "MediaInterfaces.c"
		{
			...
			GeeIterator* _tmp11_;
#line 131 "/shotwell/src/MediaInterfaces.vala"
			_tmp10_ = unflag;
#line 131 "/shotwell/src/MediaInterfaces.vala"
...
#line 132 "/shotwell/src/MediaInterfaces.vala"
				_tmp16_ = flaggable;
#line 132 "/shotwell/src/MediaInterfaces.vala"
...
#line 135 "/shotwell/src/MediaInterfaces.vala"
	_tmp17_ = controller;
#line 135 "/shotwell/src/MediaInterfaces.vala"
...
#line 114 "/shotwell/src/MediaInterfaces.vala"
...
gboolean monitorable_is_offline (Monitorable* self) {
#line 153 "/shotwell/src/MediaInterfaces.vala"
...
void monitorable_mark_online (Monitorable* self) {
#line 155 "/shotwell/src/MediaInterfaces.vala"
...
void monitorable_mark_offline (Monitorable* self) {
#line 157 "/shotwell/src/MediaInterfaces.vala"
	g_return_if_fail (IS_MONITORABLE (self));
#line 157 "/shotwell/src/MediaInterfaces.vala"
...
void monitorable_mark_many_online_offline (GeeCollection* online, GeeCollection* offline, TransactionController* controller, GError** error) {
	...
	GeeCollection* _tmp9_;
	TransactionController* _tmp17_;
#line 159 "/shotwell/src/MediaInterfaces.vala"
	g_return_if_fail ((online == NULL) || GEE_IS_COLLECTION (online));
#line 159 "/shotwell/src/MediaInterfaces.vala"
	g_return_if_fail ((offline == NULL) || GEE_IS_COLLECTION (offline));
#line 159 "/shotwell/src/MediaInterfaces.vala"
	g_return_if_fail (IS_TRANSACTION_CONTROLLER (controller));
#line 161 "/shotwell/src/MediaInterfaces.vala"
	_tmp0_ = controller;
#line 161 "/shotwell/src/MediaInterfaces.vala"
	transaction_controller_begin (_tmp0_);
#line 163 "/shotwell/src/MediaInterfaces.vala"
	_tmp1_ = online;
#line 163 "/shotwell/src/MediaInterfaces.vala"
	if (_tmp1_ != NULL) {
#line 1086 "MediaInterfaces.c"
		{
			...
			GeeCollection* _tmp2_;
			GeeIterator* _tmp3_;
#line 164 "/shotwell/src/MediaInterfaces.vala"
			_tmp2_ = online;
#line 164 "/shotwell/src/MediaInterfaces.vala"
			_tmp3_ = gee_iterable_iterator (G_TYPE_CHECK_INSTANCE_CAST (_tmp2_, GEE_TYPE_ITERABLE, GeeIterable));
#line 164 "/shotwell/src/MediaInterfaces.vala"
...
#line 165 "/shotwell/src/MediaInterfaces.vala"
				_tmp8_ = monitorable;
#line 165 "/shotwell/src/MediaInterfaces.vala"
...
#line 168 "/shotwell/src/MediaInterfaces.vala"
	_tmp9_ = offline;
#line 168 "/shotwell/src/MediaInterfaces.vala"
	if (_tmp9_ != NULL) {
#line 1139 "MediaInterfaces.c"
		{
			...
			GeeCollection* _tmp10_;
			GeeIterator* _tmp11_;
#line 169 "/shotwell/src/MediaInterfaces.vala"
			_tmp10_ = offline;
#line 169 "/shotwell/src/MediaInterfaces.vala"
			_tmp11_ = gee_iterable_iterator (G_TYPE_CHECK_INSTANCE_CAST (_tmp10_, GEE_TYPE_ITERABLE, GeeIterable));
#line 169 "/shotwell/src/MediaInterfaces.vala"
...
#line 170 "/shotwell/src/MediaInterfaces.vala"
				_tmp16_ = monitorable;
#line 170 "/shotwell/src/MediaInterfaces.vala"
...
#line 173 "/shotwell/src/MediaInterfaces.vala"
	_tmp17_ = controller;
#line 173 "/shotwell/src/MediaInterfaces.vala"
	transaction_controller_commit (_tmp17_);
...
void monitorable_set_master_file (Monitorable* self, GFile* file) {
#line 176 "/shotwell/src/MediaInterfaces.vala"
	g_return_if_fail (IS_MONITORABLE (self));
#line 176 "/shotwell/src/MediaInterfaces.vala"
...
#line 178 "/shotwell/src/MediaInterfaces.vala"
	g_return_if_fail (GEE_IS_MAP (map));
#line 178 "/shotwell/src/MediaInterfaces.vala"
	g_return_if_fail (IS_TRANSACTION_CONTROLLER (controller));
#line 180 "/shotwell/src/MediaInterfaces.vala"
	_tmp0_ = controller;
#line 180 "/shotwell/src/MediaInterfaces.vala"
	transaction_controller_begin (_tmp0_);
#line 182 "/shotwell/src/MediaInterfaces.vala"
	_tmp1_ = map;
#line 182 "/shotwell/src/MediaInterfaces.vala"
	_tmp2_ = gee_map_map_iterator (_tmp1_);
#line 182 "/shotwell/src/MediaInterfaces.vala"
	map_iter = _tmp2_;
#line 183 "/shotwell/src/MediaInterfaces.vala"
	while (TRUE) {
...
#line 184 "/shotwell/src/MediaInterfaces.vala"
		_tmp5_ = map_iter;
#line 184 "/shotwell/src/MediaInterfaces.vala"
...
#line 186 "/shotwell/src/MediaInterfaces.vala"
	_tmp11_ = controller;
#line 186 "/shotwell/src/MediaInterfaces.vala"
...
void monitorable_set_master_timestamp (Monitorable* self, GFileInfo* info) {
#line 189 "/shotwell/src/MediaInterfaces.vala"
	g_return_if_fail (IS_MONITORABLE (self));
#line 189 "/shotwell/src/MediaInterfaces.vala"
...
void monitorable_set_many_master_timestamp (GeeMap* map, TransactionController* controller, GError** error) {
	...
	GeeMapIterator* _tmp2_;
	TransactionController* _tmp11_;
#line 191 "/shotwell/src/MediaInterfaces.vala"
	g_return_if_fail (GEE_IS_MAP (map));
#line 191 "/shotwell/src/MediaInterfaces.vala"
	g_return_if_fail (IS_TRANSACTION_CONTROLLER (controller));
#line 193 "/shotwell/src/MediaInterfaces.vala"
	_tmp0_ = controller;
#line 193 "/shotwell/src/MediaInterfaces.vala"
	transaction_controller_begin (_tmp0_);
#line 195 "/shotwell/src/MediaInterfaces.vala"
	_tmp1_ = map;
#line 195 "/shotwell/src/MediaInterfaces.vala"
	_tmp2_ = gee_map_map_iterator (_tmp1_);
#line 195 "/shotwell/src/MediaInterfaces.vala"
	map_iter = _tmp2_;
#line 196 "/shotwell/src/MediaInterfaces.vala"
	while (TRUE) {
...
#line 197 "/shotwell/src/MediaInterfaces.vala"
		_tmp5_ = map_iter;
#line 197 "/shotwell/src/MediaInterfaces.vala"
		_tmp6_ = gee_map_iterator_get_key (_tmp5_);
#line 197 "/shotwell/src/MediaInterfaces.vala"
...
#line 199 "/shotwell/src/MediaInterfaces.vala"
	_tmp11_ = controller;
#line 199 "/shotwell/src/MediaInterfaces.vala"
	transaction_controller_commit (_tmp11_);
#line 191 "/shotwell/src/MediaInterfaces.vala"
...
#line 152 "/shotwell/src/MediaInterfaces.vala"
	static gboolean initialized = FALSE;
#line 152 "/shotwell/src/MediaInterfaces.vala"
	if (!initialized) {
#line 152 "/shotwell/src/MediaInterfaces.vala"
...
void dateable_set_exposure_time (Dateable* self, time_t target_time) {
#line 212 "/shotwell/src/MediaInterfaces.vala"
...
time_t dateable_get_exposure_time (Dateable* self) {
#line 214 "/shotwell/src/MediaInterfaces.vala"
...
#line 211 "/shotwell/src/MediaInterfaces.vala"
	static gboolean initialized = FALSE;
#line 211 "/shotwell/src/MediaInterfaces.vala"
	if (!initialized) {
#line 211 "/shotwell/src/MediaInterfaces.vala"
