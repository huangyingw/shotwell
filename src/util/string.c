...
inline gboolean is_string_empty (const gchar* s) {
	...
	const gchar* _tmp1_;
#line 12 "/shotwell/src/util/string.vala"
	_tmp1_ = s;
#line 12 "/shotwell/src/util/string.vala"
	if (_tmp1_ == NULL) {
#line 12 "/shotwell/src/util/string.vala"
...
gint utf8_cs_compare (void* a, void* b) {
	...
	void* _tmp1_;
	gint _tmp2_;
#line 17 "/shotwell/src/util/string.vala"
	_tmp0_ = a;
#line 17 "/shotwell/src/util/string.vala"
	_tmp1_ = b;
#line 17 "/shotwell/src/util/string.vala"
...
gint utf8_ci_compare (void* a, void* b) {
	...
	gint _tmp6_;
	gint _tmp7_;
#line 22 "/shotwell/src/util/string.vala"
	_tmp0_ = a;
#line 22 "/shotwell/src/util/string.vala"
...
gchar* uchar_array_to_string (guchar* data, int data_length1, gint length) {
	...
	const gchar* _tmp15_;
	gchar* _tmp16_;
#line 27 "/shotwell/src/util/string.vala"
	_tmp0_ = length;
#line 27 "/shotwell/src/util/string.vala"
	if (_tmp0_ < 0) {
#line 184 "string.c"
		guchar* _tmp1_;
		gint _tmp1__length1;
#line 28 "/shotwell/src/util/string.vala"
		_tmp1_ = data;
#line 28 "/shotwell/src/util/string.vala"
...
#line 30 "/shotwell/src/util/string.vala"
	_tmp2_ = g_string_new ("");
#line 30 "/shotwell/src/util/string.vala"
	builder = _tmp2_;
#line 199 "string.c"
	{
		gint ctr = 0;
#line 31 "/shotwell/src/util/string.vala"
		ctr = 0;
#line 204 "string.c"
		{
...
#line 32 "/shotwell/src/util/string.vala"
				_tmp7_ = data;
#line 32 "/shotwell/src/util/string.vala"
...
#line 250 "string.c"
					...
					gint _tmp12_;
					guchar _tmp13_;
#line 33 "/shotwell/src/util/string.vala"
					_tmp10_ = builder;
#line 33 "/shotwell/src/util/string.vala"
					_tmp11_ = data;
#line 33 "/shotwell/src/util/string.vala"
...
#line 35 "/shotwell/src/util/string.vala"
					break;
#line 272 "string.c"
				}
			}
...
#line 38 "/shotwell/src/util/string.vala"
	_tmp14_ = builder;
#line 38 "/shotwell/src/util/string.vala"
	_tmp15_ = _tmp14_->str;
#line 38 "/shotwell/src/util/string.vala"
...
static void _vala_array_add1 (guchar* * array, int* length, int* size, guchar value) {
#line 45 "/shotwell/src/util/string.vala"
	if ((*length) == (*size)) {
#line 45 "/shotwell/src/util/string.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 45 "/shotwell/src/util/string.vala"
...
guchar* string_to_uchar_array (const gchar* str, int* result_length1) {
	...
	guchar* _tmp11_;
	gint _tmp11__length1;
#line 42 "/shotwell/src/util/string.vala"
	g_return_val_if_fail (str != NULL, NULL);
#line 43 "/shotwell/src/util/string.vala"
...
#line 326 "string.c"
	{
		gint ctr = 0;
#line 44 "/shotwell/src/util/string.vala"
		ctr = 0;
#line 331 "string.c"
		{
...
#line 47 "/shotwell/src/util/string.vala"
	_tmp11_ = data;
#line 47 "/shotwell/src/util/string.vala"
	_tmp11__length1 = data_length1;
#line 47 "/shotwell/src/util/string.vala"
...
inline gchar* guarded_markup_escape_text (const gchar* plain) {
	...
	const gchar* _tmp2_;
	gboolean _tmp3_;
#line 58 "/shotwell/src/util/string.vala"
	_tmp2_ = plain;
#line 58 "/shotwell/src/util/string.vala"
...
glong find_last_offset (const gchar* str, gchar c) {
	...
	gint _tmp1_;
	gint _tmp2_;
#line 61 "/shotwell/src/util/string.vala"
	g_return_val_if_fail (str != NULL, 0L);
#line 62 "/shotwell/src/util/string.vala"
	_tmp0_ = str;
#line 62 "/shotwell/src/util/string.vala"
...
#line 62 "/shotwell/src/util/string.vala"
	offset = (glong) _tmp2_;
#line 63 "/shotwell/src/util/string.vala"
	while (TRUE) {
#line 485 "string.c"
		glong _tmp3_;
		glong _tmp4_;
...
#line 64 "/shotwell/src/util/string.vala"
		_tmp5_ = str;
#line 64 "/shotwell/src/util/string.vala"
		_tmp6_ = offset;
#line 64 "/shotwell/src/util/string.vala"
...
#line 64 "/shotwell/src/util/string.vala"
		if (_tmp7_ == _tmp8_) {
#line 65 "/shotwell/src/util/string.vala"
			result = offset;
#line 65 "/shotwell/src/util/string.vala"
			return result;
#line 518 "string.c"
...
#line 68 "/shotwell/src/util/string.vala"
	result = (glong) -1;
#line 68 "/shotwell/src/util/string.vala"
	return result;
#line 525 "string.c"
...
gboolean is_in_ci_array (const gchar* str, gchar** strings, int strings_length1) {
	...
	gchar** _tmp2_;
	gint _tmp2__length1;
#line 73 "/shotwell/src/util/string.vala"
	g_return_val_if_fail (str != NULL, FALSE);
#line 74 "/shotwell/src/util/string.vala"
	_tmp0_ = str;
#line 74 "/shotwell/src/util/string.vala"
	_tmp1_ = g_utf8_strdown (_tmp0_, (gssize) -1);
#line 74 "/shotwell/src/util/string.vala"
	strdown = _tmp1_;
#line 75 "/shotwell/src/util/string.vala"
	_tmp2_ = strings;
#line 75 "/shotwell/src/util/string.vala"
...
#line 567 "string.c"
			{
				const gchar* _tmp4_;
				const gchar* _tmp5_;
#line 76 "/shotwell/src/util/string.vala"
				_tmp4_ = strdown;
#line 76 "/shotwell/src/util/string.vala"
				_tmp5_ = str_element;
#line 76 "/shotwell/src/util/string.vala"
				if (g_strcmp0 (_tmp4_, _tmp5_) == 0) {
#line 77 "/shotwell/src/util/string.vala"
					result = TRUE;
#line 77 "/shotwell/src/util/string.vala"
...
#line 80 "/shotwell/src/util/string.vala"
	result = FALSE;
#line 80 "/shotwell/src/util/string.vala"
	_g_free0 (strdown);
#line 80 "/shotwell/src/util/string.vala"
...
#line 94 "/shotwell/src/util/string.vala"
	g_return_val_if_fail (text != NULL, NULL);
#line 95 "/shotwell/src/util/string.vala"
	output = NULL;
#line 96 "/shotwell/src/util/string.vala"
	bytes_read = (gsize) 0;
#line 97 "/shotwell/src/util/string.vala"
	charset = NULL;
#line 98 "/shotwell/src/util/string.vala"
	g_debug ("string.vala:98: CONVERT: Text did not validate as UTF-8, trying conver" \
"sion");
#line 101 "/shotwell/src/util/string.vala"
...
#line 643 "string.c"
		...
		gint _tmp10_;
		gint _tmp11_;
#line 102 "/shotwell/src/util/string.vala"
		_tmp2_ = text;
#line 102 "/shotwell/src/util/string.vala"
		_tmp3_ = text;
#line 102 "/shotwell/src/util/string.vala"
...
#line 102 "/shotwell/src/util/string.vala"
		output = _tmp7_;
#line 103 "/shotwell/src/util/string.vala"
		_tmp8_ = bytes_read;
#line 103 "/shotwell/src/util/string.vala"
		_tmp9_ = text;
#line 103 "/shotwell/src/util/string.vala"
...
#line 680 "string.c"
			const gchar* _tmp12_;
#line 104 "/shotwell/src/util/string.vala"
			_tmp12_ = charset;
#line 104 "/shotwell/src/util/string.vala"
			g_debug ("string.vala:104: CONVERT: Locale is not UTF-8, convert from %s", _tmp12_);
#line 105 "/shotwell/src/util/string.vala"
			result = output;
#line 105 "/shotwell/src/util/string.vala"
			return result;
#line 690 "string.c"
	...
	}
	{
		...
		gchar* _tmp19_;
		gchar* _tmp20_;
#line 110 "/shotwell/src/util/string.vala"
		_tmp14_ = text;
#line 110 "/shotwell/src/util/string.vala"
		_tmp15_ = text;
#line 110 "/shotwell/src/util/string.vala"
...
#line 110 "/shotwell/src/util/string.vala"
		output = _tmp20_;
#line 111 "/shotwell/src/util/string.vala"
		charset = "WINDOWS-1252";
#line 109 "/shotwell/src/util/string.vala"
		_g_free0 (_tmp13_);
#line 745 "string.c"
	}
	goto __finally6;
...
#line 109 "/shotwell/src/util/string.vala"
		_inner_error_ = NULL;
#line 113 "/shotwell/src/util/string.vala"
		_tmp21_ = _error_;
#line 113 "/shotwell/src/util/string.vala"
...
#line 760 "string.c"
			{
				...
				gchar* _tmp28_;
				gchar* _tmp29_;
#line 115 "/shotwell/src/util/string.vala"
				_tmp23_ = text;
#line 115 "/shotwell/src/util/string.vala"
				_tmp24_ = text;
#line 115 "/shotwell/src/util/string.vala"
...
#line 115 "/shotwell/src/util/string.vala"
				output = _tmp29_;
#line 116 "/shotwell/src/util/string.vala"
				charset = "ISO-8859-1";
#line 114 "/shotwell/src/util/string.vala"
				_g_free0 (_tmp22_);
#line 801 "string.c"
			}
			goto __finally7;
...
#line 121 "/shotwell/src/util/string.vala"
	_tmp30_ = bytes_read;
#line 121 "/shotwell/src/util/string.vala"
	_tmp31_ = text;
#line 121 "/shotwell/src/util/string.vala"
...
#line 860 "string.c"
		const gchar* _tmp34_;
#line 122 "/shotwell/src/util/string.vala"
		_tmp34_ = charset;
#line 122 "/shotwell/src/util/string.vala"
		g_debug ("string.vala:122: CONVERT: Guessed conversion from %s", _tmp34_);
#line 124 "/shotwell/src/util/string.vala"
		result = output;
#line 124 "/shotwell/src/util/string.vala"
		return result;
#line 870 "string.c"
	}
#line 127 "/shotwell/src/util/string.vala"
	result = NULL;
#line 127 "/shotwell/src/util/string.vala"
	_g_free0 (output);
#line 127 "/shotwell/src/util/string.vala"
...
gchar* prepare_input_text (const gchar* text, PrepareInputTextOptions options, gint dest_length) {
	...
	gint _tmp25_;
#line 131 "/shotwell/src/util/string.vala"
	_tmp0_ = text;
#line 131 "/shotwell/src/util/string.vala"
	if (_tmp0_ == NULL) {
#line 132 "/shotwell/src/util/string.vala"
		result = NULL;
#line 132 "/shotwell/src/util/string.vala"
		return result;
#line 957 "string.c"
	}
#line 134 "/shotwell/src/util/string.vala"
	_tmp1_ = text;
#line 134 "/shotwell/src/util/string.vala"
	_tmp2_ = g_strdup (_tmp1_);
#line 134 "/shotwell/src/util/string.vala"
	prepped = _tmp2_;
#line 135 "/shotwell/src/util/string.vala"
	_tmp3_ = options;
#line 135 "/shotwell/src/util/string.vala"
...
#line 969 "string.c"
		const gchar* _tmp4_;
		gboolean _tmp5_;
#line 136 "/shotwell/src/util/string.vala"
		_tmp4_ = text;
#line 136 "/shotwell/src/util/string.vala"
		_tmp5_ = g_utf8_validate (_tmp4_, (gssize) -1, NULL);
#line 136 "/shotwell/src/util/string.vala"
...
#line 978 "string.c"
			...
			gchar* _tmp7_;
			const gchar* _tmp8_;
#line 137 "/shotwell/src/util/string.vala"
			_tmp6_ = text;
#line 137 "/shotwell/src/util/string.vala"
...
#line 137 "/shotwell/src/util/string.vala"
			prepped = _tmp7_;
#line 139 "/shotwell/src/util/string.vala"
			_tmp8_ = prepped;
#line 139 "/shotwell/src/util/string.vala"
			if (_tmp8_ == NULL) {
#line 994 "string.c"
				...
				gchar* _tmp11_;
#line 140 "/shotwell/src/util/string.vala"
				_tmp10_ = options;
#line 140 "/shotwell/src/util/string.vala"
...
#line 149 "/shotwell/src/util/string.vala"
	_tmp12_ = options;
#line 149 "/shotwell/src/util/string.vala"
...
#line 1026 "string.c"
		const gchar* _tmp13_;
		gchar* _tmp14_;
#line 150 "/shotwell/src/util/string.vala"
		_tmp13_ = prepped;
#line 150 "/shotwell/src/util/string.vala"
...
#line 152 "/shotwell/src/util/string.vala"
	_tmp15_ = options;
#line 152 "/shotwell/src/util/string.vala"
...
#line 1043 "string.c"
		const gchar* _tmp16_;
		gchar* _tmp17_;
#line 153 "/shotwell/src/util/string.vala"
		_tmp16_ = prepped;
#line 153 "/shotwell/src/util/string.vala"
...
#line 157 "/shotwell/src/util/string.vala"
	_tmp18_ = options;
#line 157 "/shotwell/src/util/string.vala"
...
#line 1060 "string.c"
		const gchar* _tmp19_;
		gchar* _tmp20_;
#line 158 "/shotwell/src/util/string.vala"
		_tmp19_ = prepped;
#line 158 "/shotwell/src/util/string.vala"
...
#line 160 "/shotwell/src/util/string.vala"
	_tmp22_ = options;
#line 160 "/shotwell/src/util/string.vala"
...
#line 160 "/shotwell/src/util/string.vala"
	if (_tmp21_) {
#line 161 "/shotwell/src/util/string.vala"
		result = NULL;
#line 161 "/shotwell/src/util/string.vala"
		_g_free0 (prepped);
#line 161 "/shotwell/src/util/string.vala"
...
#line 166 "/shotwell/src/util/string.vala"
	_tmp25_ = dest_length;
#line 166 "/shotwell/src/util/string.vala"
	if (_tmp25_ >= 0) {
#line 1106 "string.c"
		...
		const gchar* _tmp31_;
		gchar* _tmp32_;
#line 167 "/shotwell/src/util/string.vala"
		_tmp26_ = prepped;
#line 167 "/shotwell/src/util/string.vala"
		_tmp27_ = g_string_new (_tmp26_);
#line 167 "/shotwell/src/util/string.vala"
		sb = _tmp27_;
#line 168 "/shotwell/src/util/string.vala"
		_tmp28_ = sb;
#line 168 "/shotwell/src/util/string.vala"
		_tmp29_ = dest_length;
#line 168 "/shotwell/src/util/string.vala"
		g_string_truncate (_tmp28_, (gsize) _tmp29_);
#line 169 "/shotwell/src/util/string.vala"
		_tmp30_ = sb;
#line 169 "/shotwell/src/util/string.vala"
		_tmp31_ = _tmp30_->str;
#line 169 "/shotwell/src/util/string.vala"
...
#line 173 "/shotwell/src/util/string.vala"
	result = prepped;
#line 173 "/shotwell/src/util/string.vala"
	return result;
#line 1147 "string.c"
...
gint64 parse_int64 (const gchar* str, gint num_base) {
	...
	gint _tmp1_;
	gint64 _tmp2_;
#line 176 "/shotwell/src/util/string.vala"
	g_return_val_if_fail (str != NULL, 0LL);
#line 177 "/shotwell/src/util/string.vala"
	_tmp0_ = str;
#line 177 "/shotwell/src/util/string.vala"
	_tmp1_ = num_base;
#line 177 "/shotwell/src/util/string.vala"
...
inline gboolean string_contains_char (const gchar* haystack, gunichar needle) {
	...
	gunichar _tmp1_;
	gint _tmp2_;
#line 182 "/shotwell/src/util/string.vala"
	g_return_val_if_fail (haystack != NULL, FALSE);
#line 183 "/shotwell/src/util/string.vala"
	_tmp0_ = haystack;
#line 183 "/shotwell/src/util/string.vala"
	_tmp1_ = needle;
#line 183 "/shotwell/src/util/string.vala"
...
inline gboolean string_contains_str (const gchar* haystack, const gchar* needle) {
	...
	const gchar* _tmp1_;
	gint _tmp2_;
#line 186 "/shotwell/src/util/string.vala"
	g_return_val_if_fail (haystack != NULL, FALSE);
#line 186 "/shotwell/src/util/string.vala"
	g_return_val_if_fail (needle != NULL, FALSE);
#line 187 "/shotwell/src/util/string.vala"
	_tmp0_ = haystack;
#line 187 "/shotwell/src/util/string.vala"
	_tmp1_ = needle;
#line 187 "/shotwell/src/util/string.vala"
...
inline gchar* string_sliced_at (const gchar* str, gint index) {
	...
	gchar* _tmp0_ = NULL;
	gint _tmp1_;
#line 190 "/shotwell/src/util/string.vala"
	g_return_val_if_fail (str != NULL, NULL);
#line 191 "/shotwell/src/util/string.vala"
	_tmp1_ = index;
#line 191 "/shotwell/src/util/string.vala"
	if (_tmp1_ >= 0) {
#line 1427 "string.c"
...
inline gchar* string_sliced_at_first_str (const gchar* haystack, const gchar* needle, gint start_index) {
	...
	gint _tmp4_;
	gchar* _tmp5_;
#line 194 "/shotwell/src/util/string.vala"
	g_return_val_if_fail (haystack != NULL, NULL);
#line 194 "/shotwell/src/util/string.vala"
	g_return_val_if_fail (needle != NULL, NULL);
#line 195 "/shotwell/src/util/string.vala"
	_tmp0_ = haystack;
#line 195 "/shotwell/src/util/string.vala"
	_tmp1_ = haystack;
#line 195 "/shotwell/src/util/string.vala"
...
inline gchar* string_sliced_at_last_str (const gchar* haystack, const gchar* needle, gint start_index) {
	...
	gint _tmp4_;
	gchar* _tmp5_;
#line 198 "/shotwell/src/util/string.vala"
	g_return_val_if_fail (haystack != NULL, NULL);
#line 198 "/shotwell/src/util/string.vala"
	g_return_val_if_fail (needle != NULL, NULL);
#line 199 "/shotwell/src/util/string.vala"
	_tmp0_ = haystack;
#line 199 "/shotwell/src/util/string.vala"
	_tmp1_ = haystack;
#line 199 "/shotwell/src/util/string.vala"
...
inline gchar* string_sliced_at_first_char (const gchar* haystack, gunichar ch, gint start_index) {
	...
	gint _tmp4_;
	gchar* _tmp5_;
#line 202 "/shotwell/src/util/string.vala"
	g_return_val_if_fail (haystack != NULL, NULL);
#line 203 "/shotwell/src/util/string.vala"
	_tmp0_ = haystack;
#line 203 "/shotwell/src/util/string.vala"
	_tmp1_ = haystack;
#line 203 "/shotwell/src/util/string.vala"
...
inline gchar* string_sliced_at_last_char (const gchar* haystack, gunichar ch, gint start_index) {
	...
	gint _tmp4_;
	gchar* _tmp5_;
#line 206 "/shotwell/src/util/string.vala"
	g_return_val_if_fail (haystack != NULL, NULL);
#line 207 "/shotwell/src/util/string.vala"
	_tmp0_ = haystack;
#line 207 "/shotwell/src/util/string.vala"
	_tmp1_ = haystack;
#line 207 "/shotwell/src/util/string.vala"
...
gchar* string_strip_leading_zeroes (const gchar* str) {
	...
	const gchar* _tmp17_;
	gchar* _tmp18_;
#line 211 "/shotwell/src/util/string.vala"
	g_return_val_if_fail (str != NULL, NULL);
#line 212 "/shotwell/src/util/string.vala"
	_tmp0_ = g_string_new ("");
#line 212 "/shotwell/src/util/string.vala"
	stripped = _tmp0_;
#line 213 "/shotwell/src/util/string.vala"
	prev_is_space = TRUE;
#line 1706 "string.c"
	{
		const gchar* iter = NULL;
		const gchar* _tmp1_;
#line 214 "/shotwell/src/util/string.vala"
		_tmp1_ = str;
#line 214 "/shotwell/src/util/string.vala"
		iter = _tmp1_;
#line 1714 "string.c"
...
#line 215 "/shotwell/src/util/string.vala"
				_tmp7_ = iter;
#line 215 "/shotwell/src/util/string.vala"
				_tmp8_ = string_get_char (_tmp7_, (glong) 0);
#line 215 "/shotwell/src/util/string.vala"
				ch = _tmp8_;
#line 217 "/shotwell/src/util/string.vala"
...
#line 1777 "string.c"
					...
					gunichar _tmp14_;
					gboolean _tmp15_;
#line 218 "/shotwell/src/util/string.vala"
					_tmp12_ = stripped;
#line 218 "/shotwell/src/util/string.vala"
					_tmp13_ = ch;
#line 218 "/shotwell/src/util/string.vala"
					g_string_append_unichar (_tmp12_, _tmp13_);
#line 219 "/shotwell/src/util/string.vala"
					_tmp14_ = ch;
#line 219 "/shotwell/src/util/string.vala"
...
#line 223 "/shotwell/src/util/string.vala"
	_tmp16_ = stripped;
#line 223 "/shotwell/src/util/string.vala"
	_tmp17_ = _tmp16_->str;
#line 223 "/shotwell/src/util/string.vala"
...
gchar* string_remove_diacritics (const gchar* istring) {
	...
	const gchar* _tmp12_;
	gchar* _tmp13_;
#line 226 "/shotwell/src/util/string.vala"
	g_return_val_if_fail (istring != NULL, NULL);
#line 227 "/shotwell/src/util/string.vala"
	_tmp0_ = g_string_new ("");
#line 227 "/shotwell/src/util/string.vala"
	builder = _tmp0_;
#line 229 "/shotwell/src/util/string.vala"
	i = 0;
#line 230 "/shotwell/src/util/string.vala"
	while (TRUE) {
#line 1894 "string.c"
		const gchar* _tmp1_;
		gchar* _tmp2_;
...
#line 231 "/shotwell/src/util/string.vala"
		_tmp7_ = ch;
#line 231 "/shotwell/src/util/string.vala"
...
#line 1943 "string.c"
			{
#line 239 "/shotwell/src/util/string.vala"
				continue;
#line 1947 "string.c"
			}
			default:
...
#line 241 "/shotwell/src/util/string.vala"
		_tmp9_ = builder;
#line 241 "/shotwell/src/util/string.vala"
		_tmp10_ = ch;
#line 241 "/shotwell/src/util/string.vala"
...
#line 243 "/shotwell/src/util/string.vala"
	_tmp11_ = builder;
#line 243 "/shotwell/src/util/string.vala"
	_tmp12_ = _tmp11_->str;
#line 243 "/shotwell/src/util/string.vala"
...
gchar* string_to_hex_string (const gchar* str) {
	...
	const gchar* _tmp8_;
	gchar* _tmp9_;
#line 246 "/shotwell/src/util/string.vala"
	g_return_val_if_fail (str != NULL, NULL);
#line 247 "/shotwell/src/util/string.vala"
	_tmp0_ = g_string_new ("");
#line 247 "/shotwell/src/util/string.vala"
	builder = _tmp0_;
#line 249 "/shotwell/src/util/string.vala"
	_tmp1_ = str;
#line 249 "/shotwell/src/util/string.vala"
	data = (guint8*) _tmp1_;
#line 250 "/shotwell/src/util/string.vala"
	while (TRUE) {
#line 1999 "string.c"
		guint8* _tmp2_;
...
#line 251 "/shotwell/src/util/string.vala"
		_tmp4_ = data;
#line 251 "/shotwell/src/util/string.vala"
		if (((gint) (*_tmp4_)) != 0) {
#line 251 "/shotwell/src/util/string.vala"
...
#line 253 "/shotwell/src/util/string.vala"
	_tmp7_ = builder;
#line 253 "/shotwell/src/util/string.vala"
	_tmp8_ = _tmp7_->str;
#line 253 "/shotwell/src/util/string.vala"
...
guint string_collated_hash (void* ptr) {
	...
	guint _tmp5_;
	guint _tmp6_;
#line 273 "/shotwell/src/util/string.vala"
	_tmp0_ = ptr;
#line 273 "/shotwell/src/util/string.vala"
	_tmp1_ = g_strdup ((const gchar*) _tmp0_);
#line 273 "/shotwell/src/util/string.vala"
	str = _tmp1_;
#line 275 "/shotwell/src/util/string.vala"
	_tmp2_ = g_str_hash;
#line 275 "/shotwell/src/util/string.vala"
...
guint string_precollated_hash (void* ptr) {
	...
	void* _tmp1_;
	guint _tmp2_;
#line 280 "/shotwell/src/util/string.vala"
	_tmp0_ = g_str_hash;
#line 280 "/shotwell/src/util/string.vala"
	_tmp1_ = ptr;
#line 280 "/shotwell/src/util/string.vala"
...
gint string_collated_compare (void* a, void* b) {
	...
	gint _tmp7_ = 0;
	gint _tmp8_;
#line 285 "/shotwell/src/util/string.vala"
	_tmp0_ = a;
#line 285 "/shotwell/src/util/string.vala"
	_tmp1_ = g_strdup ((const gchar*) _tmp0_);
#line 285 "/shotwell/src/util/string.vala"
	astr = _tmp1_;
#line 286 "/shotwell/src/util/string.vala"
	_tmp2_ = b;
#line 286 "/shotwell/src/util/string.vala"
	_tmp3_ = g_strdup ((const gchar*) _tmp2_);
#line 286 "/shotwell/src/util/string.vala"
	bstr = _tmp3_;
#line 288 "/shotwell/src/util/string.vala"
	_tmp4_ = astr;
#line 288 "/shotwell/src/util/string.vala"
	_tmp5_ = bstr;
#line 288 "/shotwell/src/util/string.vala"
...
#line 288 "/shotwell/src/util/string.vala"
	_result_ = _tmp6_;
#line 290 "/shotwell/src/util/string.vala"
	_tmp8_ = _result_;
#line 290 "/shotwell/src/util/string.vala"
	if (_tmp8_ != 0) {
#line 2146 "string.c"
...
gint string_precollated_compare (const gchar* astr, const gchar* akey, const gchar* bstr, const gchar* bkey) {
	...
	gint _tmp4_ = 0;
	gint _tmp5_;
#line 294 "/shotwell/src/util/string.vala"
...
#line 295 "/shotwell/src/util/string.vala"
	_tmp0_ = g_strcmp0;
#line 295 "/shotwell/src/util/string.vala"
	_tmp1_ = akey;
#line 295 "/shotwell/src/util/string.vala"
...
#line 295 "/shotwell/src/util/string.vala"
	_result_ = _tmp3_;
#line 297 "/shotwell/src/util/string.vala"
	_tmp5_ = _result_;
#line 297 "/shotwell/src/util/string.vala"
	if (_tmp5_ != 0) {
#line 2213 "string.c"
...
gboolean string_collated_equals (void* a, void* b) {
	...
	void* _tmp1_;
	gint _tmp2_;
#line 302 "/shotwell/src/util/string.vala"
	_tmp0_ = a;
#line 302 "/shotwell/src/util/string.vala"
	_tmp1_ = b;
#line 302 "/shotwell/src/util/string.vala"
...
gboolean string_precollated_equals (const gchar* astr, const gchar* akey, const gchar* bstr, const gchar* bkey) {
	...
	const gchar* _tmp3_;
	gint _tmp4_;
#line 306 "/shotwell/src/util/string.vala"
...
#line 307 "/shotwell/src/util/string.vala"
	_tmp0_ = astr;
#line 307 "/shotwell/src/util/string.vala"
	_tmp1_ = akey;
#line 307 "/shotwell/src/util/string.vala"
