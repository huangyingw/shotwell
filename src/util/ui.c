...
#line 25 "/shotwell/src/util/ui.vala"
	switch (self) {
#line 25 "/shotwell/src/util/ui.vala"
		case DIRECTION_FORWARD:
#line 87 "ui.c"
		{
#line 27 "/shotwell/src/util/ui.vala"
...
#line 97 "ui.c"
		{
#line 30 "/shotwell/src/util/ui.vala"
...
#line 103 "ui.c"
		...
		{
			GEnumValue* _tmp0_;
#line 33 "/shotwell/src/util/ui.vala"
...
void spin_event_loop (void) {
#line 39 "/shotwell/src/util/ui.vala"
	while (TRUE) {
#line 133 "ui.c"
		gboolean _tmp0_;
#line 39 "/shotwell/src/util/ui.vala"
...
#line 40 "/shotwell/src/util/ui.vala"
		gtk_main_iteration ();
#line 145 "ui.c"
	}
}
...
AdjustmentRelation get_adjustment_relation (GtkAdjustment* adjustment, gint value) {
	...
	gdouble _tmp2_;
#line 43 "/shotwell/src/util/ui.vala"
	g_return_val_if_fail (GTK_IS_ADJUSTMENT (adjustment), 0);
#line 44 "/shotwell/src/util/ui.vala"
	_tmp0_ = value;
#line 44 "/shotwell/src/util/ui.vala"
	_tmp1_ = adjustment;
#line 44 "/shotwell/src/util/ui.vala"
...
#line 45 "/shotwell/src/util/ui.vala"
...
#line 169 "ui.c"
		...
		gdouble _tmp7_;
#line 46 "/shotwell/src/util/ui.vala"
		_tmp3_ = value;
#line 46 "/shotwell/src/util/ui.vala"
		_tmp4_ = adjustment;
#line 46 "/shotwell/src/util/ui.vala"
...
#line 47 "/shotwell/src/util/ui.vala"
			result = ADJUSTMENT_RELATION_ABOVE;
#line 47 "/shotwell/src/util/ui.vala"
			return result;
#line 192 "ui.c"
		} else {
#line 49 "/shotwell/src/util/ui.vala"
...
void get_adjustment_page (GtkAdjustment* hadj, GtkAdjustment* vadj, GdkRectangle* result) {
	...
	GtkAdjustment* _tmp6_;
	gdouble _tmp7_;
#line 52 "/shotwell/src/util/ui.vala"
	g_return_if_fail (GTK_IS_ADJUSTMENT (hadj));
#line 52 "/shotwell/src/util/ui.vala"
	g_return_if_fail (GTK_IS_ADJUSTMENT (vadj));
#line 53 "/shotwell/src/util/ui.vala"
	memset (&rect, 0, sizeof (GdkRectangle));
#line 54 "/shotwell/src/util/ui.vala"
	_tmp0_ = hadj;
#line 54 "/shotwell/src/util/ui.vala"
	_tmp1_ = gtk_adjustment_get_value (_tmp0_);
#line 54 "/shotwell/src/util/ui.vala"
	rect.x = (gint) _tmp1_;
#line 55 "/shotwell/src/util/ui.vala"
	_tmp2_ = vadj;
#line 55 "/shotwell/src/util/ui.vala"
	_tmp3_ = gtk_adjustment_get_value (_tmp2_);
#line 55 "/shotwell/src/util/ui.vala"
	rect.y = (gint) _tmp3_;
#line 56 "/shotwell/src/util/ui.vala"
	_tmp4_ = hadj;
#line 56 "/shotwell/src/util/ui.vala"
	_tmp5_ = gtk_adjustment_get_page_size (_tmp4_);
#line 56 "/shotwell/src/util/ui.vala"
	rect.width = (gint) _tmp5_;
#line 57 "/shotwell/src/util/ui.vala"
	_tmp6_ = vadj;
#line 57 "/shotwell/src/util/ui.vala"
	_tmp7_ = gtk_adjustment_get_page_size (_tmp6_);
#line 57 "/shotwell/src/util/ui.vala"
	rect.height = (gint) _tmp7_;
#line 59 "/shotwell/src/util/ui.vala"
	*result = rect;
#line 59 "/shotwell/src/util/ui.vala"
	return;
#line 248 "ui.c"
...
#line 77 "/shotwell/src/util/ui.vala"
	_tmp0_ = field;
#line 77 "/shotwell/src/util/ui.vala"
	_tmp1_ = mask;
#line 77 "/shotwell/src/util/ui.vala"
