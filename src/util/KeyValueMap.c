...
KeyValueMap* key_value_map_construct (GType object_type, const gchar* group) {
	...
	const gchar* _tmp0_;
	gchar* _tmp1_;
#line 11 "/shotwell/src/util/KeyValueMap.vala"
	g_return_val_if_fail (group != NULL, NULL);
#line 11 "/shotwell/src/util/KeyValueMap.vala"
	self = (KeyValueMap*) g_type_create_instance (object_type);
#line 12 "/shotwell/src/util/KeyValueMap.vala"
	_tmp0_ = group;
#line 12 "/shotwell/src/util/KeyValueMap.vala"
...
KeyValueMap* key_value_map_copy (KeyValueMap* self) {
	...
	const gchar* _tmp0_;
	KeyValueMap* _tmp1_;
#line 15 "/shotwell/src/util/KeyValueMap.vala"
	g_return_val_if_fail (IS_KEY_VALUE_MAP (self), NULL);
#line 16 "/shotwell/src/util/KeyValueMap.vala"
...
#line 139 "KeyValueMap.c"
	{
		...
		GeeIterator* _tmp6_;
		GeeIterator* _tmp7_;
#line 17 "/shotwell/src/util/KeyValueMap.vala"
...
#line 17 "/shotwell/src/util/KeyValueMap.vala"
			key = (gchar*) _tmp11_;
#line 18 "/shotwell/src/util/KeyValueMap.vala"
			_tmp12_ = clone;
#line 18 "/shotwell/src/util/KeyValueMap.vala"
...
#line 20 "/shotwell/src/util/KeyValueMap.vala"
	result = clone;
#line 20 "/shotwell/src/util/KeyValueMap.vala"
	return result;
...
gchar* key_value_map_get_group (KeyValueMap* self) {
	...
	const gchar* _tmp0_;
	gchar* _tmp1_;
#line 23 "/shotwell/src/util/KeyValueMap.vala"
	g_return_val_if_fail (IS_KEY_VALUE_MAP (self), NULL);
#line 24 "/shotwell/src/util/KeyValueMap.vala"
	_tmp0_ = self->priv->group;
#line 24 "/shotwell/src/util/KeyValueMap.vala"
	_tmp1_ = g_strdup (_tmp0_);
#line 24 "/shotwell/src/util/KeyValueMap.vala"
...
GeeSet* key_value_map_get_keys (KeyValueMap* self) {
	...
	GeeSet* _tmp1_;
	GeeSet* _tmp2_;
#line 27 "/shotwell/src/util/KeyValueMap.vala"
	g_return_val_if_fail (IS_KEY_VALUE_MAP (self), NULL);
#line 28 "/shotwell/src/util/KeyValueMap.vala"
...
gboolean key_value_map_has_key (KeyValueMap* self, const gchar* key) {
	...
	const gchar* _tmp1_;
	gboolean _tmp2_;
#line 31 "/shotwell/src/util/KeyValueMap.vala"
	g_return_val_if_fail (IS_KEY_VALUE_MAP (self), FALSE);
#line 31 "/shotwell/src/util/KeyValueMap.vala"
	g_return_val_if_fail (key != NULL, FALSE);
#line 32 "/shotwell/src/util/KeyValueMap.vala"
	_tmp0_ = self->priv->map;
#line 32 "/shotwell/src/util/KeyValueMap.vala"
	_tmp1_ = key;
#line 32 "/shotwell/src/util/KeyValueMap.vala"
...
void key_value_map_set_string (KeyValueMap* self, const gchar* key, const gchar* value) {
	...
	const gchar* _tmp2_;
	const gchar* _tmp3_;
#line 35 "/shotwell/src/util/KeyValueMap.vala"
	g_return_if_fail (IS_KEY_VALUE_MAP (self));
#line 35 "/shotwell/src/util/KeyValueMap.vala"
	g_return_if_fail (key != NULL);
#line 35 "/shotwell/src/util/KeyValueMap.vala"
	g_return_if_fail (value != NULL);
#line 36 "/shotwell/src/util/KeyValueMap.vala"
	_tmp0_ = key;
#line 36 "/shotwell/src/util/KeyValueMap.vala"
	_vala_assert (_tmp0_ != NULL, "key != null");
#line 38 "/shotwell/src/util/KeyValueMap.vala"
...
void key_value_map_set_int (KeyValueMap* self, const gchar* key, gint value) {
	...
	gchar* _tmp4_;
	gchar* _tmp5_;
#line 41 "/shotwell/src/util/KeyValueMap.vala"
	g_return_if_fail (IS_KEY_VALUE_MAP (self));
#line 41 "/shotwell/src/util/KeyValueMap.vala"
	g_return_if_fail (key != NULL);
#line 42 "/shotwell/src/util/KeyValueMap.vala"
	_tmp0_ = key;
#line 42 "/shotwell/src/util/KeyValueMap.vala"
	_vala_assert (_tmp0_ != NULL, "key != null");
#line 44 "/shotwell/src/util/KeyValueMap.vala"
	_tmp1_ = self->priv->map;
#line 44 "/shotwell/src/util/KeyValueMap.vala"
	_tmp2_ = key;
#line 44 "/shotwell/src/util/KeyValueMap.vala"
...
void key_value_map_set_double (KeyValueMap* self, const gchar* key, gdouble value) {
	...
	gchar* _tmp4_;
	gchar* _tmp5_;
#line 47 "/shotwell/src/util/KeyValueMap.vala"
	g_return_if_fail (IS_KEY_VALUE_MAP (self));
#line 47 "/shotwell/src/util/KeyValueMap.vala"
	g_return_if_fail (key != NULL);
#line 48 "/shotwell/src/util/KeyValueMap.vala"
	_tmp0_ = key;
#line 48 "/shotwell/src/util/KeyValueMap.vala"
	_vala_assert (_tmp0_ != NULL, "key != null");
#line 50 "/shotwell/src/util/KeyValueMap.vala"
	_tmp1_ = self->priv->map;
#line 50 "/shotwell/src/util/KeyValueMap.vala"
	_tmp2_ = key;
#line 50 "/shotwell/src/util/KeyValueMap.vala"
...
void key_value_map_set_float (KeyValueMap* self, const gchar* key, gfloat value) {
	...
	gchar* _tmp4_;
	gchar* _tmp5_;
#line 53 "/shotwell/src/util/KeyValueMap.vala"
	g_return_if_fail (IS_KEY_VALUE_MAP (self));
#line 53 "/shotwell/src/util/KeyValueMap.vala"
	g_return_if_fail (key != NULL);
#line 54 "/shotwell/src/util/KeyValueMap.vala"
	_tmp0_ = key;
#line 54 "/shotwell/src/util/KeyValueMap.vala"
	_vala_assert (_tmp0_ != NULL, "key != null");
#line 56 "/shotwell/src/util/KeyValueMap.vala"
	_tmp1_ = self->priv->map;
#line 56 "/shotwell/src/util/KeyValueMap.vala"
	_tmp2_ = key;
#line 56 "/shotwell/src/util/KeyValueMap.vala"
...
void key_value_map_set_bool (KeyValueMap* self, const gchar* key, gboolean value) {
	...
	gchar* _tmp4_;
	gchar* _tmp5_;
#line 59 "/shotwell/src/util/KeyValueMap.vala"
	g_return_if_fail (IS_KEY_VALUE_MAP (self));
#line 59 "/shotwell/src/util/KeyValueMap.vala"
	g_return_if_fail (key != NULL);
#line 60 "/shotwell/src/util/KeyValueMap.vala"
	_tmp0_ = key;
#line 60 "/shotwell/src/util/KeyValueMap.vala"
	_vala_assert (_tmp0_ != NULL, "key != null");
#line 62 "/shotwell/src/util/KeyValueMap.vala"
	_tmp1_ = self->priv->map;
#line 62 "/shotwell/src/util/KeyValueMap.vala"
	_tmp2_ = key;
#line 62 "/shotwell/src/util/KeyValueMap.vala"
...
gchar* key_value_map_get_string (KeyValueMap* self, const gchar* key, const gchar* def) {
	...
	const gchar* _tmp4_;
	gchar* _tmp7_;
#line 65 "/shotwell/src/util/KeyValueMap.vala"
	g_return_val_if_fail (IS_KEY_VALUE_MAP (self), NULL);
#line 65 "/shotwell/src/util/KeyValueMap.vala"
	g_return_val_if_fail (key != NULL, NULL);
#line 66 "/shotwell/src/util/KeyValueMap.vala"
	_tmp0_ = self->priv->map;
#line 66 "/shotwell/src/util/KeyValueMap.vala"
	_tmp1_ = key;
#line 66 "/shotwell/src/util/KeyValueMap.vala"
...
#line 66 "/shotwell/src/util/KeyValueMap.vala"
	value = (gchar*) _tmp2_;
#line 68 "/shotwell/src/util/KeyValueMap.vala"
	_tmp4_ = value;
#line 68 "/shotwell/src/util/KeyValueMap.vala"
	if (_tmp4_ != NULL) {
...
gint key_value_map_get_int (KeyValueMap* self, const gchar* key, gint def) {
	...
	gint _tmp3_ = 0;
	const gchar* _tmp4_;
#line 71 "/shotwell/src/util/KeyValueMap.vala"
	g_return_val_if_fail (IS_KEY_VALUE_MAP (self), 0);
#line 71 "/shotwell/src/util/KeyValueMap.vala"
	g_return_val_if_fail (key != NULL, 0);
#line 72 "/shotwell/src/util/KeyValueMap.vala"
	_tmp0_ = self->priv->map;
#line 72 "/shotwell/src/util/KeyValueMap.vala"
	_tmp1_ = key;
#line 72 "/shotwell/src/util/KeyValueMap.vala"
...
#line 72 "/shotwell/src/util/KeyValueMap.vala"
	value = (gchar*) _tmp2_;
#line 74 "/shotwell/src/util/KeyValueMap.vala"
	_tmp4_ = value;
#line 74 "/shotwell/src/util/KeyValueMap.vala"
	if (_tmp4_ != NULL) {
...
gdouble key_value_map_get_double (KeyValueMap* self, const gchar* key, gdouble def) {
	...
	gdouble _tmp3_ = 0.0;
	const gchar* _tmp4_;
#line 77 "/shotwell/src/util/KeyValueMap.vala"
	g_return_val_if_fail (IS_KEY_VALUE_MAP (self), 0.0);
#line 77 "/shotwell/src/util/KeyValueMap.vala"
	g_return_val_if_fail (key != NULL, 0.0);
#line 78 "/shotwell/src/util/KeyValueMap.vala"
	_tmp0_ = self->priv->map;
#line 78 "/shotwell/src/util/KeyValueMap.vala"
	_tmp1_ = key;
#line 78 "/shotwell/src/util/KeyValueMap.vala"
...
#line 78 "/shotwell/src/util/KeyValueMap.vala"
	value = (gchar*) _tmp2_;
#line 80 "/shotwell/src/util/KeyValueMap.vala"
	_tmp4_ = value;
#line 80 "/shotwell/src/util/KeyValueMap.vala"
	if (_tmp4_ != NULL) {
...
gfloat key_value_map_get_float (KeyValueMap* self, const gchar* key, gfloat def) {
	...
	gfloat _tmp3_ = 0.0F;
	const gchar* _tmp4_;
#line 83 "/shotwell/src/util/KeyValueMap.vala"
	g_return_val_if_fail (IS_KEY_VALUE_MAP (self), 0.0F);
#line 83 "/shotwell/src/util/KeyValueMap.vala"
	g_return_val_if_fail (key != NULL, 0.0F);
#line 84 "/shotwell/src/util/KeyValueMap.vala"
	_tmp0_ = self->priv->map;
#line 84 "/shotwell/src/util/KeyValueMap.vala"
	_tmp1_ = key;
#line 84 "/shotwell/src/util/KeyValueMap.vala"
...
#line 84 "/shotwell/src/util/KeyValueMap.vala"
	value = (gchar*) _tmp2_;
#line 86 "/shotwell/src/util/KeyValueMap.vala"
	_tmp4_ = value;
#line 86 "/shotwell/src/util/KeyValueMap.vala"
	if (_tmp4_ != NULL) {
...
gboolean key_value_map_get_bool (KeyValueMap* self, const gchar* key, gboolean def) {
	...
	const gchar* _tmp4_;
#line 89 "/shotwell/src/util/KeyValueMap.vala"
	g_return_val_if_fail (IS_KEY_VALUE_MAP (self), FALSE);
#line 89 "/shotwell/src/util/KeyValueMap.vala"
	g_return_val_if_fail (key != NULL, FALSE);
#line 90 "/shotwell/src/util/KeyValueMap.vala"
	_tmp0_ = self->priv->map;
#line 90 "/shotwell/src/util/KeyValueMap.vala"
	_tmp1_ = key;
#line 90 "/shotwell/src/util/KeyValueMap.vala"
...
#line 90 "/shotwell/src/util/KeyValueMap.vala"
	value = (gchar*) _tmp2_;
#line 92 "/shotwell/src/util/KeyValueMap.vala"
	_tmp4_ = value;
#line 92 "/shotwell/src/util/KeyValueMap.vala"
	if (_tmp4_ != NULL) {
...
void key_value_map_get_point (KeyValueMap* self, const gchar* key, GdkPoint* def, GdkPoint* result) {
	...
	gpointer _tmp2_;
	const gchar* _tmp3_;
#line 100 "/shotwell/src/util/KeyValueMap.vala"
	g_return_if_fail (IS_KEY_VALUE_MAP (self));
#line 100 "/shotwell/src/util/KeyValueMap.vala"
	g_return_if_fail (key != NULL);
#line 100 "/shotwell/src/util/KeyValueMap.vala"
	g_return_if_fail (def != NULL);
#line 101 "/shotwell/src/util/KeyValueMap.vala"
	_tmp0_ = self->priv->map;
#line 101 "/shotwell/src/util/KeyValueMap.vala"
	_tmp1_ = key;
#line 101 "/shotwell/src/util/KeyValueMap.vala"
...
#line 101 "/shotwell/src/util/KeyValueMap.vala"
	value = (gchar*) _tmp2_;
#line 103 "/shotwell/src/util/KeyValueMap.vala"
	_tmp3_ = value;
#line 103 "/shotwell/src/util/KeyValueMap.vala"
	if (_tmp3_ == NULL) {
#line 832 "KeyValueMap.c"
		GdkPoint _tmp4_;
#line 104 "/shotwell/src/util/KeyValueMap.vala"
		_tmp4_ = *def;
#line 104 "/shotwell/src/util/KeyValueMap.vala"
		*result = _tmp4_;
#line 104 "/shotwell/src/util/KeyValueMap.vala"
...
#line 842 "KeyValueMap.c"
		...
		const gchar* _tmp6_;
		gint _tmp7_;
#line 106 "/shotwell/src/util/KeyValueMap.vala"
		_tmp5_.x = 0;
#line 106 "/shotwell/src/util/KeyValueMap.vala"
		_result_ = _tmp5_;
#line 107 "/shotwell/src/util/KeyValueMap.vala"
		_tmp6_ = value;
#line 107 "/shotwell/src/util/KeyValueMap.vala"
		_tmp7_ = sscanf (_tmp6_, "(%d, %d)", &_result_.x, &_result_.y);
#line 107 "/shotwell/src/util/KeyValueMap.vala"
		if (_tmp7_ == 2) {
#line 108 "/shotwell/src/util/KeyValueMap.vala"
			*result = _result_;
#line 108 "/shotwell/src/util/KeyValueMap.vala"
			_g_free0 (value);
#line 108 "/shotwell/src/util/KeyValueMap.vala"
...
#line 864 "KeyValueMap.c"
			...
			GdkPoint _tmp8_;
#line 110 "/shotwell/src/util/KeyValueMap.vala"
			_tmp8_ = *def;
#line 110 "/shotwell/src/util/KeyValueMap.vala"
			*result = _tmp8_;
#line 110 "/shotwell/src/util/KeyValueMap.vala"
...
void key_value_map_set_point (KeyValueMap* self, const gchar* key, GdkPoint* point) {
	...
	gchar* _tmp6_;
	gchar* _tmp7_;
#line 114 "/shotwell/src/util/KeyValueMap.vala"
	g_return_if_fail (IS_KEY_VALUE_MAP (self));
#line 114 "/shotwell/src/util/KeyValueMap.vala"
	g_return_if_fail (key != NULL);
#line 114 "/shotwell/src/util/KeyValueMap.vala"
	g_return_if_fail (point != NULL);
#line 115 "/shotwell/src/util/KeyValueMap.vala"
	_tmp0_ = self->priv->map;
#line 115 "/shotwell/src/util/KeyValueMap.vala"
	_tmp1_ = key;
#line 115 "/shotwell/src/util/KeyValueMap.vala"
...
#line 7 "/shotwell/src/util/KeyValueMap.vala"
...
#line 9 "/shotwell/src/util/KeyValueMap.vala"
...
#line 8 "/shotwell/src/util/KeyValueMap.vala"
	_g_free0 (self->priv->group);
#line 9 "/shotwell/src/util/KeyValueMap.vala"
