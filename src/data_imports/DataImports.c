/* DataImports.c generated by valac 0.36.6, the Vala compiler
...
static void _vala_array_add68 (gchar** * array, int* length, int* size, gchar* value) {
#line 20 "/shotwell/src/data_imports/DataImports.vala"
	if ((*length) == (*size)) {
#line 20 "/shotwell/src/data_imports/DataImports.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 20 "/shotwell/src/data_imports/DataImports.vala"
...
void data_imports_init (GError** error) {
	...
	gchar** _tmp3_;
	gint _tmp3__length1;
#line 19 "/shotwell/src/data_imports/DataImports.vala"
...
#line 22 "/shotwell/src/data_imports/DataImports.vala"
	_tmp3_ = core_ids;
#line 22 "/shotwell/src/data_imports/DataImports.vala"
	_tmp3__length1 = core_ids_length1;
#line 22 "/shotwell/src/data_imports/DataImports.vala"
	plugins_register_extension_point (SPIT_DATA_IMPORTS_TYPE_SERVICE, _ ("Data Imports"), RESOURCES_IMPORT, _tmp3_, _tmp3__length1);
#line 18 "/shotwell/src/data_imports/DataImports.vala"
	core_ids = (_vala_array_free (core_ids, core_ids_length1, (GDestroyNotify) g_free), NULL);
#line 89 "DataImports.c"
}
