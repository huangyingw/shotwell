...
gint natural_collate_read_number (gchar* s, gint* byte_index) {
	gint result = 0;
	gint number = 0;
#line 23 "/shotwell/src/NaturalCollate.vala"
	g_return_val_if_fail (s != NULL, 0);
#line 31 "/shotwell/src/NaturalCollate.vala"
	number = 0;
#line 33 "/shotwell/src/NaturalCollate.vala"
	while (TRUE) {
...
#line 34 "/shotwell/src/NaturalCollate.vala"
		_tmp7_ = number;
#line 34 "/shotwell/src/NaturalCollate.vala"
		number = _tmp7_ * 10;
#line 35 "/shotwell/src/NaturalCollate.vala"
		_tmp8_ = number;
#line 35 "/shotwell/src/NaturalCollate.vala"
		_tmp9_ = s;
#line 35 "/shotwell/src/NaturalCollate.vala"
...
#line 36 "/shotwell/src/NaturalCollate.vala"
		_tmp12_ = s;
#line 36 "/shotwell/src/NaturalCollate.vala"
		_tmp13_ = string_index_of_nth_char (_tmp12_, (glong) 1);
#line 36 "/shotwell/src/NaturalCollate.vala"
		second_char = _tmp13_;
#line 37 "/shotwell/src/NaturalCollate.vala"
		_tmp14_ = s;
#line 37 "/shotwell/src/NaturalCollate.vala"
		_tmp15_ = second_char;
#line 37 "/shotwell/src/NaturalCollate.vala"
...
#line 37 "/shotwell/src/NaturalCollate.vala"
		s = _tmp16_;
#line 38 "/shotwell/src/NaturalCollate.vala"
		_tmp17_ = *byte_index;
#line 38 "/shotwell/src/NaturalCollate.vala"
		_tmp18_ = second_char;
#line 38 "/shotwell/src/NaturalCollate.vala"
...
#line 40 "/shotwell/src/NaturalCollate.vala"
	result = number;
#line 40 "/shotwell/src/NaturalCollate.vala"
	_g_free0 (s);
#line 40 "/shotwell/src/NaturalCollate.vala"
...
gint natural_collate_compare (const gchar* str1, const gchar* str2) {
	...
	gint _tmp9_;
	gint _tmp10_;
#line 43 "/shotwell/src/NaturalCollate.vala"
	g_return_val_if_fail (str1 != NULL, 0);
#line 43 "/shotwell/src/NaturalCollate.vala"
	g_return_val_if_fail (str2 != NULL, 0);
#line 44 "/shotwell/src/NaturalCollate.vala"
	_tmp0_ = g_strcmp0;
#line 44 "/shotwell/src/NaturalCollate.vala"
	_tmp1_ = str1;
#line 44 "/shotwell/src/NaturalCollate.vala"
...
gchar* natural_collate_collate_key (gchar* str) {
	...
	gchar* _tmp72_;
	gchar* _tmp73_;
#line 47 "/shotwell/src/NaturalCollate.vala"
	g_return_val_if_fail (str != NULL, NULL);
#line 53 "/shotwell/src/NaturalCollate.vala"
	_tmp0_ = str;
#line 53 "/shotwell/src/NaturalCollate.vala"
	_tmp1_ = g_utf8_validate (_tmp0_, (gssize) -1, NULL);
#line 53 "/shotwell/src/NaturalCollate.vala"
	_vala_assert (_tmp1_, "str.validate()");
#line 54 "/shotwell/src/NaturalCollate.vala"
	_tmp2_ = g_strdup ("");
#line 54 "/shotwell/src/NaturalCollate.vala"
	_result_ = _tmp2_;
#line 55 "/shotwell/src/NaturalCollate.vala"
	_tmp3_ = str;
#line 55 "/shotwell/src/NaturalCollate.vala"
...
#line 55 "/shotwell/src/NaturalCollate.vala"
	eos = _tmp5_ == 0;
#line 57 "/shotwell/src/NaturalCollate.vala"
	while (TRUE) {
...
#line 58 "/shotwell/src/NaturalCollate.vala"
		_tmp7_ = str;
#line 58 "/shotwell/src/NaturalCollate.vala"
		_tmp8_ = g_utf8_validate (_tmp7_, (gssize) -1, NULL);
#line 58 "/shotwell/src/NaturalCollate.vala"
		_vala_assert (_tmp8_, "str.validate()");
#line 59 "/shotwell/src/NaturalCollate.vala"
		position = 0;
#line 60 "/shotwell/src/NaturalCollate.vala"
		while (TRUE) {
...
#line 62 "/shotwell/src/NaturalCollate.vala"
			_tmp16_ = position;
#line 62 "/shotwell/src/NaturalCollate.vala"
			position = _tmp16_ + 1;
#line 542 "NaturalCollate.c"
		}
#line 66 "/shotwell/src/NaturalCollate.vala"
		_tmp17_ = _result_;
#line 66 "/shotwell/src/NaturalCollate.vala"
		_tmp18_ = str;
#line 66 "/shotwell/src/NaturalCollate.vala"
...
#line 66 "/shotwell/src/NaturalCollate.vala"
		_g_free0 (_tmp21_);
#line 69 "/shotwell/src/NaturalCollate.vala"
		_tmp25_ = str;
#line 69 "/shotwell/src/NaturalCollate.vala"
		_tmp26_ = position;
#line 69 "/shotwell/src/NaturalCollate.vala"
...
#line 69 "/shotwell/src/NaturalCollate.vala"
		str = _tmp27_;
#line 71 "/shotwell/src/NaturalCollate.vala"
		_tmp28_ = str;
#line 71 "/shotwell/src/NaturalCollate.vala"
...
#line 71 "/shotwell/src/NaturalCollate.vala"
		eos = _tmp30_ == 0;
#line 72 "/shotwell/src/NaturalCollate.vala"
		position = 0;
#line 74 "/shotwell/src/NaturalCollate.vala"
		_tmp31_ = eos;
#line 74 "/shotwell/src/NaturalCollate.vala"
		if (!_tmp31_) {
#line 592 "NaturalCollate.c"
			...
			const gchar* _tmp65_;
			gchar* _tmp66_;
#line 76 "/shotwell/src/NaturalCollate.vala"
			_tmp32_ = str;
#line 76 "/shotwell/src/NaturalCollate.vala"
...
#line 76 "/shotwell/src/NaturalCollate.vala"
			number = _tmp34_;
#line 77 "/shotwell/src/NaturalCollate.vala"
			_tmp35_ = str;
#line 77 "/shotwell/src/NaturalCollate.vala"
			_tmp36_ = position;
#line 77 "/shotwell/src/NaturalCollate.vala"
...
#line 77 "/shotwell/src/NaturalCollate.vala"
			str = _tmp37_;
#line 78 "/shotwell/src/NaturalCollate.vala"
			_tmp38_ = number;
#line 78 "/shotwell/src/NaturalCollate.vala"
...
#line 79 "/shotwell/src/NaturalCollate.vala"
			_tmp44_ = g_strdup ("");
#line 79 "/shotwell/src/NaturalCollate.vala"
			to_append = _tmp44_;
#line 661 "NaturalCollate.c"
			{
				gint i = 0;
#line 80 "/shotwell/src/NaturalCollate.vala"
				i = 1;
...
#line 82 "/shotwell/src/NaturalCollate.vala"
						_tmp49_ = to_append;
#line 82 "/shotwell/src/NaturalCollate.vala"
...
#line 84 "/shotwell/src/NaturalCollate.vala"
			_tmp53_ = to_append;
#line 84 "/shotwell/src/NaturalCollate.vala"
			_tmp54_ = number;
#line 84 "/shotwell/src/NaturalCollate.vala"
...
#line 84 "/shotwell/src/NaturalCollate.vala"
			_g_free0 (_tmp56_);
#line 85 "/shotwell/src/NaturalCollate.vala"
			_tmp58_ = _result_;
#line 85 "/shotwell/src/NaturalCollate.vala"
...
#line 90 "/shotwell/src/NaturalCollate.vala"
		_tmp67_ = str;
#line 90 "/shotwell/src/NaturalCollate.vala"
...
#line 93 "/shotwell/src/NaturalCollate.vala"
	_tmp70_ = _result_;
#line 93 "/shotwell/src/NaturalCollate.vala"
...
#line 93 "/shotwell/src/NaturalCollate.vala"
	_g_free0 (_tmp72_);
#line 96 "/shotwell/src/NaturalCollate.vala"
	result = _result_;
#line 96 "/shotwell/src/NaturalCollate.vala"
	_g_free0 (str);
#line 96 "/shotwell/src/NaturalCollate.vala"
