...
#line 15 "/shotwell/src/plugins/StandardHostInterface.vala"
...
#line 16 "/shotwell/src/plugins/StandardHostInterface.vala"
...
#line 17 "/shotwell/src/plugins/StandardHostInterface.vala"
	_tmp2_ = pluggable;
#line 17 "/shotwell/src/plugins/StandardHostInterface.vala"
...
#line 18 "/shotwell/src/plugins/StandardHostInterface.vala"
	_tmp5_ = pluggable;
#line 18 "/shotwell/src/plugins/StandardHostInterface.vala"
...
#line 19 "/shotwell/src/plugins/StandardHostInterface.vala"
	_tmp7_ = pluggable;
#line 19 "/shotwell/src/plugins/StandardHostInterface.vala"
...
static gchar* plugins_standard_host_interface_parse_key (const gchar* id) {
	...
	const gchar* _tmp1_;
	GQuark _tmp3_ = 0U;
#line 25 "/shotwell/src/plugins/StandardHostInterface.vala"
...
#line 22 "/shotwell/src/plugins/StandardHostInterface.vala"
...
#line 192 "StandardHostInterface.c"
			...
			{
				gchar* _tmp4_;
#line 27 "/shotwell/src/plugins/StandardHostInterface.vala"
...
#line 208 "StandardHostInterface.c"
			...
			{
				gchar* _tmp5_;
#line 30 "/shotwell/src/plugins/StandardHostInterface.vala"
...
#line 224 "StandardHostInterface.c"
			...
			{
				gchar* _tmp6_;
#line 33 "/shotwell/src/plugins/StandardHostInterface.vala"
...
#line 240 "StandardHostInterface.c"
			...
			{
				gchar* _tmp7_;
#line 36 "/shotwell/src/plugins/StandardHostInterface.vala"
...
#line 256 "StandardHostInterface.c"
			default:
			{
				const gchar* _tmp8_;
				gchar* _tmp9_;
#line 39 "/shotwell/src/plugins/StandardHostInterface.vala"
				_tmp8_ = id;
#line 39 "/shotwell/src/plugins/StandardHostInterface.vala"
...
#line 44 "/shotwell/src/plugins/StandardHostInterface.vala"
...
static GFile* plugins_standard_host_interface_real_get_module_file (SpitHostInterface* base) {
	...
	GFile* _tmp0_;
	GFile* _tmp1_;
#line 43 "/shotwell/src/plugins/StandardHostInterface.vala"
...
static gboolean plugins_standard_host_interface_real_get_config_bool (SpitHostInterface* base, const gchar* key, gboolean def) {
	...
	gboolean _tmp6_;
	gboolean _tmp7_;
#line 47 "/shotwell/src/plugins/StandardHostInterface.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, PLUGINS_TYPE_STANDARD_HOST_INTERFACE, PluginsStandardHostInterface);
#line 47 "/shotwell/src/plugins/StandardHostInterface.vala"
	g_return_val_if_fail (key != NULL, FALSE);
#line 48 "/shotwell/src/plugins/StandardHostInterface.vala"
...
static void plugins_standard_host_interface_real_set_config_bool (SpitHostInterface* base, const gchar* key, gboolean val) {
	...
	const gchar* _tmp4_;
	gboolean _tmp5_;
#line 51 "/shotwell/src/plugins/StandardHostInterface.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, PLUGINS_TYPE_STANDARD_HOST_INTERFACE, PluginsStandardHostInterface);
#line 51 "/shotwell/src/plugins/StandardHostInterface.vala"
	g_return_if_fail (key != NULL);
#line 52 "/shotwell/src/plugins/StandardHostInterface.vala"
	_tmp0_ = config_facade_get_instance ();
#line 52 "/shotwell/src/plugins/StandardHostInterface.vala"
	_tmp1_ = _tmp0_;
#line 52 "/shotwell/src/plugins/StandardHostInterface.vala"
...
static gint plugins_standard_host_interface_real_get_config_int (SpitHostInterface* base, const gchar* key, gint def) {
	...
	gint _tmp6_;
	gint _tmp7_;
#line 55 "/shotwell/src/plugins/StandardHostInterface.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, PLUGINS_TYPE_STANDARD_HOST_INTERFACE, PluginsStandardHostInterface);
#line 55 "/shotwell/src/plugins/StandardHostInterface.vala"
	g_return_val_if_fail (key != NULL, 0);
#line 56 "/shotwell/src/plugins/StandardHostInterface.vala"
	_tmp0_ = config_facade_get_instance ();
#line 56 "/shotwell/src/plugins/StandardHostInterface.vala"
	_tmp1_ = _tmp0_;
#line 56 "/shotwell/src/plugins/StandardHostInterface.vala"
...
static void plugins_standard_host_interface_real_set_config_int (SpitHostInterface* base, const gchar* key, gint val) {
	...
	const gchar* _tmp4_;
	gint _tmp5_;
#line 59 "/shotwell/src/plugins/StandardHostInterface.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, PLUGINS_TYPE_STANDARD_HOST_INTERFACE, PluginsStandardHostInterface);
#line 59 "/shotwell/src/plugins/StandardHostInterface.vala"
	g_return_if_fail (key != NULL);
#line 60 "/shotwell/src/plugins/StandardHostInterface.vala"
	_tmp0_ = config_facade_get_instance ();
#line 60 "/shotwell/src/plugins/StandardHostInterface.vala"
	_tmp1_ = _tmp0_;
#line 60 "/shotwell/src/plugins/StandardHostInterface.vala"
...
static gchar* plugins_standard_host_interface_real_get_config_string (SpitHostInterface* base, const gchar* key, const gchar* def) {
	...
	gchar* _tmp6_;
	gchar* _tmp7_;
#line 63 "/shotwell/src/plugins/StandardHostInterface.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, PLUGINS_TYPE_STANDARD_HOST_INTERFACE, PluginsStandardHostInterface);
#line 63 "/shotwell/src/plugins/StandardHostInterface.vala"
	g_return_val_if_fail (key != NULL, NULL);
#line 64 "/shotwell/src/plugins/StandardHostInterface.vala"
	_tmp0_ = config_facade_get_instance ();
#line 64 "/shotwell/src/plugins/StandardHostInterface.vala"
	_tmp1_ = _tmp0_;
#line 64 "/shotwell/src/plugins/StandardHostInterface.vala"
...
static void plugins_standard_host_interface_real_set_config_string (SpitHostInterface* base, const gchar* key, const gchar* val) {
	...
	const gchar* _tmp4_;
	const gchar* _tmp5_;
#line 67 "/shotwell/src/plugins/StandardHostInterface.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, PLUGINS_TYPE_STANDARD_HOST_INTERFACE, PluginsStandardHostInterface);
#line 67 "/shotwell/src/plugins/StandardHostInterface.vala"
	g_return_if_fail (key != NULL);
#line 68 "/shotwell/src/plugins/StandardHostInterface.vala"
	_tmp0_ = config_facade_get_instance ();
#line 68 "/shotwell/src/plugins/StandardHostInterface.vala"
	_tmp1_ = _tmp0_;
#line 68 "/shotwell/src/plugins/StandardHostInterface.vala"
...
static gdouble plugins_standard_host_interface_real_get_config_double (SpitHostInterface* base, const gchar* key, gdouble def) {
	...
	gdouble _tmp6_;
	gdouble _tmp7_;
#line 71 "/shotwell/src/plugins/StandardHostInterface.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, PLUGINS_TYPE_STANDARD_HOST_INTERFACE, PluginsStandardHostInterface);
#line 71 "/shotwell/src/plugins/StandardHostInterface.vala"
	g_return_val_if_fail (key != NULL, 0.0);
#line 72 "/shotwell/src/plugins/StandardHostInterface.vala"
	_tmp0_ = config_facade_get_instance ();
#line 72 "/shotwell/src/plugins/StandardHostInterface.vala"
	_tmp1_ = _tmp0_;
#line 72 "/shotwell/src/plugins/StandardHostInterface.vala"
...
static void plugins_standard_host_interface_real_set_config_double (SpitHostInterface* base, const gchar* key, gdouble val) {
	...
	const gchar* _tmp4_;
	gdouble _tmp5_;
#line 75 "/shotwell/src/plugins/StandardHostInterface.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, PLUGINS_TYPE_STANDARD_HOST_INTERFACE, PluginsStandardHostInterface);
#line 75 "/shotwell/src/plugins/StandardHostInterface.vala"
	g_return_if_fail (key != NULL);
#line 76 "/shotwell/src/plugins/StandardHostInterface.vala"
	_tmp0_ = config_facade_get_instance ();
#line 76 "/shotwell/src/plugins/StandardHostInterface.vala"
	_tmp1_ = _tmp0_;
#line 76 "/shotwell/src/plugins/StandardHostInterface.vala"
...
static void plugins_standard_host_interface_real_unset_config_key (SpitHostInterface* base, const gchar* key) {
	...
	const gchar* _tmp3_;
	const gchar* _tmp4_;
#line 79 "/shotwell/src/plugins/StandardHostInterface.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (base, PLUGINS_TYPE_STANDARD_HOST_INTERFACE, PluginsStandardHostInterface);
#line 79 "/shotwell/src/plugins/StandardHostInterface.vala"
	g_return_if_fail (key != NULL);
#line 80 "/shotwell/src/plugins/StandardHostInterface.vala"
	_tmp0_ = config_facade_get_instance ();
#line 80 "/shotwell/src/plugins/StandardHostInterface.vala"
	_tmp1_ = _tmp0_;
#line 80 "/shotwell/src/plugins/StandardHostInterface.vala"
...
#line 9 "/shotwell/src/plugins/StandardHostInterface.vala"
...
#line 10 "/shotwell/src/plugins/StandardHostInterface.vala"
	_g_free0 (self->priv->config_domain);
#line 11 "/shotwell/src/plugins/StandardHostInterface.vala"
	_g_free0 (self->priv->config_id);
#line 12 "/shotwell/src/plugins/StandardHostInterface.vala"
	_g_object_unref0 (self->priv->module_file);
#line 13 "/shotwell/src/plugins/StandardHostInterface.vala"
